...
const site_docs_dev_tailwind_mdx_a76_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tailwind","title":"Tailwind CSS","description":"Använd Midas tema med Tailwind CSS","source":"@site/docs/dev/tailwind.mdx","sourceDirName":"dev","slug":"/dev/tailwind","permalink":"/dev/tailwind","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tailwind CSS","description":"Använd Midas tema med Tailwind CSS"},"sidebar":"sideBar","previous":{"title":"react-select","permalink":"/dev/react-select"},"next":{"title":"Tanstack Table","permalink":"/dev/tanstack-table"}}');
