...
const site_docs_dev_layout_get_started_mdx_b03_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/get-started","title":"Kom igång","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","source":"@site/docs/dev/layout/get-started.mdx","sourceDirName":"dev/layout","slug":"/dev/layout/get-started","permalink":"/dev/layout/get-started","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Kom igång","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"validation","permalink":"/design-patterns/validation"},"next":{"title":"Migrationsguide","permalink":"/dev/layout/migration"}}');
