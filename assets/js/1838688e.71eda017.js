...
const site_docs_components_dropzone_mdx_183_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/dropzone","title":"DropZone","description":"Ett generellt mål för drag & drop — inte begränsat till filuppladdning.","source":"@site/docs/components/dropzone.mdx","sourceDirName":"components","slug":"/components/dropzone","permalink":"/components/dropzone","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"DropZone","description":"Ett generellt mål för drag & drop — inte begränsat till filuppladdning."},"sidebar":"sideBar","previous":{"title":"DateField","permalink":"/components/datefield"},"next":{"title":"FileList","permalink":"/components/file-list"}}');
