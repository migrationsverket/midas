...
const site_docs_components_search_field_mdx_8ac_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/search-field","title":"SearchField","description":"Sökfält är en kombinationskomponent av TextField och Button","source":"@site/docs/components/search-field.mdx","sourceDirName":"components","slug":"/components/search-field","permalink":"/components/search-field","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"SearchField","tags":[],"description":"Sökfält är en kombinationskomponent av TextField och Button"},"sidebar":"sideBar","previous":{"title":"Radio","permalink":"/components/radio"},"next":{"title":"Select","permalink":"/components/select"}}');
