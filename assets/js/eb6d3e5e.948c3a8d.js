...
const site_docs_dev_layout_migration_mdx_eb6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/migration","title":"Migrationsguide","description":"Hur du går över från Layout i @midas-ds/components till @midas-ds/layout.","source":"@site/docs/dev/layout/migration.mdx","sourceDirName":"dev/layout","slug":"/dev/layout/migration","permalink":"/dev/layout/migration","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"title":"Migrationsguide","description":"Hur du går över från Layout i @midas-ds/components till @midas-ds/layout.","sidebar_position":2},"sidebar":"sideBar","previous":{"title":"Layout","permalink":"/dev/layout/"},"next":{"title":"Header","permalink":"/dev/layout/components/header"}}');
