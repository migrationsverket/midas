...
const site_docs_components_radio_mdx_7e6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/radio","title":"Radio","description":"Radio Button är en typ av inmatningsfält som används för att välja ett alternativ från en uppsättning alternativ","source":"@site/docs/components/radio.mdx","sourceDirName":"components","slug":"/components/radio","permalink":"/components/radio","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"form","permalink":"/tags/form"}],"version":"current","frontMatter":{"title":"Radio","description":"Radio Button är en typ av inmatningsfält som används för att välja ett alternativ från en uppsättning alternativ","tags":["form"]},"sidebar":"sideBar","previous":{"title":"MultiSelect","permalink":"/components/multi-select"},"next":{"title":"SearchField","permalink":"/components/search-field"}}');
