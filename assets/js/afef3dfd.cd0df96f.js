...
const site_docs_design_patterns_page_layout_header_sidebar_panel_mdx_afe_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/page-layout/header-sidebar-panel","title":"Applikationer med sidomeny","description":"Detta mönster passar applikationer med flera navigeringsalternativ och ett innehåll som behöver visas på en större skärm.","source":"@site/docs/design-patterns/page-layout/header-sidebar-panel.mdx","sourceDirName":"design-patterns/page-layout","slug":"/design-patterns/page-layout/header-sidebar-panel","permalink":"/design-patterns/page-layout/header-sidebar-panel","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"id":"header-sidebar-panel","title":"Applikationer med sidomeny","sidebar_position":2},"sidebar":"sideBar","previous":{"title":"Applikationer utan huvudmeny","permalink":"/design-patterns/page-layout/header"},"next":{"title":"Mobilorienterade applikationer","permalink":"/design-patterns/page-layout/header-navbar-panel"}}');
