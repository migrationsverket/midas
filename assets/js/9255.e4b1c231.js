...
// UNUSED EXPORTS: UNSTABLE_ListBoxLoadingSentinel
...
function $eed445e0843c11d0$var$ListBoxInner({ state: inputState, props: props, listBoxRef: listBoxRef }) {
    ...
    let { filter: filter, collectionProps: collectionProps, collectionRef: collectionRef } = (0, react.useContext)((0, Autocomplete/* UNSTABLE_InternalAutocompleteContext */._P)) || {};
    props = (0, react.useMemo)(()=>collectionProps ? {
            ...props,
            ...collectionProps
        } : props, [
        props,
...
const $eed445e0843c11d0$export$dca12b0bb56e4fc = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)('section', $eed445e0843c11d0$var$ListBoxSectionInner);
...
const $eed445e0843c11d0$export$e59f0e608576589b = (0, CollectionBuilder/* createLeafComponent */.KU)('loader', function ListBoxLoadingIndicator(props, ref, item) {
    let state = (0, react.useContext)($eed445e0843c11d0$export$7c5906fe4f1f2af2);
    ...
    return /*#__PURE__*/ (0, react).createElement((0, react).Fragment, null, /*#__PURE__*/ (0, react).createElement("div", {
        ...
        ...(0, mergeProps/* mergeProps */.v)((0, filterDOMProps/* filterDOMProps */.$)(props), optionProps),
        ...renderProps,
