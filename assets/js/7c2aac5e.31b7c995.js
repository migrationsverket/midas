...
const site_docs_components_file_list_mdx_7c2_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/file-list","title":"FileList","description":"Lista uppladdade filer","source":"@site/docs/components/file-list.mdx","sourceDirName":"components","slug":"/components/file-list","permalink":"/components/file-list","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"FileList","description":"Lista uppladdade filer"},"sidebar":"sideBar","previous":{"title":"DateField","permalink":"/components/datefield"},"next":{"title":"FileTrigger","permalink":"/components/file-trigger"}}');
