...
const site_docs_design_patterns_error_message_mdx_0de_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/error-message","title":"Validering","description":"Sammanfattning","source":"@site/docs/design-patterns/error-message.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/error-message","permalink":"/design-patterns/error-message","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{},"sidebar":"sideBar","previous":{"title":"Knappar och länkar","permalink":"/design-patterns/buttons-and-links"},"next":{"title":"Fokus","permalink":"/design-patterns/focus"}}');
