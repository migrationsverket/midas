...
const site_docs_dev_layout_components_layout_mdx_f9a_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/layout","title":"Layout, LayoutContent & Main","description":"Grundläggande strukturkomponenter för sidor.","source":"@site/docs/dev/layout/components/layout.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/layout","permalink":"/dev/layout/components/layout","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Layout, LayoutContent & Main","description":"Grundläggande strukturkomponenter för sidor."},"sidebar":"sideBar","previous":{"title":"Header","permalink":"/dev/layout/components/header"},"next":{"title":"Navbar","permalink":"/dev/layout/components/navbar"}}');
