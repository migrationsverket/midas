...
const site_docs_components_layout_get_started_mdx_b23_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/get-started","title":"Kom igång","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","source":"@site/docs/components/layout/get-started.mdx","sourceDirName":"components/layout","slug":"/components/layout/get-started","permalink":"/components/layout/get-started","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":0,"frontMatter":{"title":"Kom igång","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","sidebar_position":0},"sidebar":"sideBar","previous":{"title":"InfoBanner","permalink":"/components/info-banner"},"next":{"title":"Header","permalink":"/components/layout/header"}}');
