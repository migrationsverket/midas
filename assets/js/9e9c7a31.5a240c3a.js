...
const site_docs_components_accordion_mdx_9e9_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/accordion","title":"Accordion","description":"Dragspelskomponenten låter användare visa och dölja delar av relaterat innehåll på en sida.","source":"@site/docs/components/accordion.mdx","sourceDirName":"components","slug":"/components/accordion","permalink":"/components/accordion","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"components","permalink":"/tags/components"},{"inline":true,"label":"menu","permalink":"/tags/menu"},{"inline":true,"label":"accordion","permalink":"/tags/accordion"}],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Accordion","sidebar_position":1,"tags":["components","menu","accordion"],"description":"Dragspelskomponenten låter användare visa och dölja delar av relaterat innehåll på en sida."},"sidebar":"sideBar","previous":{"title":"Komponenter","permalink":"/components/"},"next":{"title":"Breadcrumbs","permalink":"/components/breadcrumbs"}}');
