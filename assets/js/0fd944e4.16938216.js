...
const site_docs_components_layout_header_mdx_0fd_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/header","title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","source":"@site/docs/components/layout/header.mdx","sourceDirName":"components/layout","slug":"/components/layout/header","permalink":"/components/layout/header","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Kom igång","permalink":"/components/layout/get-started"},"next":{"title":"Navbar","permalink":"/components/layout/navbar"}}');
