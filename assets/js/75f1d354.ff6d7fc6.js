...
const site_docs_components_layout_legacy_mdx_75f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/legacy","title":"Legacy Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud.","source":"@site/docs/components/layout/legacy.mdx","sourceDirName":"components/layout","slug":"/components/layout/legacy","permalink":"/components/layout/legacy","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"title":"Legacy Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud.","sidebar_position":7},"sidebar":"sideBar","previous":{"title":"Migrationsguide","permalink":"/components/layout/migration"},"next":{"title":"LinkButton","permalink":"/components/link-button"}}');
