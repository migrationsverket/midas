import{L as R}from"./LinkButton-mt5uTXFC.js";import"./iframe-y3W67OGZ.js";import"./preload-helper-Dp1pzeXC.js";import"./arrow-right-D4kjB7wC.js";import"./utils-BJXuAV4-.js";import"./clsx-B-dksMZM.js";import"./useFocusRing-CjSgtFIL.js";import"./index-C50br37e.js";import"./index-FvKmgXGU.js";import"./createLucideIcon-CR3oL2jv.js";import"./clsx-Ciqy0D92.js";import"./square-arrow-out-up-right-CWmqP84F.js";const{expect:j,userEvent:x}=__STORYBOOK_MODULE_TEST__,q={component:R,title:"Components/LinkButton",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{children:{name:"label"},variant:{options:["primary","secondary","tertiary","danger"],control:{type:"radio"},defaultValue:"primary"},isDisabled:{options:[!0,!1],control:{type:"radio"}},iconPlacement:{options:["right","left"],control:{type:"radio"},defaultValue:"left"}},args:{size:"large"}},r={args:{children:"Till E-tjänst",href:"#","data-testid":"link-button",className:"test-class"}},a={args:{...r.args,variant:"secondary"}},e={args:{...r.args,variant:"tertiary"}},t={args:{...r.args,children:"Föregående",iconPlacement:"left"}},n={args:{...r.args,isDisabled:!0},play:async({canvas:L,step:O})=>{await O("It should have cursor not allowed when disabled",async()=>{const i=L.getByRole("link");await x.hover(i),await j(i).toHaveStyle({cursor:"not-allowed"})})}},s={args:{children:"Till E-tjänst","data-testid":"link-button",onPress:()=>alert("navigation fn")}},o={args:{"data-testid":"link-button",children:"Radera",variant:"danger"}};var c,l,d;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
