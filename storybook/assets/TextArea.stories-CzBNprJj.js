import{j as r}from"./jsx-runtime-Nms4Y4qS.js";import{$ as F,a as B,I as L,b as H}from"./TextField-BLg3SWSQ.js";import{R as g}from"./index-BwDkhjyp.js";import"./Form-BnF4q38W.js";import"./useFocusable-oEo1n-jK.js";import"./index-Drt3gf4w.js";import"./_commonjsHelpers-BosuxZz1.js";import"./clsx-B-dksMZM.js";import"./useControlledState-CktEcWfI.js";import"./Hidden-CeomKQRv.js";import"./Button-C_z7reC9.js";import"./triangle-alert-BkMwT_kE.js";import"./createLucideIcon-WuqQdmgs.js";const O='"../../../theme/src/lib/tokens.css"',q='"Inter", sans-serif',z="#ffdfdf",G="(max-width: 767px)",J="#f2f2f2",K="#e6e6e6",Q="#bfbfbf",U="#000000",X="#e62323",Y="#2e7ca5",Z="500",ee="400",re="#1f1f1f",se="_textArea_k5imp_4",te="_count_k5imp_45",m={tokens:O,display:q,signalRed10:z,smBreakpoint:G,gray10:J,gray20:K,gray50:Q,black:U,signalRed100:X,blue100:Y,mediumWeight:Z,regularWeight:ee,inputText:re,textArea:se,count:te},ae=({label:v,description:w,rows:A,maxCharacters:s,errorMessage:D,showCounter:N,...c})=>{const[i,P]=g.useState(""),[p,T]=g.useState(!1),d=l=>{const u=l.target.value;P(u),s&&T(u.length>s)},W=()=>s?r.jsxs("span",{className:m.count,children:[i.length," / ",s]}):N?r.jsx("span",{className:m.count,children:i.length}):null,V=l=>p?`${i.length-l} tecken för mycket`:D;return r.jsx(F,{className:B.inputField,...c,children:r.jsxs(L,{label:v,description:w,errorMessage:V(s||0),isInvalid:p||c.isInvalid,...c,children:[r.jsx(W,{}),r.jsx(H,{className:m.textArea,rows:A,onFocus:d,onChange:d})]})})},be={component:ae,title:"Components/TextArea",tags:["autodocs"],argTypes:{label:{type:"string",description:"Etikett"},description:{type:"string"}}},e={args:{label:"Label",description:"Description"}},t={args:{...e.args,isInvalid:!0,errorMessage:"Error"}},a={args:{...e.args,maxCharacters:50}},n={args:{...e.args,showCounter:!0}},o={args:{...e.args,isDisabled:!0}};var f,x,h;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
    label: 'Label',
