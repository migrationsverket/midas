...
Vi har bytt API på accordion då den tidigare byggde på Radix UI. Nu har React Aria lagt till Accordions i sitt paket så därför har vi följt detta istället. Det nya APIet är förenklat från den tidigare vilket vi tror kommer unerlätta. Tillsammmans med förenklingen av APIet kommer även en ny varaint av Accordion.
