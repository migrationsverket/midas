...
Alla borttagna exporter har haft dokumenterade ersättningar sedan de markerades som deprecated. Se respektive komponents dokumentation för aktuellt API.
