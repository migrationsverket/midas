...
import { tokens, flat } from '@midas-ds/components/theme'
...
export const Layers = () => {
  return (
    ...
    >
      ...
      >
        <div style={{ backgroundColor: tokens.background['@'].$value, padding: '1rem' }}>
          <Text>background</Text>
          <div style={{ backgroundColor: flat.layer01Base, padding: '1rem', margin: '1rem 0 0 0' }}>
            <Text>layer01</Text>
