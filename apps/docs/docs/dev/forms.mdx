...
Om ett formulär valideras och har ogiltigta fält skall dessa presenteras i en översiktslista för att summera vad användaren behöver rätta till. För detta används en kombination av komponenterna `InfoBanner` och `Link`.
