...
import { UncontrolledForm, ControlledForm, RealtimeValidation, ServerValidation } from '@site/src/components/examples/form/FormExamples'
...
Den enklaste varianten för att använda ett formulär är via browserns FormData API. Submit är inaktiverat
...
:::tip
Felmeddelande kan presenteras under eller över formulärskomponenten via `errorPosition`. Se [mönster](/design-patterns/forms/#position-av-felmeddelande)
för mer information.
:::
