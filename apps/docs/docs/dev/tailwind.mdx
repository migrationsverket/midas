...
:::tip Sammanfattning
- **Semantiska tokens** (background-base, text-primary, space-medium, etc.): Använd `[var(--midas-*)]`
...
- **Spacing** - `--midas-space-xsmall/small/medium/large/xlarge` + numeriska steg (t.ex. `--midas-space-10`)
- **Storlekar** - `--midas-size-icon`, `--midas-size-control`, `--midas-size-option`, etc.
