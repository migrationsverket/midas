...
Sidebar är huvudnavigationen i layoutpaketet. Själva navigationen sker via [navigationskomponenterna](/dev/layout/components/navigation) `Navigation`, `NavigationItem` och `NavigationLink`.
