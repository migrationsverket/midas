...
När Sidebar är ihopfälld visas etiketten i `NavigationLink` som en tooltip vid hover. Därför är det viktigt att varje länk alltid har en `children`-prop (etikett) eftersom det är nödvändigt för tillgänglighet.
