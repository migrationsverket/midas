...
I `@midas-ds/components` finns komponenterna [Select](/components/form/select) och [ComboBox](/components/form/combobox)
...
Följande exempel visar hur du kan använda react-select för att sätta upp en komponent som efterliknar [ComboBox](/components/form/combobox) med flerval.
