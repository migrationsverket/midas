...
:::info
`Radio` från @midas-ds/components är en komposit av komponenterna `RadioField` & `RadioButton`. För ökad kontroll, vänligen importera respektive komponent separat.
:::
