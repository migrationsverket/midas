...
import {
  ...
  SimpleConfirm
} from "../../src/components/examples/checkbox/CheckboxExample";
...
Kryssrutor används för att låta användaren välja inget, ett eller flera alternativ. Om det endast ska gå att välja ett objekt i listan är det en [Radioknapp](/components/radio) som ska användas
