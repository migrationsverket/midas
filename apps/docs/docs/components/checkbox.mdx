...
:::info
`Checkbox` från @midas-ds/components är en komposit av komponenterna `CheckboxField` & `CheckboxButton`. För ökad kontroll, vänligen importera respektive komponent separat.
:::
