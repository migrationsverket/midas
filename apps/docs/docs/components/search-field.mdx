...
## Med etikett och beskrivning

Precis som andra fält kan `SearchField` ta en `label` och `description`. Används när fältet inte har en tydlig kontext från omgivningen.
