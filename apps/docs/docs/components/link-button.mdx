...
flowchart TD;
    ...
    style A fill:#143C50,color:#ffffff, stroke-width:0px
    style B fill:#143C50,color:#ffffff, stroke-width:0px
    style C fill:#fff,color:#143C50, stroke:#143C50, stroke-width:2px
    style D  fill:#fff,color:#143C50, stroke:#143C50, stroke-width:2px
    style E fill:#143C50,color:#ffffff, stroke-width:0px
