...
Om användaren behöver ha möjlighet att avstå från att välja ett de givna alternativen är rekommendationen att skapa ett sista alternativ som du kallar "Inget av givna alternativ" eller liknande.
...
Använd Radioknappar när användaren bara ska göra **ett** av flera val i en lista. Använd [Checkbox](/components/form/checkbox) om flera val ska kunna göras. Om det är fler alternativ än fem bör [Select](/components/form/select) användas istället.
