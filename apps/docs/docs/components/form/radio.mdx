...
Använd Radioknappar när användaren bara ska göra **ett** av flera val i en lista. Använd [Checkbox](/components/form/checkbox) om flera val ska kunna göras. Om det är fler alternativ än fem bör [Select](/components/select) användas istället.
