...
Filuppladdning skapas genom att kombinera [FileTrigger](/components/filetrigger), DropZone och [FileList](/components/file-list). Nedan beskrivs varianter och beteenden för filuppladdning. Se respektive komponent för API-dokumentation.
