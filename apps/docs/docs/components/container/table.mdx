...
Komponent för att visualisera data. Kan kombineras med andra komponenter, till exempel [Select](/components/form/select),
för att filtrera eller [SearchField](/components/form/search-field) för att söka osv.
