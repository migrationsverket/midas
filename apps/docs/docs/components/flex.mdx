...
<ComponentHeader name={'flex'} info={Info}/>
...
<Flex>
    <FlexItem col={12}>
        En kolumn som tar upp all bredd på en rad.
    </FlexItem>
    <FlexItem>
        En kolumn som tar upp så mycket plats den behöver.
    </FlexItem>
    <FlexItem col={"auto"}>
        En kolumn som fyller ut resterande plats på raden.
    </FlexItem>
    <FlexItem col={6}>
        En kolumn som tar 50% av bredden, men 100% i mobilen.
    </FlexItem>
</Flex>
```
