...
Om länken går till en annan URL än där besökaren för tillfället befinner sig bör länken öppnas i en ny flik. Detta görs genom att sätta `target='_blank'` på länken, detta förtydligas automatiskt i komponenten med en ikon.
