...
Select är en typ av input-fält som används för att välja **ett** alternativ från en uppsättning av flera alternativ. Om det ska gå att välja flera eller inget alternativ är det [Checkbox](./checkbox.mdx) som ska användas
...
```mermaid
flowchart TD;
    A[Ska användaren kunna välja mer än ett alternativ?] 
