...
Syftet med Navbar är att få applikationen att likna en native mobilapp, som oftast har navigation i botten av appen. Navbar ska inte användas samtidigt som [MobileMenu](/components/layout/header), utan Navbar används som den enda navigationen på små skärmar. Navbar kan användas tillsammans med [Sidebar](/components/layout/sidebar) — båda döljer sig automatiskt beroende på skärmstorlek, så inkludera båda i trädet och låt dem ta hand om responsiviteten själva.
