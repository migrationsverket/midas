...
Sidopanel som används som huvudnavigation i våra desktopapplikationer. Själva navigationen styrs av [navigationskomponenterna](/components/layout/navigation) `Navigation`, `NavigationItem` och `NavigationLink`.
