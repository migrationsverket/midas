...
Navigationskomponent som används både i [Sidebar](/components/layout/sidebar), [Navbar](/components/layout/navbar) och [MobileMenu](/components/layout/header/#mobilemenu) men med olika utseende beroende på kontext. Navigation anpassar automatiskt utseendet efter var den befinner sig.
