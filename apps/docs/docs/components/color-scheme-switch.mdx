...
`ColorSchemeSwitchMenu` är en kompakt variant som bara visar det aktiva läget. Valet görs via en meny. Den är lämplig att använda i situationer när det är ont om plats, t.ex. i [Header](/components/layout/header/).
