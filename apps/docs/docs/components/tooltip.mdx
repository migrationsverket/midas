...
Komponent som användas för att visa kort, temporär och icke-essentiell information när användaren hovrar över eller fokuserar på ett element.
...
Typiska användningsområden för Tooltip är för att förklara ikoner, för att visa kortkommandon eller för att beskriva en term. Tooltips ska inte användas för att visa information som användaren behöver för att kunna använda en komponent eller slutföra en uppgift. Om det finns mer information att visa än vad som ryms i en Tooltip, om det behövs interaktiva element eller om informationen är viktig för användaren används [Popover](/components/popover).

### Använd Tooltip för:

- Kort, stödjande information som är extra och inte nödvändig för att förstå eller slutföra en uppgift.

### Använd inte Tooltip för:

- Viktig information, felmeddelanden eller instruktioner som användaren måste se för att kunna fortsätta.

## Riktlinjer

- Håll texten kort och konkret
- Se till att tooltipen beskriver samma sak som triggern visar.
- Lägg inte längre text i en Tooltip än vad som är lätt att läsa på en gång.
- Använd inte Tooltip som enda sätt att göra en funktion synlig eller förståelig
