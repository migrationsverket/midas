...
<DatePicker label="Välj ett datum när du vill vara ledig" aria-label="Välj datum" />

### DateRangePicker

<DateRangePicker label="Ange din semesterperiod" aria-label="Välj spann av datum" />
