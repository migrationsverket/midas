...
## type, inputMode och autoComplete

`type` kan användas för att aktivera inbyggd validering av fältet. `type="email"` kräver att det som skrivs in är en giltig e-postadress.
