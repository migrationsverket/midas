...
import { TextField, TextFieldBase, Input, Label, Text, FieldError } from '@midas-ds/components'
...
Inmatningsfält när användaren ska fylla i kortare information, tex namn, personnummer eller e-postadress.
För inmatning som kräver flera rader används [TextArea](./textarea.mdx).
