...
Inmatningsfält när användaren ska fylla i kortare information, tex namn, personnummer eller e-postadress. För längre inmatning används [TextArea](/components/textarea).
...
`inputMode="email"` visar ett virtuellt tangentbord som är anpassat för e-postinmatning.
