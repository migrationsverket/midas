...
<ComponentHeader name={'Modal'} info={Info} friendlyName="Skriv svenska namn för komponenten" overrideHeadlessLink="https://react-spectrum.adobe.com/react-aria/Dialog.html" />
