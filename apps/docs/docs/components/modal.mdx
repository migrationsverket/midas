...
import { FormExample, ConfirmationExample, CustomCSSExample, HideCloseButtonExample } from '@site/src/components/examples/ModalExamples'
...
### Inaktivera stängningsknapp i header

Vid specialfall där användaren inte ska tillåtas lämna modalen kan stängningsknapp i headern
inaktiveras.
