...
Kort börjar med en grundläggande komponent som endast definierar kortytan. Sedan finns flertalet underkomponenter som kan användas för att flexibelt bygga upp kortet med olika innehåll.
...
Titeln är som standard en semantisk `<h2>` som ser ut som en `<h3>` (`<h5>` i horisontell layout). Korrigera det semantiska elementet med `elementType` vid behov.
