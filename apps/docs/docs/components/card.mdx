...
`CardLink` stöder även egenskapen `as` för att ersätta grundkomponenten med länken från ditt ramverk, för client-side routing. Se [Routing på klientnivå](/dev/client-side-routing) för mer information.
