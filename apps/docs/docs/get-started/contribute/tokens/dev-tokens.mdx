...
<ColorPaletteTable tokens={{
  ...
  lagoonblue: tokenDictionary.color.lagoonblue,
}} />
...
Semantiska färgtokens för Tag-komponenten. Byggda ovanpå primitiva paletter — signalfärger för `blue`, `green`, `red`, `yellow` samt dedikerade paletter för `teal`, `lagoonblue`, `orange` och `purple`. Används i: Tag.
