...
Gör ett produktionsbygge av dokumentationen:
...
På grund av prestandaproblem görs inte detta per default av `serve`-kommandot.

Kör dokumentationen lokalt och inkludera typescript-typer i tabeller:
