...
Du kan nu använda Midas design tokens som CSS-variabler. Läs mer om våra [tokens](/get-started/contribute/tokens/dev-tokens) för att se alla tillgängliga alternativ.
...
:::info Kommande breaking changes i v18

Vi samlar planerade brytande ändringar och tillhörande migreringsvägar i ett [GitHub-ärende](https://github.com/migrationsverket/midas/issues/1109). Där finns också information om vilka **future flags** som redan finns tillgängliga — opt-in-props du kan börja använda idag för att förbereda dig inför v18.
