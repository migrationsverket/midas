...
import { SimpleSearchExample } from '@site/src/components/examples/search-and-filter/SearchExamples'
...
- En sökning sker innan det inte finns någon data att ta ställning till. Syftet med sökningen är att se vad det finns för data. Användaren vet inte vilka värden som finns och sökningen är därför oftast mer fri, typiskt ett fritextfält.
...
Standardfallet vid sökning är ett [Sökfält](/components/search-field) där användaren skriver in en sökterm, tex Dossnummer.

<SimpleSearchExample />

I vissa fall behövs en mer avancerad sökning med flera alternativ. Då använder vi samma designmönster som för filtrering, se nedan.
