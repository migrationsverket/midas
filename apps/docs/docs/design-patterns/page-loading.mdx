...
- Visa en Spinner centrerat på skärmen och tona ner bakgrunden.

Undvik när:

- Vi vet hur gränssnittet kommer att se ut. Använd skeleton istället
- Endast en del av sidan laddas. Använd en spinner eller Skeleton på en komponenten/delen istället
