...
>
  ...
  >
    <div style={{ backgroundColor: semantic.background, padding: '1rem' }}>
      ...
      <div style={{ backgroundColor: semantic.layer01, padding: '1rem', margin: '1rem 0 0 0' }}>
        <Text>layer01</Text>
        <div style={{ backgroundColor: semantic.layer02, padding: '1rem', margin: '1rem 0 0 0' }}>
          <Text>layer02</Text>
        </div>
      </div>
    </div>
...
export const TokenGroup = ({ children }) => {
  return (
    <Flex
      fluid
      className='docs-card'
