...
Här kan du läsa om hur vi använder färger i Midas och hur de är tokeniserade. Tokens är en del av vår design och används för att skapa enhetlighet och konsekvens i våra produkter. Vi har definierat ett antal färger, typsnitt och storlekar som används genom hela vår plattform.
...
Färger är uppdelade i två grupper: referens och semantiska färger. Referensfärger är de grundläggande enskilda färgvärdena som används för att bygga upp vår palett.

Semantiska färger används för att sätta en färg på element i både ljust och mörk läge. De är döpta för att beskriva vart de bör användas. Nedan ser vi ett enkelt exempel med bakgrund och text med ett token men olika färger i ljust respektive mörkt läge.
