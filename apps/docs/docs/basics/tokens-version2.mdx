...
import { Grid, GridItem, Text } from '@midas-ds/components'
import { baseColors, semantic, generatedTokens, tokens, variables } from '@midas-ds/components/theme'
import CodeBlock from '@theme/CodeBlock'
import {Token, TokenList, Layers, ColorSpectrum, TokenNaming } from '@site/src/components/tokens'
...
<div style={{backgroundColor: variables.backgroundInverse, color: variables.textOnColor}}>HELLO HELLO</div>
