...
export const semantic = {
  ...
  borderTertiary: `light-dark(${baseColors.blue170}, ${baseColors.blue170})`,
  ...
  notificationBorderSuccess: `light-dark(${baseColors.signalGreen100}, ${baseColors.signalGreen100})`,
  notificationBorderInfo: `light-dark(${baseColors.signalBlue100}, ${baseColors.signalBlue100})`,
  notificationBorderImportant: `light-dark(${baseColors.signalYellow100}, ${baseColors.signalYellow100})`,
  notificationBorderWarning: `light-dark(${baseColors.signalRed100}, ${baseColors.signalRed100})`,
  notificationBackgroundSuccess: `light-dark(${baseColors.signalGreen20}, ${baseColors.gray180})`,
  notificationBackgroundInfo: `light-dark(${baseColors.signalBlue10}, ${baseColors.gray180})`,
  notificationBackgroundImportant: `light-dark(${baseColors.signalYellow10}, ${baseColors.gray180})`,
