...
describe('given a table with 1 row', async () => {
  it('should have only one page', async () => {
    ...
    await expect.element(getByText('1 - 1 of 1 row')).toBeInTheDocument()
  })
})
...
describe('given a table with 10 rows', async () => {
  it('should have only one page', async () => {
    ...
    await expect.element(getByText('1 - 10 of 10 rows')).toBeInTheDocument()
    await expect.element(getByText('of 1 page')).toBeInTheDocument()
  })
})
