...
<Button variant='tertiary'>Ta bort anmälan</Button>
  ...
  <Button isDisabled>{fruits.shuffled(1).name}</Button>
      ...
      children: ["För god tillgänglighet bör du sätta en label på ", (0,jsx_runtime.jsx)(_components.code, {
        children: "ButtonGroup"
  ...
  <Button isDisabled>{fruits.shuffled(1).name}</Button>
      ...
      scope: {
        ButtonGroup: ButtonGroup/* ButtonGroup */.e,
        Button: Button/* Button */.$,
        ButtonContext: dist_Button/* ButtonContext */.k
      },
      children: `<ButtonContext.Provider value={{isDisabled: true}}>
    <ButtonGroup>
      <Button>{fruits.shuffled(1).name}</Button>
      <Button variant="secondary">{fruits.shuffled(1).name}</Button>
      <Button>{fruits.shuffled(1).name}</Button>
      ...
      children: ["Se mönstret ", (0,jsx_runtime.jsxs)(Link/* Link */.N, {
