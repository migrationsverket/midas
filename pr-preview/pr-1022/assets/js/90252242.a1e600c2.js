...
const site_docs_components_modal_mdx_902_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/modal","title":"Modal","description":"Modal som lägger sig över allt annat innehåll.","source":"@site/docs/components/modal.mdx","sourceDirName":"components","slug":"/components/modal","permalink":"/pr-preview/pr-1022/components/modal","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Modal","description":"Modal som lägger sig över allt annat innehåll."},"sidebar":"sideBar","previous":{"title":"Menu","permalink":"/pr-preview/pr-1022/components/menu"},"next":{"title":"Pagination","permalink":"/pr-preview/pr-1022/components/pagination"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
function $5df64b3807dc15ee$export$d699905dd57c73ca() {
    ...
    (0, react.useEffect)(()=>{
        ...
        updateSize($5df64b3807dc15ee$var$getViewportSize());
        if ((0, platform/* isIOS */.un)()) window.addEventListener('blur', onBlur, true);
        if (!$5df64b3807dc15ee$var$visualViewport) window.addEventListener('resize', onResize);
        else $5df64b3807dc15ee$var$visualViewport.addEventListener('resize', onResize);
        return ()=>{
            cancelAnimationFrame(frame);
            if ((0, platform/* isIOS */.un)()) window.removeEventListener('blur', onBlur, true);
...
var _excluded=["className"];var ModalOverlay=/*#__PURE__*/(0,react.forwardRef)(function(_ref,ref){var className=_ref.className,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)($f3f84453ead64de5$export$8948f78d83984c69,Object.assign({className:(0,clsx/* default */.A)(className,ModalOverlay_module.modalOverlay),ref:ref},rest));});ModalOverlay.displayName='ModalOverlay';
;// ./packages/components/src/modal/Modal.tsx
var Modal_excluded=["children","title","hideCloseButton"];var Modal=/*#__PURE__*/(0,react.forwardRef)(function(_ref,ref){var children=_ref.children,title=_ref.title,_ref$hideCloseButton=_ref.hideCloseButton,hideCloseButton=_ref$hideCloseButton===void 0?false:_ref$hideCloseButton,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Modal_excluded);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return/*#__PURE__*/(0,jsx_runtime.jsx)(ModalOverlay,Object.assign({},rest,{children:(0,utils/* composeRenderProps */.HW)(children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsx)($f3f84453ead64de5$export$2b77a92f1a5ad772,{className:Modal_module.modal,ref:ref,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Dialog/* Dialog */.lG,{className:Modal_module.dialog,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Modal_module.modalHeader,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Modal_module.modalTitle,children:title&&/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* Heading */.D,{level:3,elementType:"h2",slot:"title",children:title})}),!hideCloseButton&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{slot:"close",variant:"tertiary",icon:x/* default */.A,iconPlacement:"right",children:strings.format('close')})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Modal_module.modalBody,tabIndex:-1,children:children})]})});})}));});Modal.displayName='Modal';
// EXTERNAL MODULE: ./packages/components/src/text/Text.tsx + 1 modules
var Text = __webpack_require__(19615);
