...
const site_docs_components_tag_mdx_e49_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/tag","title":"Tag","description":"Statusindikator","source":"@site/docs/components/tag.mdx","sourceDirName":"components","slug":"/components/tag","permalink":"/pr-preview/pr-1246/components/tag","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tag","description":"Statusindikator"},"sidebar":"sideBar","previous":{"title":"Tabs","permalink":"/pr-preview/pr-1246/components/tabs"},"next":{"title":"Text","permalink":"/pr-preview/pr-1246/components/text"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
;// ./apps/docs/src/components/examples/tag/TagExamples.tsx
var DynamicExample=function DynamicExample(){var items=[{id:'sky',name:'Sky'},{id:'mint',name:'Mint'},{id:'cream',name:'Cream'},{id:'teal',name:'Teal'},{id:'lagoon',name:'Lagoon'},{id:'lavender',name:'Lavender'},{id:'peach',name:'Peach'},{id:'pippin',name:'Pippin'}];return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagGroup */.C,{"aria-label":"Taggar",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagList/* TagList */.L,{items:items,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{id:item.id,color:item.id,children:item.name});}})})});};
...
const Scooter = (0,createLucideIcon/* default */.A)("scooter", __iconNode);
