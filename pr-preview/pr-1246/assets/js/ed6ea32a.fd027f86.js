...
const site_docs_design_patterns_feedback_mdx_ed6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/feedback","title":"Handlingar","description":"Detta mönster beskriver hur vi hanterar handlingar i våra system. Vi använder begreppet handling för att beskriva ett medvetet initiativ av användaren för att göra något i systemet. Handlingar utförs typiskt via knappar eller menyalternativ.","source":"@site/docs/design-patterns/feedback.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/feedback","permalink":"/pr-preview/pr-1246/design-patterns/feedback","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{},"sidebar":"sideBar","previous":{"title":"Knappar och länkar","permalink":"/pr-preview/pr-1246/design-patterns/buttons-and-links"},"next":{"title":"Formulär","permalink":"/pr-preview/pr-1246/design-patterns/forms"}}');
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["Detta mönster beskriver hur vi hanterar handlingar i våra system. Vi använder begreppet ", (0,jsx_runtime.jsx)(_components.em, {
        children: "handling"
      }), " för att beskriva ett medvetet initiativ av användaren för att göra något i systemet. Handlingar utförs typiskt via knappar eller menyalternativ."]
      ...
      children: "Denna sortens handling utförs alltid när den initieras av användaren. Fel eller saknade förutsättningar kommuniceras efter användarens försök att utföra handlingen."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "användning",
      children: "Användning"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Detta är normalfallet för handlingar. De flesta tillgängliga handlingar behöver inte valideras utan kan utföras direkt när användaren initierar dem.\nTypiska exempel:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
