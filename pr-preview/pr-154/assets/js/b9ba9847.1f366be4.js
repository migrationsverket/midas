...
const site_docs_components_logo_mdx_b9b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/logo","title":"Logo","description":"Migrationsverkets officiella logotyp, den röda bron tillsammans med namnet","source":"@site/docs/components/logo.mdx","sourceDirName":"components","slug":"/components/logo","permalink":"/pr-preview/pr-154/components/logo","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Logo","description":"Migrationsverkets officiella logotyp, den röda bron tillsammans med namnet"},"sidebar":"sideBar","previous":{"title":"Link","permalink":"/pr-preview/pr-154/components/link"},"next":{"title":"Modal","permalink":"/pr-preview/pr-154/components/modal"}}');
