...
module.exports = /*#__PURE__*/JSON.parse('{"permalink":"/pr-preview/pr-154/blog/midas-open-source","source":"@site/blog/open-source.md","title":"Midas har nu öppen källkod","description":"Designsystemet har nu öppen källkod och versionshanterat på GitHub. Detta för att vi enklare ska kunna dela med oss av vårt designsystem med andra myndigheter som också gått samma väg.","date":"2024-06-25T06:55:54.000Z","tags":[{"inline":true,"label":"midas","permalink":"/pr-preview/pr-154/blog/tags/midas"}],"readingTime":0.94,"hasTruncateMarker":true,"authors":[],"frontMatter":{"title":"Midas har nu öppen källkod","description":"Designsystemet har nu öppen källkod och versionshanterat på GitHub. Detta för att vi enklare ska kunna dela med oss av vårt designsystem med andra myndigheter som också gått samma väg.","slug":"midas-open-source","tags":["midas"],"hide_table_of_contents":true},"unlisted":false,"prevItem":{"title":"Release 12","permalink":"/pr-preview/pr-154/blog/release-12"}}');
