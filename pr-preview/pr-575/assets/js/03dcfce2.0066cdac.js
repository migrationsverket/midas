...
const site_docs_components_date_picker_mdx_03d_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/date-picker","title":"DatePicker","description":"Fält för att välja ett datum eller ett spann av datum med kalender.","source":"@site/docs/components/date-picker.mdx","sourceDirName":"components","slug":"/components/date-picker","permalink":"/pr-preview/pr-575/components/date-picker","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"DatePicker","description":"Fält för att välja ett datum eller ett spann av datum med kalender.","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
var _excluded=["children","isDisabled","isInvalid"];var DatePickerInputField=function DatePickerInputField(_ref){var _clsx,_clsx2;var children=_ref.children,isDisabled=_ref.isDisabled,isInvalid=_ref.isInvalid,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var _useTheme=(0,MidasThemeProvider/* useTheme */.D)(rest),size=_useTheme.size;return/*#__PURE__*/(0,jsx_runtime.jsxs)(Group/* Group */.Y,{className:(0,clsx/* clsx */.$)(DatePicker_module.inputField,(_clsx={},_clsx[DatePicker_module.medium]=size==='medium',_clsx)),children:[children,/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{className:(0,clsx/* clsx */.$)(DatePicker_module.calendarButton,(_clsx2={},_clsx2[DatePicker_module.medium]=size==='medium',_clsx2)),"data-invalid":isInvalid||undefined,isDisabled:isDisabled,children:/*#__PURE__*/(0,jsx_runtime.jsx)(calendar_days/* default */.A,{"aria-hidden":true,size:20})})]});};
