...
const site_docs_components_modal_mdx_902_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/modal","title":"Modal","description":"Modal som lägger sig över allt annat innehåll.","source":"@site/docs/components/modal.mdx","sourceDirName":"components","slug":"/components/modal","permalink":"/pr-preview/pr-137/components/modal","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Modal","tags":[],"description":"Modal som lägger sig över allt annat innehåll."},"sidebar":"sideBar","previous":{"title":"Logo","permalink":"/pr-preview/pr-137/components/logo"},"next":{"title":"MultiSelect","permalink":"/pr-preview/pr-137/components/multi-select"}}');
...
const modal_namespaceObject = /*#__PURE__*/JSON.parse('{"_id":"@midas-ds/modal@0.1.1","_rev":"1-e341d372be6f661967831db15b22b83f","name":"@midas-ds/modal","dist-tags":{"latest":"0.1.1"},"versions":["0.1.0","0.1.1"],"time":{"created":"2024-11-01T10:27:54.664Z","modified":"2024-11-06T12:37:43.111Z","0.1.0":"2024-11-01T10:27:54.939Z","0.1.1":"2024-11-06T12:37:42.935Z"},"bugs":{"url":"https://github.com/migrationsverket/midas/issues"},"homepage":"https://github.com/migrationsverket/midas#readme","repository":{"type":"git","url":"git+https://github.com/migrationsverket/midas.git"},"description":"```bash npm install @midas-ds/modal ```","maintainers":["wilhelmconsid <wilhelm.hjelm@consid.se>"],"readmeFilename":"README.md","_contentLength":0,"version":"0.1.1","main":"./index.js","types":"./index.d.ts","exports":{".":{"import":"./index.mjs","require":"./index.js","types":"./index.d.ts"}},"peerDependencies":{"react":"^18.2.0"},"publishConfig":{"access":"public"},"gitHead":"7d794fde2b4234bc8805910a101a684795e8cdee","_nodeVersion":"20.11.1","_npmVersion":"10.2.4","dist":{"integrity":"sha512-24RZXpYcONrqJXPkNNhl5LajOwFtFp6zJ0WZk7NscihXNdVnIgvdnLLW25O99rQDsTzSILVFe9ThDuJCg2gpIA==","shasum":"6f8d088018f0b816647bccba6e98bbdc441de30d","tarball":"https://registry.npmjs.org/@midas-ds/modal/-/modal-0.1.1.tgz","fileCount":8,"unpackedSize":166623,"signatures":[{"keyid":"SHA256:jl3bwswu80PjjokCgh0o2w5c2U4LhQAE57gj9cz1kzA","sig":"MEUCIAWjbriHeMQBQqGfeQ9Mvg84KF8gABjFxAMwlocGNCheAiEAuaVg0fEdSzrQKGIKh/0GfWtTyqkh+srXJ6jd51eVb/k="}]},"_npmUser":"wilhelmconsid <wilhelm.hjelm@consid.se>","directories":{},"_npmOperationalInternal":{"host":"s3://npm-registry-packages","tmp":"tmp/modal_0.1.1_1730896662653_0.6169893816612826"},"_hasShrinkwrap":false}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: `
<>
      <Button onPress={setIsOpened}>Radera frukter</Button>
      <Modal isDismissable isOpen={isOpened} onOpenChange={setIsOpened}>
      {({ close }) => (
      <>
          <ModalHeader />
          <ModalBody
...
`
      ...
      children: `<>
  <Button onPress={setIsOpened}>Öppna modal</Button>
  <Modal isDismissable isOpen={isOpened} onOpenChange={setIsOpened}>
      {({ close }) => (
          <>
              <ModalHeader />
