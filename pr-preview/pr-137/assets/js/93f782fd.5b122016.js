...
const site_docs_components_grid_mdx_93f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/grid","title":"Grid","description":"Grid baserat på tekniken display grid i css","source":"@site/docs/components/grid.mdx","sourceDirName":"components","slug":"/components/grid","permalink":"/pr-preview/pr-137/components/grid","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"grid","permalink":"/pr-preview/pr-137/tags/grid"}],"version":"current","frontMatter":{"title":"Grid","tags":["grid"],"description":"Grid baserat på tekniken display grid i css"},"sidebar":"sideBar","previous":{"title":"Flex","permalink":"/pr-preview/pr-137/components/flex"},"next":{"title":"InfoBanner","permalink":"/pr-preview/pr-137/components/info-banner"}}');
