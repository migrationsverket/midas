...
const site_docs_components_select_mdx_af1_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/select","title":"Select","description":"<ComponentHeader","source":"@site/docs/components/select.mdx","sourceDirName":"components","slug":"/components/select","permalink":"/pr-preview/pr-137/components/select","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"form","permalink":"/pr-preview/pr-137/tags/form"}],"version":"current","frontMatter":{"title":"Select","tags":["form"]},"sidebar":"sideBar","previous":{"title":"SearchField","permalink":"/pr-preview/pr-137/components/search-field"},"next":{"title":"Spinner","permalink":"/pr-preview/pr-137/components/spinner"}}');
