...
const site_docs_dev_dark_mode_mdx_861_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/dark-mode","title":"Mörkt läge","description":"Hantera mörkt läge i designsystemet","source":"@site/docs/dev/dark-mode.mdx","sourceDirName":"dev","slug":"/dev/dark-mode","permalink":"/pr-preview/pr-1231/dev/dark-mode","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Mörkt läge","description":"Hantera mörkt läge i designsystemet"},"sidebar":"sideBar","previous":{"title":"Vanliga problem","permalink":"/pr-preview/pr-1231/dev/common-issues"},"next":{"title":"Formulär","permalink":"/pr-preview/pr-1231/dev/forms"}}');
