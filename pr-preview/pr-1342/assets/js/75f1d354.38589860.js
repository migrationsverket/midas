"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9408],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_layout_legacy_mdx_75f_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-layout-legacy-mdx-75f.json
const site_docs_components_layout_legacy_mdx_75f_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/legacy","title":"Legacy Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud.","source":"@site/docs/components/layout/legacy.mdx","sourceDirName":"components/layout","slug":"/components/layout/legacy","permalink":"/pr-preview/pr-1342/components/layout/legacy","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":7,"frontMatter":{"title":"Legacy Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud.","sidebar_position":7},"sidebar":"sideBar","previous":{"title":"Migrationsguide","permalink":"/pr-preview/pr-1342/components/layout/migration"},"next":{"title":"LinkButton","permalink":"/pr-preview/pr-1342/components/link-button"}}');
...
;// ./apps/docs/docs/components/layout/legacy.mdx
