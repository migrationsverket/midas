...
const site_docs_components_breadcrumbs_mdx_aca_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/breadcrumbs","title":"Breadcrumbs","description":"Brödsmulor används för att visa användaren var hen är i ett navigationsträd.","source":"@site/docs/components/breadcrumbs.mdx","sourceDirName":"components","slug":"/components/breadcrumbs","permalink":"/pr-preview/pr-1342/components/breadcrumbs","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Breadcrumbs","description":"Brödsmulor används för att visa användaren var hen är i ett navigationsträd."},"sidebar":"sideBar","previous":{"title":"Badge","permalink":"/pr-preview/pr-1342/components/badge"},"next":{"title":"Button","permalink":"/pr-preview/pr-1342/components/button"}}');
