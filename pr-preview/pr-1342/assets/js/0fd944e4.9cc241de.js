"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[7647],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_layout_header_mdx_0fd_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-layout-header-mdx-0fd.json
const site_docs_components_layout_header_mdx_0fd_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/header","title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","source":"@site/docs/components/layout/header.mdx","sourceDirName":"components/layout","slug":"/components/layout/header","permalink":"/pr-preview/pr-1342/components/layout/header","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Kom igång","permalink":"/pr-preview/pr-1342/components/layout/get-started"},"next":{"title":"Navbar","permalink":"/pr-preview/pr-1342/components/layout/navbar"}}');
...
// EXTERNAL MODULE: ./node_modules/@react-spectrum/utils/dist/useMediaQuery.mjs + 1 modules
var useMediaQuery = __webpack_require__(13486);
...
var collapsibleActions=[{id:'profile',label:'Min profil',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(user/* default */.A,{size:20})},{id:'settings',label:'Inställningar',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings/* default */.A,{size:20})},{id:'help',label:'Hjälp',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(circle_question_mark/* default */.A,{size:20})}];var BasicHeaderExample=function BasicHeaderExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",style:{overflow:'hidden',padding:0},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Header/* Header */.Y,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(MobileMenu/* MobileMenu */.q,{title:"Mitt system",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Navigation/* Navigation */.V,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationItem/* NavigationItem */.s,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationLink/* NavigationLink */.T,{href:"/",icon:/*#__PURE__*/(0,jsx_runtime.jsx)(house/* default */.A,{}),isActive:true,children:"Hem"})})})}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderLogo/* HeaderLogo */.b,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderTitle/* HeaderTitle */.g,{children:"Mitt system"}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderActions/* HeaderActions */.l,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(bell/* default */.A,{size:20}),children:"Notiser"})})]})});};var OverflowHeaderExample=function OverflowHeaderExample(){var isNarrow=(0,useMediaQuery/* useMediaQuery */.U)('(max-width: 700px)');return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",style:{overflow:'hidden',padding:0},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Header/* Header */.Y,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderLogo/* HeaderLogo */.b,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderTitle/* HeaderTitle */.g,{children:"Mitt system"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(HeaderActions/* HeaderActions */.l,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(bell/* default */.A,{size:20}),children:"Notiser"}),isNarrow?/*#__PURE__*/(0,jsx_runtime.jsxs)(Menu/* MenuTrigger */.cQ,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{"aria-label":"Fler alternativ",icon:/*#__PURE__*/(0,jsx_runtime.jsx)(ellipsis/* default */.A,{size:20})}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuPopover/* MenuPopover */.b,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(menu_Menu/* Menu */.W,{children:collapsibleActions.map(function(action){return/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:action.id,children:action.label},action.id);})})})]}):collapsibleActions.map(function(action){return/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:action.icon,children:action.label},action.id);})]})]})});};var HeaderActionsExample=function HeaderActionsExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",style:{overflow:'hidden',padding:0},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Header/* Header */.Y,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderLogo/* HeaderLogo */.b,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderTitle/* HeaderTitle */.g,{children:"Mitt system"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(HeaderActions/* HeaderActions */.l,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(bell/* default */.A,{size:20}),children:"Notiser"}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(user/* default */.A,{size:20}),children:"Min profil"}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings/* default */.A,{size:20}),children:"Inst\xE4llningar"})]})]})});};var MobileHeaderExample=function MobileHeaderExample(){var url=(0,useBaseUrl/* default */.Ay)('/layout-examples/header-mobile');return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",style:{display:'flex',alignItems:'center'},children:/*#__PURE__*/(0,jsx_runtime.jsx)("iframe",{title:"Header with mobile menu example",style:{width:'60%',height:72,border:'none',display:'block'},src:url})});};
;// ./apps/docs/docs/components/layout/header.mdx
...
const toc = [{
  ...
  "value": "Globala handlingar",
  "id": "globala-handlingar",
  "level": 2
}, {
  "value": "Overflow",
  "id": "overflow",
  ...
  "value": "Navigering på små skärmar/fönster",
  "id": "navigering-på-små-skärmarfönster",
  "level": 2
}, {
  "value": "Props",
  "id": "props",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Sidhuvud med logotyp, navigation på små skärmar samt plats för globala handlingar. Renderar ett semantiskt ", (0,jsx_runtime.jsx)(_components.code, {
        children: "<header>"
      }), "-element och tillhandahåller kontext för logotypstorlek (responsiv)."]
      ...
      children: ["Logotypen läggs till i Header via ", (0,jsx_runtime.jsx)(_components.code, {
        children: "<HeaderLogo>"
      }), ". Header hanterar responsiv storlek automatiskt och visar en kompakt variant på små skärmar (≤ 640px). Logotypen kan länka till startsidan genom att wrappas i den routing-komponent som används i applikationen."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      id: "globala-handlingar",
      children: "Globala handlingar"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["I Header läggs globala handlingar, alltså handlingar som användaren ska kunna komma åt från alla sidor i applikationen. Typiska globala handlingar är Logga ut och Inställningar. Dessa läggs till i Header via ", (0,jsx_runtime.jsx)(_components.code, {
        children: "<HeaderActions>"
      }), ". Varje global handling ska ha en ikon och en beskrivande etikett."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "<Header>\n  <HeaderLogo />\n  <HeaderTitle>Mitt system</HeaderTitle>\n  <HeaderActions>\n    <HeaderAction icon={<Bell size={20} />}>Notiser</HeaderAction>\n    <HeaderAction icon={<User size={20} />}>Min profil</HeaderAction>\n    <HeaderAction icon={<Settings size={20} />}>Inställningar</HeaderAction>\n  </HeaderActions>\n</Header>\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(HeaderActionsExample, {}), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "overflow",
      children: "Overflow"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "HeaderActions hanterar inte overflow automatiskt. Om applikationen har många globala handlingar behöver dessa läggas i en overflow-meny på små skärmar. Det görs via en mediaquery. Prova att ändra bredden på fönstret nedan för att se beteendet:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      id: "navigering-på-små-skärmarfönster",
      children: "Navigering på små skärmar/fönster"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Navigering på små skärmar/webbläsarfönster (≤ 640px) görs via Header och komponenten ", (0,jsx_runtime.jsx)(_components.code, {
        children: "MobileMenu"
      ...
      }), ". Det är därmed säkert att alltid inkludera den i trädet."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
