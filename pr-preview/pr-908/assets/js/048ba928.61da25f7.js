...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/files/MIDAS_UIkit_24-81f776070c0f1acc5b49a0b827ee6403.zip");
...
const site_docs_get_started_designer_mdx_048_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"get-started/designer","title":"Designa med Midas","description":"Eftersom vi är på väg att införa Figma så är allt skrivet utifrån hur vårt UI-kit i Figma är uppbyggt.","source":"@site/docs/get-started/designer.mdx","sourceDirName":"get-started","slug":"/get-started/designer","permalink":"/pr-preview/pr-908/get-started/designer","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"title":"Designa med Midas","sidebar_label":"Designresurser","sidebar_position":4,"pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
/* eslint-disable @nx/enforce-module-boundaries */function ThemedImage(_ref){var imageSrc=_ref.imageSrc,imageSrcDark=_ref.imageSrcDark;var imgSrc=(0,useBaseUrl/* default */.Ay)(imageSrc);var imgSrcDark=(0,useBaseUrl/* default */.Ay)(imageSrcDark);return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("img",{className:""+index_module/* default */.A.lightImage,src:imgSrc,alt:""}),/*#__PURE__*/(0,jsx_runtime.jsx)("img",{className:""+index_module/* default */.A.darkImage,src:imgSrcDark,alt:""})]});}
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.admonition, {
      ...
      children: [(0,jsx_runtime.jsx)(LinkButton/* LinkButton */.z, {
        ...
        target: "\\_blank",
        href: (__webpack_require__(39420)/* ["default"] */ .A),
        download: true,
        standalone: true,
      ...
      id: "",
      children: (0,jsx_runtime.jsx)(ThemedImage, {
        imageSrc: '/img/logo-storybook-default.svg',
        imageSrcDark: '/img/logo-storybook-inverse.svg'
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Storybook är en interaktiv miljö för våra UI-komponenter. Här kan du se alla komponenter i vårt bibliotek, testa dem i\nolika varianter och se hur de beter sig. Det är ett utmärkt verktyg för både utvecklare och designers för att utforska\noch förstå hur våra komponenter fungerar."
