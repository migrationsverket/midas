"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[6380],{
...
/* harmony export */ });
/* harmony import */ var _intlStrings_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93749);
...
function $d6542812f0669241$export$a407b657d3044108(props, state, ref) {
    ...
    let stringFormatter = (0, _react_aria_i18n__WEBPACK_IMPORTED_MODULE_4__/* .useLocalizedStringFormatter */ .o)((0, ($parcel$interopDefault(_intlStrings_mjs__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A))), '@react-aria/toast');
    ...
    let [isVisible, setIsVisible] = (0, react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
    (0, react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        setIsVisible(true);
    }, []);
    let toastProps = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .filterDOMProps */ .$)(props, {
        labelable: true
    });
    return {
        toastProps: {
...
class $a86207c5d7f7e1fb$var$LandmarkManager {
   ...
   */ getLandmarkByRole(role) {
    ...
    addLandmark(newLandmark) {
        ...
        if (this.landmarks.filter((landmark)=>landmark.role === 'main').length > 1 && "production" !== 'production') // removed by dead control flow
{}
   ...
   */ checkLabels(role) {
        ...
        if (landmarksWithRole.size > 1) {
            ...
            if (duplicatesWithoutLabel.length > 0 && "production" !== 'production') // removed by dead control flow
{}
...
function $6cc546b19ee7130a$export$b8cbbb20a51697de(props, state, ref) {
    ...
    let updateTimers = (0, useEffectEvent/* useEffectEvent */.J)(()=>{
    ...
    (0, useLayoutEffect/* useLayoutEffect */.N)(()=>{
        ...
        if (removedFocusedToastIndex > -1) {
            ...
            if ((0, useFocusVisible/* getInteractionModality */.ME)() === 'pointer' && ((_lastFocused_current = lastFocused.current) === null || _lastFocused_current === void 0 ? void 0 : _lastFocused_current.isConnected)) (0, focusWithoutScrolling/* focusWithoutScrolling */.e)(lastFocused.current);
            else {
                let i = 0;
                let nextToast;
                let prevToast;
