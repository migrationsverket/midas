...
function $46a4342aab3d8076$export$87e0539f600c24e5(props, state, ref) {
    ...
    let endDragging = (e)=>{
        ...
        let target = e.target;
        if (ref.current && (0, DOMFunctions/* isFocusWithin */.ae)(ref.current) && (!(0, DOMFunctions/* nodeContains */.sD)(ref.current, target) || !target.closest('button, [role="button"]'))) state.selectFocusedDate();
    };
    (0, useEvent/* useEvent */._)(windowRef, 'pointerup', endDragging);
    // Also stop range selection on blur, e.g. tabbing away from the calendar.
    res.calendarProps.onBlur = (e)=>{
        if (!ref.current) return;
        if ((!e.relatedTarget || !(0, DOMFunctions/* nodeContains */.sD)(ref.current, e.relatedTarget)) && state.anchorDate) state.selectFocusedDate();
    };
