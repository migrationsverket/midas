...
const site_docs_dev_dark_mode_mdx_861_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/dark-mode","title":"Mörkt läge","description":"Hantera mörkt läge i designsystemet","source":"@site/docs/dev/dark-mode.mdx","sourceDirName":"dev","slug":"/dev/dark-mode","permalink":"/pr-preview/pr-1110/dev/dark-mode","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Mörkt läge","description":"Hantera mörkt läge i designsystemet"},"sidebar":"sideBar","previous":{"title":"Vanliga problem","permalink":"/pr-preview/pr-1110/dev/common-issues"},"next":{"title":"Formulär","permalink":"/pr-preview/pr-1110/dev/forms"}}');
...
'use client';var ColorSchemeSwitch=function ColorSchemeSwitch(_ref){var _ref$selector=_ref.selector,selector=_ref$selector===void 0?':root':_ref$selector,_ref$defaultValue=_ref.defaultValue,defaultValue=_ref$defaultValue===void 0?new Set(['light dark']):_ref$defaultValue,className=_ref.className;// set hard to light or dark or "light dark" for system
