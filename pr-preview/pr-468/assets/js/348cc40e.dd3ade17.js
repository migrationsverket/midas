...
var BasicExample=function BasicExample(props){return/*#__PURE__*/(0,jsx_runtime.jsx)(_Layout,Object.assign({variant:"internal",items:[{items:[{title:'Översikt',href:'#',icon:House}]},{title:'Ansökan',items:[{title:'Skapa ansökan',href:'#',icon:plus/* default */.A},{title:'Beslut',href:'#',icon:Gavel}]},{title:'Kort och konto',items:[{title:'LMA-kort',href:'#',icon:Calendar},{title:'Avvikelser',href:'#',icon:ClipboardList,hasBadge:true}]}],title:"Skapa ans\xF6kningar",user:{name:'Namn Namnsson',title:'Roll eller behörighet'},app:{name:'Namn på applikationen'},headerChildren:/*#__PURE__*/(0,jsx_runtime.jsx)(LinkButton/* LinkButton */.z,{variant:"tertiary",target:"_blank",children:"\xD6ppna annan tj\xE4nst"})},props,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{background:tokens.semantic.layer02,display:'flex',justifyContent:'center',alignItems:'center',height:'100vh',border:"dotted 2px "+tokens.semantic.borderSubtle,color:tokens.semantic.textPrimary},children:"Din applikation"})}));};
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"tokens":"\"../theme/tokens.css\"","--font-family":"\"Inter\", sans-serif","--signal-red-140":"#e62323","--text-on-color":"light-dark(#ffffff, #ffffff)","badge":"badge_nGgv","hasChildren":"hasChildren_Zdhr","badgeContainer":"badgeContainer_X7uq"});
