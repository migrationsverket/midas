...
const site_docs_components_select_mdx_af1_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/select","title":"Select","description":"<ComponentHeader","source":"@site/docs/components/select.mdx","sourceDirName":"components","slug":"/components/select","permalink":"/pr-preview/pr-1237/components/select","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Select"},"sidebar":"sideBar","previous":{"title":"SearchField","permalink":"/pr-preview/pr-1237/components/search-field"},"next":{"title":"Skeleton","permalink":"/pr-preview/pr-1237/components/skeleton"}}');
