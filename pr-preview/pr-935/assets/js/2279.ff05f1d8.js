(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[2279],{
...
/* harmony import */ var _isIndex_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25353);
/* harmony import */ var _isObject_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(23149);
...
function isIterateeCall(value, index, object) {
  if (!(0,_isObject_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(object)) {
    return false;
  }
  ...
  if (type == 'number'
    ...
    return (0,_eq_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(object[index], value);
  }
  return false;
}
...
const change = (color, channels) => {
    const ch = _color_index_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.parse(color);
    for (const c in channels) {
        ch[c] = _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp[c](channels[c]);
    }
    return _color_index_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.stringify(ch);
};
/* EXPORT */
...
/* harmony export */ });
/* harmony import */ var _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26936);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11316);


// src/rendering-util/selectSvgElement.ts

var selectSvgElement = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((id) => {
  const { securityLevel } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
...
/* harmony export */ });
/* harmony import */ var _chunk_NCRKNZAS_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22269);
/* harmony import */ var _chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65425);
/* harmony import */ var _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(98045);
/* harmony import */ var _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(26936);
...
// src/internals.ts
var internalHelpers = {
  common: _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2,
  getConfig: _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj,
  insertCluster: _chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertCluster */ .U,
  insertEdge: _chunk_NCRKNZAS_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdge */ .Jo,
  insertEdgeLabel: _chunk_NCRKNZAS_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdgeLabel */ .jP,
  insertMarkers: _chunk_NCRKNZAS_mjs__WEBPACK_IMPORTED_MODULE_0__/* .markers_default */ .g0,
  insertNode: _chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertNode */ .on,
  interpolateToCurve: _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_2__/* .interpolateToCurve */ .Ib,
  labelHelper: _chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .labelHelper */ .Zk,
  log: _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm,
  positionEdgeLabel: _chunk_NCRKNZAS_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionEdgeLabel */ .T_
};

// src/rendering-util/render.ts
var layoutAlgorithms = {};
var registerLayoutLoaders = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((loaders) => {
  for (const loader of loaders) {
    layoutAlgorithms[loader.name] = loader;
  }
}, "registerLayoutLoaders");
var registerDefaultLayoutLoaders = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async () => await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(2334), __webpack_require__.e(1487)]).then(__webpack_require__.bind(__webpack_require__, 91487)), "loader")
    }
  ]);
}, "registerDefaultLayoutLoaders");
registerDefaultLayoutLoaders();
var render = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async (data4Layout, svg) => {
...
var getRegisteredLayoutAlgorithm = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((algorithm = "", { fallback = "dagre" } = {}) => {
  if (algorithm in layoutAlgorithms) {
    return algorithm;
  }
  if (fallback in layoutAlgorithms) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn(`Layout algorithm ${algorithm} is not registered. Using ${fallback} as fallback.`);
    return fallback;
  }
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   n: () => (/* binding */ package_default)
/* harmony export */ });
// package.json
var package_default = {
  name: "mermaid",
...
/* harmony export */ });
/* harmony import */ var _chunk_WH6PBGIT_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44120);
/* harmony import */ var _chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65425);
/* harmony import */ var _chunk_JSVUIEYQ_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(79423);
/* harmony import */ var _chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(75828);
/* harmony import */ var _chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(50708);
/* harmony import */ var _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(98045);
/* harmony import */ var _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(26936);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11316);
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(29893);
...
var addEdgeMarkers = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((svgPath, edge, url, id, diagramType, strokeColor) => {
...
var addEdgeMarker = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((svgPath, position, arrowType, url, id, diagramType, strokeColor) => {
  const arrowTypeInfo = arrowTypesMap[arrowType];
  if (!arrowTypeInfo) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn(`Unknown arrow type: ${arrowType}`);
    return;
  }
...
var clear = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => {
  edgeLabels.clear();
  terminalLabels.clear();
}, "clear");
var getLabelStyles = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((styleArray) => {
  let styles = styleArray ? styleArray.reduce((acc, style) => acc + ";" + style, "") : "";
  return styles;
}, "getLabelStyles");
var insertEdgeLabel = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (elem, edge) => {
  let useHtmlLabels = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart.htmlLabels);
  const labelElement = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_4__/* .createText */ .GZ)(elem, edge.label, {
    style: getLabelStyles(edge.labelStyle),
    useHtmlLabels,
    addSvgBackground: true,
    isNode: false
  });
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("abc82", edge, edge.labelType);
  ...
  if (useHtmlLabels) {
    ...
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ltv)(labelElement);
  ...
  if (edge.startLabelLeft) {
    const startLabelElement = await (0,_chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .createLabel_default */ .DA)(
      edge.startLabelLeft,
  ...
  if (edge.endLabelLeft) {
    const endLabelElement = await (0,_chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .createLabel_default */ .DA)(edge.endLabelLeft, getLabelStyles(edge.labelStyle));
  ...
  if (edge.endLabelRight) {
    const endLabelElement = await (0,_chunk_CV3G5MRU_mjs__WEBPACK_IMPORTED_MODULE_1__/* .createLabel_default */ .DA)(edge.endLabelRight, getLabelStyles(edge.labelStyle));
...
function setTerminalWidth(fo, value) {
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart.htmlLabels && fo) {
    fo.style.width = value.length * 9 + "px";
    fo.style.height = "12px";
  }
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(setTerminalWidth, "setTerminalWidth");
var positionEdgeLabel = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((edge, paths) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Moving label abc88 ", edge.id, edge.label, edgeLabels.get(edge.id), paths);
  let path = paths.updatedPath ? paths.updatedPath : paths.originalPath;
  const siteConfig = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  ...
  if (edge.label) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.calcLabelPosition(path);
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var outsideNode = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((node, point2) => {
  const x = node.x;
  const y = node.y;
...
var intersection = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((node, outsidePoint, insidePoint) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(`intersection calc abc89:
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(`abc89 top/bottom calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
    return res;
  } else {
    ...
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
    if (r === 0) {
      _x = outsidePoint.x;
      _y = outsidePoint.y;
    }
...
var cutPathAtIntersect = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((_points, boundaryNode) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("abc88 cutPathAtIntersect", _points, boundaryNode);
  let points = [];
  let lastPointOutside = _points[0];
  let isInside = false;
  _points.forEach((point2) => {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("abc88 checking point", point2, boundaryNode);
    if (!outsideNode(boundaryNode, point2) && !isInside) {
      const inter = intersection(boundaryNode, lastPointOutside, point2);
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("abc88 inside", point2, lastPointOutside, inter);
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("abc88 intersection", inter, boundaryNode);
      ...
      if (!points.some((e) => e.x === inter.x && e.y === inter.y)) {
        ...
        _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("abc88 no intersect", inter, points);
      }
      isInside = true;
    } else {
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("abc88 outside", point2, lastPointOutside);
  ...
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("returning points", points);
  return points;
}, "cutPathAtIntersect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(extractCornerPoints, "extractCornerPoints");
var findAdjacentPoint = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(pointA, pointB, distance) {
...
var fixCorners = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(lineData) {
...
var insertEdge = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(elem, edge, clusterDb, diagramType, startNode, endNode, id) {
  const { handDrawnSeed } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  ...
  for (const key in edge.cssCompiledStyles) {
    if ((0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isLabelStyle */ .KX)(key)) {
      continue;
    }
  ...
  if (edge.toCluster) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("to cluster abc88", clusterDb.get(edge.toCluster));
  ...
  let curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveBasis */ .qrM;
  curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveLinear */ .lUB;
  switch (edge.curve) {
    case "linear":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveLinear */ .lUB;
      break;
    case "basis":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveBasis */ .qrM;
      break;
    case "cardinal":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveCardinal */ .y8u;
      break;
    case "bumpX":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveBumpX */ .Wi0;
      break;
    case "bumpY":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveBumpY */ .PGM;
      break;
    case "catmullRom":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveCatmullRom */ .oDi;
      break;
    case "monotoneX":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveMonotoneX */ .nVG;
      break;
    case "monotoneY":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveMonotoneY */ .uxU;
      break;
    case "natural":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveNatural */ .Xf2;
      break;
    case "step":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveStep */ .GZz;
      break;
    case "stepAfter":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveStepAfter */ .UPb;
      break;
    case "stepBefore":
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveStepBefore */ .dyv;
      break;
    default:
      curve = d3__WEBPACK_IMPORTED_MODULE_7__/* .curveBasis */ .qrM;
  }
  const { x, y } = (0,_chunk_WH6PBGIT_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getLineFunctionsWithOffset */ .R)(edge);
  const lineFunction = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .line */ .n8j)().x(x).y(y).curve(curve);
  let strokeClasses;
  ...
  if (edge.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .A.svg(elem);
    ...
    svgPath = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ltv)(svgPathNode).select("path").attr("id", edge.id).attr("class", " " + strokeClasses + (edge.classes ? " " + edge.classes : "")).attr("style", edgeStyles ? edgeStyles.reduce((acc, style) => acc + ";" + style, "") : "");
  ...
  let url = "";
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart.arrowMarkerAbsolute || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().state.arrowMarkerAbsolute) {
    url = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getUrl */ .ID)(true);
  }
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("arrowTypeStart", edge.arrowTypeStart);
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("arrowTypeEnd", edge.arrowTypeEnd);
  addEdgeMarkers(svgPath, edge, url, id, diagramType, strokeColor);
  const midIndex = Math.floor(points.length / 2);
  const point2 = points[midIndex];
  if (!_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.isLabelCoordinateInPath(point2, svgPath.attr("d"))) {
    pointsHasChanged = true;
  }
  let paths = {};
  if (pointsHasChanged) {
...
var insertMarkers = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, markerArray, type, id) => {
  markerArray.forEach((markerName) => {
    markers[markerName](elem, type, id);
  });
}, "insertMarkers");
var extension = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Making markers for ", id);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionStart").attr("class", "marker extension " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 1,7 L18,13 V 1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionEnd").attr("class", "marker extension " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 1,1 V 13 L18,7 Z");
}, "extension");
var composition = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionStart").attr("class", "marker composition " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionEnd").attr("class", "marker composition " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "composition");
var aggregation = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationStart").attr("class", "marker aggregation " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationEnd").attr("class", "marker aggregation " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "aggregation");
var dependency = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyStart").attr("class", "marker dependency " + type).attr("refX", 6).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 5,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyEnd").attr("class", "marker dependency " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L14,7 L9,1 Z");
}, "dependency");
var lollipop = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopStart").attr("class", "marker lollipop " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopEnd").attr("class", "marker lollipop " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
}, "lollipop");
var point = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var circle = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-circleEnd").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", 11).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-circleStart").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", -1).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
}, "circle");
var cross = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-crossEnd").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", 12).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-crossStart").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", -1).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
}, "cross");
var barb = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var only_one = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var zero_or_one = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var one_or_more = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var zero_or_more = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var requirement_arrow = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
var requirement_contains = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, type, id) => {
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-MRT3R2DC.mjs
var chunk_MRT3R2DC = __webpack_require__(78052);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NXG7ZM6U.mjs
var chunk_NXG7ZM6U = __webpack_require__(10373);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NCRKNZAS.mjs
var chunk_NCRKNZAS = __webpack_require__(22269);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-WH6PBGIT.mjs
var chunk_WH6PBGIT = __webpack_require__(44120);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-CV3G5MRU.mjs
var chunk_CV3G5MRU = __webpack_require__(65425);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-JSVUIEYQ.mjs
var chunk_JSVUIEYQ = __webpack_require__(79423);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-7RNWAQOT.mjs
var chunk_7RNWAQOT = __webpack_require__(75828);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-62K37W7T.mjs + 13 modules
var chunk_62K37W7T = __webpack_require__(50708);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-U37J5Y7L.mjs
var chunk_U37J5Y7L = __webpack_require__(98045);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-4HWIWPIY.mjs
var chunk_4HWIWPIY = __webpack_require__(12754);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-T57MJCP2.mjs
var chunk_T57MJCP2 = __webpack_require__(10163);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-VIW5F6AA.mjs + 3 modules
var chunk_VIW5F6AA = __webpack_require__(26936);
...
var src = __webpack_require__(11316);
...
var id = "c4";
var detector = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(txt);
}, "detector");
var loader = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 2651).then(__webpack_require__.bind(__webpack_require__, 32651));
...
var id2 = "flowchart";
var detector2 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
  if (config?.flowchart?.defaultRenderer === "dagre-wrapper" || config?.flowchart?.defaultRenderer === "elk") {
    return false;
  }
  return /^\s*graph/.test(txt);
}, "detector");
var loader2 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 1424).then(__webpack_require__.bind(__webpack_require__, 31424));
...
var detector3 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
...
var loader3 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 1424).then(__webpack_require__.bind(__webpack_require__, 31424));
...
var id4 = "er";
var detector4 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*erDiagram/.test(txt);
}, "detector");
var loader4 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 1280).then(__webpack_require__.bind(__webpack_require__, 61280));
...
var id5 = "gitGraph";
var detector5 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*gitGraph/.test(txt);
}, "detector");
var loader5 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(7411)]).then(__webpack_require__.bind(__webpack_require__, 47411));
...
var id6 = "gantt";
var detector6 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*gantt/.test(txt);
}, "detector");
var loader6 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4924).then(__webpack_require__.bind(__webpack_require__, 54924));
...
var id7 = "info";
var detector7 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*info/.test(txt);
}, "detector");
var loader7 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(6108)]).then(__webpack_require__.bind(__webpack_require__, 56108));
...
var id8 = "pie";
var detector8 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*pie/.test(txt);
}, "detector");
var loader8 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(8365)]).then(__webpack_require__.bind(__webpack_require__, 48365));
...
var detector9 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*quadrantChart/.test(txt);
}, "detector");
var loader9 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 6228).then(__webpack_require__.bind(__webpack_require__, 56228));
...
var id10 = "xychart";
var detector10 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*xychart(-beta)?/.test(txt);
}, "detector");
var loader10 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 250).then(__webpack_require__.bind(__webpack_require__, 80250));
...
var detector11 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*requirement(Diagram)?/.test(txt);
}, "detector");
var loader11 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4881).then(__webpack_require__.bind(__webpack_require__, 74881));
...
var id12 = "sequence";
var detector12 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*sequenceDiagram/.test(txt);
}, "detector");
var loader12 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 6851).then(__webpack_require__.bind(__webpack_require__, 16851));
...
var id13 = "class";
var detector13 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
  if (config?.class?.defaultRenderer === "dagre-wrapper") {
    return false;
  }
  return /^\s*classDiagram/.test(txt);
}, "detector");
var loader13 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(776), __webpack_require__.e(3849)]).then(__webpack_require__.bind(__webpack_require__, 93849));
...
var detector14 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
  if (/^\s*classDiagram/.test(txt) && config?.class?.defaultRenderer === "dagre-wrapper") {
    return true;
  }
  return /^\s*classDiagram-v2/.test(txt);
}, "detector");
var loader14 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(776), __webpack_require__.e(4008)]).then(__webpack_require__.bind(__webpack_require__, 14008));
...
var id15 = "state";
var detector15 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
  if (config?.state?.defaultRenderer === "dagre-wrapper") {
    return false;
  }
  return /^\s*stateDiagram/.test(txt);
}, "detector");
var loader15 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(2334), __webpack_require__.e(3086), __webpack_require__.e(8181)]).then(__webpack_require__.bind(__webpack_require__, 88181));
...
var detector16 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config) => {
...
var loader16 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3086), __webpack_require__.e(7277)]).then(__webpack_require__.bind(__webpack_require__, 17277));
...
var id17 = "journey";
var detector17 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*journey/.test(txt);
}, "detector");
var loader17 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4802).then(__webpack_require__.bind(__webpack_require__, 54802));
...
var draw = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((_text, id28, version) => {
  chunk_VIW5F6AA/* log */.Rm.debug("rendering svg for syntax error\n");
  const svg = (0,chunk_T57MJCP2/* selectSvgElement */.D)(id28);
  const g = svg.append("g");
  svg.attr("viewBox", "0 0 2412 512");
  (0,chunk_VIW5F6AA/* configureSvgSize */.a$)(svg, 100, 512, true);
...
var diagram = {
  ...
  renderer,
  parser: {
    parse: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
      return;
    }, "parse")
  }
};
...
var detector18 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt, config = {}) => {
  if (
...
var loader18 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 1424).then(__webpack_require__.bind(__webpack_require__, 31424));
...
var id19 = "timeline";
var detector19 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*timeline/.test(txt);
}, "detector");
var loader19 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4051).then(__webpack_require__.bind(__webpack_require__, 34051));
...
var id20 = "mindmap";
var detector20 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*mindmap/.test(txt);
}, "detector");
var loader20 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(165), __webpack_require__.e(6320)]).then(__webpack_require__.bind(__webpack_require__, 16320));
...
var id21 = "kanban";
var detector21 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*kanban/.test(txt);
}, "detector");
var loader21 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 8176).then(__webpack_require__.bind(__webpack_require__, 28176));
...
var id22 = "sankey";
var detector22 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*sankey(-beta)?/.test(txt);
}, "detector");
var loader22 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 7573).then(__webpack_require__.bind(__webpack_require__, 27573));
...
var id23 = "packet";
var detector23 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*packet(-beta)?/.test(txt);
}, "detector");
var loader23 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(1454)]).then(__webpack_require__.bind(__webpack_require__, 61454));
...
var id24 = "radar";
var detector24 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*radar-beta/.test(txt);
}, "detector");
var loader24 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(2716)]).then(__webpack_require__.bind(__webpack_require__, 92716));
...
var id25 = "block";
var detector25 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*block(-beta)?/.test(txt);
}, "detector");
var loader25 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(7546)]).then(__webpack_require__.bind(__webpack_require__, 87546));
...
var detector26 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*architecture/.test(txt);
}, "detector");
var loader26 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(165), __webpack_require__.e(6587)]).then(__webpack_require__.bind(__webpack_require__, 96587));
...
var id27 = "treemap";
var detector27 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((txt) => {
  return /^\s*treemap/.test(txt);
}, "detector");
var loader27 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3624), __webpack_require__.e(8731), __webpack_require__.e(6710)]).then(__webpack_require__.bind(__webpack_require__, 86710));
...
var addDiagrams = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
  if (hasLoadedDiagrams) {
    return;
  }
  hasLoadedDiagrams = true;
  (0,chunk_VIW5F6AA/* registerDiagram */.Js)("error", errorDiagram_default, (text) => {
    return text.toLowerCase().trim() === "error";
  });
  (0,chunk_VIW5F6AA/* registerDiagram */.Js)(
    "---",
    // --- diagram type may appear if YAML front-matter is not parsed correctly
    {
      db: {
        clear: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
        }, "clear")
      },
      styles: {},
      // should never be used
      renderer: {
        draw: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
        }, "draw")
      },
      parser: {
        parse: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
      ...
      init: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => null, "init")
      // no op
    },
    (text) => {
  ...
  if (true) {
    (0,chunk_VIW5F6AA/* registerLazyLoadedDiagrams */.Xd)(detector_default, detector_default3, architectureDetector_default);
  }
  (0,chunk_VIW5F6AA/* registerLazyLoadedDiagrams */.Xd)(
    c4Detector_default,
    detector_default4,
...
var loadRegisteredDiagrams = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  chunk_VIW5F6AA/* log */.Rm.debug(`Loading registered diagrams`);
  const results = await Promise.allSettled(
    Object.entries(chunk_VIW5F6AA/* detectors */.mW).map(async ([key, { detector: detector28, loader: loader28 }]) => {
      if (!loader28) {
        return;
      }
      try {
        (0,chunk_VIW5F6AA/* getDiagram */.Gs)(key);
      } catch {
        try {
          const { diagram: diagram2, id: id28 } = await loader28();
          (0,chunk_VIW5F6AA/* registerDiagram */.Js)(id28, diagram2, detector28);
        } catch (err) {
          chunk_VIW5F6AA/* log */.Rm.error(`Failed to load external diagram with key ${key}. Removing from detectors.`);
          delete chunk_VIW5F6AA/* detectors */.mW[key];
          throw err;
        }
      }
    })
  ...
  if (failed.length > 0) {
    chunk_VIW5F6AA/* log */.Rm.error(`Failed to load ${failed.length} external diagrams`);
    for (const res of failed) {
      chunk_VIW5F6AA/* log */.Rm.error(res);
    }
...
(0,chunk_VIW5F6AA/* __name */.K2)(setA11yDiagramInfo, "setA11yDiagramInfo");
...
(0,chunk_VIW5F6AA/* __name */.K2)(addSVGa11yTitleDescription, "addSVGa11yTitleDescription");
...
var Diagram = class _Diagram {
  ...
  static {
    (0,chunk_VIW5F6AA/* __name */.K2)(this, "Diagram");
  }
  static async fromText(text, metadata = {}) {
    const config = (0,chunk_VIW5F6AA/* getConfig */.zj)();
    const type = (0,chunk_VIW5F6AA/* detectType */.Ch)(text, config);
    text = (0,chunk_U37J5Y7L/* encodeEntities */.C4)(text) + "\n";
    try {
      (0,chunk_VIW5F6AA/* getDiagram */.Gs)(type);
    } catch {
      const loader28 = (0,chunk_VIW5F6AA/* getDiagramLoader */.J$)(type);
      if (!loader28) {
        throw new chunk_VIW5F6AA/* UnknownDiagramError */.C0(`Diagram ${type} not found.`);
      }
      const { id: id28, diagram: diagram2 } = await loader28();
      (0,chunk_VIW5F6AA/* registerDiagram */.Js)(id28, diagram2);
    }
    const { db, parser, renderer: renderer2, init: init2 } = (0,chunk_VIW5F6AA/* getDiagram */.Gs)(type);
    if (parser.parser) {
      parser.parser.yy = db;
    }
    db.clear?.();
...
var attachFunctions = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
...
var cleanupComments = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((text) => {
  return text.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart();
}, "cleanupComments");

// src/diagram-api/frontmatter.ts
function extractFrontMatter(text) {
  const matches = text.match(chunk_VIW5F6AA/* frontMatterRegex */.EJ);
  if (!matches) {
    return {
      text,
      metadata: {}
  ...
  let parsed = (0,chunk_MRT3R2DC/* load */.H)(matches[1], {
    // To support config, we need JSON schema.
    // https://www.yaml.org/spec/1.2/spec.html#id2803231
    schema: chunk_MRT3R2DC/* JSON_SCHEMA */.r
  }) ?? {};
...
(0,chunk_VIW5F6AA/* __name */.K2)(extractFrontMatter, "extractFrontMatter");

// src/preprocess.ts
var cleanupText = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((code) => {
  return code.replace(/\r\n?/g, "\n").replace(
    /<(\w+)([^>]*)>/g,
    (match, tag, attributes) => "<" + tag + attributes.replace(/="([^"]*)"/g, "='$1'") + ">"
  );
}, "cleanupText");
var processFrontmatter = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((code) => {
...
var processDirectives = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((code) => {
  const initDirective = chunk_U37J5Y7L/* utils_default */._K.detectInit(code) ?? {};
  const wrapDirectives = chunk_U37J5Y7L/* utils_default */._K.detectDirective(code, "wrap");
  ...
  return {
    text: (0,chunk_U37J5Y7L/* removeDirectives */.vU)(code),
...
function preprocessDiagram(code) {
  ...
  const config = (0,chunk_U37J5Y7L/* cleanAndMerge */.$t)(frontMatterResult.config, directiveResult.directive);
...
(0,chunk_VIW5F6AA/* __name */.K2)(preprocessDiagram, "preprocessDiagram");
...
(0,chunk_VIW5F6AA/* __name */.K2)(toBase64, "toBase64");
...
function processAndSetConfigs(text) {
  ...
  (0,chunk_VIW5F6AA/* reset */.cL)();
  (0,chunk_VIW5F6AA/* addDirective */.xA)(processed.config ?? {});
  return processed;
}
(0,chunk_VIW5F6AA/* __name */.K2)(processAndSetConfigs, "processAndSetConfigs");
...
(0,chunk_VIW5F6AA/* __name */.K2)(mermaid_core_parse, "parse");
var cssImportantStyles = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((cssClass, element, cssClasses = []) => {
  return `
.${cssClass} ${element} { ${cssClasses.join(" !important; ")} !important; }`;
}, "cssImportantStyles");
var createCssStyles = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((config, classDefs = /* @__PURE__ */ new Map()) => {
  let cssStyles = "";
...
var createUserStyles = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((config, graphType, classDefs, svgId) => {
  const userCSSstyles = createCssStyles(config, classDefs);
  const allStyles = (0,chunk_VIW5F6AA/* styles_default */.tM)(graphType, userCSSstyles, config.themeVariables);
  return serialize(compile(`${svgId}{${allStyles}}`), stringify);
}, "createUserStyles");
var cleanUpSvgCode = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((svgCode = "", inSandboxMode, useArrowMarkerUrls) => {
  ...
  cleanedUpSvg = (0,chunk_U37J5Y7L/* decodeEntities */.Sm)(cleanedUpSvg);
  cleanedUpSvg = cleanedUpSvg.replace(/<br>/g, "<br/>");
  return cleanedUpSvg;
}, "cleanUpSvgCode");
var putIntoIFrame = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((svgCode = "", svgElement) => {
...
var appendDivSvgG = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((parentRoot, id28, enclosingDivId, divStyle, svgXlink) => {
...
(0,chunk_VIW5F6AA/* __name */.K2)(sandboxedIframe, "sandboxedIframe");
var removeExistingElements = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((doc, id28, divId, iFrameId) => {
  doc.getElementById(id28)?.remove();
  doc.getElementById(divId)?.remove();
  doc.getElementById(iFrameId)?.remove();
}, "removeExistingElements");
var render = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async function(id28, text, svgContainingElement) {
  addDiagrams();
  const processed = processAndSetConfigs(text);
  text = processed.code;
  const config = (0,chunk_VIW5F6AA/* getConfig */.zj)();
  chunk_VIW5F6AA/* log */.Rm.debug(config);
  ...
  const removeTempElements = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
  ...
  try {
    await diag.renderer.draw(text, id28, chunk_4HWIWPIY/* package_default */.n.version, diag);
  } catch (e) {
    if (config.suppressErrorRendering) {
      removeTempElements();
    } else {
      errorRenderer_default.draw(text, id28, chunk_4HWIWPIY/* package_default */.n.version);
    }
    throw e;
  }
  ...
  chunk_VIW5F6AA/* log */.Rm.debug("config.arrowMarkerAbsolute", config.arrowMarkerAbsolute);
  svgCode = cleanUpSvgCode(svgCode, isSandboxed, (0,chunk_VIW5F6AA/* evaluate */._3)(config.arrowMarkerAbsolute));
  if (isSandboxed) {
...
function initialize(userOptions = {}) {
  const options = (0,chunk_VIW5F6AA/* assignWithDepth_default */.hH)({}, userOptions);
  ...
  (0,chunk_VIW5F6AA/* saveConfigFromInitialize */.wZ)(options);
  if (options?.theme && options.theme in chunk_VIW5F6AA/* themes_default */.H$) {
    options.themeVariables = chunk_VIW5F6AA/* themes_default */.H$[options.theme].getThemeVariables(
      options.themeVariables
    );
  } else if (options) {
    options.themeVariables = chunk_VIW5F6AA/* themes_default */.H$.default.getThemeVariables(options.themeVariables);
  }
  const config = typeof options === "object" ? (0,chunk_VIW5F6AA/* setSiteConfig */.UU)(options) : (0,chunk_VIW5F6AA/* getSiteConfig */.Q2)();
  (0,chunk_VIW5F6AA/* setLogLevel */.He)(config.logLevel);
  addDiagrams();
}
(0,chunk_VIW5F6AA/* __name */.K2)(initialize, "initialize");
var getDiagramFromText = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((text, metadata = {}) => {
...
(0,chunk_VIW5F6AA/* __name */.K2)(addA11yInfo, "addA11yInfo");
var mermaidAPI = Object.freeze({
  render,
  parse: mermaid_core_parse,
  getDiagramFromText,
  initialize,
  getConfig: chunk_VIW5F6AA/* getConfig */.zj,
  setConfig: chunk_VIW5F6AA/* setConfig */.Nk,
  getSiteConfig: chunk_VIW5F6AA/* getSiteConfig */.Q2,
  updateSiteConfig: chunk_VIW5F6AA/* updateSiteConfig */.B6,
  reset: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
    (0,chunk_VIW5F6AA/* reset */.cL)();
  }, "reset"),
  globalReset: /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
    (0,chunk_VIW5F6AA/* reset */.cL)(chunk_VIW5F6AA/* defaultConfig */.sb);
  }, "globalReset"),
  defaultConfig: chunk_VIW5F6AA/* defaultConfig */.sb
});
(0,chunk_VIW5F6AA/* setLogLevel */.He)((0,chunk_VIW5F6AA/* getConfig */.zj)().logLevel);
(0,chunk_VIW5F6AA/* reset */.cL)((0,chunk_VIW5F6AA/* getConfig */.zj)());

// src/mermaid.ts
var handleError = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((error, errors, parseError) => {
  chunk_VIW5F6AA/* log */.Rm.warn(error);
  if ((0,chunk_U37J5Y7L/* isDetailedError */.dq)(error)) {
    if (parseError) {
...
var run = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async function(options = {
  querySelector: ".mermaid"
}) {
  try {
    await runThrowsErrors(options);
  } catch (e) {
    if ((0,chunk_U37J5Y7L/* isDetailedError */.dq)(e)) {
      chunk_VIW5F6AA/* log */.Rm.error(e.str);
    }
    if (mermaid.parseError) {
      mermaid.parseError(e);
    }
    if (!options.suppressErrors) {
      chunk_VIW5F6AA/* log */.Rm.error("Use the suppressErrors option to suppress these errors");
      throw e;
    }
  }
}, "run");
var runThrowsErrors = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async function({ postRenderCallback, querySelector, nodes } = {
  querySelector: ".mermaid"
}) {
  const conf = mermaidAPI.getConfig();
  chunk_VIW5F6AA/* log */.Rm.debug(`${!postRenderCallback ? "No " : ""}Callback function found`);
  let nodesToProcess;
  if (nodes) {
  ...
  chunk_VIW5F6AA/* log */.Rm.debug(`Found ${nodesToProcess.length} diagrams`);
  if (conf?.startOnLoad !== void 0) {
    chunk_VIW5F6AA/* log */.Rm.debug("Start On Load: " + conf?.startOnLoad);
    mermaidAPI.updateSiteConfig({ startOnLoad: conf?.startOnLoad });
  }
  const idGenerator = new chunk_U37J5Y7L/* utils_default */._K.InitIDGenerator(conf.deterministicIds, conf.deterministicIDSeed);
  let txt;
  const errors = [];
  for (const element of Array.from(nodesToProcess)) {
    chunk_VIW5F6AA/* log */.Rm.info("Rendering diagram: " + element.id);
    ...
    txt = (0,esm/* dedent */.T)(chunk_U37J5Y7L/* utils_default */._K.entityDecode(txt)).trim().replace(/<br\s*\/?>/gi, "<br/>");
    const init2 = chunk_U37J5Y7L/* utils_default */._K.detectInit(txt);
    if (init2) {
      chunk_VIW5F6AA/* log */.Rm.debug("Detected early reinit: ", init2);
    }
    try {
...
var initialize2 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(function(config) {
  mermaidAPI.initialize(config);
}, "initialize");
var init = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async function(config, nodes, callback) {
  chunk_VIW5F6AA/* log */.Rm.warn("mermaid.init is deprecated. Please use run instead.");
  if (config) {
    initialize2(config);
  }
...
var registerExternalDiagrams = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (diagrams, {
  lazyLoad = true
} = {}) => {
  addDiagrams();
  (0,chunk_VIW5F6AA/* registerLazyLoadedDiagrams */.Xd)(...diagrams);
  if (lazyLoad === false) {
    await loadRegisteredDiagrams();
  }
}, "registerExternalDiagrams");
var contentLoaded = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(function() {
  if (mermaid.startOnLoad) {
    const { startOnLoad } = mermaidAPI.getConfig();
    if (startOnLoad) {
      mermaid.run().catch((err) => chunk_VIW5F6AA/* log */.Rm.error("Mermaid failed to initialize", err));
    }
  }
}, "contentLoaded");
...
var setParseErrorHandler = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(function(parseErrorHandler) {
  mermaid.parseError = parseErrorHandler;
}, "setParseErrorHandler");
var executionQueue = [];
var executionQueueRunning = false;
var executeQueue = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async () => {
  ...
  while (executionQueue.length > 0) {
    ...
    if (f) {
      try {
        ...
        chunk_VIW5F6AA/* log */.Rm.error("Error executing queue", e);
      }
    }
  }
  executionQueueRunning = false;
}, "executeQueue");
var parse2 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (text, parseOptions) => {
  return new Promise((resolve, reject) => {
    const performCall = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => new Promise((res, rej) => {
      mermaidAPI.parse(text, parseOptions).then(
        ...
        (e) => {
          chunk_VIW5F6AA/* log */.Rm.error("Error parsing", e);
          mermaid.parseError?.(e);
          rej(e);
          reject(e);
        }
...
var render2 = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((id28, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => new Promise((res, rej) => {
...
var getRegisteredDiagramsMetadata = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(() => {
  return Object.keys(chunk_VIW5F6AA/* detectors */.mW).map((id28) => ({
    id: id28
  }));
...
var mermaid = {
  ...
  run,
  registerExternalDiagrams,
  registerLayoutLoaders: chunk_NXG7ZM6U/* registerLayoutLoaders */.sO,
  initialize: initialize2,
  parseError: void 0,
  contentLoaded,
  setParseErrorHandler,
  detectType: chunk_VIW5F6AA/* detectType */.Ch,
  registerIconPacks: chunk_62K37W7T/* registerIconPacks */.pC,
  getRegisteredDiagramsMetadata
};
...
/* harmony export */ });
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72453);
/* harmony import */ var _channels_reusable_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93539);
/* harmony import */ var _color_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74886);
/* harmony import */ var _change_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8232);
/* IMPORT */
...
const rgba = (r, g, b = 0, a = 1) => {
    if (typeof r !== 'number')
        return (0,_change_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(r, { a: g });
    const channels = _channels_reusable_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.set({
        r: _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp.r(r),
        g: _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp.g(g),
        b: _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp.b(b),
        a: _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp.a(a)
    });
    return _color_index_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.stringify(channels);
};
/* EXPORT */
...
__webpack_require__.d(__webpack_exports__, {
  ...
  dj: () => (/* binding */ renderKatexSanitized),
  cL: () => (/* binding */ chunk_VIW5F6AA_reset),
...
var change = __webpack_require__(8232);
...
// EXTERNAL MODULE: ./node_modules/dompurify/dist/purify.es.mjs
var purify_es = __webpack_require__(99418);
;// ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-VIW5F6AA.mjs
...
var chunk_VIW5F6AA_reset = /* @__PURE__ */ __name((config2 = siteConfig) => {
  directives = [];
...
function setupDompurifyHooks() {
  ...
  purify_es/* default */.A.addHook("beforeSanitizeAttributes", (node) => {
    if (node.tagName === "A" && node.hasAttribute("target")) {
      node.setAttribute(TEMPORARY_ATTRIBUTE, node.getAttribute("target") ?? "");
    }
  });
  purify_es/* default */.A.addHook("afterSanitizeAttributes", (node) => {
...
var removeScript = /* @__PURE__ */ __name((txt) => {
  ...
  const sanitizedText = purify_es/* default */.A.sanitize(txt);
...
var sanitizeText = /* @__PURE__ */ __name((text, config2) => {
  ...
  if (config2.dompurifyConfig) {
    text = purify_es/* default */.A.sanitize(sanitizeMore(text, config2), config2.dompurifyConfig).toString();
  } else {
    text = purify_es/* default */.A.sanitize(sanitizeMore(text, config2), {
      FORBID_TAGS: ["style"]
    }).toString();
  }
  return text;
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
  ...
  if (true) {
    const { default: katex } = await __webpack_require__.e(/* import() */ 2130).then(__webpack_require__.bind(__webpack_require__, 22130));
 ...
 * // => { 'a': [{ 'b': 2, 'c': 3 }, { 'd': 4, 'e': 5 }] }
 */
var merge = (0,_createAssigner/* default */.A)(function(object, source, srcIndex) {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   R: () => (/* binding */ getLineFunctionsWithOffset)
/* harmony export */ });
/* harmony import */ var _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26936);
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(calculateDeltaAndAngle, "calculateDeltaAndAngle");
var pointTransformer = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((data) => {
  if (Array.isArray(data)) {
    return { x: data[0], y: data[1] };
  }
  return data;
}, "pointTransformer");
var getLineFunctionsWithOffset = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((edge) => {
  return {
    x: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(d, i, data) {
      let offset = 0;
    ...
    y: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(d, i, data) {
      let offset = 0;
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _MapCache_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29471);
...
// EXTERNAL MODULE: ./node_modules/ts-dedent/esm/index.js
var esm = __webpack_require__(60513);
;// ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-62K37W7T.mjs
...
var registerIconPacks = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((iconLoaders) => {
  for (const iconLoader of iconLoaders) {
    ...
    chunk_VIW5F6AA/* log */.Rm.debug("Registering icon pack:", iconLoader.name);
    if ("loader" in iconLoader) {
      loaderStore.set(iconLoader.name, iconLoader.loader);
    } else if ("icons" in iconLoader) {
      iconsStore.set(iconLoader.name, iconLoader.icons);
    } else {
      chunk_VIW5F6AA/* log */.Rm.error("Invalid icon loader:", iconLoader);
      throw new Error('Invalid icon loader. Must have either "icons" or "loader" property.');
    }
  }
}, "registerIconPacks");
var getRegisteredIconData = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (iconName, fallbackPrefix) => {
...
var isIconAvailable = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (iconName) => {
  try {
...
var getIconSVG = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (iconName, customisations, extraAttributes) => {
  let iconData;
  try {
  ...
  return (0,chunk_VIW5F6AA/* sanitizeText */.jZ)(svg, (0,chunk_VIW5F6AA/* getConfig */.zj)());
}, "getIconSVG");
...
(0,chunk_VIW5F6AA/* __name */.K2)(preprocessMarkdown, "preprocessMarkdown");
function markdownToLines(markdown, config = {}) {
  ...
  (0,chunk_VIW5F6AA/* __name */.K2)(processNode, "processNode");
...
(0,chunk_VIW5F6AA/* __name */.K2)(markdownToLines, "markdownToLines");
function markdownToHTML(markdown, { markdownAutoWrap } = {}) {
  ...
  function output(node) {
    ...
    chunk_VIW5F6AA/* log */.Rm.warn(`Unsupported markdown: ${node.type}`);
    return node.raw;
  }
  (0,chunk_VIW5F6AA/* __name */.K2)(output, "output");
  return nodes.map(output).join("");
}
(0,chunk_VIW5F6AA/* __name */.K2)(markdownToHTML, "markdownToHTML");
...
(0,chunk_VIW5F6AA/* __name */.K2)(splitTextToChars, "splitTextToChars");
function splitWordToFitWidth(checkFit, word) {
  const characters = splitTextToChars(word.content);
  return splitWordToFitWidthRecursion(checkFit, [], characters, word.type);
}
(0,chunk_VIW5F6AA/* __name */.K2)(splitWordToFitWidth, "splitWordToFitWidth");
...
(0,chunk_VIW5F6AA/* __name */.K2)(splitWordToFitWidthRecursion, "splitWordToFitWidthRecursion");
...
(0,chunk_VIW5F6AA/* __name */.K2)(splitLineToFitWidth, "splitLineToFitWidth");
...
(0,chunk_VIW5F6AA/* __name */.K2)(splitLineToFitWidthRecursion, "splitLineToFitWidthRecursion");
...
(0,chunk_VIW5F6AA/* __name */.K2)(applyStyle, "applyStyle");
async function addHtmlSpan(element, node, width, classes, addBackground = false, config = (0,chunk_VIW5F6AA/* getConfig */.zj)()) {
  const fo = element.append("foreignObject");
  fo.attr("width", `${10 * width}px`);
  fo.attr("height", `${10 * width}px`);
  const div = fo.append("xhtml:div");
  const sanitizedLabel = (0,chunk_VIW5F6AA/* hasKatex */.Wi)(node.label) ? await (0,chunk_VIW5F6AA/* renderKatexSanitized */.dj)(node.label.replace(chunk_VIW5F6AA/* common_default */.Y2.lineBreakRegex, "\n"), config) : (0,chunk_VIW5F6AA/* sanitizeText */.jZ)(node.label, config);
...
(0,chunk_VIW5F6AA/* __name */.K2)(addHtmlSpan, "addHtmlSpan");
function createTspan(textElement, lineIndex, lineHeight) {
  return textElement.append("tspan").attr("class", "text-outer-tspan").attr("x", 0).attr("y", lineIndex * lineHeight - 0.1 + "em").attr("dy", lineHeight + "em");
}
(0,chunk_VIW5F6AA/* __name */.K2)(createTspan, "createTspan");
...
(0,chunk_VIW5F6AA/* __name */.K2)(computeWidthOfText, "computeWidthOfText");
...
(0,chunk_VIW5F6AA/* __name */.K2)(computeDimensionOfText, "computeDimensionOfText");
function createFormattedText(width, g, structuredText, addBackground = false) {
  ...
  for (const line of structuredText) {
    const checkWidth = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)((line2) => computeWidthOfText(labelGroup, lineHeight, line2) <= width, "checkWidth");
...
(0,chunk_VIW5F6AA/* __name */.K2)(createFormattedText, "createFormattedText");
...
(0,chunk_VIW5F6AA/* __name */.K2)(updateTextContentAndStyles, "updateTextContentAndStyles");
    ...
    pendingReplacements.push(
      (async () => {
        ...
        if (await isIconAvailable(registeredIconName)) {
          ...
          return `<i class='${(0,chunk_VIW5F6AA/* sanitizeText */.jZ)(fullMatch, config).replace(":", " ")}'></i>`;
        }
      })()
    );
    return fullMatch;
...
(0,chunk_VIW5F6AA/* __name */.K2)(replaceIconSubstring, "replaceIconSubstring");
var createText = /* @__PURE__ */ (0,chunk_VIW5F6AA/* __name */.K2)(async (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
  ...
  if (useHtmlLabels) {
    ...
    const decodedReplacedText = await replaceIconSubstring((0,chunk_U37J5Y7L/* decodeEntities */.Sm)(htmlText), config);
    const inputForKatex = text.replace(/\\\\/g, "\\");
    const node = {
      isNode,
      label: (0,chunk_VIW5F6AA/* hasKatex */.Wi)(text) ? inputForKatex : decodedReplacedText,
...
var _arrayLikeKeys = __webpack_require__(83607);
// EXTERNAL MODULE: ./node_modules/lodash-es/isObject.js
var isObject = __webpack_require__(23149);
// EXTERNAL MODULE: ./node_modules/lodash-es/_isPrototype.js
var _isPrototype = __webpack_require__(97271);
...
/* harmony export */ });
/* harmony import */ var _chunk_JSVUIEYQ_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79423);
/* harmony import */ var _chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75828);
/* harmony import */ var _chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50708);
/* harmony import */ var _chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(98045);
/* harmony import */ var _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26936);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(11316);
/* harmony import */ var roughjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29893);
...
var labelHelper = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (parent, node, _classes) => {
  let cssClasses;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.htmlLabels);
  if (!_classes) {
  ...
  const labelEl = shapeSvg.insert("g").attr("class", "label").attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(node.labelStyle));
  let label;
  ...
  const text2 = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)((0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(label), (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()), {
    useHtmlLabels,
    width: node.width || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart?.wrappingWidth,
        ...
        [...images].map(
          (img) => new Promise((res) => {
            function setupImage() {
              ...
              if (noImgText) {
                const bodyFontSize = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().fontSize ? (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().fontSize : window.getComputedStyle(document.body).fontSize;
                const enlargingFactor = 5;
                const [parsedBodyFontSize = _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .defaultConfig_default */ .UI.fontSize] = (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .I5)(bodyFontSize);
            ...
            (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(setupImage, "setupImage");
            setTimeout(() => {
              if (img.complete) {
                setupImage();
              }
...
var insertLabel = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (parent, label, options) => {
  const useHtmlLabels = options.useHtmlLabels || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.flowchart?.htmlLabels);
  const labelEl = parent.insert("g").attr("class", "label").attr("style", options.labelStyle || "");
  const text2 = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)((0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(label), (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()), {
    useHtmlLabels,
    width: options.width || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.flowchart?.wrappingWidth,
    style: options.labelStyle,
    addSvgBackground: !!options.icon || !!options.img
  });
  let bbox = text2.getBBox();
  const halfPadding = options.padding / 2;
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()?.flowchart?.htmlLabels)) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
var updateNodeBounds = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node, element) => {
  const bbox = element.node().getBBox();
  node.width = bbox.width;
  node.height = bbox.height;
}, "updateNodeBounds");
var getNodeClasses = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node, extra) => (node.look === "handDrawn" ? "rough-node" : "node") + " " + node.cssClasses + " " + (extra || ""), "getNodeClasses");
function createPathFromPoints(points) {
  const pointStrings = points.map((p, i) => `${i === 0 ? "M" : "L"}${p.x},${p.y}`);
  pointStrings.push("Z");
  return pointStrings.join(" ");
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(createPathFromPoints, "createPathFromPoints");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateFullSineWavePoints, "generateFullSineWavePoints");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateCirclePoints, "generateCirclePoints");
...
var intersectRect = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node, point) => {
  var x = node.x;
  var y = node.y;
  var dx = point.x - x;
  var dy = point.y - y;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(applyStyle, "applyStyle");
async function addHtmlLabel(node) {
  ...
  const div = fo.append("xhtml:div");
  const config = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  let label = node.label;
  if (node.label && (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(node.label)) {
    label = await (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatexSanitized */ .dj)(node.label.replace(_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.lineBreakRegex, "\n"), config);
  }
  const labelClass = node.isNode ? "nodeLabel" : "edgeLabel";
  ...
  ">" + label + "</span>";
  div.html((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(labelSpan, config));
  applyStyle(div, node.labelStyle);
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(addHtmlLabel, "addHtmlLabel");
var createLabel = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (_vertexText, style, isTitle, isNode) => {
  ...
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart.htmlLabels)) {
    ...
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("vertexText" + vertexText);
    const node = {
      isNode,
      label: (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(vertexText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
var createRoundedRectPathD = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, totalWidth, totalHeight, radius) => [
  "M",
  x + radius,
  y,
...
// src/rendering-util/rendering-elements/clusters.js
var rect = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (parent, node) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
  const { labelStyles, nodeStyles, borderStyles, backgroundStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  const shapeSvg = parent.insert("g").attr("class", "cluster " + node.cssClasses).attr("id", node.id).attr("data-look", node.look);
  const useHtmlLabels = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels);
  const labelEl = shapeSvg.insert("g").attr("class", "cluster-label ");
  const text2 = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(labelEl, node.label, {
    style: node.labelStyle,
    useHtmlLabels,
    isNode: true
  });
  let bbox = text2.getBBox();
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels)) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
  ...
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Data ", node, JSON.stringify(node));
  let rect2;
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
    const options = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {
      roughness: 0.7,
      fill: clusterBkg,
      // fill: 'red',
    ...
    rect2 = shapeSvg.insert(() => {
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Rough node insert CXC", roughNode);
      return roughNode;
    }, ":first-child");
  ...
  const { subGraphTitleTopMargin } = (0,_chunk_JSVUIEYQ_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  labelEl.attr(
    "transform",
...
var noteGroup = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((parent, node) => {
...
var roundedWithTitle = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (parent, node) => {
  const siteConfig = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  ...
  label.attr(
    "transform",
    `translate(${node.x - bbox.width / 2}, ${y + 1 - ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels) ? 0 : 3)})`
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.offsetX = 0;
...
var kanbanSection = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (parent, node) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
...
var divider = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((parent, node) => {
  const siteConfig = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { themeVariables, handDrawnSeed } = siteConfig;
...
var insertCluster = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async (elem, node) => {
  const shape = node.shape || "rect";
  const cluster = await shapes[shape](elem, node);
  clusterElems.set(node.id, cluster);
  return cluster;
}, "insertCluster");
var clear = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(intersectNode, "intersectNode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(intersectEllipse, "intersectEllipse");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(intersectCircle, "intersectCircle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(intersectLine, "intersectLine");
function sameSign(r1, r2) {
  return r1 * r2 > 0;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(sameSign, "sameSign");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(intersectPolygon, "intersectPolygon");
...
function anchor(parent, node) {
  const { labelStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "black", stroke: "none", fillStyle: "solid" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
  }
  const roughNode = rc.circle(0, 0, radius * 2, options);
  const circleElem = shapeSvg.insert(() => roughNode, ":first-child");
  circleElem.attr("class", "anchor").attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  updateNodeBounds(node, circleElem);
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Circle intersect", node, radius, point);
    return intersect_default.circle(node, radius, point);
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(anchor, "anchor");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateArcPoints, "generateArcPoints");
async function bowTieRect(parent, node) {
  const { labelStyles, nodeStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.labelStyle = labelStyles;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(bowTieRect, "bowTieRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(insertPolygonShape, "insertPolygonShape");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(card, "card");

// src/rendering-util/rendering-elements/shapes/choice.ts

function choice(parent, node) {
  const { nodeStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.label = "";
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(choice, "choice");
...
async function circle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    circleElem.attr("class", "basic label-container").attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(circle, "circle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(createLine, "createLine");
function crossedCircle(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("crossedCircle intersect", node, { radius, point });
    const pos = intersect_default.circle(node, radius, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(crossedCircle, "crossedCircle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateCirclePoints2, "generateCirclePoints");
async function curlyBraceLeft(parent, node) {
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "none" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
    options.fillStyle = "solid";
  }
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(curlyBraceLeft, "curlyBraceLeft");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateCirclePoints3, "generateCirclePoints");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(curlyBraceRight, "curlyBraceRight");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateCirclePoints4, "generateCirclePoints");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(curlyBraces, "curlyBraces");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(curvedTrapezoid, "curvedTrapezoid");

// src/rendering-util/rendering-elements/shapes/cylinder.ts

var createCylinderPathD = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
...
var createOuterCylinderPathD = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
...
async function cylinder(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    const outerNode = rc.path(outerPathData, (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {}));
    const innerLine = rc.path(innerPathData, (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fill: "none" }));
    ...
    cylinder2 = shapeSvg.insert("path", ":first-child").attr("d", pathData).attr("class", "basic label-container").attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles)).attr("style", nodeStyles);
  }
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(cylinder, "cylinder");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(dividedRectangle, "dividedRectangle");
...
async function doublecircle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
    const outerOptions = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { roughness: 0.2, strokeWidth: 2.5 });
    const innerOptions = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { roughness: 0.2, strokeWidth: 1.5 });
    const outerRoughNode = rc.circle(0, 0, outerRadius * 2, outerOptions);
    const innerRoughNode = rc.circle(0, 0, innerRadius * 2, innerOptions);
    circleGroup = shapeSvg.insert("g", ":first-child");
    circleGroup.attr("class", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(node.cssClasses)).attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("DoubleCircle intersect", node, outerRadius, point);
    return intersect_default.circle(node, outerRadius, point);
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(doublecircle, "doublecircle");
...
function filledCircle(parent, node, { config: { themeVariables } }) {
  ...
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
  const { nodeBorder } = themeVariables;
  const options = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { fillStyle: "solid" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
  }
  const circleNode = rc.circle(0, 0, radius * 2, options);
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("filledCircle intersect", node, { radius, point });
    const pos = intersect_default.circle(node, radius, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(filledCircle, "filledCircle");
...
async function flippedTriangle(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Triangle intersect", node, points, point);
    return intersect_default.polygon(node, points, point);
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(flippedTriangle, "flippedTriangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(forkJoin, "forkJoin");
...
async function halfRoundedRectangle(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Pill intersect", node, { radius, point });
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(halfRoundedRectangle, "halfRoundedRectangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(hexagon, "hexagon");
...
async function hourglass(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Pill intersect", node, { points });
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(hourglass, "hourglass");
...
async function icon(parent, node, { config: { themeVariables, flowchart } }) {
  ...
  const { nodeBorder } = themeVariables;
  const { stylesMap } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compileStyles */ .WW)(node);
  const x = -width / 2;
  const y = -height / 2;
  const labelPadding = node.label ? 8 : 0;
  const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
  const options = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, { stroke: "none", fill: "none" });
  if (node.look !== "handDrawn") {
    options.roughness = 0;
    options.fillStyle = "solid";
  }
  ...
  if (node.icon) {
    ...
    iconElem.html(
      `<g>${await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getIconSVG */ .WY)(node.icon, {
        height: iconSize,
        width: iconSize,
        fallbackPrefix: ""
      })}</g>`
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("iconSquare intersect", node, point);
    if (!node.label) {
      return intersect_default.rect(node, point);
    }
    const dx = node.x ?? 0;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(icon, "icon");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(iconCircle, "iconCircle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(iconRounded, "iconRounded");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(iconSquare, "iconSquare");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(imageSquare, "imageSquare");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(inv_trapezoid, "inv_trapezoid");
...
async function drawRect(parent, node, options) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
    const options2 = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(node, {});
    ...
    rect2.attr("class", "basic label-container").attr("style", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(cssStyles));
  } else {
    rect2 = shapeSvg.insert("rect", ":first-child");
    rect2.attr("class", "basic label-container").attr("style", nodeStyles).attr("rx", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(rx)).attr("ry", (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .KL)(ry)).attr("x", x).attr("y", y).attr("width", totalWidth).attr("height", totalHeight);
  }
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(drawRect, "drawRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(labelRect, "labelRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(lean_left, "lean_left");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(lean_right, "lean_right");
...
function lightningBolt(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("lightningBolt intersect", node, point);
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(lightningBolt, "lightningBolt");

// src/rendering-util/rendering-elements/shapes/linedCylinder.ts

var createCylinderPathD2 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${width},0`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createOuterCylinderPathD2 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD2 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
  return [`M${x - width / 2},${-height / 2}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createInnerCylinderPathD");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(linedCylinder, "linedCylinder");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(linedWaveEdgedRect, "linedWaveEdgedRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(multiRect, "multiRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(multiWaveEdgedRectangle, "multiWaveEdgedRectangle");
...
async function note(parent, node, { config: { themeVariables } }) {
  const { labelStyles, nodeStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(node);
  node.labelStyle = labelStyles;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)().flowchart?.htmlLabels !== false;
  if (!useHtmlLabels) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(note, "note");

// src/rendering-util/rendering-elements/shapes/question.ts

var createDecisionBoxPathD = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, size) => {
  return [
    `M${x + size / 2},${y}`,
    `L${x + size},${y - size / 2}`,
    `L${x + size / 2},${y - size}`,
...
async function question(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(question, "question");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(rect_left_inv_arrow, "rect_left_inv_arrow");
...
async function rectWithTitle(parent, node) {
  ...
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Text 2", description);
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(rectWithTitle, "rectWithTitle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(generateArcPoints2, "generateArcPoints");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(roundedRect, "roundedRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(shadedProcess, "shadedProcess");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(slopedRect, "slopedRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(squareRect2, "squareRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(stadium, "stadium");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(state, "state");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(stateEnd, "stateEnd");
...
function stateStart(parent, node, { config: { themeVariables } }) {
  ...
  if (node.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
    const roughNode = rc.circle(0, 0, 14, (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .solidStateFill */ .ue)(lineColor));
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(stateStart, "stateStart");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(subroutine, "subroutine");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(taggedRect, "taggedRect");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(taggedWaveEdgedRectangle, "taggedWaveEdgedRectangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(text, "text");

// src/rendering-util/rendering-elements/shapes/tiltedCylinder.ts

var createCylinderPathD3 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
  return `M${x},${y}
...
var createOuterCylinderPathD3 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y}`,
    `M${x + width},${y}`,
    `a${rx},${ry} 0,0,0 ${0},${-height}`,
...
var createInnerCylinderPathD3 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((x, y, width, height, rx, ry) => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(tiltedCylinder, "tiltedCylinder");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(trapezoid, "trapezoid");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(trapezoidalPentagon, "trapezoidalPentagon");
...
async function triangle(parent, node) {
  ...
  node.labelStyle = labelStyles;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node, getNodeClasses(node));
  const useHtmlLabels = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart?.htmlLabels);
  const w = bbox.width + (node.padding ?? 0);
  const h = w + bbox.height;
  const tw = w + bbox.height;
  const points = [
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(triangle, "triangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(waveEdgedRectangle, "waveEdgedRectangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(waveRectangle, "waveRectangle");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(windowPane, "windowPane");
...
async function erBox(parent, node) {
  ...
  if (node.look === "handDrawn") {
    const { themeVariables: themeVariables2 } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  ...
  const config = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  ...
  if (entityNode.attributes.length === 0 && node.label) {
    ...
    if ((0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(node.label, config) + options2.labelPaddingX * 2 < config.er.minEntityWidth) {
      node.width = config.er.minEntityWidth;
    }
    const shapeSvg2 = await drawRect(parent, node, options2);
    if (!(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels)) {
  ...
  const { themeVariables } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(erBox, "erBox");
async function addText(shapeSvg, labelText, config, translateX = 0, translateY = 0, classes = [], style = "") {
  ...
  if (labelText !== (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(labelText)) {
    labelText = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(labelText);
    labelText = labelText.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
  }
  const text2 = label.node().appendChild(
    await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
      label,
      labelText,
      {
        width: (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(labelText, config) + 100,
        style,
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(addText, "addText");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(textHelper, "textHelper");
async function addText2(parentGroup, node, yOffset, styles = []) {
  const textEl = parentGroup.insert("g").attr("class", "label").attr("style", styles.join("; "));
  const config = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)();
  let useHtmlLabels = "useHtmlLabels" in node ? node.useHtmlLabels : (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels) ?? true;
  let textContent = "";
  if ("text" in node) {
  ...
  if ((0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textContent)) {
    useHtmlLabels = true;
  }
  const text2 = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    textEl,
    (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText2 */ .oB)((0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(textContent)),
    {
      width: (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(textContent, config) + 50,
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(addText2, "addText");
...
async function classBox(parent, node) {
  ...
  const GAP = PADDING;
  const useHtmlLabels = node.useHtmlLabels ?? (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.htmlLabels) ?? true;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(classBox, "classBox");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(requirementBox, "requirementBox");
async function addText3(parentGroup, inputText, yOffset, style = "") {
  ...
  const text2 = await (0,_chunk_62K37W7T_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    textEl,
    (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText2 */ .oB)((0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .Sm)(inputText)),
    {
      width: (0,_chunk_U37J5Y7L_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Un)(inputText, config) + 50,
      // Add room for error when splitting text into multiple lines
      classes: "markdown-node-label",
      useHtmlLabels,
      style
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(addText3, "addText");

// src/rendering-util/rendering-elements/shapes/kanbanItem.ts

var colorFromPriority = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((priority) => {
  switch (priority) {
    case "Very High":
      return "red";
    case "High":
...
async function kanbanItem(parent, kanbanNode, { config }) {
  const { labelStyles, nodeStyles } = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles2String */ .GX)(kanbanNode);
  ...
  if (kanbanNode.look === "handDrawn") {
    const rc = roughjs__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A.svg(shapeSvg);
    const options2 = (0,_chunk_7RNWAQOT_mjs__WEBPACK_IMPORTED_MODULE_1__/* .userNodeOverrides */ .Fr)(kanbanNode, {});
    const roughNode = rx || ry ? rc.path(createRoundedRectPathD(x, y, totalWidth, totalHeight, rx || 0), options2) : rc.rectangle(x, y, totalWidth, totalHeight, options2);
    rect2 = shapeSvg.insert(() => roughNode, ":first-child");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(kanbanItem, "kanbanItem");
...
var generateShapeMap = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(isValidShape, "isValidShape");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(insertNode, "insertNode");
var setNodeElem = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, node) => {
  nodeElems.set(node.id, elem);
}, "setNodeElem");
var clear2 = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
  nodeElems.clear();
}, "clear");
var positionNode = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node) => {
  const el = nodeElems.get(node.id);
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace(
    "Transforming node",
    node.diff,
    node,
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseKeys_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(69471);
/* harmony import */ var _getTag_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9779);
/* harmony import */ var _isArguments_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(52274);
...
/* harmony import */ var _isBuffer_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(99912);
/* harmony import */ var _isPrototype_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(97271);
/* harmony import */ var _isTypedArray_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(33858);
...
var reusable = __webpack_require__(93539);
// EXTERNAL MODULE: ./node_modules/khroma/dist/constants.js
var constants = __webpack_require__(63122);
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _adjust_channel_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(95635);
/* IMPORT */
...
var solidStateFill = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((color) => {
  const { handDrawnSeed } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  return {
    fill: color,
    hachureAngle: 120,
    // angle of hachure,
...
var compileStyles = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((node) => {
  const stylesMap = styles2Map([...node.cssCompiledStyles || [], ...node.cssStyles || []]);
  return { stylesMap, stylesArray: [...stylesMap] };
}, "compileStyles");
var styles2Map = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((styles) => {
...
var isLabelStyle = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((key) => {
...
var styles2String = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((node) => {
...
var userNodeOverrides = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((node, options) => {
  const { themeVariables, handDrawnSeed } = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .D7)();
  const { nodeBorder, mainBkg } = themeVariables;
...
var getStrokeDashArray = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((strokeDasharrayStyle) => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isNothing, "isNothing");
function isObject(subject) {
  return typeof subject === "object" && subject !== null;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isObject, "isObject");
function toArray(sequence) {
  if (Array.isArray(sequence)) return sequence;
  else if (isNothing(sequence)) return [];
  return [sequence];
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(toArray, "toArray");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(extend, "extend");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(repeat, "repeat");
function isNegativeZero(number) {
  return number === 0 && Number.NEGATIVE_INFINITY === 1 / number;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isNegativeZero, "isNegativeZero");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(formatError, "formatError");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(YAMLException$1, "YAMLException$1");
YAMLException$1.prototype = Object.create(Error.prototype);
YAMLException$1.prototype.constructor = YAMLException$1;
YAMLException$1.prototype.toString = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function toString(compact) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getLine, "getLine");
function padStart(string, max) {
  return common.repeat(" ", max - string.length) + string;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(padStart, "padStart");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(makeSnippet, "makeSnippet");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(compileStyleAliases, "compileStyleAliases");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(Type$1, "Type$1");
var type = Type$1;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(compileList, "compileList");
function compileMap() {
  var result = {
    scalar: {},
    sequence: {},
  ...
  (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(collectType, "collectType");
  for (index = 0, length = arguments.length; index < length; index += 1) {
    arguments[index].forEach(collectType);
  }
  return result;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(compileMap, "compileMap");
function Schema$1(definition) {
  return this.extend(definition);
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(Schema$1, "Schema$1");
Schema$1.prototype.extend = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function extend2(definition) {
  var implicit = [];
  var explicit = [];
...
var str = new type("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(data) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlNull, "resolveYamlNull");
function constructYamlNull() {
  return null;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlNull, "constructYamlNull");
function isNull(object) {
  return object === null;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isNull, "isNull");
var _null = new type("tag:yaml.org,2002:null", {
  ...
  predicate: isNull,
  represent: {
    canonical: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      return "~";
    }, "canonical"),
    lowercase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      return "null";
    }, "lowercase"),
    uppercase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      return "NULL";
    }, "uppercase"),
    camelcase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      return "Null";
    }, "camelcase"),
    empty: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
      return "";
    }, "empty")
  },
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlBoolean, "resolveYamlBoolean");
function constructYamlBoolean(data) {
  return data === "true" || data === "True" || data === "TRUE";
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlBoolean, "constructYamlBoolean");
function isBoolean(object) {
  return Object.prototype.toString.call(object) === "[object Boolean]";
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isBoolean, "isBoolean");
var bool = new type("tag:yaml.org,2002:bool", {
  ...
  predicate: isBoolean,
  represent: {
    lowercase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(object) {
      return object ? "true" : "false";
    }, "lowercase"),
    uppercase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(object) {
      return object ? "TRUE" : "FALSE";
    }, "uppercase"),
    camelcase: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(object) {
      return object ? "True" : "False";
    }, "camelcase")
  },
  defaultStyle: "lowercase"
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isHexCode, "isHexCode");
function isOctCode(c) {
  return 48 <= c && c <= 55;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isOctCode, "isOctCode");
function isDecCode(c) {
  return 48 <= c && c <= 57;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isDecCode, "isDecCode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlInteger, "resolveYamlInteger");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlInteger, "constructYamlInteger");
function isInteger(object) {
  return Object.prototype.toString.call(object) === "[object Number]" && (object % 1 === 0 && !common.isNegativeZero(object));
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isInteger, "isInteger");
var int = new type("tag:yaml.org,2002:int", {
  ...
  predicate: isInteger,
  represent: {
    binary: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(obj) {
      return obj >= 0 ? "0b" + obj.toString(2) : "-0b" + obj.toString(2).slice(1);
    }, "binary"),
    octal: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(obj) {
      return obj >= 0 ? "0o" + obj.toString(8) : "-0o" + obj.toString(8).slice(1);
    }, "octal"),
    decimal: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(obj) {
      return obj.toString(10);
    }, "decimal"),
    /* eslint-disable max-len */
    hexadecimal: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(obj) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlFloat, "resolveYamlFloat");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlFloat, "constructYamlFloat");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(representYamlFloat, "representYamlFloat");
function isFloat(object) {
  return Object.prototype.toString.call(object) === "[object Number]" && (object % 1 !== 0 || common.isNegativeZero(object));
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isFloat, "isFloat");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlTimestamp, "resolveYamlTimestamp");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlTimestamp, "constructYamlTimestamp");
function representYamlTimestamp(object) {
  return object.toISOString();
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(representYamlTimestamp, "representYamlTimestamp");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlMerge, "resolveYamlMerge");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlBinary, "resolveYamlBinary");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlBinary, "constructYamlBinary");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(representYamlBinary, "representYamlBinary");
function isBinary(obj) {
  return Object.prototype.toString.call(obj) === "[object Uint8Array]";
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isBinary, "isBinary");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlOmap, "resolveYamlOmap");
function constructYamlOmap(data) {
  return data !== null ? data : [];
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlOmap, "constructYamlOmap");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlPairs, "resolveYamlPairs");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlPairs, "constructYamlPairs");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(resolveYamlSet, "resolveYamlSet");
function constructYamlSet(data) {
  return data !== null ? data : {};
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(constructYamlSet, "constructYamlSet");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(_class, "_class");
function is_EOL(c) {
  return c === 10 || c === 13;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(is_EOL, "is_EOL");
function is_WHITE_SPACE(c) {
  return c === 9 || c === 32;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(is_WHITE_SPACE, "is_WHITE_SPACE");
function is_WS_OR_EOL(c) {
  return c === 9 || c === 32 || c === 10 || c === 13;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(is_WS_OR_EOL, "is_WS_OR_EOL");
function is_FLOW_INDICATOR(c) {
  return c === 44 || c === 91 || c === 93 || c === 123 || c === 125;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(is_FLOW_INDICATOR, "is_FLOW_INDICATOR");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(fromHexCode, "fromHexCode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(escapedHexLen, "escapedHexLen");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(fromDecimalCode, "fromDecimalCode");
function simpleEscapeSequence(c) {
  return c === 48 ? "\0" : c === 97 ? "\x07" : c === 98 ? "\b" : c === 116 ? "	" : c === 9 ? "	" : c === 110 ? "\n" : c === 118 ? "\v" : c === 102 ? "\f" : c === 114 ? "\r" : c === 101 ? "\x1B" : c === 32 ? " " : c === 34 ? '"' : c === 47 ? "/" : c === 92 ? "\\" : c === 78 ? "\x85" : c === 95 ? "\xA0" : c === 76 ? "\u2028" : c === 80 ? "\u2029" : "";
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(simpleEscapeSequence, "simpleEscapeSequence");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(charFromCodepoint, "charFromCodepoint");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(State$1, "State$1");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(generateError, "generateError");
function throwError(state, message) {
  throw generateError(state, message);
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(throwError, "throwError");
function throwWarning(state, message) {
  if (state.onWarning) {
    state.onWarning.call(null, generateError(state, message));
  }
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(throwWarning, "throwWarning");
var directiveHandlers = {
  YAML: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function handleYamlDirective(state, name, args) {
  ...
  TAG: /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function handleTagDirective(state, name, args) {
    var handle, prefix;
    if (args.length !== 2) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(captureSegment, "captureSegment");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(mergeMappings, "mergeMappings");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(storeMappingPair, "storeMappingPair");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readLineBreak, "readLineBreak");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(skipSeparationSpace, "skipSeparationSpace");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(testDocumentSeparator, "testDocumentSeparator");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeFoldedLines, "writeFoldedLines");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readPlainScalar, "readPlainScalar");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readSingleQuotedScalar, "readSingleQuotedScalar");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readDoubleQuotedScalar, "readDoubleQuotedScalar");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readFlowCollection, "readFlowCollection");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readBlockScalar, "readBlockScalar");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readBlockSequence, "readBlockSequence");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readBlockMapping, "readBlockMapping");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readTagProperty, "readTagProperty");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readAnchorProperty, "readAnchorProperty");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readAlias, "readAlias");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(composeNode, "composeNode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(readDocument, "readDocument");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(loadDocuments, "loadDocuments");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(loadAll$1, "loadAll$1");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(load$1, "load$1");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(compileStyleMap, "compileStyleMap");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(encodeHex, "encodeHex");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(State, "State");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(indentString, "indentString");
function generateNextLine(state, level) {
  return "\n" + common.repeat(" ", state.indent * level);
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(generateNextLine, "generateNextLine");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(testImplicitResolving, "testImplicitResolving");
function isWhitespace(c) {
  return c === CHAR_SPACE || c === CHAR_TAB;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isWhitespace, "isWhitespace");
function isPrintable(c) {
  return 32 <= c && c <= 126 || 161 <= c && c <= 55295 && c !== 8232 && c !== 8233 || 57344 <= c && c <= 65533 && c !== CHAR_BOM || 65536 <= c && c <= 1114111;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isPrintable, "isPrintable");
function isNsCharOrWhitespace(c) {
  return isPrintable(c) && c !== CHAR_BOM && c !== CHAR_CARRIAGE_RETURN && c !== CHAR_LINE_FEED;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isNsCharOrWhitespace, "isNsCharOrWhitespace");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isPlainSafe, "isPlainSafe");
function isPlainSafeFirst(c) {
  return isPrintable(c) && c !== CHAR_BOM && !isWhitespace(c) && c !== CHAR_MINUS && c !== CHAR_QUESTION && c !== CHAR_COLON && c !== CHAR_COMMA && c !== CHAR_LEFT_SQUARE_BRACKET && c !== CHAR_RIGHT_SQUARE_BRACKET && c !== CHAR_LEFT_CURLY_BRACKET && c !== CHAR_RIGHT_CURLY_BRACKET && c !== CHAR_SHARP && c !== CHAR_AMPERSAND && c !== CHAR_ASTERISK && c !== CHAR_EXCLAMATION && c !== CHAR_VERTICAL_LINE && c !== CHAR_EQUALS && c !== CHAR_GREATER_THAN && c !== CHAR_SINGLE_QUOTE && c !== CHAR_DOUBLE_QUOTE && c !== CHAR_PERCENT && c !== CHAR_COMMERCIAL_AT && c !== CHAR_GRAVE_ACCENT;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isPlainSafeFirst, "isPlainSafeFirst");
function isPlainSafeLast(c) {
  return !isWhitespace(c) && c !== CHAR_COLON;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isPlainSafeLast, "isPlainSafeLast");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(codePointAt, "codePointAt");
function needIndentIndicator(string) {
  var leadingSpaceRe = /^\n* /;
  return leadingSpaceRe.test(string);
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(needIndentIndicator, "needIndentIndicator");
var STYLE_PLAIN = 1;
var STYLE_SINGLE = 2;
var STYLE_LITERAL = 3;
var STYLE_FOLDED = 4;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(chooseScalarStyle, "chooseScalarStyle");
function writeScalar(state, string, level, iskey, inblock) {
  state.dump = function() {
    ...
    (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(testAmbiguity, "testAmbiguity");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeScalar, "writeScalar");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(blockHeader, "blockHeader");
function dropEndingNewline(string) {
  return string[string.length - 1] === "\n" ? string.slice(0, -1) : string;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(dropEndingNewline, "dropEndingNewline");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(foldString, "foldString");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(foldLine, "foldLine");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(escapeString, "escapeString");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeFlowSequence, "writeFlowSequence");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeBlockSequence, "writeBlockSequence");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeFlowMapping, "writeFlowMapping");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeBlockMapping, "writeBlockMapping");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(detectType, "detectType");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(writeNode, "writeNode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getDuplicateReferences, "getDuplicateReferences");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(inspectNode, "inspectNode");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(dump$1, "dump$1");
var dump_1 = dump$1;
var dumper = {
  dump: dump_1
};
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(renamed, "renamed");
...
var getSubGraphTitleMargins = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(({
  flowchart
}) => {
...
const adjustChannel = (color, channel, amount) => {
    const channels = _color_index_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.parse(color);
    const amountCurrent = channels[channel];
    const amountNext = _utils_index_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.channel.clamp[channel](amountCurrent + amount);
    if (amountCurrent !== amountNext)
        channels[channel] = amountNext;
    return _color_index_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.stringify(channels);
};
/* EXPORT */
...
/* harmony export */   $t: () => (/* binding */ cleanAndMerge),
/* harmony export */   C4: () => (/* binding */ encodeEntities),
/* harmony export */   I5: () => (/* binding */ parseFontSize),
/* harmony export */   Ib: () => (/* binding */ interpolateToCurve),
/* harmony export */   KL: () => (/* binding */ handleUndefinedAttr),
/* harmony export */   Sm: () => (/* binding */ decodeEntities),
/* harmony export */   Un: () => (/* binding */ calculateTextWidth),
/* harmony export */   _K: () => (/* binding */ utils_default),
/* harmony export */   bH: () => (/* binding */ wrapLabel),
/* harmony export */   dq: () => (/* binding */ isDetailedError),
/* harmony export */   pe: () => (/* binding */ ZERO_WIDTH_SPACE),
/* harmony export */   rY: () => (/* binding */ getEdgeId),
/* harmony export */   ru: () => (/* binding */ calculateTextHeight),
/* harmony export */   sM: () => (/* binding */ getStylesFromArray),
/* harmony export */   vU: () => (/* binding */ removeDirectives),
...
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11316);
/* harmony import */ var lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46632);
/* harmony import */ var lodash_es_merge_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(42837);
...
var detectInit = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(text, config) {
  const inits = detectDirective(text, /(?:init\b)|(?:initialize\b)/);
  let results = {};
  if (Array.isArray(inits)) {
    const args = inits.map((init) => init.args);
    (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeDirective */ .$i)(args);
    results = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .assignWithDepth_default */ .hH)(results, [...args]);
  } else {
    results = inits.args;
  }
  if (!results) {
  ...
  let type = (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .detectType */ .Ch)(text, config);
  const prop = "config";
...
var detectDirective = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(text, type = null) {
  try {
...
`,
    ...
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.debug(
      `Detecting diagram directive${type !== null ? " type:" + type : ""} based on the text:${text}`
    );
    let match;
    const result = [];
    while ((match = _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .DB.exec(text)) !== null) {
      if (match.index === _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .DB.lastIndex) {
        _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .DB.lastIndex++;
      }
    ...
    _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.error(
      `ERROR: ${error.message} - Unable to parse directive type: '${type}' based on the text: '${text}'`
    );
    return { type: void 0, args: null };
  }
}, "detectDirective");
var removeDirectives = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(text) {
  return text.replace(_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .DB, "");
}, "removeDirectives");
var isSubstringInArray = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(str, arr) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(interpolateToCurve, "interpolateToCurve");
function formatUrl(linkStr, config) {
  ...
  if (config.securityLevel !== "loose") {
    return (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeUrl */ .J)(url);
  }
  return url;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(formatUrl, "formatUrl");
var runFunc = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((functionName, ...params) => {
  ...
  for (let i = 0; i < len; i++) {
    obj = obj[arrPaths[i]];
    if (!obj) {
      _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.error(`Function name: ${functionName} not found in window`);
      return;
    }
  }
  obj[fnName](...params);
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(distance, "distance");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(traverseEdge, "traverseEdge");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(calcLabelPosition, "calcLabelPosition");
var roundNumber = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((num, precision = 2) => {
  const factor = Math.pow(10, precision);
  return Math.round(num * factor) / factor;
}, "roundNumber");
var calculatePoint = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((points, distanceToTraverse) => {
...
var calcCardinalityPosition = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((isRelationTypePresent, points, initialPosition) => {
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info(`our points ${JSON.stringify(points)}`);
...
function calcTerminalLabelPosition(terminalMarkerSize, position, _points) {
  ...
  _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .Rm.info("our points", points);
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(calcTerminalLabelPosition, "calcTerminalLabelPosition");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(getStylesFromArray, "getStylesFromArray");
var cnt = 0;
var generateId = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(() => {
  cnt++;
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(makeRandomHex, "makeRandomHex");
var random = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((options) => {
  return makeRandomHex(options.length);
}, "random");
var getTextObj = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var drawSimpleText = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(elem, textData) {
  const nText = textData.text.replace(_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .Y2.lineBreakRegex, " ");
...
var wrapLabel = (0,lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(
  (label, maxWidth, config) => {
    ...
    if (_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .Y2.lineBreakRegex.test(label)) {
      return label;
    }
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(calculateTextHeight, "calculateTextHeight");
function calculateTextWidth(text, config) {
  return calculateTextDimensions(text, config).width;
}
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(calculateTextWidth, "calculateTextWidth");
var calculateTextDimensions = (0,lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(
  (text, config) => {
    ...
    const lines = text.split(_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .Y2.lineBreakRegex);
    const dims = [];
...
var InitIDGenerator = class {
  ...
  static {
    (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(this, "InitIDGenerator");
  }
};
var decoder;
var entityDecode = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(html) {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isDetailedError, "isDetailedError");
var insertTitle = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((parent, cssClass, titleTopMargin, title) => {
  if (!title) {
    return;
  }
...
var parseFontSize = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((fontSize) => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(cleanAndMerge, "cleanAndMerge");
var utils_default = {
  assignWithDepth: _chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .assignWithDepth_default */ .hH,
  wrapLabel,
  calculateTextHeight,
  calculateTextWidth,
...
var encodeEntities = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(text) {
  let txt = text;
...
var decodeEntities = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(function(text) {
  return text.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities");
var getEdgeId = /* @__PURE__ */ (0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)((from, to, {
  counter = 0,
  prefix,
  suffix
}, id) => {
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(handleUndefinedAttr, "handleUndefinedAttr");
...
(0,_chunk_VIW5F6AA_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .K2)(isLabelCoordinateInPath, "isLabelCoordinateInPath");
