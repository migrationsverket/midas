...
function $e1995378a142960e$export$18af5c7a9e9b3664(type, render) {
    ...
    let Result = (0, react.forwardRef)((props, ref)=>{
        ...
        return $e1995378a142960e$var$useSSRCollectionNode(type, props, ref, 'children' in props ? props.children : null, null, (node)=>/*#__PURE__*/ (0, react).createElement(Component, {
                node: node
            }));
    });
    // @ts-ignore
