...
const site_docs_design_patterns_validation_mdx_f40_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/validation","title":"validation","description":"Validering ska hjälpa våra användare att fylla i formulär rätt. Syftet är att ge tydlig återkoppling vid fel och samtidigt underlätta för användaren att rätta till dessa.","source":"@site/docs/design-patterns/validation.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/validation","permalink":"/pr-preview/pr-1213/design-patterns/validation","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{},"sidebar":"sideBar","previous":{"title":"Tabeller","permalink":"/pr-preview/pr-1213/design-patterns/tables"},"next":{"title":"Layout","permalink":"/pr-preview/pr-1213/dev/layout/"}}');
...
/* unused harmony import specifier */ var ValidationExamples_InfoBanner;
/* unused harmony import specifier */ var ValidationExamples_Link;
/* unused harmony import specifier */ var _jsx;
/* unused harmony import specifier */ var _jsxs;
var ToastRegion=function ToastRegion(){return/*#__PURE__*/(0,jsx_runtime.jsx)(Toast/* GlobalToastRegion */.r$,{});};var ErrorMessagePositionExample=function ErrorMessagePositionExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:6,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange f\xF6rnamn",errorMessage:"Du m\xE5ste ange ett f\xF6rnamn",isInvalid:true,errorPosition:"top"})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:6,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange f\xF6rnamn",errorMessage:"Du m\xE5ste ange ett f\xF6rnamn",isInvalid:true,errorPosition:"bottom"})})]})});};var ValidateAfterSubmitExample=function ValidateAfterSubmitExample(){var _useState=(0,react.useState)(''),name=_useState[0],setName=_useState[1];var _useState2=(0,react.useState)(false),isInvalid=_useState2[0],setIsInvalid=_useState2[1];var handleChange=function handleChange(value){setName(value);if(value.trim()!==''){setIsInvalid(false);}};var handlePress=function handlePress(){setIsInvalid(name.trim()==='');if(name.trim()!==''){Toast/* toastQueue */.ni.add({message:'Formuläret skickades!',type:'success'},{timeout:5000});}};return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange f\xF6rnamn",value:name,onChange:handleChange,errorMessage:isInvalid?'Du måste ange ett förnamn':undefined,isInvalid:isInvalid})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:"auto",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{onPress:handlePress,children:"Skicka"})})]})});};var DirectValidationExample=function DirectValidationExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{type:"email",label:"Ange din mejladress",description:"Ange en giltig mejladress, t.ex. namn@exempel.se",errorMessage:"Du m\xE5ste ha @ och dom\xE4n med i din mejladress",errorPosition:"top"})});};var ErrorMessageListExample=function ErrorMessageListExample(){var _useState3=(0,react.useState)({name:'',email:''}),values=_useState3[0],setValues=_useState3[1];var _useState4=(0,react.useState)({}),validationErrors=_useState4[0],setValidationErrors=_useState4[1];var validators={name:function name(v){return v.trim()===''?'Du måste ange ett namn':null;},email:function email(v){return v.trim()===''?'Du måste ange en mejladress':null;}};return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Form/* Form */.l,{validationErrors:validationErrors,onSubmit:function onSubmit(e){e.preventDefault();var errs=Object.fromEntries(Object.keys(validators).map(function(key){return[key,validators[key](values[key])];}).filter(function(_ref){var msg=_ref[1];return msg;}));setValidationErrors(errs);if(Object.keys(errs).length===0)// Show success toast
Toast/* toastQueue */.ni.add({message:'Formuläret skickades!',type:'success'},{timeout:5000});},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[Object.keys(validationErrors).length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsx)(InfoBanner/* InfoBanner */.z,{type:"warning",title:"Justera dessa f\xE4lt",children:/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{children:Object.entries(validationErrors).map(function(_ref2){var field=_ref2[0],msg=_ref2[1];return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,{href:"#"+field,children:msg})},field);})})})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{id:"name",name:"name",label:"Namn",value:values.name,onChange:function onChange(v){return setValues(function(prev){return Object.assign({},prev,{name:v});});}})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{id:"email",name:"email",label:"Mejladress",value:values.email,onChange:function onChange(v){return setValues(function(prev){return Object.assign({},prev,{email:v});});}})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:"auto",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{type:"submit",children:"Skicka"})})]})})});};var DatabaseValidationExample=function DatabaseValidationExample(){var _useState5=(0,react.useState)(false),isChecking=_useState5[0],setIsChecking=_useState5[1];var _useState6=(0,react.useState)(''),value=_useState6[0],setValue=_useState6[1];var _useState7=(0,react.useState)(''),error=_useState7[0],setError=_useState7[1];function handleBlur(){return _handleBlur.apply(this,arguments);}function _handleBlur(){_handleBlur=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(){return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.n){case 0:if(!(!error&&value.trim()!=='')){_context.n=2;break;}setIsChecking(true);// Simulate an async database check
_context.n=1;return new Promise(function(resolve){return setTimeout(resolve,2500);});case 1:setIsChecking(false);if(value.trim()!=='12345'){setError('Kortnumret kunde inte hittas i databasen. Testa med 12345');}else{setError('');}case 2:return _context.a(2);}},_callee);}));return _handleBlur.apply(this,arguments);}function handleSubmit(){return _handleSubmit.apply(this,arguments);}function _handleSubmit(){_handleSubmit=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee2(){return (0,regenerator/* default */.A)().w(function(_context2){while(1)switch(_context2.n){case 0:if(!(value.trim()==='')){_context2.n=1;break;}setError('Du måste fylla i ditt kortnummer för att kunna gå vidare');return _context2.a(2);case 1:if(!error){_context2.n=2;break;}return _context2.a(2);case 2:setError('');Toast/* toastQueue */.ni.add({message:'Formuläret skickades!',type:'success'},{timeout:5000});case 3:return _context2.a(2);}},_callee2);}));return _handleSubmit.apply(this,arguments);}return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"field-and-spinner",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange ditt kortnummer",description:"Ditt kortnummer kommer kontrolleras mot databasen. Det kan ta en liten stund",value:value,onChange:function onChange(newValue){setValue(newValue);if(error)setError('');},onBlur:handleBlur,isInvalid:!!error,errorMessage:error}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"spinner-box",children:isChecking&&/*#__PURE__*/(0,jsx_runtime.jsx)(Spinner/* Spinner */.y,{small:true})})]})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:"auto",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{isDisabled:isChecking,onPress:handleSubmit,children:"Skicka"})})]})});};var ErrorMessageList=function ErrorMessageList(){return/*#__PURE__*/_jsx("div",{className:"card",children:/*#__PURE__*/_jsx(ValidationExamples_InfoBanner,{type:"warning",title:"Justera dessa f\xE4lt",children:/*#__PURE__*/_jsxs("ul",{children:[/*#__PURE__*/_jsx("li",{children:/*#__PURE__*/_jsx(ValidationExamples_Link,{href:"#felmeddelandelista",children:"Felmeddelande fr\xE5n f\xE4lt A"})}),/*#__PURE__*/_jsx("li",{children:/*#__PURE__*/_jsx(ValidationExamples_Link,{href:"#felmeddelandelista",children:"Felmeddelande fr\xE5n f\xE4lt B"})})]})})});};
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(ToastRegion, {}), "\n", (0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["Fält som kontrolleras mot databas eller extern källa valideras efter att användaren lämnat fältet. ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/pr-1213/design-patterns/page-loading#spinner-bredvid-ett-f%C3%A4lt",
