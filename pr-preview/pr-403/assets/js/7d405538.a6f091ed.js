...
const Example = props => {
  return (0,jsx_runtime.jsx)(CodeBlock/* default */.A, {
    ...
    ...props,
    children: `<p>Varannan vecka släpper vi en ny release, vilket du kan <Link href="/changelog">Läsa mer om här.</Link></p>`
  });
};
const toc = [{
  "value": "Installation",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: `<p>Designsystemet utvecklas ständigt, <Link href="/changelog">vilket du kan läsa mer om här i vår releasefeed.</Link> Varannan vecka kommer det ett nytt släpp med buggfixar, nya komponenter eller nya funktioner på befintliga komponenter.</p>`
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "fristående",
      children: "Fristående"
