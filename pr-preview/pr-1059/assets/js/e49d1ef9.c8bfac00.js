...
var _excluded=["className","color","dismissable","type"];var Tag=function Tag(_ref){var _clsx;var className=_ref.className,color=_ref.color,_ref$dismissable=_ref.dismissable,dismissable=_ref$dismissable===void 0?false:_ref$dismissable,type=_ref.type,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* Tag */.vw,Object.assign({className:(0,clsx/* default */.A)(Tag_module.tag,dismissable&&Tag_module.dismissable,(_clsx={},_clsx[Tag_module.green]=color==='green'||!color&&type==='success',_clsx[Tag_module.blue]=color==='blue'||!color&&type==='info',_clsx[Tag_module.yellow]=color==='yellow'||!color&&type==='important',_clsx[Tag_module.red]=color==='red'||!color&&type==='warning',_clsx),className)},props,{children:(0,utils/* composeRenderProps */.HW)(props.children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Tag_module.tagText,children:children}),dismissable&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",size:"medium",className:Tag_module.button,slot:"remove",children:/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20})})]});})}));};
...
const site_docs_components_tag_mdx_e49_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/tag","title":"Tag","description":"Statusindikator","source":"@site/docs/components/tag.mdx","sourceDirName":"components","slug":"/components/tag","permalink":"/pr-preview/pr-1059/components/tag","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tag","description":"Statusindikator"},"sidebar":"sideBar","previous":{"title":"Tabs","permalink":"/pr-preview/pr-1059/components/tabs"},"next":{"title":"Text","permalink":"/pr-preview/pr-1059/components/text"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
