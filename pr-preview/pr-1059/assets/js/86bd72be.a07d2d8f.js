...
var _excluded=["className","color","dismissable","isDismissable","type"];var Tag=function Tag(_ref){var _clsx;var className=_ref.className,color=_ref.color,_ref$dismissable=_ref.dismissable,dismissable=_ref$dismissable===void 0?false:_ref$dismissable,_ref$isDismissable=_ref.isDismissable,isDismissable=_ref$isDismissable===void 0?false:_ref$isDismissable,type=_ref.type,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var isTagDismissable=isDismissable||typeof isDismissable==='undefined'&&dismissable;return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* Tag */.vw,Object.assign({className:(0,clsx/* default */.A)(Tag_module.tag,isTagDismissable&&Tag_module.dismissable,(_clsx={},_clsx[Tag_module.green]=color==='green'||!color&&type==='success',_clsx[Tag_module.blue]=color==='blue'||!color&&type==='info',_clsx[Tag_module.yellow]=color==='yellow'||!color&&type==='important',_clsx[Tag_module.red]=color==='red'||!color&&type==='warning',_clsx),className)},props,{textValue:props.textValue||(typeof props.children==='string'?props.children:undefined),children:(0,utils/* composeRenderProps */.HW)(props.children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Tag_module.tagText,children:children}),isTagDismissable&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",size:"medium",className:Tag_module.button,slot:"remove",children:/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20})})]});})}));};
