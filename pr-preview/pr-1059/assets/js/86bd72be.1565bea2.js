...
var SelectTags=function SelectTags(_ref){var showTags=_ref.showTags,isDisabled=_ref.isDisabled;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var state=(0,react.useContext)(Select/* SelectStateContext */.nT);var handleRemove=function handleRemove(keys){state==null||state.selectionManager.toggleSelection(Array.from(keys)[0]);};if(!(state!=null&&state.selectedItems.length)||!showTags){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(tag_group_TagGroup/* TagGroup */.C,{"aria-label":strings.format('selectedItems'),className:Select_module.tagGroup,onRemove:handleRemove,selectionBehavior:"toggle",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagList */.LY,{items:state.selectedItems,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{dismissable:true,id:item.key,isDisabled:isDisabled,textValue:item.textValue,children:item.textValue},item.key);}})});};
// EXTERNAL MODULE: ./node_modules/clsx/dist/clsx.mjs
...
var _excluded=["className","color","dismissable","type"];var Tag=function Tag(_ref){var _clsx;var className=_ref.className,color=_ref.color,_ref$dismissable=_ref.dismissable,dismissable=_ref$dismissable===void 0?false:_ref$dismissable,type=_ref.type,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* Tag */.vw,Object.assign({className:(0,clsx/* default */.A)(Tag_module.tag,dismissable&&Tag_module.dismissable,(_clsx={},_clsx[Tag_module.green]=color==='green'||!color&&type==='success',_clsx[Tag_module.blue]=color==='blue'||!color&&type==='info',_clsx[Tag_module.yellow]=color==='yellow'||!color&&type==='important',_clsx[Tag_module.red]=color==='red'||!color&&type==='warning',_clsx),className)},props,{textValue:props.textValue||(typeof props.children==='string'?props.children:undefined),children:(0,utils/* composeRenderProps */.HW)(props.children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Tag_module.tagText,children:children}),dismissable&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",size:"medium",className:Tag_module.button,slot:"remove",children:/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20})})]});})}));};
