...
var dist_DropZone = __webpack_require__(46090);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
;// ./packages/components/src/file-upload/FileUpload.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const FileUpload_module = ({"dropzone":"dropzone_bGZ8"});
// EXTERNAL MODULE: ./packages/components/src/utils/clsx.ts
var clsx = __webpack_require__(1160);
...
var FileList = __webpack_require__(93754);
// EXTERNAL MODULE: ./packages/components/src/file-list/FileListItem.tsx + 1 modules
var FileListItem = __webpack_require__(24757);
...
var arrow_up_from_line = __webpack_require__(11944);
;// ./apps/docs/src/components/examples/file-upload/FileUploadExamples.tsx
var FileListExample=function FileListExample(){var _React$useState=react.useState([]),files=_React$useState[0],setFiles=_React$useState[1];var handleSelect=function handleSelect(e){var selected=e?Array.from(e):[];setFiles(function(prev){var existingNames=new Set(prev.map(function(f){return f.name;}));return[].concat(prev,selected.filter(function(f){return!existingNames.has(f.name);}));});};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FileTrigger,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{children:"V\xE4lj filer"})}),files.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)(FileList/* FileList */.$,{children:files.map(function(file){return/*#__PURE__*/(0,jsx_runtime.jsx)(FileListItem/* FileListItem */.I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]});};var DropZoneExample=function DropZoneExample(){var _React$useState2=react.useState([]),files=_React$useState2[0],setFiles=_React$useState2[1];var setUniqueFiles=function setUniqueFiles(newFiles){setFiles(function(oldFiles){var existingNames=new Set(oldFiles.map(function(f){return f.name;}));return[].concat(oldFiles,newFiles.filter(function(f){return!existingNames.has(f.name);}));});};var handleDrop=/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(e){var fileItems,droppedFiles;return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.n){case 0:fileItems=e.items.filter(function(item){return item.kind==='file';});_context.n=1;return Promise.all(fileItems.map(function(item){return item.getFile();}));case 1:droppedFiles=_context.v;setUniqueFiles(droppedFiles);case 2:return _context.a(2);}},_callee);}));return function handleDrop(_x){return _ref.apply(this,arguments);};}();var handleSelect=function handleSelect(e){var selectedFiles=e?Array.from(e):[];setUniqueFiles(selectedFiles);};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(DropZone,{onDrop:handleDrop,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FileTrigger,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* Button */.$,{variant:"secondary",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(arrow_up_from_line/* default */.A,{})," V\xE4lj fil"]})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"label",children:"Dra och sl\xE4pp filer h\xE4r"})]}),files.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)(FileList/* FileList */.$,{style:{marginTop:'1rem'},children:files.map(function(file){return/*#__PURE__*/(0,jsx_runtime.jsx)(FileListItem/* FileListItem */.I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]});};
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      className: "card",
      children: (0,jsx_runtime.jsx)(FileListExample, {})
