...
class $2a25aae57d74318e$export$a05409b8bb224a5a {
    ...
    getKeyPageAbove(key) {
        ...
        let itemRect = this.layoutDelegate.getItemRect(key);
        if (!itemRect) return null;
        if (!(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .isScrollable */ .o)(menu)) return this.getFirstKey();
    ...
    getKeyPageBelow(key) {
        ...
        let itemRect = this.layoutDelegate.getItemRect(key);
        if (!itemRect) return null;
        if (!(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .isScrollable */ .o)(menu)) return this.getLastKey();
        if (this.orientation === 'horizontal') {
 ...
 */ const $612b8eb6cb90e02d$export$62ed72bc21f6b8a6 = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)($612b8eb6cb90e02d$var$DropIndicator);
