...
const site_docs_dev_client_side_routing_mdx_870_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/client-side-routing","title":"Routing på klientnivå","description":"Hantera Client Side Navigation tillsammans med designsystemet","source":"@site/docs/dev/client-side-routing.mdx","sourceDirName":"dev","slug":"/dev/client-side-routing","permalink":"/pr-preview/pr-1118/dev/client-side-routing","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Routing på klientnivå","description":"Hantera Client Side Navigation tillsammans med designsystemet"},"sidebar":"sideBar","previous":{"title":"Validering i formulär","permalink":"/pr-preview/pr-1118/design-patterns/validation"},"next":{"title":"Vanliga problem","permalink":"/pr-preview/pr-1118/dev/common-issues"}}');
