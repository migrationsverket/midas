"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[3863],{
...
function $4e8b0456ef72939f$export$9610e69494fadfd2(props, state, ref) {
    ...
    let focus = ()=>{
        ...
        if (ref.current !== null && (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !(0, DOMFunctions/* isFocusWithin */.ae)(ref.current))) (0, focusSafely/* focusSafely */.l)(ref.current);
    };
