...
const site_docs_components_menu_mdx_635_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/menu","title":"Menu","description":"En meny kan användas för att samla ihop funktioner som sällan används eller som kompletterar nuvarande funktion.","source":"@site/docs/components/menu.mdx","sourceDirName":"components","slug":"/components/menu","permalink":"/pr-preview/pr-1276/components/menu","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Menu","description":"En meny kan användas för att samla ihop funktioner som sällan används eller som kompletterar nuvarande funktion."},"sidebar":"sideBar","previous":{"title":"Logo","permalink":"/pr-preview/pr-1276/components/logo"},"next":{"title":"Modal","permalink":"/pr-preview/pr-1276/components/modal"}}');
