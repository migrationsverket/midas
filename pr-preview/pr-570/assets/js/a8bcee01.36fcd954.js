...
const site_docs_design_patterns_forms_mdx_a8b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/forms","title":"Formulär","description":"Generella riktlinjer","source":"@site/docs/design-patterns/forms.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/forms","permalink":"/pr-preview/pr-570/design-patterns/forms","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function RelatedQuestions() {
  ...
  // 'light' or 'dark'
  const imgSrc = (0,useBaseUrl/* default */.Ay)('/img/formexamples/relatedQuestionsLight.svg');
  const imgSrcDark = (0,useBaseUrl/* default */.Ay)('/img/formexamples/relatedQuestionsDark.svg');
  return (0,jsx_runtime.jsx)("img", {
    src: colorMode === 'light' ? imgSrc : imgSrcDark,
    alt: "Relaterade frågor på samma sida"
  });
}
function UnrelatedQuestions() {
  const {colorMode} = (0,contexts_colorMode/* useColorMode */.G)();
  // 'light' or 'dark'
  const imgSrc = (0,useBaseUrl/* default */.Ay)('/img/formexamples/unrelatedQuestionsLight.svg');
  const imgSrcDark = (0,useBaseUrl/* default */.Ay)('/img/formexamples/unrelatedQuestionsDark.svg');
  return (0,jsx_runtime.jsx)("img", {
    src: colorMode === 'light' ? imgSrc : imgSrcDark,
    alt: "Orelaterade frågor på samma sida"
  });
}
const toc = [{
