...
// EXTERNAL MODULE: ./node_modules/react-aria-components/dist/private/FileTrigger.mjs
var FileTrigger = __webpack_require__(524);
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      }), " för hur den kan användas.\nFileTrigger är en komponent utan utseende och går att använda direkt från React Aria eller importeras från Midas."]
      ...
      children: ["Se ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/file-list",
        children: "FileList"
      }), " för dokumentation av listkomponenten."]
      ...
      children: ["Använd FileTrigger tillsammans med ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: "DropZone"
      }), " för att tillåta val av filer via drag & drop.\nDropZone är en generell yta för drag & drop och dokumenteras separat — se dess ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/dropzone",
        children: "egen sida"
      }), "\nför tillstånd, validering och etikettering."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      className: "card",
      children: (0,jsx_runtime.jsx)(FileUploadExamples/* DropZoneExample */.qk, {})
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "alternativ",
      children: "Alternativ"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), " för att tillåta flera filer samtidigt, och ", (0,jsx_runtime.jsx)(_components.code, {
        children: "acceptedFileTypes"
      }), " för att begränsa vilka filtyper\nsom går att välja. Se ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/dropzone#validering",
        children: "DropZone: Validering"
      }), " för filtypsbegränsning som även gäller\ndrag & drop."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "media-capture",
      ...
      className: "card",
      children: (0,jsx_runtime.jsx)(FileTrigger/* FileTrigger */.F, {
...
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30236);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(54031);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(93754);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(20316);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19615);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(19060);
/* harmony import */ var _midas_ds_components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(24757);
/* harmony import */ var lucide_react__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(94796);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(96540);
/* harmony import */ var react_aria__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(211);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(74848);
var FileListExample=function FileListExample(){var _React$useState=react__WEBPACK_IMPORTED_MODULE_10__.useState([]),files=_React$useState[0],setFiles=_React$useState[1];var handleSelect=function handleSelect(e){var selected=e?Array.from(e):[];setFiles(function(prev){var existingNames=new Set(prev.map(function(f){return f.name;}));return[].concat(prev,selected.filter(function(f){return!existingNames.has(f.name);}));});};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div",{style:{display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_2__/* .FileTrigger */ .F,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_3__/* .Button */ .$,{children:"V\xE4lj filer"})}),files.length>0&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_4__/* .FileList */ .$,{children:files.map(function(file){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_8__/* .FileListItem */ .I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]});};var DropZoneExample=function DropZoneExample(){var _React$useState2=react__WEBPACK_IMPORTED_MODULE_10__.useState([]),files=_React$useState2[0],setFiles=_React$useState2[1];var setUniqueFiles=function setUniqueFiles(newFiles){setFiles(function(oldFiles){var existingNames=new Set(oldFiles.map(function(f){return f.name;}));return[].concat(oldFiles,newFiles.filter(function(f){return!existingNames.has(f.name);}));});};var handleDrop=/*#__PURE__*/function(){var _ref=(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(/*#__PURE__*/(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)().m(function _callee(e){var fileItems,droppedFiles;return (0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)().w(function(_context){while(1)switch(_context.n){case 0:fileItems=e.items.filter(react_aria__WEBPACK_IMPORTED_MODULE_11__/* .isFileDropItem */ .nH);_context.n=1;return Promise.all(fileItems.map(function(item){return item.getFile();}));case 1:droppedFiles=_context.v;setUniqueFiles(droppedFiles);case 2:return _context.a(2);}},_callee);}));return function handleDrop(_x){return _ref.apply(this,arguments);};}();var handleSelect=function handleSelect(e){var selectedFiles=e?Array.from(e):[];setUniqueFiles(selectedFiles);};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_5__/* .DropZone */ .w,{onDrop:handleDrop,"aria-label":"Dra och sl\xE4pp filer h\xE4r",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_6__/* .Text */ .E,{slot:"label",children:"Dra och sl\xE4pp filer h\xE4r"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_2__/* .FileTrigger */ .F,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_3__/* .Button */ .$,{variant:"secondary",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A,{"aria-hidden":true,size:20}),"V\xE4lj fil"]})})]}),files.length>0&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_4__/* .FileList */ .$,{style:{marginTop:'1rem'},children:files.map(function(file){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_8__/* .FileListItem */ .I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]});};var ACCEPTED_FILE_TYPES=['image/jpeg','image/png'];var ValidatedDropZoneExample=function ValidatedDropZoneExample(){var _React$useState3=react__WEBPACK_IMPORTED_MODULE_10__.useState(false),isInvalid=_React$useState3[0],setIsInvalid=_React$useState3[1];var validate=function validate(files){setIsInvalid(files.some(function(file){return!ACCEPTED_FILE_TYPES.includes(file.type);}));};var handleSelect=function handleSelect(fileList){if(fileList)validate(Array.from(fileList));};var handleDrop=/*#__PURE__*/function(){var _ref2=(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(/*#__PURE__*/(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)().m(function _callee2(e){var fileItems,droppedFiles;return (0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_regenerator_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)().w(function(_context2){while(1)switch(_context2.n){case 0:fileItems=e.items.filter(react_aria__WEBPACK_IMPORTED_MODULE_11__/* .isFileDropItem */ .nH);_context2.n=1;return Promise.all(fileItems.map(function(item){return item.getFile();}));case 1:droppedFiles=_context2.v;validate(droppedFiles);case 2:return _context2.a(2);}},_callee2);}));return function handleDrop(_x2){return _ref2.apply(this,arguments);};}();return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)("div",{style:{display:'flex',flexDirection:'column',width:'100%',maxWidth:480},children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_5__/* .DropZone */ .w,{onDrop:handleDrop,isInvalid:isInvalid,"aria-label":"Sl\xE4pp filer h\xE4r",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_6__/* .Text */ .E,{slot:"label",children:"Sl\xE4pp filer h\xE4r"}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_2__/* .FileTrigger */ .F,{acceptedFileTypes:ACCEPTED_FILE_TYPES,onSelect:handleSelect,children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_3__/* .Button */ .$,{variant:"secondary",children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(lucide_react__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A,{"aria-hidden":true,size:20}),"V\xE4lj .jpg- eller .png-filer"]})})]}),isInvalid&&/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_midas_ds_components__WEBPACK_IMPORTED_MODULE_7__/* .FieldError */ .b,{isInvalid:true,children:"Endast .jpg- och .png-filer till\xE5ts"})]});};
...
/* harmony import */ var react_aria__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46686);
/* harmony import */ var _utils_clsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1160);
/* harmony import */ var _FileList_module_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(72160);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(74848);
'use client';var _excluded=["className","children"];var FileList=function FileList(_ref){var className=_ref.className,children=_ref.children,props=(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref,_excluded);var listRef=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_aria__WEBPACK_IMPORTED_MODULE_2__/* .FocusScope */ .n1,{children:/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("ul",Object.assign({},props,{ref:listRef,tabIndex:-1,className:(0,_utils_clsx__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(_FileList_module_css__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.fileList,className),children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(FocusGuard,{containerRef:listRef}),children]}))});};/**
 ...
 */var FocusGuard=function FocusGuard(_ref2){var containerRef=_ref2.containerRef;var focusManager=(0,react_aria__WEBPACK_IMPORTED_MODULE_2__/* .useFocusManager */ .H8)();var focusManagerRef=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(focusManager);(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function(){focusManagerRef.current=focusManager;});(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function(){var container=containerRef.current;if(!container)return;var observer=new MutationObserver(function(mutations){var _focusManagerRef$curr;var hadRemoval=mutations.some(function(m){return m.removedNodes.length>0;});if(!hadRemoval)return;if(document.activeElement!==document.body)return;if(!((_focusManagerRef$curr=focusManagerRef.current)!=null&&_focusManagerRef$curr.focusFirst({tabbable:true}))){container.focus();}});observer.observe(container,{childList:true});return function(){return observer.disconnect();};},[containerRef]);return null;};
...
var ProgressBar = __webpack_require__(90445);
// EXTERNAL MODULE: ./packages/components/src/common/FeedbackStatusIcon.tsx + 1 modules
var FeedbackStatusIcon = __webpack_require__(74890);
...
const translations_namespaceObject = /*#__PURE__*/JSON.parse('{"en":{"removeFile":"Remove","cancelUpload":"Cancel","uploading":"Uploading","uploadComplete":"Upload complete"},"sv":{"removeFile":"Ta bort","cancelUpload":"Avbryt","uploading":"Laddar upp","uploadComplete":"Uppladdning klar"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/file-list/FileListItem.tsx
'use client';var FileListItem=function FileListItem(_ref){var fileName=_ref.fileName,fileSize=_ref.fileSize,_ref$status=_ref.status,status=_ref$status===void 0?'idle':_ref$status,progress=_ref.progress,errorMessage=_ref.errorMessage,onCancel=_ref.onCancel,onDelete=_ref.onDelete,className=_ref.className;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var isUploading=status==='uploading';var onPress=isUploading?onCancel!=null?onCancel:onDelete:onDelete;return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{className:(0,clsx/* default */.A)(FileList_module/* default */.A.fileListItem,className),"data-status":status,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:FileList_module/* default */.A.row,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:FileList_module/* default */.A.iconSlot,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ProgressBar/* ProgressBar */.z,{shape:"circular",small:true,value:progress,isIndeterminate:progress===undefined,"aria-label":strings.format('uploading'),"aria-hidden":isUploading?undefined:true,className:FileList_module/* default */.A.progressIcon}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.ring,"aria-hidden":true}),/*#__PURE__*/(0,jsx_runtime.jsx)(FeedbackStatusIcon/* FeedbackStatusIcon */.$,{status:"success","aria-hidden":true,size:16,className:(0,clsx/* default */.A)(FileList_module/* default */.A.checkmark,FileList_module/* default */.A.successIcon)})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:FileList_module/* default */.A.fileInfo,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileName,children:fileName}),fileSize&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileSize,children:fileSize})]}),onPress&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",onPress:onPress,"aria-label":strings.format(isUploading?'cancelUpload':'removeFile')+" "+fileName,className:FileList_module/* default */.A.deleteButton,children:isUploading?/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20,"aria-hidden":true}):/*#__PURE__*/(0,jsx_runtime.jsx)(trash_2/* default */.A,{size:20,"aria-hidden":true})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:FileList_module/* default */.A.errorReveal,children:errorMessage&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{isInvalid:true,children:errorMessage})}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{role:"status",children:status==='success'?strings.format('uploadComplete'):''})]});};
...
var _excluded=["label","labelProps","showValueLabel","shape","small"];var CIRCLE_RADIUS=8;var CIRCUMFERENCE=2*Math.PI*CIRCLE_RADIUS;var INDETERMINATE_ARC=CIRCUMFERENCE*0.25;var ProgressBar=function ProgressBar(_ref){var label=_ref.label,labelProps=_ref.labelProps,_ref$showValueLabel=_ref.showValueLabel,showValueLabel=_ref$showValueLabel===void 0?false:_ref$showValueLabel,_ref$shape=_ref.shape,shape=_ref$shape===void 0?'linear':_ref$shape,_ref$small=_ref.small,small=_ref$small===void 0?false:_ref$small,progressBarProps=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(private_ProgressBar/* ProgressBar */.z,Object.assign({},progressBarProps,{className:(0,clsx/* default */.A)(ProgressBar_module.progressBar,progressBarProps.className),children:function children(_ref2){var percentage=_ref2.percentage,valueLabel=_ref2.valueText,isIndeterminate=_ref2.isIndeterminate;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,Object.assign({elementType:"span"},labelProps,{className:(0,clsx/* default */.A)(labelProps==null?void 0:labelProps.className,ProgressBar_module.label),children:label})),showValueLabel&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,Object.assign({elementType:"span"},labelProps,{// Override the label id to prevent duplicates
id:label?'':labelProps==null?void 0:labelProps.id,className:(0,clsx/* default */.A)(labelProps==null?void 0:labelProps.className,ProgressBar_module.value),children:valueLabel})),shape==='circular'?/*#__PURE__*/(0,jsx_runtime.jsxs)("svg",{className:(0,clsx/* default */.A)(ProgressBar_module.circular,small&&ProgressBar_module.circularSmall),viewBox:"0 0 20 20","aria-hidden":true,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("circle",{className:ProgressBar_module.circularTrack,cx:10,cy:10,r:CIRCLE_RADIUS}),/*#__PURE__*/(0,jsx_runtime.jsx)("circle",{className:(0,clsx/* default */.A)(ProgressBar_module.circularIndicator,isIndeterminate&&ProgressBar_module.circularIndeterminate),cx:10,cy:10,r:CIRCLE_RADIUS,style:isIndeterminate?{strokeDasharray:INDETERMINATE_ARC+" "+CIRCUMFERENCE}:{strokeDasharray:CIRCUMFERENCE,strokeDashoffset:CIRCUMFERENCE*(1-(percentage!=null?percentage:0)/100)}})]}):/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:ProgressBar_module.track,children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:ProgressBar_module.indicator,style:{width:(isIndeterminate?50:percentage)+"%"}})})]});}}));};
