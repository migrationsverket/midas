...
const site_docs_components_file_list_mdx_7c2_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/file-list","title":"FileList","description":"Lista uppladdade filer","source":"@site/docs/components/file-list.mdx","sourceDirName":"components","slug":"/components/file-list","permalink":"/pr-preview/pr-1366/components/file-list","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"FileList","description":"Lista uppladdade filer"},"sidebar":"sideBar","previous":{"title":"DateField","permalink":"/pr-preview/pr-1366/components/datefield"},"next":{"title":"FileTrigger","permalink":"/pr-preview/pr-1366/components/file-trigger"}}');
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: [(0,jsx_runtime.jsx)(_components.code, {
          children: "progress"
        }), " är bara ett tal du själv räknar fram och skickar in — komponenten vet inget om hur uppladdningen\nsker. ", (0,jsx_runtime.jsx)(_components.code, {
          children: "fetch"
...
'use client';var FileListItem=function FileListItem(_ref){var fileName=_ref.fileName,fileSize=_ref.fileSize,_ref$status=_ref.status,status=_ref$status===void 0?'idle':_ref$status,progress=_ref.progress,errorMessage=_ref.errorMessage,onCancel=_ref.onCancel,onDelete=_ref.onDelete,className=_ref.className;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var isUploading=status==='uploading';var onPress=isUploading?onCancel!=null?onCancel:onDelete:onDelete;return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{className:(0,clsx/* default */.A)(FileList_module/* default */.A.fileListItem,className),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(FileList_module/* default */.A.row,status==='error'&&FileList_module/* default */.A.error),children:[status==='uploading'&&/*#__PURE__*/(0,jsx_runtime.jsx)(ProgressBar/* ProgressBar */.z,{shape:"circular",small:true,value:progress,isIndeterminate:progress===undefined,"aria-label":strings.format('uploading'),className:FileList_module/* default */.A.statusIcon}),status==='success'&&/*#__PURE__*/(0,jsx_runtime.jsx)(FeedbackStatusIcon/* FeedbackStatusIcon */.$,{status:"success","aria-hidden":true,className:FileList_module/* default */.A.statusIcon}),/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:FileList_module/* default */.A.fileInfo,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileName,children:fileName}),fileSize&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileSize,children:fileSize})]}),onPress&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",onPress:onPress,"aria-label":strings.format(isUploading?'cancelUpload':'removeFile')+" "+fileName,className:FileList_module/* default */.A.deleteButton,children:isUploading?/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20,"aria-hidden":true}):/*#__PURE__*/(0,jsx_runtime.jsx)(trash_2/* default */.A,{size:20,"aria-hidden":true})})]}),status==='error'&&errorMessage&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{isInvalid:true,className:FileList_module/* default */.A.error,children:errorMessage}),status==='success'&&/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{role:"status",children:strings.format('uploadComplete')})]});};
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"fileList":"fileList_v7Yz","fileListItem":"fileListItem_rpF7","row":"row_gaDP","error":"error_tvB8","statusIcon":"statusIcon_E330","fileInfo":"fileInfo_mtqe","fileName":"fileName_qyUR","fileSize":"fileSize_ds3p","deleteButton":"deleteButton_ulZ8"});
