"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[4342],{
...
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/dnd/utils.mjs
var dnd_utils = __webpack_require__(211);
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/dnd/constants.mjs
var constants = __webpack_require__(69471);
...
function $8659ad8e5ae1862d$export$62447ad3d2ec7da6() {
    ...
    let modality = (0, dnd_utils/* useDragModality */.dK)();
...
function $f302ef02e940a6f8$export$ccdee5eaf73cf661(options) {
    ...
    let state = (0, react.useRef)({
        ...
        dropEffect: 'none',
        allowedOperations: (0, constants/* DROP_OPERATION */.Eq).all,
    ...
    let onDragOver = (e)=>{
        ...
        if (allowedOperations !== state.allowedOperations) {
            ...
            if (typeof options.getDropOperation === 'function') {
                let types = new (0, dnd_utils/* DragTypes */.CQ)(e.dataTransfer);
                dropOperation = $f302ef02e940a6f8$var$getDropOperation(allowedOperations, options.getDropOperation(types, allowedOps));
            }
            state.dropEffect = (0, constants/* DROP_OPERATION_TO_DROP_EFFECT */.KP)[dropOperation] || 'none';
        }
    ...
    let onDrop = (e)=>{
        ...
        (0, dnd_utils/* setGlobalDropEffect */.a6)(state.dropEffect);
        if (typeof options.onDrop === 'function') {
            let dropOperation = (0, constants/* DROP_EFFECT_TO_DROP_OPERATION */.q$)[state.dropEffect];
            let items = (0, dnd_utils/* readFromDataTransfer */.Cb)(e.dataTransfer);
            let rect = e.currentTarget.getBoundingClientRect();
            let event = {
                type: 'drop',
                x: e.clientX - rect.x,
        ...
        if (dndStateSnapshot.draggingCollectionRef == null) (0, dnd_utils/* setGlobalDropEffect */.a6)(undefined);
        ...
        (0, dnd_utils/* setGlobalDnDState */.v_)(dndStateSnapshot);
    };
...
function $f302ef02e940a6f8$var$getAllowedOperations(e) {
    let allowedOperations = (0, constants/* DROP_OPERATION_ALLOWED */.pQ)[e.dataTransfer.effectAllowed];
    ...
    if (0, dnd_utils/* globalAllowedDropOperations */.r9) allowedOperations &= (0, dnd_utils/* globalAllowedDropOperations */.r9);
    ...
    let allowedModifiers = (0, constants/* DROP_OPERATION */.Eq).none;
    if ((0, platform/* isMac */.cX)()) {
        if (e.altKey) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).copy;
        ...
        if (e.ctrlKey && !(0, platform/* isIPad */.bh)()) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).link;
        if (e.metaKey) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).move;
    } else {
        if (e.altKey) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).link;
        if (e.shiftKey) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).move;
        if (e.ctrlKey) allowedModifiers |= (0, constants/* DROP_OPERATION */.Eq).copy;
    }
...
function $f302ef02e940a6f8$var$allowedOperationsToArray(allowedOperationsBits) {
    ...
    if (allowedOperationsBits & (0, constants/* DROP_OPERATION */.Eq).move) allowedOperations.push('move');
    if (allowedOperationsBits & (0, constants/* DROP_OPERATION */.Eq).copy) allowedOperations.push('copy');
    if (allowedOperationsBits & (0, constants/* DROP_OPERATION */.Eq).link) allowedOperations.push('link');
    return allowedOperations;
}
function $f302ef02e940a6f8$var$getDropOperation(allowedOperations, operation) {
    let op = (0, constants/* DROP_OPERATION */.Eq)[operation];
...
function $692863997030a376$export$2314ca2a3e892862(options) {
    ...
    let onCopy = (0, useEffectEvent/* useEffectEvent */.J)((e)=>{
        ...
        e.preventDefault();
        if (e.clipboardData) {
            (0, dnd_utils/* writeToDataTransfer */.m5)(e.clipboardData, options.getItems({
                action: 'copy'
            }));
            options.onCopy?.();
        }
    ...
    let onPaste = (0, useEffectEvent/* useEffectEvent */.J)((e)=>{
        ...
        e.preventDefault();
        if (e.clipboardData) {
            let items = (0, dnd_utils/* readFromDataTransfer */.Cb)(e.clipboardData);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ $2991e2e71ca29774$export$f8fc6581787339b3),
/* harmony export */   $8: () => (/* binding */ $2991e2e71ca29774$export$4a7729b856e9a690),
/* harmony export */   Eq: () => (/* binding */ $2991e2e71ca29774$export$60b7b4bcf3903d8e),
/* harmony export */   KP: () => (/* binding */ $2991e2e71ca29774$export$5eacb0769d26d3b2),
/* harmony export */   pQ: () => (/* binding */ $2991e2e71ca29774$export$9bbdfc78cf083e16),
/* harmony export */   q$: () => (/* binding */ $2991e2e71ca29774$export$608ecc6f1b23c35d),
/* harmony export */   ss: () => (/* binding */ $2991e2e71ca29774$export$fd9f9fc120c5402d)
/* harmony export */ });
/* unused harmony export EFFECT_ALLOWED */
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License. You may obtain a copy
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CQ: () => (/* binding */ $d40e85a29b831dd6$export$7f04ce188c91447c),
/* harmony export */   Cb: () => (/* binding */ $d40e85a29b831dd6$export$d9e760437831f8b3),
/* harmony export */   a6: () => (/* binding */ $d40e85a29b831dd6$export$64f52ed7349ddb84),
/* harmony export */   dK: () => (/* binding */ $d40e85a29b831dd6$export$49bac5d6d4b352ea),
/* harmony export */   m5: () => (/* binding */ $d40e85a29b831dd6$export$f9c1490890ddd063),
/* harmony export */   nH: () => (/* binding */ $d40e85a29b831dd6$export$a144e1752ebe0aa),
/* harmony export */   r9: () => (/* binding */ $d40e85a29b831dd6$export$f0130eb70b6347b8),
/* harmony export */   ti: () => (/* binding */ $d40e85a29b831dd6$export$6ca6700462636d0b),
/* harmony export */   v_: () => (/* binding */ $d40e85a29b831dd6$export$6c10d32b362bfa5f)
/* harmony export */ });
/* unused harmony exports droppableCollectionMap, DIRECTORY_DRAG_TYPE, getDroppableCollectionId, getDroppableCollectionRef, getTypes, getDragModality, isTextDropItem, isDirectoryDropItem, setDraggingCollectionRef, setDraggingKeys, setDropCollectionRef, clearGlobalDnDState, isInternalDropOperation, globalDropEffect, setGlobalAllowedDropOperations */
/* unused harmony import specifier */ var $8f5a2122b0992be3$export$630ff653c5ada6a9;
/* harmony import */ var _constants_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(69471);
/* harmony import */ var _interactions_useFocusVisible_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35692);
...
function $d40e85a29b831dd6$export$49bac5d6d4b352ea() {
    return $d40e85a29b831dd6$var$mapModality((0, _interactions_useFocusVisible_mjs__WEBPACK_IMPORTED_MODULE_1__/* .useInteractionModality */ .lb)());
}
...
function $d40e85a29b831dd6$export$f9c1490890ddd063(dataTransfer, items) {
    ...
    for (let [type, items] of groupedByType)if ((0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .NATIVE_DRAG_TYPES */ .$8).has(type)) {
    ...
    if (needsCustomData) {
        ...
        dataTransfer.items.add(data, (0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CUSTOM_DRAG_TYPE */ .ss));
    }
}
class $d40e85a29b831dd6$export$7f04ce188c91447c {
    constructor(dataTransfer){
        this.types = new Set();
        let hasFiles = false;
        for (let item of dataTransfer.items)if (item.type !== (0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CUSTOM_DRAG_TYPE */ .ss)) {
            ...
            this.types.add((0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .GENERIC_TYPE */ .$));
        }
    ...
    has(type) {
        ...
        if (this.includesUnknownTypes || type === $d40e85a29b831dd6$export$990fced5dfac2637 && this.types.has((0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .GENERIC_TYPE */ .$)) || type === '*/*') return true;
...
function $d40e85a29b831dd6$export$d9e760437831f8b3(dataTransfer) {
    ...
    if (dataTransfer.types.includes((0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CUSTOM_DRAG_TYPE */ .ss))) try {
        let data = dataTransfer.getData((0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CUSTOM_DRAG_TYPE */ .ss));
    ...
    if (!hasCustomType) {
        ...
        for (let item of dataTransfer.items){
            ...
            stringItems.set(item.type || (0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .GENERIC_TYPE */ .$), dataTransfer.getData(item.type));
...
function $d40e85a29b831dd6$var$createFileItem(file) {
    ...
    return {
        kind: 'file',
        type: file.type || (0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .GENERIC_TYPE */ .$),
        name: file.name,
...
let $d40e85a29b831dd6$export$f0130eb70b6347b8 = (0, _constants_mjs__WEBPACK_IMPORTED_MODULE_0__/* .DROP_OPERATION */ .Eq).none;
