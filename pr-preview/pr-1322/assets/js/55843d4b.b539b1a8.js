...
const site_docs_basics_language_mdx_558_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/language","title":"Språk","description":"När vi skriver texter för Migrationsverkets digitala kanaler och tjänster utgår vi från Myndigheternas skrivregler, som är Språkrådets vägledning för alla som skriver inom offentlig verksamhet.","source":"@site/docs/basics/language.mdx","sourceDirName":"basics","slug":"/basics/language","permalink":"/pr-preview/pr-1322/basics/language","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"id":"language","title":"Språk","sidebar_position":4},"sidebar":"sideBar","previous":{"title":"Ikoner","permalink":"/pr-preview/pr-1322/basics/icons"},"next":{"title":"Tillgänglighet","permalink":"/pr-preview/pr-1322/basics/accessibility"}}');
