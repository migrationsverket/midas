...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: "Komponent som används för att kunna visa fördjupande information eller ge plats för sekundära verktyg som till exempel filter, utan att behöva navigera bort från huvudinnehållet. Panelen visas alltid till höger om huvudinnehållet."
