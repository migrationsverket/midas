...
var SelectTrigger=function SelectTrigger(_ref){var _clsx;var isDisabled=_ref.isDisabled,selectionMode=_ref.selectionMode,size=_ref.size;var state=(0,react.useContext)(Select/* SelectStateContext */.nT);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* Button */.$,{className:(0,dist_clsx/* default */.A)((_clsx={},_clsx[Select_module.medium]=size==='medium',_clsx),Select_module.trigger),"data-invalid":!!(state!=null&&state.displayValidation.isInvalid)||undefined,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Select/* SelectValue */.yv,{className:Select_module.selectValue,"data-disabled":isDisabled||undefined,children:function children(_ref2){var selectedText=_ref2.selectedText,defaultChildren=_ref2.defaultChildren;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Select_module.placeholder,children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Select_module.truncate,children:selectionMode==='multiple'&&selectedText?/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{}):selectedText||defaultChildren})});}}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{"aria-hidden":"true",style:{display:'flex'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_down/* default */.A,{size:20})})]});};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   e: () => (/* binding */ mockPersonData)
/* harmony export */ });
var mockPersonData=[{id:'1',firstName:'Anna',lastName:'Andersson',email:'anna.andersson@example.com',department:'Engineering',status:'Active'},{id:'2',firstName:'Erik',lastName:'Eriksson',email:'erik.eriksson@example.com',department:'Marketing',status:'Active'},{id:'3',firstName:'Maria',lastName:'Svensson',email:'maria.svensson@example.com',department:'HR',status:'Inactive'},{id:'4',firstName:'Lars',lastName:'Larsson',email:'lars.larsson@example.com',department:'Sales',status:'Active'},{id:'5',firstName:'Karin',lastName:'Nilsson',email:'karin.nilsson@example.com',department:'Engineering',status:'Pending'},{id:'6',firstName:'Johan',lastName:'Johansson',email:'johan.johansson@example.com',department:'Finance',status:'Active'},{id:'7',firstName:'Emma',lastName:'Karlsson',email:'emma.karlsson@example.com',department:'Marketing',status:'Inactive'},{id:'8',firstName:'Sofia',lastName:'Pettersson',email:'sofia.pettersson@example.com',department:'Engineering',status:'Pending'}];
...
// EXTERNAL MODULE: ./packages/components/src/text/Text.tsx + 1 modules
var Text = __webpack_require__(19615);
;// ./packages/components/src/pagination/utils.ts
/**
 * Get the current page of an index, given a page size
 */var findPage=function findPage(index,pageSize){return index>=pageSize?Math.floor(index/pageSize):0;};
// EXTERNAL MODULE: ./packages/components/src/utils/intl/useLocalizedStringFormatter.ts
var useLocalizedStringFormatter = __webpack_require__(88413);
;// ./packages/components/src/pagination/intl/translations.json
const translations_namespaceObject = /*#__PURE__*/JSON.parse('{"en":{"nextPage":"Next page","previousPage":"Previous page","rowsPerPage":"Rows per page:","of":"of","pages":"pages","rows":"rows","selectPage":"Select page"},"sv":{"nextPage":"Nästa sida","previousPage":"Föregående sida","rowsPerPage":"Rader per sida:","of":"av","pages":"sidor","rows":"rader","selectPage":"Välj sida"}}');
;// ./packages/components/src/pagination/Pagination.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Pagination_module = ({"pagination":"pagination_HJBG","separator":"separator_KrH_","select":"select_hG_C","listBoxItem":"listBoxItem_qqcw","pageSize":"pageSize_ktJF select_hG_C","result":"result_cUk2 separator_KrH_","pageIndexContainer":"pageIndexContainer_j7JJ separator_KrH_","label":"label_MymH","pageIndex":"pageIndex_Uiq9 select_hG_C","buttons":"buttons_sTKK","button":"button_PL3T separator_KrH_"});
// EXTERNAL MODULE: ./node_modules/@react-aria/focus/dist/FocusScope.mjs + 1 modules
var FocusScope = __webpack_require__(49336);
;// ./packages/components/src/pagination/Pagination.tsx
var NavigationButtons=function NavigationButtons(_ref){var getCanNextPage=_ref.getCanNextPage,getCanPreviousPage=_ref.getCanPreviousPage,nextPage=_ref.nextPage,previousPage=_ref.previousPage;var focusManager=(0,FocusScope/* useFocusManager */.H8)();var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var onKeyDown=function onKeyDown(e){switch(e.key){case'ArrowRight':focusManager==null||focusManager.focusNext({wrap:true});break;case'ArrowLeft':focusManager==null||focusManager.focusPrevious({wrap:true});break;}};return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":strings.format('previousPage'),className:Pagination_module.button,isDisabled:!getCanPreviousPage(),onKeyDown:onKeyDown,onPress:previousPage,variant:"icon",children:/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_left/* default */.A,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":strings.format('nextPage'),className:Pagination_module.button,isDisabled:!getCanNextPage(),onKeyDown:onKeyDown,onPress:nextPage,variant:"icon",children:/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_right/* default */.A,{})})]});};var Pagination=function Pagination(props){var getPageCount=props.getPageCount,getRowCount=props.getRowCount,pageIndex=props.pageIndex,pageSize=props.pageSize,_props$pageSizeOption=props.pageSizeOptions,pageSizeOptions=_props$pageSizeOption===void 0?[10,20,30,40,50]:_props$pageSizeOption,setPageIndex=props.setPageIndex,setPageSize=props.setPageSize;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var pageCount=getPageCount();var rowCount=getRowCount();var lastVisibleItem=(pageIndex+1)*pageSize;var firstVisibleItem=lastVisibleItem-pageSize+1;var handleChangePageIndex=function handleChangePageIndex(value){setPageIndex(value!==null?Number(value):0);};var handleChangePageSize=function handleChangePageSize(value){var newPageSize=value!==null?Number(value):pageSize;setPageSize(newPageSize);setPageIndex(findPage(firstVisibleItem,newPageSize));};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Pagination_module.pagination,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Select/* Select */.l,{className:Pagination_module.pageSize,items:pageSizeOptions.map(function(size){return{id:size.toString(),name:size};}),label:strings.format('rowsPerPage'),onChange:handleChangePageSize,value:pageSize.toString(),children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{className:Pagination_module.listBoxItem,id:item.id,textValue:item.id,children:item.name});}}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Text/* Text */.E,{className:Pagination_module.result,children:[firstVisibleItem," -",' ',lastVisibleItem>rowCount?rowCount:lastVisibleItem,' ',strings.format('of')," ",rowCount.toLocaleString(),' ',strings.format('rows')]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Pagination_module.pageIndexContainer,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Select/* Select */.l,{"aria-label":strings.format('selectPage'),className:Pagination_module.pageIndex,items:Array.from({length:pageCount},function(_,i){return{id:i.toString(),name:i};}),onChange:handleChangePageIndex,value:pageIndex.toString(),children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{className:Pagination_module.listBoxItem,id:item.id,textValue:(Number(item.id)+1).toString(),children:item.name+1});}}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Text/* Text */.E,{className:Pagination_module.label,children:[strings.format('of')," ",pageCount," ",strings.format('pages')]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Pagination_module.buttons,children:/*#__PURE__*/(0,jsx_runtime.jsx)(FocusScope/* FocusScope */.n1,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationButtons,Object.assign({},props))})})]});};
...
const site_docs_dev_tanstack_table_mdx_86b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tanstack-table","title":"Tanstack Table","description":"Implementation av Tanstack Table","source":"@site/docs/dev/tanstack-table.mdx","sourceDirName":"dev","slug":"/dev/tanstack-table","permalink":"/pr-preview/pr-978/dev/tanstack-table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tanstack Table","description":"Implementation av Tanstack Table","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(28453);
// EXTERNAL MODULE: ./apps/docs/src/components/examples/index.ts + 12 modules
var examples = __webpack_require__(30425);
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { Pagination } from 'todo/path/to/Pagination'\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
