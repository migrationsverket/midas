...
const site_docs_components_breadcrumbs_mdx_aca_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/breadcrumbs","title":"Breadcrumbs","description":"Brödsmulor används för att visa användaren vart hen är i ett navigationsträd.","source":"@site/docs/components/breadcrumbs.mdx","sourceDirName":"components","slug":"/components/breadcrumbs","permalink":"/pr-preview/pr-1042/components/breadcrumbs","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Breadcrumbs","description":"Brödsmulor används för att visa användaren vart hen är i ett navigationsträd."},"sidebar":"sideBar","previous":{"title":"Badge","permalink":"/pr-preview/pr-1042/components/badge"},"next":{"title":"Button","permalink":"/pr-preview/pr-1042/components/button"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
var CollapsedBreadcrumbsExample=function CollapsedBreadcrumbsExample(){var items=[{id:'start',label:'Start'},{id:'produkter',label:'Produkter'},{id:'kategori',label:'Kategori'},{id:'underkategori',label:'Underkategori'},{id:'artikel',label:'Artikel'}];var first=items[0];var middle=items.slice(1,-2);var last=items.slice(-2);var breadcrumbItems=[{id:first.id,content:/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,{children:first.label})}].concat(middle.length>0?[{id:'ellipsis',content:/*#__PURE__*/(0,jsx_runtime.jsxs)(Menu/* MenuTrigger */.cQ,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon","aria-label":"Visa fler br\xF6dsmulor",style:{minWidth:'auto',padding:0,height:'auto'},children:"\u2026"}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuPopover/* MenuPopover */.b,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(menu_Menu/* Menu */.W,{onAction:function onAction(id){return console.log('Navigera till:',id);},children:middle.map(function(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:item.id,children:item.label},item.id);})})})]})}]:[],last.map(function(item){return{id:item.id,content:/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,{children:item.label})};}));return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Breadcrumbs/* Breadcrumbs */.B,{items:breadcrumbItems,onAction:function onAction(id){return console.log('Navigera till:',id);},children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Breadcrumb/* Breadcrumb */.Q,{id:item.id,children:item.content});}})});};
