import{j as C}from"./iframe-BWGsaiHR.js";import{B as K}from"./Button-Bt9chofq.js";import{P as M}from"./plus-DdiGFugf.js";import{X as U}from"./x-BzVYZYxZ.js";import"./preload-helper-Dp1pzeXC.js";import"./Button.module-DWkXlqFG.js";import"./Button-mDKaISjU.js";import"./utils-Dn17eObK.js";import"./clsx-B-dksMZM.js";import"./Hidden-MpjXKP0x.js";import"./useFocusRing-BgbQT13K.js";import"./index-C6DFDgEn.js";import"./index-BsaL0LMI.js";import"./useLabels-B17culgM.js";import"./useButton-WQGa6IkK.js";import"./createLucideIcon-CxmKe3N4.js";const{expect:p,userEvent:m}=__STORYBOOK_MODULE_TEST__,ca={component:K,title:"Components/Button",tags:["autodocs"],args:{variant:"primary",children:"Button",size:"large"},argTypes:{children:{type:"string"},isDisabled:{options:[!0,!1],control:{type:"radio"}}}},e={args:{children:"Button",className:"test-class"}},n={args:{variant:"secondary"}},s={args:{children:"Lägg till",variant:"tertiary",icon:M}},o={args:{variant:"primary",isDisabled:!0,children:"Lägg till"},play:async({canvas:t})=>{const a=t.getByRole("button");await m.click(a),await p(a).toBeDisabled()}},c={args:{variant:"secondary",isDisabled:!0},play:async({canvas:t})=>{const a=t.getByRole("button");await m.click(a),await p(a).toBeDisabled()}},i={args:{children:"Button",fullwidth:!0}},l={args:{children:C.jsx(U,{size:20,"aria-hidden":!0}),variant:"icon","aria-label":"Stäng"}},d={args:{children:"Button",variant:"danger"}},u={tags:["!dev","!autodocs"],parameters:{chromatic:{disableSnapshot:!0}},args:{children:"Button",className:"test-class"},play:async({canvas:t,step:a})=>{await a("it should have focus when clicked",async()=>{const r=t.getByRole("button");await m.click(r),await p(r).toBeEnabled(),r.focus(),await m.keyboard("{Enter}"),await p(r).toHaveFocus()})}};var g,y,b;e.parameters={...e.parameters,docs:{...(g=e.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    children: 'Button',
