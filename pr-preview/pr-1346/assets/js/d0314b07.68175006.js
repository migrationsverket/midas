...
const site_docs_get_started_install_mdx_d03_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"get-started/install","title":"Installera Midas","description":"Midas kan installeras och användas i ett React-projekt med en pakethanterare som till exempel npm eller yarn.","source":"@site/docs/get-started/install.mdx","sourceDirName":"get-started","slug":"/get-started/install","permalink":"/pr-preview/pr-1346/get-started/install","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2,"frontMatter":{"title":"Installera Midas","sidebar_label":"Installera","sidebar_position":2},"sidebar":"sideBar","previous":{"title":"Om","permalink":"/pr-preview/pr-1346/get-started/about"},"next":{"title":"Översikt","permalink":"/pr-preview/pr-1346/get-started/contribute/"}}');
...
(0,useIsomorphicLayoutEffect/* default */.A)(function(){if(valueToSync){setSelectedValue(valueToSync);}},[valueToSync]);var selectValue=(0,react.useCallback)(function(newValue){if(!isValidValue({value:newValue,tabValues:tabValues})){throw new Error("Can't select invalid tab value="+newValue);}setSelectedValue(newValue);setQueryString(newValue);setStorageValue(newValue);},[setQueryString,setStorageValue,tabValues]);return{selectedValue:selectedValue,selectValue:selectValue,tabValues:tabValues,lazy:(_props$lazy=props.lazy)!=null?_props$lazy:false,block:(_props$block=props.block)!=null?_props$block:false};}var TabsContext=/*#__PURE__*/(0,react.createContext)(null);function useTabs(){var contextValue=react.useContext(TabsContext);if(!contextValue){throw new Error('useTabsContext() must be used within a Tabs component');}return contextValue;}function TabsProvider(props){return/*#__PURE__*/(0,jsx_runtime.jsx)(TabsContext.Provider,{value:props.value,children:props.children});}
...
,{className:className}),/*#__PURE__*/(0,jsx_runtime.jsx)(TabContent,{children:children})]});}function Tabs(props){var isBrowser=(0,useIsBrowser/* default */.A)();var value=useTabsContextValue(props);return/*#__PURE__*/(0,jsx_runtime.jsx)(TabsProvider,{value:value// Remount tabs after hydration
// Temporary fix for https://github.com/facebook/docusaurus/issues/5653
,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TabsContainer,{className:props.className,children:sanitizeTabsChildren(props.children)})},String(isBrowser));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function TabItemPanel(_ref){var children=_ref.children,className=_ref.className,hidden=_ref.hidden;return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{role:"tabpanel",className:(0,clsx/* default */.A)(TabItem_styles_module.tabItem,className),hidden:hidden,children:children});}function TabItem(_ref2){var children=_ref2.children,className=_ref2.className,value=_ref2.value;var _useTabs=useTabs(),selectedValue=_useTabs.selectedValue,lazy=_useTabs.lazy;var isSelected=value===selectedValue;// TODO Docusaurus v4: use <Activity> ?
