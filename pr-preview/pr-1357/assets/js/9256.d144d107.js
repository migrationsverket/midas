"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9256],{
...
/* harmony export */ });
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59069);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86827);
...
var drawRect = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)((element, rectData) => {
...
var drawBackgroundRect = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)((element, bounds) => {
  const rectData = {
    x: bounds.startx,
    y: bounds.starty,
...
var drawText = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)((element, textData) => {
  const nText = textData.text.replace(_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_0__/* .lineBreakRegex */ .H1, " ");
...
var drawImage = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)((elem, x, y, link) => {
...
var drawEmbeddedImage = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)((element, x, y, link) => {
...
var getNoteRect = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(() => {
  const noteRectData = {
    x: 0,
    y: 0,
    width: 100,
...
var getTextObj = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(() => {
  const testObject = {
    x: 0,
    y: 0,
    width: 100,
...
var createTooltip = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K)(() => {
...
/* harmony export */ });
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86827);
...
/* harmony export */ });
/* harmony import */ var _chunk_2Q5K7J3B_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15350);
/* harmony import */ var _chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81818);
/* harmony import */ var _chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(91730);
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34502);
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(59069);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31293);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(86827);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(70451);
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16750);
...
var parser = (function() {
  var o = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 3:
          yy.apply($$[$0]);
    ...
    parseError: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function parse(input) {
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ (function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: { "case-insensitive": true },
      performAction: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(Parser, "Parser");
...
var SequenceDB = class {
  constructor() {
    this.state = new _chunk_2Q5K7J3B_mjs__WEBPACK_IMPORTED_MODULE_0__/* .ImperativeState */ .m(() => ({
      prevActor: void 0,
    ...
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .SV;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccDescription */ .EI;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setDiagramTitle */ .ke;
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccTitle */ .iN;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccDescription */ .m7;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getDiagramTitle */ .ab;
    this.apply = this.apply.bind(this);
    this.parseBoxData = this.parseBoxData.bind(this);
    this.parseMessage = this.parseMessage.bind(this);
    this.clear();
    this.setWrap((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().wrap);
    this.LINETYPE = LINETYPE;
    this.ARROWTYPE = ARROWTYPE;
    this.PLACEMENT = PLACEMENT;
  }
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(this, "SequenceDB");
  }
  addBox(data) {
  ...
  addActor(id, name, description, type, metadata) {
    ...
    if (metadata !== void 0) {
      ...
      doc = (0,_chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_1__/* .load */ .H)(yamlData, { schema: _chunk_ZIRB5QZD_mjs__WEBPACK_IMPORTED_MODULE_1__/* .JSON_SCHEMA */ .r });
    }
    type = doc?.type ?? type;
  ...
  autoWrap() {
    ...
    return (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().sequence?.wrap ?? false;
  }
  clear() {
    this.state.reset();
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .clear */ .IU)();
  }
  parseMessage(str) {
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug(`parseMessage: ${JSON.stringify(message)}`);
    return message;
  }
  ...
  parseBoxData(str) {
    ...
    return {
      text: cleanedText ? (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(cleanedText, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : void 0,
      color,
      wrap
    };
  }
  ...
  addLinks(actorId, text) {
    ...
    try {
      let sanitizedText = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(text.text, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
      sanitizedText = sanitizedText.replace(/&equals;/g, "=");
      sanitizedText = sanitizedText.replace(/&amp;/g, "&");
      const links = JSON.parse(sanitizedText);
      this.insertLinks(actor, links);
    } catch (e) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.error("error while parsing actor link text", e);
    }
  }
  ...
  addProperties(actorId, text) {
    const actor = this.getActor(actorId);
    try {
      const sanitizedText = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(text.text, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
      const properties = JSON.parse(sanitizedText);
      this.insertProperties(actor, properties);
    } catch (e) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.error("error while parsing actor properties text", e);
    }
  }
  ...
  addDetails(actorId, text) {
    ...
    try {
      ...
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.error("error while parsing actor details text", e);
    }
  }
    ...
    if (Array.isArray(param)) {
      ...
      switch (param.type) {
        ...
        case "altEnd":
          ...
          break;
        case "setAccTitle":
          (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .SV)(param.text);
          break;
        case "parStart":
  ...
  getConfig() {
    return (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().sequence;
  }
};

// src/diagrams/sequence/styles.js
var getStyles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((options) => {
  const dropShadow = options.dropShadow ?? "none";
  const { look } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  return `.actor {
...
var drawRect2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, rectData) {
  const rectElement = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawRect */ .tk)(elem, rectData);
  if ((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)().look === "neo") {
    rectElement.attr("data-look", "neo");
  }
  return rectElement;
}, "drawRect");
var drawPopup = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, minMenuWidth, textAttrs, forceMenus) {
  ...
  if (links != null) {
    ...
    for (let key in links) {
      ...
      var sanitizedLink = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_8__/* .sanitizeUrl */ .J)(links[key]);
...
var popupMenuToggle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(popId) {
  return "var pu = document.getElementById('" + popId + "'); if (pu != null) { pu.style.display = pu.style.display == 'block' ? 'none' : 'block'; }";
}, "popupMenuToggle");
var drawKatex = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(elem, textData, msgModel = null) {
  let textElem = elem.append("foreignObject");
  const linesSanitized = await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatexSanitized */ .dj)(textData.text, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)());
...
var drawText = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, textData) {
  let prevTextHeight = 0;
  let textHeight = 0;
  const lines = textData.text.split(_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .I5)(textData.fontSize);
  let textElems = [];
  let dy = 0;
  let yfunc = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(() => textData.y, "yfunc");
  if (textData.valign !== void 0 && textData.textMargin !== void 0 && textData.textMargin > 0) {
    switch (textData.valign) {
      case "top":
      case "start":
        yfunc = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(() => Math.round(textData.y + textData.textMargin), "yfunc");
        break;
      case "middle":
      case "center":
        yfunc = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(() => Math.round(textData.y + (prevTextHeight + textHeight + textData.textMargin) / 2), "yfunc");
        break;
      case "bottom":
      case "end":
        yfunc = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(() => Math.round(
  ...
  for (let [i, line] of lines.entries()) {
    ...
    const text = line || _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .ZERO_WIDTH_SPACE */ .pe;
    if (textData.tspan) {
...
var drawLabel = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, txtObject) {
  function genPoints(x, y, width, height, cut) {
    return x + "," + y + " " + (x + width) + "," + y + " " + (x + width) + "," + (y + height - cut) + " " + (x + width - cut * 1.2) + "," + (y + height) + " " + x + "," + (y + height);
  }
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(genPoints, "genPoints");
...
var actorCnt = -1;
var fixLifeLineHeights = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((diagram2, actors, actorKeys, conf2) => {
  if (!diagram2.select) {
    return;
  }
...
var drawActorTypeParticipant = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  ...
  const rect = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getNoteRect */ .PB)();
  var cssclass = "actor";
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawEmbeddedImage */ .CP)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc.substr(1));
    } else {
      (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawImage */ .aC)(g, rect.x + rect.width - 20, rect.y + 10, iconSrc);
    }
  }
  if (!isFooter) {
  ...
  _drawTextCandidateFunc(conf2, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description))(
    actor.description,
    g,
    rect.x,
    rect.y,
...
var drawActorTypeCollections = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeQueue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + actor.height;
  const { look, theme, themeVariables } = conf2;
  ...
  if (actor.properties?.icon) {
    ...
    if (iconSrc.charAt(0) === "@") {
      (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawEmbeddedImage */ .CP)(g, iconX, iconY, iconSrc.substr(1));
    } else {
      (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawImage */ .aC)(g, iconX, iconY, iconSrc);
    }
  }
  _drawTextCandidateFunc(conf2, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description))(
    actor.description,
...
var drawActorTypeControl = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, diagramId, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeEntity = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 75;
  const { look, theme, themeVariables } = conf2;
...
var drawActorTypeDatabase = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeBoundary = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
...
var drawActorTypeActor = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, actor, conf2, isFooter, actorIndexMap) {
  const actorY = isFooter ? actor.stopy : actor.starty;
  const center = actor.x + actor.width / 2;
  const centerY = actorY + 80;
  const { look, theme, themeVariables } = conf2;
...
var drawActor = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(elem, actor, conf2, isFooter, diagramId, diagObj, actorIndexMap) {
...
var drawBox = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, box, conf2) {
...
var anchorElement = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem) {
  return elem.append("g");
}, "anchorElement");
var drawActivation = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(_elem, bounds2, verticalPos, conf2, actorActivations2, diagObj, actorIndexMap) {
...
var drawLoop = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(elem, loopModel, labelText, conf2, msg) {
  const {
    boxMargin,
    boxTextMargin,
    labelBoxHeight,
  ...
  const drawLoopLine = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(startx, starty, stopx, stopy) {
  ...
  let txt = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getTextObj */ .HT)();
  txt.text = labelText;
  ...
  txt.fontWeight = fontWeight;
  txt.wrap = true;
  let textElem = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(txt.text) ? await drawKatex(g, txt, loopModel) : drawText(g, txt);
  if (loopModel.sectionTitles !== void 0) {
    for (const [idx, item] of Object.entries(loopModel.sectionTitles)) {
      if (item.message) {
        ...
        if ((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(txt.text)) {
...
var drawBackgroundRect2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, bounds2) {
  (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .drawBackgroundRect */ .lC)(elem, bounds2);
}, "drawBackgroundRect");
var insertDatabaseIcon = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertComputerIcon = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertClockIcon = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertArrowHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertArrowFilledHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertSequenceNumber = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertArrowCrossHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertDropShadow = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, conf2) {
  const { theme } = conf2;
...
var getTextObj2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var getNoteRect2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
  return {
    x: 0,
    y: 0,
    fill: "#EDF2AE",
...
var _drawTextCandidateFunc = /* @__PURE__ */ (function() {
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(byText, "byText");
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    const { actorFontSize, actorFontFamily, actorFontWeight } = conf2;
    const [_actorFontSize, _actorFontSizePx] = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .I5)(actorFontSize);
    const lines = content.split(_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.lineBreakRegex);
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(byTspan, "byTspan");
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(byFo, "byFo");
  async function byKatex(content, g, x, y, width, height, textAttrs, conf2) {
    const dim = await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(content, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)());
    const s = g.append("switch");
    ...
    text.append("div").style("text-align", "center").style("vertical-align", "middle").html(await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatexSanitized */ .dj)(content, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .zj)()));
    byTspan(content, s, x, y, width, height, textAttrs, conf2);
    _setTextAttrs(text, textAttrs);
  }
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(byKatex, "byKatex");
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(_setTextAttrs, "_setTextAttrs");
...
var insertSolidTopArrowHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertSolidBottomArrowHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertStickTopArrowHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var insertStickBottomArrowHead = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, id) {
...
var svgDraw_default = {
  ...
  fixLifeLineHeights,
  sanitizeUrl: _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_8__/* .sanitizeUrl */ .J,
  insertDropShadow,
  insertSolidTopArrowHead,
  insertSolidBottomArrowHead,
  insertStickTopArrowHead,
...
var bounds = {
  ...
  activations: [],
  models: {
    getHeight: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      return Math.max.apply(
        null,
        this.actors.length === 0 ? [0] : this.actors.map((actor) => actor.height || 0)
      ) + (this.loops.length === 0 ? 0 : this.loops.map((it) => it.height || 0).reduce((acc, h) => acc + h)) + (this.messages.length === 0 ? 0 : this.messages.map((it) => it.height || 0).reduce((acc, h) => acc + h)) + (this.notes.length === 0 ? 0 : this.notes.map((it) => it.height || 0).reduce((acc, h) => acc + h));
    }, "getHeight"),
    clear: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      this.actors = [];
      this.boxes = [];
      this.loops = [];
      this.messages = [];
    ...
    addBox: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(boxModel) {
      this.boxes.push(boxModel);
    }, "addBox"),
    addActor: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(actorModel) {
      this.actors.push(actorModel);
    }, "addActor"),
    addLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(loopModel) {
      this.loops.push(loopModel);
    }, "addLoop"),
    addMessage: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msgModel) {
      this.messages.push(msgModel);
    }, "addMessage"),
    addNote: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(noteModel) {
      this.notes.push(noteModel);
    }, "addNote"),
    lastActor: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      return this.actors[this.actors.length - 1];
    }, "lastActor"),
    lastLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      return this.loops[this.loops.length - 1];
    }, "lastLoop"),
    lastMessage: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
      return this.messages[this.messages.length - 1];
    }, "lastMessage"),
    lastNote: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
  ...
  init: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    this.sequenceItems = [];
    this.activations = [];
    this.models.clear();
    this.data = {
    ...
    this.verticalPos = 0;
    setConf((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
  }, "init"),
  updateVal: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(obj, key, val, fun) {
    if (obj[key] === void 0) {
      obj[key] = val;
    } else {
  ...
  updateBounds: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(startx, starty, stopx, stopy) {
    const _self = this;
    let cnt = 0;
    function updateFn(type) {
      return /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function updateItemBounds(item) {
        cnt++;
    ...
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(updateFn, "updateFn");
    this.sequenceItems.forEach(updateFn());
    this.activations.forEach(updateFn("activation"));
  }, "updateBounds"),
  insert: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(startx, starty, stopx, stopy) {
    const _startx = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(startx, stopx);
    const _stopx = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(startx, stopx);
    const _starty = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(starty, stopy);
    const _stopy = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(starty, stopy);
  ...
  newActivation: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(message, diagram2, actors) {
  ...
  endActivation: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(message) {
    const lastActorActivationIdx = this.activations.map(function(activation) {
      return activation.actor;
    }).lastIndexOf(message.from);
    return this.activations.splice(lastActorActivationIdx, 1)[0];
  }, "endActivation"),
  createLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    return {
      startx: void 0,
  ...
  newLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(title = { message: void 0, wrap: false, width: void 0 }, fill) {
    this.sequenceItems.push(this.createLoop(title, fill));
  }, "newLoop"),
  endLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    return this.sequenceItems.pop();
  }, "endLoop"),
  isLoopOverlap: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    return this.sequenceItems.length ? this.sequenceItems[this.sequenceItems.length - 1].overlap : false;
  }, "isLoopOverlap"),
  addSectionToLoop: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(message) {
  ...
  saveVerticalPos: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    if (this.isLoopOverlap()) {
      this.savedVerticalPos = this.verticalPos;
    }
  }, "saveVerticalPos"),
  resetVerticalPos: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    if (this.isLoopOverlap()) {
      this.verticalPos = this.savedVerticalPos;
    }
  }, "resetVerticalPos"),
  bumpVerticalPos: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(bump) {
    this.verticalPos = this.verticalPos + bump;
    this.data.stopy = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(this.data.stopy, this.verticalPos);
  }, "bumpVerticalPos"),
  getVerticalPos: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    return this.verticalPos;
  }, "getVerticalPos"),
  getBounds: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function() {
    return { bounds: this.data, models: this.models };
  }, "getBounds")
};
var drawNote = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(elem, noteModel, id) {
  ...
  const textObj = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getTextObj */ .HT)();
  ...
  const textElem = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textObj.text) ? await drawKatex(g, textObj) : drawText(g, textObj);
...
var drawCentralConnection = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(elem, msg, msgModel, diagObj, startx, stopx, lineStartY) {
  ...
  const getCircleOffset = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((isLeftToRight2, isReverse2) => {
  ...
  const drawCircle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((cx) => {
...
var messageFont = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((cnf) => {
  return {
...
var noteFont = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((cnf) => {
  return {
...
var actorFont = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((cnf) => {
  return {
...
async function boundMessage(_diagram, msgModel) {
  ...
  const lines = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.splitBreaks(message).length;
  const isKatexMsg = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(message);
  const textDims = isKatexMsg ? await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(message, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(message, messageFont(conf));
  if (!isKatexMsg) {
  ...
  if (startx === stopx) {
    ...
    totalOffset += 30;
    const dx = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(textWidth / 2, conf.width / 2);
    bounds.insert(
      startx - dx,
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(boundMessage, "boundMessage");
var drawMessage = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(diagram2, msgModel, lineStartY, diagObj, msg, diagramId) {
  const { startx, stopx, starty, message, type, sequenceIndex, sequenceVisible } = msgModel;
  const textDims = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(message, messageFont(conf));
  const textObj = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getTextObj */ .HT)();
  ...
  textObj.tspan = false;
  if ((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(textObj.text)) {
  ...
  if (startx === stopx) {
    ...
    if (conf.rightAngles) {
      line = diagram2.append("path").attr(
        "d",
        `M  ${lineStartX},${lineStartY} H ${startx + _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width / 2, textWidth / 2)} V ${lineStartY + 25} H ${startx}`
      );
    } else {
      line = diagram2.append("path").attr(
        "d",
  ...
  if (conf.arrowMarkerAbsolute) {
    url = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getUrl */ .ID)(true);
  }
...
var addActorRenderingData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(diagram2, actors, createdActors, actorKeys, verticalPos, messages, isFooter) {
  let prevWidth = 0;
  let prevMargin = 0;
  let prevBox = void 0;
  let maxHeight = 0;
  for (const actorKey of actorKeys) {
    ...
    actor.width = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actor.width || conf.width, conf.width);
    actor.height = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actor.height || conf.height, conf.height);
    actor.margin = actor.margin || conf.actorMargin;
    maxHeight = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, actor.height);
...
var drawActors = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(diagram2, actors, actorKeys, isFooter, diagramId, diagObj, actorIndexMap) {
  if (!isFooter) {
    for (const actorKey of actorKeys) {
      const actor = actors.get(actorKey);
    ...
    for (const actorKey of actorKeys) {
      ...
      maxHeight = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, height);
    }
    bounds.bumpVerticalPos(maxHeight + conf.boxMargin);
  }
}, "drawActors");
var drawActorsPopup = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(diagram2, actors, actorKeys, doc) {
  let maxHeight = 0;
  let maxWidth = 0;
  for (const actorKey of actorKeys) {
    const actor = actors.get(actorKey);
...
var setConf = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(cnf) {
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .assignWithDepth_default */ .hH)(conf, cnf);
  if (cnf.fontFamily) {
...
var actorActivations = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(actor) {
  return bounds.activations.filter(function(activation) {
    return activation.actor === actor;
  });
}, "actorActivations");
var activationBounds = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(actor, actors) {
  const actorObj = actors.get(actor);
  const activations = actorActivations(actor);
  const left = activations.reduce(
    function(acc, activation) {
      return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(acc, activation.startx);
    },
    actorObj.x + actorObj.width / 2 - 1
  );
  const right = activations.reduce(
    function(acc, activation) {
      return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(acc, activation.stopx);
    },
    actorObj.x + actorObj.width / 2 + 1
  );
  return [left, right];
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(msg.message, textConf);
    const totalOffset = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
  bounds.bumpVerticalPos(heightAdjust);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(adjustLoopHeightForWrap, "adjustLoopHeightForWrap");
function adjustCreatedDestroyedData(msg, msgModel, lineStartY, index, actors, createdActors, destroyedActors) {
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(receiverAdjustment, "receiverAdjustment");
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(senderAdjustment, "senderAdjustment");
  const actorArray = [
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(adjustCreatedDestroyedData, "adjustCreatedDestroyedData");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(_text, id, _version, diagObj) {
  const { securityLevel, sequence, look, themeVariables } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  conf = sequence;
  let sandboxElement;
  ...
  bounds.init();
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug(diagObj.db);
  const diagram2 = securityLevel === "sandbox" ? root.select(`[id="${id}"]`) : (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ltv)(`[id="${id}"]`);
  const actors = diagObj.db.getActors();
  ...
  (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(activeEnd, "activeEnd");
  let sequenceIndex = 1;
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug("createdActors", createdActors);
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug("destroyedActors", destroyedActors);
  ...
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .configureSvgSize */ .a$)(diagram2, height, width, conf.useMaxWidth);
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug(`models:`, bounds.models);
}, "draw");
async function getMaxMessageWidthPerActor(actors, messages, diagObj) {
  ...
  for (const msg of messages) {
    if (actors.get(msg.to) && actors.get(msg.from)) {
      ...
      const wrappedMessage = msg.wrap ? _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(wrappedMessage) ? await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(msg.message, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(wrappedMessage, textFont);
      const messageWidth = messageDimensions.width + 2 * conf.wrapPadding;
      if (isMessage && msg.from === actor.nextActor) {
        maxMessageWidthPerActor[msg.to] = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
          maxMessageWidthPerActor[msg.to] || 0,
          messageWidth
        );
      } else if (isMessage && msg.from === actor.prevActor) {
        maxMessageWidthPerActor[msg.from] = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
        ...
        maxMessageWidthPerActor[actor.prevActor] = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
  return maxMessageWidthPerActor;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(getMaxMessageWidthPerActor, "getMaxMessageWidthPerActor");
var getRequiredPopupWidth = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(actor) {
  let requiredPopupWidth = 0;
  const textFont = actorFont(conf);
  for (const key in actor.links) {
    const labelDimensions = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(key, textFont);
...
async function calculateActorMargins(actors, actorToMessageWidth, boxes) {
  ...
  for (const prop of actors.keys()) {
    ...
    if (actor.wrap) {
      actor.description = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(actor.description) ? await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(actor.description, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(actor.description, actorFont(conf));
    actor.width = actor.wrap ? conf.width : _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, actDims.width + 2 * conf.wrapPadding);
    actor.height = actor.wrap ? _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actDims.height, conf.height) : conf.height;
    maxHeight = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, actor.height);
  }
  for (const actorKey in actorToMessageWidth) {
    ...
    if (!nextActor) {
      ...
      actor.margin = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actorWidth2, conf.actorMargin);
      continue;
    }
    const messageWidth = actorToMessageWidth[actorKey];
    const actorWidth = messageWidth + conf.actorMargin - actor.width / 2 - nextActor.width / 2;
    actor.margin = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(actorWidth, conf.actorMargin);
  }
  let maxBoxHeight = 0;
  boxes.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(box.name, textFont);
    maxBoxHeight = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(boxMsgDimensions.height, maxBoxHeight);
    const minWidth = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(totalWidth, boxMsgDimensions.width + 2 * conf.wrapPadding);
  ...
  return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(maxHeight, conf.height);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(calculateActorMargins, "calculateActorMargins");
var buildNoteModel = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(msg, actors, diagObj) {
  const fromActor = actors.get(msg.from);
  const toActor = actors.get(msg.to);
  const startx = fromActor.x;
  const stopx = toActor.x;
  const shouldWrap = msg.wrap && msg.message;
  let textDimensions = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .Wi)(msg.message) ? await (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .calculateMathMLDimensions */ .Dl)(msg.message, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()) : _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(
    shouldWrap ? _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
    width: shouldWrap ? conf.width : _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin),
    height: 0,
    startx: fromActor.x,
    stopx: 0,
    starty: 0,
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    noteModel.width = shouldWrap ? _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width) : _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx + (fromActor.width + conf.actorMargin) / 2;
  } else if (msg.placement === diagObj.db.PLACEMENT.LEFTOF) {
    noteModel.width = shouldWrap ? _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, textDimensions.width + 2 * conf.noteMargin) : _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
      fromActor.width / 2 + toActor.width / 2,
      textDimensions.width + 2 * conf.noteMargin
    );
    noteModel.startx = startx - noteModel.width + (fromActor.width - conf.actorMargin) / 2;
  } else if (msg.to === msg.from) {
    textDimensions = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(
      shouldWrap ? _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(msg.message, _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, fromActor.width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
    noteModel.width = shouldWrap ? _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(conf.width, fromActor.width) : _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(fromActor.width, conf.width, textDimensions.width + 2 * conf.noteMargin);
  ...
  if (shouldWrap) {
    noteModel.message = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
      msg.message,
      noteModel.width - 2 * conf.wrapPadding,
      noteFont(conf)
    );
  }
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug(
...
var hasCentralConnection = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msg, diagObj) {
  const { CENTRAL_CONNECTION, CENTRAL_CONNECTION_REVERSE, CENTRAL_CONNECTION_DUAL } = diagObj.db.LINETYPE;
...
var calculateCentralConnectionOffset = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msg, diagObj, isArrowToRight) {
  const {
...
var isReverseArrowType = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msg, diagObj) {
  const {
...
var isBidirectionalArrowType = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msg, diagObj) {
...
var buildMessageModel = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(function(msg, actors, diagObj) {
  const { look } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  if (![
    diagObj.db.LINETYPE.SOLID_OPEN,
    diagObj.db.LINETYPE.DOTTED_OPEN,
  ...
  const adjustValue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((value) => {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.wrapLabel(
      msg.message,
      _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
...
var calculateLoopBounds = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)(async function(messages, actors, _maxWidthPerActor, diagObj) {
  const loops = {};
  const stack = [];
  ...
  for (const msg of messages) {
    ...
    if (isNote) {
      ...
      stack.forEach((stk) => {
        current = stk;
        current.from = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(current.from, noteModel.startx);
        current.to = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.to, noteModel.startx + noteModel.width);
        current.width = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, Math.abs(current.from - current.to)) - conf.labelBoxWidth;
      });
    } else {
      ...
      if (msgModel.startx && msgModel.stopx && stack.length > 0) {
        stack.forEach((stk) => {
          ...
          if (msgModel.startx === msgModel.stopx) {
            ...
            current.from = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(
              from.x - msgModel.width / 2,
              from.x - from.width / 2,
              current.from
            );
            current.to = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(
              to.x + msgModel.width / 2,
              to.x + from.width / 2,
              current.to
            );
            current.width = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, Math.abs(current.to - current.from)) - conf.labelBoxWidth;
          } else {
            current.from = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMin(msgModel.startx, current.from);
            current.to = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(msgModel.stopx, current.to);
            current.width = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.getMax(current.width, msgModel.width) - conf.labelBoxWidth;
          }
        });
      }
    }
  ...
  bounds.activations = [];
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .R.debug("Loop type widths:", loops);
  return loops;
}, "calculateLoopBounds");
...
var diagram = {
  ...
  init: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K)((cnf) => {
    if (!cnf.sequence) {
      cnf.sequence = {};
    }
    if (cnf.wrap) {
      cnf.sequence.wrap = cnf.wrap;
      (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setConfig2 */ .XV)({ sequence: { wrap: cnf.wrap } });
    }
  }, "init")
};
