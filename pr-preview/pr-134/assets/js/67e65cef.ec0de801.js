...
const site_docs_components_info_banner_mdx_67e_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/info-banner","title":"InfoBanner","description":"Information banner visar viktiga och aktuella meddelanden, som till exempel systemnotiser.","source":"@site/docs/components/info-banner.mdx","sourceDirName":"components","slug":"/components/info-banner","permalink":"/pr-preview/pr-134/components/info-banner","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"InfoBanner","description":"Information banner visar viktiga och aktuella meddelanden, som till exempel systemnotiser."},"sidebar":"sideBar","previous":{"title":"Grid","permalink":"/pr-preview/pr-134/components/grid"},"next":{"title":"LinkButton","permalink":"/pr-preview/pr-134/components/link-button"}}');
