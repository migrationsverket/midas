...
const site_docs_components_button_mdx_074_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/button","title":"Button","description":"Knappar används när användaren vill utföra en handling t.ex. spara ifylld information eller öppna ett formulär.","source":"@site/docs/components/button.mdx","sourceDirName":"components","slug":"/components/button","permalink":"/pr-preview/pr-134/components/button","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"button","permalink":"/pr-preview/pr-134/tags/button"},{"inline":true,"label":"form","permalink":"/pr-preview/pr-134/tags/form"}],"version":"current","frontMatter":{"title":"Button","description":"Knappar används när användaren vill utföra en handling t.ex. spara ifylld information eller öppna ett formulär.","tags":["button","form"]},"sidebar":"sideBar","previous":{"title":"Breadcrumbs","permalink":"/pr-preview/pr-134/components/breadcrumbs"},"next":{"title":"Card","permalink":"/pr-preview/pr-134/components/card"}}');
