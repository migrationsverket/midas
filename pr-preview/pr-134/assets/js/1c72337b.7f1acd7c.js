...
const site_docs_components_checkbox_mdx_1c7_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/checkbox","title":"Checkbox","description":"Används för att låta användaren välja inget, ett eller flera alternativ.","source":"@site/docs/components/checkbox.mdx","sourceDirName":"components","slug":"/components/checkbox","permalink":"/pr-preview/pr-134/components/checkbox","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"form","permalink":"/pr-preview/pr-134/tags/form"}],"version":"current","frontMatter":{"title":"Checkbox","description":"Används för att låta användaren välja inget, ett eller flera alternativ.","tags":["form"]},"sidebar":"sideBar","previous":{"title":"Card","permalink":"/pr-preview/pr-134/components/card"},"next":{"title":"ComboBox","permalink":"/pr-preview/pr-134/components/combobox"}}');
