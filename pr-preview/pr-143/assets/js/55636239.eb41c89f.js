"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[7048],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_index_mdx_556_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-index-mdx-556.json
const site_docs_components_index_mdx_556_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/index","title":"Komponenter","description":"","source":"@site/docs/components/index.mdx","sourceDirName":"components","slug":"/components/","permalink":"/pr-preview/pr-143/components/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Komponenter"},"sidebar":"sideBar","previous":{"title":"Språk och skrivregler","permalink":"/pr-preview/pr-143/basics/language"},"next":{"title":"Accordion","permalink":"/pr-preview/pr-143/components/accordion"}}');
...
;// ./apps/docs/docs/components/index.mdx
