...
const site_docs_design_patterns_focus_mdx_560_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/focus","title":"Fokus","description":"Fokusmarkering används för att visa användaren vilken komponent som har tabbfokus. Detta är till hjälp när användare navigerar på sidan med tangentbord eller andra tillgänglighetsverktyg. Fokus ska finnas tillgängligt på alla komponenter.","source":"@site/docs/design-patterns/focus.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/focus","permalink":"/pr-preview/pr-143/design-patterns/focus","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{},"sidebar":"sideBar","previous":{"title":"Validering","permalink":"/pr-preview/pr-143/design-patterns/error-message"},"next":{"title":"Frågeformulär","permalink":"/pr-preview/pr-143/design-patterns/forms"}}');
