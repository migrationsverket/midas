...
const toc = [{
  ...
  "value": "Titel eller label",
  "id": "titel-eller-label",
  "level": 3
}, {
...
<Button variant='tertiary'>Ta bort anmälan</Button>
  ...
  <Button isDisabled>{fruits.shuffled(1).name}</Button>
      ...
      id: "titel-eller-label",
      children: "Titel eller label"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "För god tillgänglighet bör du sätta en titel på gruppen av knappar. Antingen med en osynlig aria-label för skärmläsare eller en synlig titel."
    }), "\n", (0,jsx_runtime.jsx)(CodeBlock/* default */.A, {
      scope: {
        ButtonGroup: ButtonGroup/* ButtonGroup */.e,
        Button: Button/* Button */.$
      },
      children: `<ButtonGroup title="Välj en frukt">
  <Button>{fruits.shuffled(1).name}</Button>
  <Button variant="secondary">{fruits.shuffled(1).name}</Button>
  <Button isDisabled>{fruits.shuffled(1).name}</Button>
</ButtonGroup>`
