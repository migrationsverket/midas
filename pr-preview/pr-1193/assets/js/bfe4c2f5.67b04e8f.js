...
const site_docs_components_color_scheme_switch_mdx_bfe_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/color-scheme-switch","title":"ColorSchemeSwitch","description":"Växlare för färgschema (ljust, mörkt, systemets inställning)","source":"@site/docs/components/color-scheme-switch.mdx","sourceDirName":"components","slug":"/components/color-scheme-switch","permalink":"/pr-preview/pr-1193/components/color-scheme-switch","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"ColorSchemeSwitch","description":"Växlare för färgschema (ljust, mörkt, systemets inställning)"},"sidebar":"sideBar","previous":{"title":"Checkbox","permalink":"/pr-preview/pr-1193/components/checkbox"},"next":{"title":"ComboBox","permalink":"/pr-preview/pr-1193/components/combobox"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
