...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    ...
    }), "\n", (0,jsx_runtime.jsx)(BrowserOnly/* default */.A, {
      children: () => (0,jsx_runtime.jsx)("div", {
        ...
        children: (0,jsx_runtime.jsxs)(tabs_Tabs/* Tabs */.t, {
          ...
          children: [(0,jsx_runtime.jsx)(Text/* Text */.E, {
            children: "Oavsett om du äter en frukt, lite bär, en näve grönsaker eller baljväxter, får du i dig många viktiga näringsämnen som kroppen behöver för att må bra - fibrer, C-vitamin, folat/folsyra, vitamin K, kalium och antioxidanter, som karotenoider. Eftersom olika sorters frukt och grönt innehåller olika näringsämnen är det bra att äta varierat."
          }), (0,jsx_runtime.jsx)(Text/* Text */.E, {
            children: "För näringsvärdet spelar det mindre roll om man äter färska eller frysta frukter och grönsaker. Frysta produkter håller längre och är ett smart sätt att minska matsvinnet."
          }), (0,jsx_runtime.jsx)(Text/* Text */.E, {
            children: "Frysta importerade hallon kan vara förorenade med norovirus, som orsakar vinterkräksjukan. Det kan också finnas norovirus och hepatit A-virus på andra frysta bär men det är mycket ovanligare."
          })]
        })
      })
...
var Tabs=function Tabs(_ref){var tabs=_ref.tabs,label=_ref.label,children=_ref.children,className=_ref.className,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var _useObserveElement=(0,useObserveElement/* default */.A)(document.body,true),bodyWidth=_useObserveElement.width;var orientation=bodyWidth>=tokens.windowSizes.md?'horizontal':'vertical';var childrenArray=react.Children.toArray(children);// Check if the number of children matches the number of tabs
