...
const site_docs_dev_client_side_routing_mdx_870_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/client-side-routing","title":"Routing på klientnivå","description":"Hantera Client Side Navigation tillsammans med designsystemet","source":"@site/docs/dev/client-side-routing.mdx","sourceDirName":"dev","slug":"/dev/client-side-routing","permalink":"/pr-preview/pr-987/dev/client-side-routing","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Routing på klientnivå","description":"Hantera Client Side Navigation tillsammans med designsystemet","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
