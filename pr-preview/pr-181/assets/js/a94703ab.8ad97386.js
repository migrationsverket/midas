 ...
 */function DocSidebarItemsExpandedStateProvider(_ref){var children=_ref.children;var _useState=(0,react.useState)(null),expandedItem=_useState[0],setExpandedItem=_useState[1];var contextValue=(0,react.useMemo)(function(){return{expandedItem:expandedItem,setExpandedItem:setExpandedItem};},[expandedItem]);return/*#__PURE__*/(0,jsx_runtime.jsx)(Context.Provider,{value:contextValue,children:children});}function useDocSidebarItemsExpandedState(){var value=(0,react.useContext)(Context);if(value===EmptyContext){throw new reactUtils/* ReactContextError */.dV('DocSidebarItemsExpandedStateProvider');}return value;}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocSidebarItems(_ref){var items=_ref.items,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,DocSidebarItems_excluded);var visibleItems=(0,docsUtils/* useVisibleSidebarItems */.Y)(items,props.activePath);return/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebarItemsExpandedStateProvider,{children:visibleItems.map(function(item,index){return/*#__PURE__*/(0,jsx_runtime.jsx)(DocSidebarItem,Object.assign({item:item,index:index},props),index);})});}// Optimize sidebar at each "level"
