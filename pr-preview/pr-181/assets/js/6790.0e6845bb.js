"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[6790],{
...
/* harmony export */ });
/* harmony import */ var _chunk_EICJXIV7_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(79972);
/* harmony import */ var _chunk_TM57GTNK_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79740);
/* harmony import */ var _chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(85039);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 8:
          this.$ = $$[$0 - 1];
    ...
    parseError: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
  ...
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(Parser, "Parser");
...
var ClassMember = class {
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "ClassMember");
  }
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(input, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.parameters)})${this.returnType ? " : " + (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseGenericTypes */ .QO)(this.returnType) : ""}` : ""}`;
...
var functions = [];
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((txt) => _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()), "sanitizeText");
var splitClassNameAndType = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(_id) {
  const id = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  let genericType = "";
  let className = id;
  if (id.indexOf("~") > 0) {
...
var setClassLabel = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(_id, label) {
  const id = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  if (label) {
...
var addClass = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(_id) {
  const id = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  const { className, type } = splitClassNameAndType(id);
  if (classes.has(className)) {
    return;
  }
  const name = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(className, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  classes.set(name, {
    id: name,
    type,
    label: name,
...
var addInterface = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(label, classId) {
...
var lookUpDomId = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(_id) {
  const id = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  if (classes.has(id)) {
...
var clear2 = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  relations = [];
...
var getClass = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id) {
  return classes.get(id);
}, "getClass");
var getClasses = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return classes;
}, "getClasses");
var getRelations = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return relations;
}, "getRelations");
var getNotes = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return notes;
}, "getNotes");
var addRelation = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(classRelation) {
  _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("Adding relation: " + JSON.stringify(classRelation));
  const invalidTypes = [
  ...
  classRelation.relationTitle1 = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(
    classRelation.relationTitle1.trim(),
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()
  );
  classRelation.relationTitle2 = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(
    classRelation.relationTitle2.trim(),
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()
  );
  relations.push(classRelation);
}, "addRelation");
var addAnnotation = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(className, annotation) {
  const validatedClassName = splitClassNameAndType(className).className;
  classes.get(validatedClassName).annotations.push(annotation);
}, "addAnnotation");
var addMember = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(className, member) {
  addClass(className);
  const validatedClassName = splitClassNameAndType(className).className;
...
var addMembers = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(className, members) {
  if (Array.isArray(members)) {
    members.reverse();
    members.forEach((member) => addMember(className, member));
  }
}, "addMembers");
var addNote = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(text, className) {
  const note = {
...
var cleanupLabel = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(label) {
  if (label.startsWith(":")) {
    label = label.substring(1);
  }
  return sanitizeText2(label.trim());
}, "cleanupLabel");
var setCssClass = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ids, className) {
...
var defineClass = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ids, style) {
  for (const id of ids) {
...
var setTooltip = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ids, tooltip) {
...
var getTooltip = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, namespace) {
  if (namespace && namespaces.has(namespace)) {
    return namespaces.get(namespace).classes.get(id).tooltip;
  }
  return classes.get(id).tooltip;
}, "getTooltip");
var setLink = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ids, linkStr, target) {
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (/\d/.exec(_id[0])) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (theClass) {
      theClass.link = _chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.formatUrl(linkStr, config);
...
var setClickEvent = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
...
var setClickFunc = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(_domId, functionName, functionArgs) {
  const domId = _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_domId, (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
    ...
    functions.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
var bindFunctions = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(element) {
...
var setupToolTips = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(element) {
...
functions.push(setupToolTips);
var direction = "TB";
var getDirection = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => direction, "getDirection");
var setDirection = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((dir) => {
  direction = dir;
}, "setDirection");
var addNamespace = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id) {
...
var getNamespace = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(name) {
  return namespaces.get(name);
}, "getNamespace");
var getNamespaces = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function() {
  return namespaces;
}, "getNamespaces");
var addClassesToNamespace = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, classNames) {
  if (!namespaces.has(id)) {
    return;
  }
...
var setCssStyle = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(id, styles) {
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getArrowMarker, "getArrowMarker");
var getData = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  const nodes = [];
  const edges = [];
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  ...
  for (const classRelation of relations) {
    cnt++;
    const edge = {
      id: (0,_chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEdgeId */ .rY)(classRelation.id1, classRelation.id2, {
        prefix: "id",
        counter: cnt
      }),
...
var classDb_default = {
  ...
  getConfig: /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().class, "getConfig"),
  addClass,
  bindFunctions,
  clear: clear2,
  getClass,
...
var getStyles = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses2 = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("REF0:");
  _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Drawing class diagram (v3)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_EICJXIV7_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getDiagramElement */ .A)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_TM57GTNK_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_TM57GTNK_mjs__WEBPACK_IMPORTED_MODULE_1__/* .render */ .XX)(data4Layout, svg);
  const padding = 8;
  _chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_2__/* .utils_default */ ._K.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_EICJXIV7_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .P)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
