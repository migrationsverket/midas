...
const toc = [{
  ...
  "value": "Mönster för validering",
  "id": "mönster-för-validering",
  "level": 2
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      id: "mönster-för-validering",
      children: "Mönster för validering"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Vi använder två olika mönster för validering i formulär."
      ...
      children: ["Om det finns fält som har valideringsfel efter att användaren tryckt på en knapp för att gå vidare eller skicka in formuläret, så ska dessa sammanfattas i en felmeddelandelista som visas högst upp på sidan. Felmeddelandelistan är en ", (0,jsx_runtime.jsx)(_components.code, {
        children: "Infobanner"
