...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      id: "isinvisible",
      children: "isInvisible"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Vi vill använda så disablade knappar så lite som möjligt eftersom dessa inte är tillgängliga för en skärmläsare. Men i vissa fall är det inte lämpligt för användaren att klicka på knappen. Då kan vi använda ", (0,jsx_runtime.jsx)(_components.code, {
        children: "isInvisible"
      }), ". Den gör knappen helt osynlig för användaren, men uppfyller alla krav i WCAG 26.4.1. En osynlig knapp läses upp som \"osynlig\" av skärmläsare och syns i elementlistan, men är som sagt helt osynlig för seende användare."]
    }), "\n", (0,jsx_runtime.jsx)("div", {
      id: "april-fools",
      className: "card",
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Grattis, du hittade vårt aprilskämt!"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "grupp-av-knappar",
