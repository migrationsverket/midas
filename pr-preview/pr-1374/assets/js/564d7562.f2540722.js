...
const site_docs_get_started_releases_mdx_564_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"get-started/releases","title":"Versionshantering","description":"Midas paket (@midas-ds/components, @midas-ds/theme, m.fl.) versionshanteras enligt Semantic Versioning, formatet MAJOR.MINOR.PATCH, t.ex. 2.4.1:","source":"@site/docs/get-started/releases.mdx","sourceDirName":"get-started","slug":"/get-started/releases","permalink":"/pr-preview/pr-1374/get-started/releases","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":2.5,"frontMatter":{"title":"Versionshantering","sidebar_label":"Versionshantering","sidebar_position":2.5},"sidebar":"sideBar","previous":{"title":"Installera","permalink":"/pr-preview/pr-1374/get-started/install"},"next":{"title":"Översikt","permalink":"/pr-preview/pr-1374/get-started/contribute/"}}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsxs)(_components.p, {
      ...
      }), ", formatet ", (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        children: "Det finns inget fast releaseschema."
      ...
      }), " Merparten av vårt arbete är nya features och buggfixar, alltså bakåtkompatibla PATCH- och MINOR-releaser du kan ta emot utan att behöva ändra något i din kod. En MAJOR-version är undantaget, inte det normala, och sker bara när det verkligen behövs."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Vi räknar en ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "breaking change"
      }), " utifrån kontraktet: props, exporterade typer och funktionalitet, inte pixel-för-pixel-utseende. Rena visuella justeringar (färger, mellanrum, storlekar) landar normalt i en PATCH eller MINOR, även om de är synliga, eftersom de inte kräver att du ändrar din kod."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
