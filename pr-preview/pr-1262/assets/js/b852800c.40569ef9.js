...
;// ./packages/layout/src/sidebar/SidebarContext.tsx
'use client';var SidebarContext=/*#__PURE__*/(0,react.createContext)(undefined);
...
;// ./packages/layout/src/header/mobile-menu/MobileMenuContext.tsx
'use client';var MobileMenuContext=/*#__PURE__*/(0,react.createContext)(undefined);
;// ./packages/layout/src/navigation/navigation-link/NavigationLink.tsx
'use client';var NavigationLink_excluded=["as","children","className","isActive","icon","aria-label"];var NavigationLink=function NavigationLink(_ref){var _clsx;var as=_ref.as,children=_ref.children,className=_ref.className,isActive=_ref.isActive,icon=_ref.icon,ariaLabel=_ref['aria-label'],rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,NavigationLink_excluded);var mobileMenuContext=(0,react.useContext)(MobileMenuContext);var sidebarContext=(0,react.useContext)(SidebarContext);var isCollapsed=sidebarContext==null?void 0:sidebarContext.isCollapsed;var ctx=(0,react.useContext)(Dialog/* OverlayTriggerStateContext */.RG);var Component=as||Link/* Link */.N;var toggle=function toggle(){if(ctx!=null&&ctx.isOpen){ctx==null||ctx.setOpen(false);}};var title=typeof children==='string'?children:undefined;if(!title&&!ariaLabel&&"production"!=='production')// removed by dead control flow
{}return/*#__PURE__*/(0,jsx_runtime.jsxs)(Tooltip/* TooltipTrigger */.k,{isDisabled:!isCollapsed||!title&&!ariaLabel,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(useFocusable/* Focusable */.zo,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Component,Object.assign({"aria-current":isActive&&'page',"aria-label":ariaLabel||(isCollapsed?title:undefined),className:(0,utils_clsx/* clsx */.$)(className,NavigationLink_module.navigationLink,(_clsx={},_clsx[NavigationLink_module.sidebar]=sidebarContext||mobileMenuContext,_clsx[NavigationLink_module.collapsed]=isCollapsed,_clsx)),"data-active":isActive||undefined},as?{onClick:function onClick(e){toggle();rest.onClick==null||rest.onClick(e);}}:{onPress:function onPress(e){toggle();rest.onPress==null||rest.onPress(e);}},rest,{children:[icon,/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:NavigationLink_module.title,children:children})]}))}),/*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip/* Tooltip */.m,{placement:"right",children:title})]});};
...
var NavigationBadgeExample=function NavigationBadgeExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{width:240},children:/*#__PURE__*/(0,jsx_runtime.jsx)(SidebarContext.Provider,{value:{isCollapsed:false},children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationItem,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationLink,{icon:/*#__PURE__*/(0,jsx_runtime.jsxs)(BadgeContainer/* BadgeContainer */.d,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(bell/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* Badge */.E,{children:"12"})]}),children:"Meddelanden"})})})})});};
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Wrapper-komponent som renderar ett ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: "<ul>"
      }), " inuti. Stödjer både statisk och dynamisk rendering via Collections."]
      ...
      children: ["Skicka in ", (0,jsx_runtime.jsx)(_components.code, {
        children: "BadgeContainer"
      }), " som ", (0,jsx_runtime.jsx)(_components.code, {
        children: "icon"
      }), "-prop för att visa en notisindikator på länken."]
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "<NavLink path='/mina-arenden' icon={<FileText />}>\n  Mina ärenden\n</NavLink>\n"
      })
