...
const site_docs_get_started_designer_mdx_048_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"get-started/designer","title":"Designa med Midas","description":"Vi får inte lagra några personuppgifter, t.ex. namn eller personnummer, i våra skisser. Vi använder därför alltid fiktiv data om vi behöver visa personuppgifter.","source":"@site/docs/get-started/designer.mdx","sourceDirName":"get-started","slug":"/get-started/designer","permalink":"/pr-preview/pr-1262/get-started/designer","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":4,"frontMatter":{"title":"Designa med Midas","sidebar_label":"Designa","sidebar_position":4},"sidebar":"sideBar","previous":{"title":"Tokens list reference","permalink":"/pr-preview/pr-1262/get-started/contribute/tokens/dev-tokens"},"next":{"title":"Designprinciper","permalink":"/pr-preview/pr-1262/basics/principles"}}');
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.admonition, {
      ...
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Vi får inte lagra några personuppgifter, t.ex. namn eller personnummer, i våra skisser. Vi använder därför alltid fiktiv data om vi behöver visa personuppgifter."
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "ui-kit",
      children: "UI-kit"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Vårt UI-kit till Figma innehåller komponenter och mönster som vi använder för att designa våra produkter och tjänster. Komponenterna i vårt UI-kit är en spegling av hur komponenterna ser ut i komponentbiblioteket. Vi använder så ofta som möjligt samma namn på Variant properties i Figma som namnen på props i komponenterna."
      ...
      children: "Om du vill testa hur komponenterna beter sig i olika situationer kan du göra det i Storybook. Storybook är en interaktiv miljö för våra UI-komponenter. Här kan du se alla komponenter i vårt bibliotek, testa dem i\nolika varianter och se hur de beter sig. Det finns en länk till Storybook i sidhuvudet på varje komponentsida."
    }), "\n", (0,jsx_runtime.jsx)(Link/* Link */.N, {
      standalone: true,
      target: "\\_blank",
      ...
      children: "Hittat en bugg eller förbättringsmöjlighet? Kontakta oss via alla de normala kontaktvägarna. Alla synpunkter är välkomna!"
    })]
  });
}
