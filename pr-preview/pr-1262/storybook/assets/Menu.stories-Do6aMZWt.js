...
* You must render the expected element type (e.g. if \`<button>\` is expected, you cannot render an \`<a>\`).
* Only a single root DOM element can be rendered (no fragments).
* You must pass through props and ref to the underlying DOM element, merging with your own prop as appropriate.`,name:"render",required:!1,type:{name:'DOMRenderFunction<"div" | "hr", undefined>'}}}}}catch{}const be={title:"Components/Menu",component:a,subcomponents:{MenuItem:n},render:t=>e.jsxs(S,{children:[e.jsx(j,{"aria-label":"Menu",variant:"icon",size:t.size,children:e.jsx(b,{size:20})}),e.jsx(y,{children:e.jsx(a,{...t})})]}),args:{children:t=>e.jsx(n,{...t,children:t.name}),items:[{id:0,name:"Open"},{id:1,name:"Rename..."},{id:2,name:"Duplicate"},{id:3,name:"Share..."},{id:4,name:"Delete..."}]}},l={},o={args:{selectionMode:"single"},render:t=>{const[r,i]=I.useState(new Set(["center"]));return e.jsxs(e.Fragment,{children:[e.jsxs(S,{children:[e.jsx(j,{"aria-label":"Menu",variant:"icon",size:t.size,children:e.jsx(b,{size:20})}),e.jsx(y,{children:e.jsxs(a,{...t,selectedKeys:r,onSelectionChange:i,children:[e.jsx(n,{id:"left",children:"Left"}),e.jsx(n,{id:"center",children:"Center"}),e.jsx(n,{id:"right",children:"Right"})]})})]}),e.jsxs(s,{children:["Current selection (controlled): ",[...r].join(", ")]})]})}},c={args:{selectionMode:"multiple"},render:t=>{const[r,i]=I.useState(new Set(["sidebar","console"]));return e.jsxs(e.Fragment,{children:[e.jsxs(S,{children:[e.jsx(j,{"aria-label":"Menu",variant:"icon",size:t.size,children:e.jsx(b,{size:20})}),e.jsx(y,{children:e.jsxs(a,{...t,selectedKeys:r,onSelectionChange:i,children:[e.jsx(n,{id:"sidebar",children:"Sidebar"}),e.jsx(n,{id:"searchbar",children:"Searchbar"}),e.jsx(n,{id:"tools",children:"Tools"}),e.jsx(n,{id:"console",children:"Console"})]})})]}),e.jsxs(s,{children:["Current selection (controlled):",r==="all"?"all":[...r].join(", ")]})]})}},d={args:{items:[{name:"Left Panel",id:"left",children:[{id:1,name:"Final Copy (1)"}]},{name:"Right Panel",id:"right",children:[{id:2,name:"index.ts"},{id:3,name:"package.json"},{id:4,name:"license.txt"}]}],children:t=>e.jsxs(g,{children:[e.jsx(P,{children:t.name}),e.jsx(q,{items:t.children,children:r=>e.jsx(n,{children:r.name})})]})}},m={args:{children:e.jsxs(e.Fragment,{children:[e.jsx(n,{children:"New…"}),e.jsx(n,{children:"Open…"}),e.jsx(M,{}),e.jsx(n,{children:"Save"}),e.jsx(n,{children:"Save as…"}),e.jsx(n,{children:"Rename…"}),e.jsx(M,{}),e.jsx(n,{children:"Page setup…"}),e.jsx(n,{children:"Print…"})]})}},u={args:{children:e.jsxs(e.Fragment,{children:[e.jsxs(n,{textValue:"Copy",children:[e.jsx(s,{slot:"label",children:"Copy"}),e.jsx(s,{slot:"description",children:"Copy the selected text"}),e.jsx(f,{children:"⌘C"})]}),e.jsxs(n,{textValue:"Cut",children:[e.jsx(s,{slot:"label",children:"Cut"}),e.jsx(s,{slot:"description",children:"Cut the selected text"}),e.jsx(f,{children:"⌘X"})]}),e.jsxs(n,{textValue:"Paste",children:[e.jsx(s,{slot:"label",children:"Paste"}),e.jsx(s,{slot:"description",children:"Paste the copied text"}),e.jsx(f,{children:"⌘V"})]})]})}},p={args:{selectionMode:"multiple",children:e.jsxs(e.Fragment,{children:[e.jsxs(n,{textValue:"Copy",children:[e.jsx(s,{slot:"label",children:"Copy"}),e.jsx(s,{slot:"description",children:"Copy the selected text"})]}),e.jsxs(n,{textValue:"Cut",children:[e.jsx(s,{slot:"label",children:"Cut"}),e.jsx(s,{slot:"description",children:"Cut the selected text"})]}),e.jsxs(n,{textValue:"Paste",children:[e.jsx(s,{slot:"label",children:"Paste"}),e.jsx(s,{slot:"description",children:"Paste the copied text"})]})]})}},h={args:{items:[{id:0,name:"Copy"},{id:1,name:"Cut"},{id:2,name:"Paste",isDisabled:!0}]}},x={args:{items:[{id:"0",name:"Menu item"},{id:"1",name:"Menu item"},{id:"2",name:"Menu item"},{id:"3",name:"Sub menu",children:[{id:"31",name:"Sub menu item"},{id:"32",name:"Sub menu item"},{id:"33",name:"Sub menu item"}]},{id:"4",name:"Other menu item"}],children:function t(r){return r.children?e.jsxs(w,{children:[e.jsx(n,{children:r.name},r.name),e.jsx(y,{children:e.jsx(a,{items:r.children,children:i=>t(i)})})]}):e.jsx(n,{children:r.name},r.name)}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:"{}",...l.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...x.parameters?.docs?.source}}};const je=["Primary","ControlledSingleSelection","ControlledMultipleSelection","Sections","Separators","TextSlots","MultiSelectWithDescriptions","DisabledItems","SubMenus"];export{c as ControlledMultipleSelection,o as ControlledSingleSelection,h as DisabledItems,p as MultiSelectWithDescriptions,l as Primary,d as Sections,m as Separators,x as SubMenus,u as TextSlots,je as __namedExportsOrder,be as default};
