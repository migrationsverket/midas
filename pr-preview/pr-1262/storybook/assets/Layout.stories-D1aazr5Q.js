import{i as e}from"./preload-helper-CT_b8DTk.js";import{$a as t,qa as n,t as r}from"./iframe-wIrQpvsR.js";import{t as i}from"./Button-DfwGnCqw.js";import{B as a,J as o,M as s,O as c,Pt as l,b as u,ct as d,i as f,it as p,m,t as h}from"./lucide-react-Czj83E29.js";import{t as g}from"./button-BsRQBdUh.js";import{n as _,r as v,t as y}from"./link-button-BtybssNz.js";import{t as b}from"./LinkButton-B_hdFie5.js";var x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{h(),n(),v(),g(),y(),x=r(),{layer02Base:S,borderColorSubtle:C,textPrimary:w}=t,T={component:_,tags:[`autodocs`],title:`Components/Layout`,parameters:{layout:`fullscreen`,rootElement:`div`},args:{className:`test-class`}},E=[{items:[{title:`Hem`,href:`#`,icon:l,active:!0},{title:`Ansökan`,href:`#`,icon:m},{title:`Boka`,href:`#`,icon:p,hasBadge:!0},{title:`Profil`,href:`#`,icon:f},{title:`Kontakt`,href:`#`,icon:u}]},{title:`Ansökan`,items:[{title:`Skapa ansökan`,href:`#`,icon:u},{title:`Beslut`,href:`#`,icon:a}]},{title:`Kort och konto`,items:[{title:`LMA-kort`,href:`#`,icon:p},{title:`Avvikelser`,href:`#`,icon:o}]}],D=()=>(0,x.jsx)(`div`,{style:{background:S,display:`flex`,justifyContent:`center`,alignItems:`center`,height:`80vh`,border:`dotted 2px ${C}`,color:w},children:`Din applikation`}),O={args:{items:E,user:{name:`Namn Namnsson`,title:`Roll eller behörighet`},app:{name:`Namn på applikationen`},title:`Skapa ansökningar`,children:(0,x.jsx)(D,{})}},k={args:{items:E,user:{name:`Namn Namnsson`,title:`Roll eller behörighet`},app:{name:`Namn på applikationen`},title:`Skapa ansökningar`,variant:`external`,children:(0,x.jsx)(D,{}),headerChildren:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(i,{variant:`icon`,icon:d,"aria-label":`Notiser`,size:`medium`}),(0,x.jsx)(i,{variant:`icon`,icon:s,"aria-label":`Byt språk`,size:`medium`}),(0,x.jsx)(i,{variant:`icon`,icon:c,"aria-label":`Logga ut`,size:`medium`})]})}},A={render:()=>(0,x.jsx)(_.Provider,{id:`test`,items:E,title:`Skapa ansökningar`,user:{name:`Test Testsson`,title:`Testare`},app:{name:`Namn på applikationen`},variant:`internal`,headerChildren:(0,x.jsx)(b,{variant:`tertiary`,target:`_blank`,children:`Öppna annan tjänst`}),isCollapsed:!1,setIsCollapsed:()=>null,children:(0,x.jsx)(_.Header,{})})},j={render:()=>(0,x.jsx)(_.Provider,{id:`test`,items:E,title:`Skapa ansökningar`,user:{name:`Test Testsson`,title:`Testare`},app:{name:`Namn på applikationen`},variant:`external`,headerChildren:(0,x.jsx)(b,{variant:`tertiary`,target:`_blank`,children:`Öppna annan tjänst`}),isCollapsed:!1,setIsCollapsed:()=>null,children:(0,x.jsx)(_.Navbar,{})})},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  args: {
    items: items,
    user: {
      name: 'Namn Namnsson',
