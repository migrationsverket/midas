...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Spinner_module = ({"container":"container_ytPE","spinner":"spinner_eR4D","rotating":"rotating_m95R","primary":"primary_lFr3","onColor":"onColor_I_Ly","dark":"dark_YbwO"});
...
var Spinner=function Spinner(_ref){var small=_ref.small,variant=_ref.variant,className=_ref.className;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(Spinner_module.container,className),role:"status",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(loader_circle/* default */.A,{className:(0,clsx/* default */.A)(Spinner_module.spinner,variant==='primary'&&Spinner_module.primary,variant==='onColor'&&Spinner_module.onColor),size:small?20:96,strokeWidth:small?2:8,absoluteStrokeWidth:true}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:strings.format('loadingPleaseWait')})]});};
