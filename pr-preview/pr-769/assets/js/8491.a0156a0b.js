"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[8491],{
...
/* harmony import */ var _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65323);
...
var parser = function() {
  var o = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(k, v, o2, l) {
  ...
  var parser2 = {
    trace: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function trace() {
    }, "trace"),
    yy: {},
    ...
    performAction: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      var $0 = $$.length - 1;
      switch (yystate) {
        case 8:
          this.$ = $$[$0 - 1];
    ...
    parseError: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function parseError(str, hash) {
      if (hash.recoverable) {
        this.trace(str);
      } else {
    ...
    parse: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function parse(input) {
      ...
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(popStack, "popStack");
      function lex() {
        var token;
      ...
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(lex, "lex");
  ...
  var lexer = /* @__PURE__ */ function() {
    var lexer2 = {
      ...
      setInput: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(input, yy) {
        this.yy = yy || this.yy || {};
        this._input = input;
      ...
      input: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
      ...
      unput: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(ch) {
        var len = ch.length;
        var lines = ch.split(/(?:\r\n?|\n)/g);
      ...
      more: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
        this._more = true;
        return this;
      }, "more"),
      // When called from action, signals the lexer that this rule fails to match the input, so the next matching rule (regex) should be tested instead.
      reject: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
      ...
      less: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(n) {
        this.unput(this.match.slice(n));
      }, "less"),
      // displays already matched input, i.e. for error messages
      pastInput: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
        var past = this.matched.substr(0, this.matched.length - this.match.length);
        return (past.length > 20 ? "..." : "") + past.substr(-20).replace(/\n/g, "");
      }, "pastInput"),
      // displays upcoming input, i.e. for error messages
      upcomingInput: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
        var next = this.match;
        if (next.length < 20) {
      ...
      showPosition: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
        var pre = this.pastInput();
        var c = new Array(pre.length + 1).join("-");
        return pre + this.upcomingInput() + "\n" + c + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(match, indexed_rule) {
      ...
      next: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function() {
        if (this.done) {
          return this.EOF;
        }
        if (!this._input) {
      ...
      lex: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function lex() {
        var r = this.next();
        if (r) {
          return r;
        } else {
      ...
      begin: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function begin(condition) {
        this.conditionStack.push(condition);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function popState() {
      ...
      _currentRules: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function _currentRules() {
      ...
      topState: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function topState(n) {
      ...
      pushState: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function pushState(condition) {
        this.begin(condition);
      }, "pushState"),
      // return the number of states currently on the stack
      stateStackSize: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function stateStackSize() {
        return this.conditionStack.length;
      }, "stateStackSize"),
      options: {},
      performAction: /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
...
{}
  ...
  (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(Parser, "Parser");
...
var ClassMember = class {
  static {
    (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(this, "ClassMember");
  }
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .jZ)(input, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .parseGenericTypes */ .QO)(this.returnType);
      }
    }
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((txt) => _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()), "sanitizeText");
var ClassDB = class {
  constructor() {
    this.relations = [];
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((element) => {
      let tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(".mermaidTooltip");
      if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
        tooltipElem = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0);
      }
      const svg = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(element).select("svg");
      const nodes = svg.selectAll("g.node");
      nodes.on("mouseover", (event) => {
        const el = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ltv)(event.currentTarget);
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccTitle */ .iN;
    this.setAccDescription = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setAccDescription */ .EI;
    this.getAccDescription = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getAccDescription */ .m7;
    this.setDiagramTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getDiagramTitle */ .ab;
    this.getConfig = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().class, "getConfig");
  ...
  static {
    (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(this, "ClassDB");
  }
  splitClassNameAndType(_id) {
    const id = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(className, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
  ...
  clear() {
    ...
    this.namespaceCounter = 0;
    this.direction = "TB";
    (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .clear */ .IU)();
  }
  getClass(id) {
  ...
  addRelation(classRelation) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Adding relation: " + JSON.stringify(classRelation));
    const invalidTypes = [
    ...
    classRelation.relationTitle1 = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)()
    );
    classRelation.relationTitle2 = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
    ids.split(",").forEach((_id) => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .Y2.sanitizeText(_domId, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)());
    const config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getEdgeId */ .rY)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var getStyles = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((options) => `g.classGroup text {
...
var getDir = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((parsedItem, defaultDir = "TB") => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("REF0:");
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.info("Drawing class diagram (v3)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const data4Layout = diag.db.getData();
  const svg = (0,_chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getDiagramElement */ .A)(id, securityLevel);
  data4Layout.type = diag.type;
  data4Layout.layoutAlgorithm = (0,_chunk_BRE4QBWZ_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_BRE4QBWZ_mjs__WEBPACK_IMPORTED_MODULE_2__/* .render */ .XX)(data4Layout, svg);
  const padding = 8;
  _chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_1__/* .setupViewPortForSVG */ .P)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
