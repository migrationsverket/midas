"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[2788],{
...
var getDir = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  if (!parsedItem.doc) {
    return defaultDir;
  }
  let dir = defaultDir;
...
var getClasses = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(function(text, diagramObj) {
  return diagramObj.db.getClasses();
}, "getClasses");
var draw = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(async function(text, id, _version, diag) {
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("REF0:");
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Drawing state diagram (v2)", id);
  const { securityLevel, state: conf, layout } = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  ...
  try {
    ...
    links.forEach((linkInfo, key) => {
      ...
      if (!stateId) {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn("\u26A0\uFE0F Invalid or missing stateId from key:", JSON.stringify(key));
        return;
      }
      ...
      if (!matchedElem) {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn("\u26A0\uFE0F Could not find node matching text:", stateId);
        return;
      }
      const parent = matchedElem.parentNode;
      if (!parent) {
        _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn("\u26A0\uFE0F Node has no parent, cannot wrap:", stateId);
        return;
      }
      ...
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("\u{1F517} Wrapped node in <a> tag for:", stateId, linkInfo.url);
    });
  } catch (err) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.error("\u274C Error injecting clickable links:", err);
  }
  ...
  (0,_chunk_HPOVUXKZ_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setupViewPortForSVG */ .P)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
...
(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(stateDomId, "stateDomId");
var setupDoc = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parentParsedItem, doc, diagramStates, nodes, edges, altFlag, look, classes) => {
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case STMT_STATE:
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(item.description ?? "", (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()),
...
var getDir2 = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
    for (const parsedItemDoc of parsedItem.doc) {
      if (parsedItemDoc.stmt === "dir") {
...
(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(insertOrUpdateNode, "insertOrUpdateNode");
function getClassesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.classes?.join(" ") ?? "";
}
(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getClassesFromDbInfo, "getClassesFromDbInfo");
function getStylesFromDbInfo(dbInfoItem) {
  return dbInfoItem?.styles ?? [];
}
(0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getStylesFromDbInfo, "getStylesFromDbInfo");
var dataFetcher = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((parent, parsedItem, diagramStates, nodes, edges, altFlag, look, classes) => {
  const itemId = parsedItem.id;
  const dbState = diagramStates.get(itemId);
  const classStr = getClassesFromDbInfo(dbState);
  const style = getStylesFromDbInfo(dbState);
  const config = (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("dataFetcher parsedItem", parsedItem, dbState, style);
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeTextOrArray(newNode.description, config);
    }
    ...
    if (!newNode.type && parsedItem.doc) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting cluster for XCX", itemId, getDir2(parsedItem));
      newNode.type = "group";
    ...
    if (parent && parent.id !== "root") {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
  ...
  if (parsedItem.doc) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("Adding nodes children ");
    setupDoc(parsedItem, parsedItem.doc, diagramStates, nodes, edges, !altFlag, look, classes);
  }
}, "dataFetcher");
var reset = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  nodeDb.clear();
  graphItemCount = 0;
}, "reset");
...
var newClassesList = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => /* @__PURE__ */ new Map(), "newClassesList");
var newDoc = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc");
var clone = /* @__PURE__ */ (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((o) => JSON.parse(JSON.stringify(o)), "clone");
var StateDB = class {
  constructor(version) {
  ...
  static {
    (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "StateDB");
  }
  static {
    this.relationType = {
      AGGREGATION: 0,
  ...
  setRootDoc(o) {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting root doc", o);
    this.rootDoc = o;
    if (this.version === 1) {
      this.extract(o);
    } else {
  ...
  docTranslator(parent, node, first) {
    ...
    if (doc.length > 0 && currentDoc.length > 0) {
      const newNode = {
        stmt: STMT_STATE,
        id: (0,_chunk_F7MYA6JM_mjs__WEBPACK_IMPORTED_MODULE_2__/* .generateId */ .$C)(),
        type: "divider",
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
    ...
    if (!this.currentDocument.states.has(trimmedId)) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Adding state ", trimmedId, descr);
    ...
    if (descr) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state description", trimmedId, descr);
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(doc2.note.text, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)());
    }
    if (classes) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state classes", trimmedId, classes);
    ...
    if (styles) {
      _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Setting state styles", trimmedId, styles);
  ...
  logDocuments() {
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.info("Documents = ", this.documents);
  }
  getRelations() {
  ...
  addLink(stateId, url, tooltip) {
    ...
    _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.warn("Adding link", stateId, url, tooltip);
  }
  /**
  ...
  addRelationObjs(item1, item2, relationTitle = "") {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(relationTitle, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? _chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(title, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState?.descriptions?.push(_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .Y2.sanitizeText(_descr, (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)()));
  }
  cleanupLabel(label) {
  ...
  getConfig() {
    return (0,_chunk_BMRFU3JQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)().state;
  }
};
