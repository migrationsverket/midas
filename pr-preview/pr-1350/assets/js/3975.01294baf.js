...
/* harmony import */ var _chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(78257);
/* harmony import */ var _chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21570);
/* harmony import */ var _chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(91730);
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34502);
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(59069);
...
var ClassMember = class {
  ...
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .sanitizeText */ .jZ)(input, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.returnType);
      }
    }
  ...
  parseMember(input) {
    ...
    const combinedText = `${this.visibility ? "\\" + this.visibility : ""}${(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.id)}${this.memberType === "method" ? `(${(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.parameters)})${this.returnType ? " : " + (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .parseGenericTypes */ .QO)(this.returnType) : ""}` : ""}`;
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K)((txt) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)()), "sanitizeText");
var ClassDB = class _ClassDB {
  constructor() {
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K)((element) => {
      const tooltipElem = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_4__/* .createTooltip */ .Ck)();
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getAccTitle */ .iN;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .setAccDescription */ .EI;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getAccDescription */ .m7;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getDiagramTitle */ .ab;
    this.getConfig = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K)(() => (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().class, "getConfig");
  ...
  splitClassNameAndType(_id) {
    const id = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(className, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)());
  ...
  clear() {
    ...
    this.diagramId = "";
    this.direction = "TB";
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .clear */ .IU)();
  }
  getClass(id) {
  ...
  addRelation(classRelation) {
    ...
    classRelation.relationTitle1 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)()
    );
    classRelation.relationTitle2 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
    ids.split(",").forEach((_id) => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(_domId, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)());
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEdgeId */ .rY)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__/* .__name */ .K)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getRegisteredLayoutAlgorithm */ .q7)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_3__/* .render */ .XX)(data4Layout, svg);
  const padding = 8;
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupViewPortForSVG */ .P)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
