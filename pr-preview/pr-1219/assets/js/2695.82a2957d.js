"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[2695],{
...
{}
   ...
   */ f6Handler(e) {
        if (e.key === 'F6') {
            ...
            let handled = e.altKey ? this.focusMain() : this.navigate((0, DOMFunctions/* getEventTarget */.wt)(e), e.shiftKey);
            if (handled) {
                e.preventDefault();
                e.stopPropagation();
            }
    ...
    navigate(from, backward) {
        ...
        if (nextLandmark.lastFocused) {
            ...
            if ((0, DOMFunctions/* nodeContains */.sD)(document.body, lastFocused)) {
                lastFocused.focus();
                return true;
            }
        }
   ...
   */ focusinHandler(e) {
        let currentLandmark = this.closestLandmark((0, DOMFunctions/* getEventTarget */.wt)(e));
        if (currentLandmark && currentLandmark.ref.current !== (0, DOMFunctions/* getEventTarget */.wt)(e)) this.updateLandmark({
            ref: currentLandmark.ref,
            lastFocused: (0, DOMFunctions/* getEventTarget */.wt)(e)
        });
   ...
   */ focusoutHandler(e) {
        let previousFocusedElement = (0, DOMFunctions/* getEventTarget */.wt)(e);
...
function $6cc546b19ee7130a$export$b8cbbb20a51697de(props, state, ref) {
    ...
    return {
        regionProps: (0, mergeProps/* mergeProps */.v)(landmarkProps, hoverProps, focusWithinProps, {
            ...
            onFocus: (e)=>{
                let target = (0, DOMFunctions/* getEventTarget */.wt)(e).closest('[role="alertdialog"]');
