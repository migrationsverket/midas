...
const site_docs_dev_common_issues_mdx_1cc_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/common-issues","title":"Vanliga problem","description":"Hantera Client Side Navigation tillsammans med designsystemet","source":"@site/docs/dev/common-issues.mdx","sourceDirName":"dev","slug":"/dev/common-issues","permalink":"/pr-preview/pr-1260/dev/common-issues","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Vanliga problem","description":"Hantera Client Side Navigation tillsammans med designsystemet"},"sidebar":"sideBar","previous":{"title":"Routing på klientnivå","permalink":"/pr-preview/pr-1260/dev/client-side-routing"},"next":{"title":"Mörkt läge","permalink":"/pr-preview/pr-1260/dev/dark-mode"}}');
