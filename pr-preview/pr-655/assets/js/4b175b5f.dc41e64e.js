...
/* harmony default export */ const Skeleton_module = ({"tokens":"\"../theme/tokens.css\"","--field-skeleton":"light-dark(#f2f2f2, #262626)","--background-inverse":"light-dark(#171717, #f2f2f2)","skeleton":"skeleton_r1UF","circle":"circle_V2WO","wave":"wave_h9Fk","conflict":"conflict_DyGH"});
// EXTERNAL MODULE: ./node_modules/clsx/dist/clsx.mjs
var clsx = __webpack_require__(34164);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/skeleton/Skeleton.tsx
var _excluded=["variant","width","height","isAnimated","className","style"];var Skeleton=function Skeleton(_ref){var _ref$variant=_ref.variant,variant=_ref$variant===void 0?'rectangle':_ref$variant,width=_ref.width,height=_ref.height,_ref$isAnimated=_ref.isAnimated,isAnimated=_ref$isAnimated===void 0?true:_ref$isAnimated,className=_ref.className,style=_ref.style,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);if(variant==='circle'&&height!==undefined){console.warn('Height is not allowed when using circle, control size with width');}var ref=react.useRef(null);var _React$useState=react.useState(false),isConflict=_React$useState[0],setIsConflict=_React$useState[1];react.useEffect(function(){var node=ref.current;function getVisibleBackground(element){while(element){var bg=getComputedStyle(element).backgroundColor;if(bg!=='transparent'&&bg!=='rgba(0, 0, 0, 0)'){return bg;}element=element.parentElement;}return null;}if(node){var visibleBg=getVisibleBackground(node.parentElement);if(visibleBg==='rgb(242, 242, 242)'){setIsConflict(true);}}},[]);return/*#__PURE__*/(0,jsx_runtime.jsx)("div",Object.assign({ref:ref,className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module[variant],isAnimated&&Skeleton_module.wave,isConflict&&Skeleton_module.conflict,className),style:Object.assign({width:width,height:height},style)},rest));};
