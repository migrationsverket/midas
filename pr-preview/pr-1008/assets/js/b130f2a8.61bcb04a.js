"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[1166],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_form_search_field_mdx_b13_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-form-search-field-mdx-b13.json
const site_docs_components_form_search_field_mdx_b13_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/form/search-field","title":"SearchField","description":"Sökfält är ett inmatningsfält anpassat för sökning","source":"@site/docs/components/form/search-field.mdx","sourceDirName":"components/form","slug":"/components/form/search-field","permalink":"/pr-preview/pr-1008/components/form/search-field","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"SearchField","description":"Sökfält är ett inmatningsfält anpassat för sökning","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
;// ./apps/docs/docs/components/form/search-field.mdx
