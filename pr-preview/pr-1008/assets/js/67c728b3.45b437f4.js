"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[367],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_container_accordion_mdx_67c_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-container-accordion-mdx-67c.json
const site_docs_components_container_accordion_mdx_67c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/container/accordion","title":"Accordion","description":"Dragspelskomponenten låter användare visa och dölja delar av relaterat innehåll på en sida.","source":"@site/docs/components/container/accordion.mdx","sourceDirName":"components/container","slug":"/components/container/accordion","permalink":"/pr-preview/pr-1008/components/container/accordion","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Accordion","sidebar_position":1,"description":"Dragspelskomponenten låter användare visa och dölja delar av relaterat innehåll på en sida.","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
;// ./apps/docs/docs/components/container/accordion.mdx
