"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[4610],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_container_table_mdx_d5b_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-container-table-mdx-d5b.json
const site_docs_components_container_table_mdx_d5b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/container/table","title":"Table","description":"En enkel tabell för att visualisera data.","source":"@site/docs/components/container/table.mdx","sourceDirName":"components/container","slug":"/components/container/table","permalink":"/pr-preview/pr-1008/components/container/table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Table","description":"En enkel tabell för att visualisera data.","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
;// ./apps/docs/docs/components/container/table.mdx
