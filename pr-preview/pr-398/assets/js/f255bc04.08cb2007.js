...
const site_docs_components_progress_bar_mdx_f25_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/progress-bar","title":"ProgressBar","description":"Progress bar med fördefinerad stil, använder role=\\"progressbar\\" under huven","source":"@site/docs/components/progress-bar.mdx","sourceDirName":"components","slug":"/components/progress-bar","permalink":"/pr-preview/pr-398/components/progress-bar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"ProgressBar","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
