"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[536],{
...
var findOrCreateNode = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((ID) => {
  ID = chunk_CSCIHK7Q/* common_default */.Y2.sanitizeText(ID, (0,chunk_CSCIHK7Q/* getConfig2 */.D7)());
...
var sankeyDB_default = {
  nodesMap,
  getConfig: /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(() => (0,chunk_CSCIHK7Q/* getConfig2 */.D7)().sankey, "getConfig"),
  getNodes,
  getLinks,
  getGraph,
  addLink,
  findOrCreateNode,
  getAccTitle: chunk_CSCIHK7Q/* getAccTitle */.iN,
  setAccTitle: chunk_CSCIHK7Q/* setAccTitle */.SV,
  getAccDescription: chunk_CSCIHK7Q/* getAccDescription */.m7,
  setAccDescription: chunk_CSCIHK7Q/* setAccDescription */.EI,
  getDiagramTitle: chunk_CSCIHK7Q/* getDiagramTitle */.ab,
  setDiagramTitle: chunk_CSCIHK7Q/* setDiagramTitle */.ke,
  clear: clear2
};
...
var findCentralNodeLayer = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((nodes2) => {
  let maxValue = 0;
  let centralLayer = 0;
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(function(text, id, _version, diagObj) {
  const { securityLevel, sankey: conf } = (0,chunk_CSCIHK7Q/* getConfig2 */.D7)();
  const defaultSankeyConfig = chunk_CSCIHK7Q/* defaultConfig2 */.ME.sankey;
  let sandboxElement;
  ...
  const getNodeColor = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((nodeId) => {
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
  ...
  const getLabelPosition = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((d) => {
  ...
  const appendLabel = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((className) => labelsGroup.selectAll(className ? `.${className}` : "text").data(graph.nodes).join("text").attr("class", className ?? null).attr("x", (d) => getLabelPosition(d).x).attr("y", (d) => (d.y1 + d.y0) / 2).attr("dy", `${showValues ? "0" : "0.35"}em`).attr("text-anchor", (d) => getLabelPosition(d).anchor).text(getText), "appendLabel");
  if (labelStyle === "outlined") {
  ...
  switch (linkColor) {
    case "gradient":
      ...
      break;
    case "source":
      coloring = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((d) => getNodeColor(d.source.id), "coloring");
      break;
    case "target":
      coloring = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)((d) => getNodeColor(d.target.id), "coloring");
      break;
    default:
      coloring = linkColor;
  }
  link.append("path").attr("d", sankeyLinkHorizontal()).attr("stroke", coloring).attr("stroke-width", (d) => Math.max(1, d.width));
  (0,chunk_CSCIHK7Q/* setupGraphViewbox */.ot)(void 0, svg, 0, useMaxWidth);
}, "draw");
