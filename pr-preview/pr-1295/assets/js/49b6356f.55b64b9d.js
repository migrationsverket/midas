...
const site_docs_dev_layout_index_mdx_49b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/index","title":"Layout","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","source":"@site/docs/dev/layout/index.mdx","sourceDirName":"dev/layout","slug":"/dev/layout/","permalink":"/pr-preview/pr-1295/dev/layout/","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Layout","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Validering i formulär","permalink":"/pr-preview/pr-1295/design-patterns/validation"},"next":{"title":"Migrationsguide","permalink":"/pr-preview/pr-1295/dev/layout/migration"}}');
