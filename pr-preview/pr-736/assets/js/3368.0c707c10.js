"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[3368],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  jX: () => (/* binding */ $1910c06f0ca9905e$export$a2680a798823803c),
  A0: () => (/* binding */ $1910c06f0ca9905e$export$f850895b287ef28e),
  mz: () => (/* binding */ $1910c06f0ca9905e$export$fddc468cd8cb4db9)
});

// UNUSED EXPORTS: ColumnResizer, ResizableTableContainer, TableContext, TableStateContext, UNSTABLE_TableLoadingSentinel
...
class $1910c06f0ca9905e$var$TableCollection extends (0, BaseCollection/* BaseCollection */.W) {
    ...
    *[Symbol.iterator]() {
    ...
    constructor(...args){
        super(...args), this.headerRows = [], this.columns = [], this.rows = [], this.rowHeaderColumnKeys = new Set(), this.head = new (0, BaseCollection/* CollectionNode */.P)('tableheader', -1), this.body = new (0, BaseCollection/* CollectionNode */.P)('tablebody', -2), this.columnsDirty = true;
    }
}
...
const $1910c06f0ca9905e$export$92aad1076056e17a = (0, CollectionBuilder/* createLeafComponent */.KU)('loader', function TableLoadingIndicator(props, ref, item) {
    let state = (0, react.useContext)($1910c06f0ca9905e$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    ...
    (0, useLoadMoreSentinel/* UNSTABLE_useLoadMoreSentinel */.c)(memoedLoadMoreProps, sentinelRef);
    let renderProps = (0, utils/* useRenderProps */.Sl)({
        ...otherProps,
        id: undefined,
