...
const site_docs_components_table_mdx_903_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/table","title":"Table","description":"En enkel tabell för att visualisera data.","source":"@site/docs/components/table.mdx","sourceDirName":"components","slug":"/components/table","permalink":"/pr-preview/pr-1248/components/table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Table","description":"En enkel tabell för att visualisera data."},"sidebar":"sideBar","previous":{"title":"Spinner","permalink":"/pr-preview/pr-1248/components/spinner"},"next":{"title":"Tabs","permalink":"/pr-preview/pr-1248/components/tabs"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
var columns=[{name:'Namn',id:'name',isRowHeader:true},{name:'Beskrivning',id:'description',width:'max-content'}];var rows=[{id:'apple',name:'Apple',description:'Pink lady is a good one'},{id:'banana',name:'Banana',description:'A yellow fruit'},{id:'pear',name:'Pear',description:'Usually green'}];var BasicExample=function BasicExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Table */.XI,{"aria-label":"Fruit",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* TableHeader */.A0,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{isRowHeader:true,children:"Name"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{children:"Description"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* TableBody */.BF,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Row */.fI,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:"Banana"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:"A yellow fruit"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Row */.fI,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:"Pear"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:"Usually green"})]})]})]})});};var FullExample=function FullExample(props){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Table */.XI,Object.assign({"aria-label":"Fruit"},props,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableHeader */.A0,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{isRowHeader:column.isRowHeader,children:column.name});}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableBody */.BF,{items:rows,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Row */.fI,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:item[column.id]});}});}})]}))});};var ControlledExample=function ControlledExample(props){var _React$useState=react.useState(new Set(['apple'])),selectedKeys=_React$useState[0],setSelectedKeys=_React$useState[1];return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FullExample,Object.assign({selectedKeys:selectedKeys,onSelectionChange:setSelectedKeys,selectionMode:"multiple"},props)),"Valda rader: ",Array.from(selectedKeys).join(', ')]});};var RowOnActionExample=function RowOnActionExample(){var _React$useState2=react.useState(null),lastClicked=_React$useState2[0],setLastClicked=_React$useState2[1];return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"card",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Table */.XI,{"aria-label":"Fruit",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableHeader */.A0,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{isRowHeader:column.isRowHeader,children:column.name});}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableBody */.BF,{items:rows,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Row */.fI,{columns:columns,onAction:function onAction(){return setLastClicked(item);},children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:item[column.id]});}});}})]}),lastClicked&&/*#__PURE__*/(0,jsx_runtime.jsxs)("p",{style:{marginTop:'0.75rem'},children:["Klickad rad: ",/*#__PURE__*/(0,jsx_runtime.jsx)("strong",{children:lastClicked.name})]})]});};var TableOnRowActionExample=function TableOnRowActionExample(){var _React$useState3=react.useState(null),lastKey=_React$useState3[0],setLastKey=_React$useState3[1];return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"card",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Table */.XI,{"aria-label":"Fruit",onRowAction:setLastKey,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableHeader */.A0,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{isRowHeader:column.isRowHeader,children:column.name});}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableBody */.BF,{items:rows,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Row */.fI,{id:item.id,columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:item[column.id]});}});}})]}),lastKey&&/*#__PURE__*/(0,jsx_runtime.jsxs)("p",{style:{marginTop:'0.75rem'},children:["Klickad nyckel: ",/*#__PURE__*/(0,jsx_runtime.jsx)("strong",{children:String(lastKey)})]})]});};var SortingExample=function SortingExample(props){var _React$useState4=react.useState({column:'name',direction:'ascending'}),sortDescriptor=_React$useState4[0],setSortDescriptor=_React$useState4[1];var sortedRows=[].concat(rows).sort(function(a,b){var first=a[sortDescriptor.column];var second=b[sortDescriptor.column];var cmp=0;if(typeof first==='string'&&typeof second==='string'){cmp=first.localeCompare(second);}else if(typeof first==='number'&&typeof second==='number'){cmp=first-second;}if(sortDescriptor.direction==='descending'){cmp*=-1;}return cmp;});return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Table/* Table */.XI,Object.assign({"aria-label":"Fruit",sortDescriptor:sortDescriptor,onSortChange:setSortDescriptor},props,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableHeader */.A0,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Column */.VP,{isRowHeader:column.isRowHeader,allowsSorting:true,children:column.name});}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* TableBody */.BF,{items:sortedRows,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Row */.fI,{columns:columns,children:function children(column){return/*#__PURE__*/(0,jsx_runtime.jsx)(Table/* Cell */.fh,{children:item[column.id]});}});}})]}))});};
