...
// extracted by mini-css-extract-plugin
/* harmony default export */ const LinkButton_module = ({"tokens":"\"../../../theme/src/lib/tokens.css\"","display":"\"Inter\", sans-serif","desktopSize":"1rem","mediumWeight":"500","blue150":"#143c50","gray10":"#f2f2f2","gray50":"#bfbfbf","blue100":"#2e7ca5","smBreakpoint":"(max-width: 767px)","linkButton":"linkButton_YIrq","icon":"icon_d8GV","fullwidth":"fullwidth_EeuX"});
// EXTERNAL MODULE: ./node_modules/clsx/dist/clsx.mjs
var clsx = __webpack_require__(34164);
...
'use client';var _excluded=["children","isDisabled","fullwidth"];/**
 * A link to be used when a user expects a button but web technologies force us to use a a-tag
 * */var LinkButton=function LinkButton(_ref){var children=_ref.children,isDisabled=_ref.isDisabled,fullwidth=_ref.fullwidth,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Link/* Link */.N,Object.assign({isDisabled:isDisabled,className:(0,clsx/* default */.A)(LinkButton_module.linkButton,fullwidth&&LinkButton_module.fullwidth,LinkButton_module.link,rest.className)},rest,{children:[children,/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_right/* default */.A,{size:20,className:LinkButton_module.icon})]}));};
