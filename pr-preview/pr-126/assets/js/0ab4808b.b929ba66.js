...
function _createMdxContent(props) {
  ...
  <FlexItem col="auto">
    <LinkButton variant="secondary" href="#">{fruits.shuffled(1).name}</LinkButton>
      ...
      children: ["Om den tertiära knappen används fristående från andra knappar ska den ha en ikon. Ikonen läggs till via ", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        children: "icon"
      ...
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { Plus } from 'lucide-react'\n<LinkButton iconPlacement=\"right\" variant=\"tertiary\" icon={Plus} href=\"Om\">Om</LinkButton>\n"
      })
    }), "\n", (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_midas_ds_link_button__WEBPACK_IMPORTED_MODULE_4__/* .LinkButton */ .z, {
      iconPlacement: "right",
      variant: "tertiary",
