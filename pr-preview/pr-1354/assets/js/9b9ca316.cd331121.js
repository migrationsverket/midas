...
var ComboBoxTags=function ComboBoxTags(_ref){var selectionMode=_ref.selectionMode,isDisabled=_ref.isDisabled;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var state=(0,react.useContext)(ComboBox/* ComboBoxStateContext */.Wf);var handleRemove=function handleRemove(keys){state==null||state.selectionManager.toggleSelection(Array.from(keys)[0]);};if(selectionMode!=='multiple'||!(state!=null&&state.selectedItems.length)){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagGroup */.C,{"aria-label":strings.format('selectedItems'),onRemove:handleRemove,selectionBehavior:"toggle",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagList/* TagList */.L,{items:state.selectedItems,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{isDismissable:true,id:item.key,isDisabled:isDisabled,textValue:item.textValue,children:item.textValue},item.key);}})});};
...
'use client';var ComboBox_excluded=["label","description","errorMessage","children","items","className","errorPosition","size","popover","listBoxProps"];function ComboBox_ComboBox(_ref){var _clsx,_clsx2,_clsx3;var label=_ref.label,description=_ref.description,errorMessage=_ref.errorMessage,children=_ref.children,items=_ref.items,className=_ref.className,_ref$errorPosition=_ref.errorPosition,errorPosition=_ref$errorPosition===void 0?'top':_ref$errorPosition,_ref$size=_ref.size,size=_ref$size===void 0?'large':_ref$size,popover=_ref.popover,listBoxProps=_ref.listBoxProps,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,ComboBox_excluded);var inputRef=(0,react.useRef)(null);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var handlePointerUp=function handlePointerUp(event){if(event.currentTarget.value){var _inputRef$current;(_inputRef$current=inputRef.current)==null||_inputRef$current.select();}};var handleFieldPointerUp=function handleFieldPointerUp(event){var _inputRef$current2,_inputRef$current3;var target=event.target;if(target.closest('[role="grid"]')||target.closest('button')){return;}(_inputRef$current2=inputRef.current)==null||_inputRef$current2.focus();(_inputRef$current3=inputRef.current)==null||_inputRef$current3.select();};return/*#__PURE__*/(0,jsx_runtime.jsxs)(ComboBox/* ComboBox */.a3,Object.assign({className:(0,clsx/* default */.A)(ComboBox_module.combobox,className)},props,{"data-readonly":props.isReadOnly||undefined,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(LabelWrapper/* LabelWrapper */.cR,{popover:popover,children:label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:label})}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:description}),errorPosition==='top'&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Group/* Group */.Y,{className:ComboBox_module.wrap,"data-readonly":props.isReadOnly||undefined,onPointerUp:handleFieldPointerUp,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(ComboBox_module.fieldContent,(_clsx={},_clsx[ComboBox_module.medium]=size==='medium',_clsx[ComboBox_module.disabled]=props.isDisabled,_clsx)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ComboBoxTags,{selectionMode:props.selectionMode,isDisabled:props.isDisabled}),/*#__PURE__*/(0,jsx_runtime.jsx)(ComboBoxInput,{className:(0,clsx/* default */.A)(ComboBox_module.inputField,(_clsx2={},_clsx2[ComboBox_module.medium]=size==='medium',_clsx2[ComboBox_module.multi]=props.selectionMode!=='single',_clsx2)),"data-readonly":props.isReadOnly||undefined,onPointerUp:handlePointerUp,ref:inputRef})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{className:(0,clsx/* default */.A)(ComboBox_module.button,(_clsx3={},_clsx3[ComboBox_module.medium]=size==='medium',_clsx3)),"aria-label":strings.format('showList'),children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:ComboBox_module.icon,"aria-hidden":"true",children:/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_down/* default */.A,{size:20,"aria-hidden":true})})})]}),errorPosition==='bottom'&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxPopover,{offset:4,children:/*#__PURE__*/(0,jsx_runtime.jsx)(ListBox/* ListBox */.q,Object.assign({items:items,renderEmptyState:function renderEmptyState(){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxEmptyState,{children:strings.format('noResultsFound')});}},listBoxProps,{children:children}))})]}));}
