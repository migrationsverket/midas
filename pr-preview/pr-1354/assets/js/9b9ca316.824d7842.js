...
const site_docs_components_combobox_mdx_9b9_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/combobox","title":"ComboBox","description":"Sökbar version av Select","source":"@site/docs/components/combobox.mdx","sourceDirName":"components","slug":"/components/combobox","permalink":"/pr-preview/pr-1354/components/combobox","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"ComboBox","description":"Sökbar version av Select"},"sidebar":"sideBar","previous":{"title":"ColorSchemeSwitch","permalink":"/pr-preview/pr-1354/components/color-scheme-switch"},"next":{"title":"DatePicker","permalink":"/pr-preview/pr-1354/components/date-picker"}}');
...
/* harmony default export */ const ComboBox_module = ({"combobox":"combobox_kSJb","wrap":"wrap_JKDx","inputField":"inputField_oWSg","fieldContent":"fieldContent_dwqU","medium":"medium_ptka","disabled":"disabled_PbnQ","multi":"multi_YziE","text":"text_ngKo","button":"button_yH32","icon":"icon_C34F"});
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
// EXTERNAL MODULE: ./node_modules/react-aria-components/dist/private/ComboBox.mjs + 37 modules
var ComboBox = __webpack_require__(83259);
...
;// ./packages/components/src/list-box/ListBoxPopover.tsx
var _excluded=["className","children"];var ListBoxPopover=function ListBoxPopover(_ref){var className=_ref.className,children=_ref.children,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(Popover/* Popover */.A,Object.assign({className:(0,clsx/* default */.A)(className,ListBox_module/* default */.A.listBoxPopover),offset:0},rest,{children:children}));};
...
const translations_namespaceObject = /*#__PURE__*/JSON.parse('{"en":{"showList":"Show list","noResultsFound":"No results found","selectedItems":"Selected items"},"sv":{"showList":"Visa lista","noResultsFound":"Inga träffar","selectedItems":"Valda objekt"}}');
;// ./packages/components/src/list-box/list-box-empty-state/ListBoxEmptyState.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const ListBoxEmptyState_module = ({"listBoxEmptyState":"listBoxEmptyState_ga6f"});
;// ./packages/components/src/list-box/list-box-empty-state/ListBoxEmptyState.tsx
var ListBoxEmptyState_excluded=["className"];var ListBoxEmptyState=function ListBoxEmptyState(_ref){var className=_ref.className,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,ListBoxEmptyState_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,Object.assign({className:(0,clsx/* default */.A)(className,ListBoxEmptyState_module.listBoxEmptyState)},rest));};
...
;// ./packages/components/src/combobox/ComboBoxTags.tsx
var ComboBoxTags=function ComboBoxTags(_ref){var selectionMode=_ref.selectionMode,isDisabled=_ref.isDisabled,isReadOnly=_ref.isReadOnly;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var state=(0,react.useContext)(ComboBox/* ComboBoxStateContext */.Wf);var handleRemove=function handleRemove(keys){state==null||state.selectionManager.toggleSelection(Array.from(keys)[0]);};if(selectionMode!=='multiple'||!(state!=null&&state.selectedItems.length)){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagGroup */.C,{"aria-label":strings.format('selectedItems'),onRemove:handleRemove,selectionBehavior:"toggle",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagList/* TagList */.L,{items:state.selectedItems,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{isDismissable:!isDisabled&&!isReadOnly,id:item.key,isDisabled:isDisabled,textValue:item.textValue,children:item.textValue},item.key);}})});};
// EXTERNAL MODULE: ./node_modules/react-aria-components/dist/private/Input.mjs
var Input = __webpack_require__(36594);
;// ./packages/components/src/combobox/ComboBoxInput.tsx
var ComboBoxInput_excluded=["onKeyDown"];var ComboBoxInput=/*#__PURE__*/(0,react.forwardRef)(function(_ref,ref){var onKeyDown=_ref.onKeyDown,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,ComboBoxInput_excluded);var state=(0,react.useContext)(ComboBox/* ComboBoxStateContext */.Wf);var handleKeyDown=function handleKeyDown(event){if(event.key==='Backspace'&&event.currentTarget.value===''&&event.currentTarget.selectionStart===0){var _state$selectedItems;var selectedItems=(_state$selectedItems=state==null?void 0:state.selectedItems)!=null?_state$selectedItems:[];var lastSelectedItem=selectedItems[selectedItems.length-1];if(lastSelectedItem){state==null||state.selectionManager.toggleSelection(lastSelectedItem.key);}}onKeyDown==null||onKeyDown(event);};return/*#__PURE__*/(0,jsx_runtime.jsx)(Input/* Input */.p,Object.assign({},props,{onKeyDown:handleKeyDown,ref:ref}));});ComboBoxInput.displayName='ComboBoxInput';
;// ./packages/components/src/combobox/ComboBox.tsx
'use client';var ComboBox_excluded=["label","description","errorMessage","children","items","className","errorPosition","size","popover","listBoxProps"];function ComboBox_ComboBox(_ref){var _clsx,_clsx2,_clsx3;var label=_ref.label,description=_ref.description,errorMessage=_ref.errorMessage,children=_ref.children,items=_ref.items,className=_ref.className,_ref$errorPosition=_ref.errorPosition,errorPosition=_ref$errorPosition===void 0?'top':_ref$errorPosition,_ref$size=_ref.size,size=_ref$size===void 0?'large':_ref$size,popover=_ref.popover,listBoxProps=_ref.listBoxProps,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,ComboBox_excluded);var inputRef=(0,react.useRef)(null);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var handleFieldPointerUp=function handleFieldPointerUp(event){var _inputRef$current,_inputRef$current2;var target=event.target;if(target.closest('[role="grid"]')||target.closest('button')){return;}(_inputRef$current=inputRef.current)==null||_inputRef$current.focus();(_inputRef$current2=inputRef.current)==null||_inputRef$current2.select();};return/*#__PURE__*/(0,jsx_runtime.jsxs)(ComboBox/* ComboBox */.a3,Object.assign({className:(0,clsx/* default */.A)(ComboBox_module.combobox,className)},props,{"data-readonly":props.isReadOnly||undefined,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(LabelWrapper/* LabelWrapper */.cR,{popover:popover,children:label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:label})}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:description}),errorPosition==='top'&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),/*#__PURE__*/(0,jsx_runtime.jsxs)(Group/* Group */.Y,{className:ComboBox_module.wrap,isReadOnly:props.isReadOnly,onPointerUp:handleFieldPointerUp,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(ComboBox_module.fieldContent,(_clsx={},_clsx[ComboBox_module.medium]=size==='medium',_clsx[ComboBox_module.disabled]=props.isDisabled,_clsx)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ComboBoxTags,{selectionMode:props.selectionMode,isDisabled:props.isDisabled,isReadOnly:props.isReadOnly}),/*#__PURE__*/(0,jsx_runtime.jsx)(ComboBoxInput,{className:(0,clsx/* default */.A)(ComboBox_module.inputField,(_clsx2={},_clsx2[ComboBox_module.medium]=size==='medium',_clsx2[ComboBox_module.multi]=props.selectionMode!=='single',_clsx2)),"data-readonly":props.isReadOnly||undefined,ref:inputRef})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{className:(0,clsx/* default */.A)(ComboBox_module.button,(_clsx3={},_clsx3[ComboBox_module.medium]=size==='medium',_clsx3)),"aria-label":strings.format('showList'),children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:ComboBox_module.icon,"aria-hidden":"true",children:/*#__PURE__*/(0,jsx_runtime.jsx)(chevron_down/* default */.A,{size:20,"aria-hidden":true})})})]}),errorPosition==='bottom'&&/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxPopover,{offset:4,children:/*#__PURE__*/(0,jsx_runtime.jsx)(ListBox/* ListBox */.q,Object.assign({items:items,renderEmptyState:function renderEmptyState(){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxEmptyState,{children:strings.format('noResultsFound')});}},listBoxProps,{children:children}))})]}));}
...
// EXTERNAL MODULE: ./node_modules/react-stately/dist/private/data/useAsyncList.mjs + 1 modules
var useAsyncList = __webpack_require__(73577);
;// ./apps/docs/src/components/examples/combobox/ComboboxExamples.tsx
var BasicExample=function BasicExample(){return/*#__PURE__*/(0,jsx_runtime.jsxs)(ComboBox_ComboBox,{label:"V\xE4lj din favoritfrukt",description:"Du kan bara v\xE4lja en",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Lime",children:"Lime"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"\xC4pple",children:"\xC4pple"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Banan",children:"Banan"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Kiwi",children:"Kiwi"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Apelsin",children:"Apelsin"})]});};var ControlledExample=function ControlledExample(){var _React$useState=react.useState(null),selectedFruit=_React$useState[0],setSelectedFruit=_React$useState[1];return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(ComboBox_ComboBox,{label:"V\xE4lj din favoritfrukt",description:"Du kan bara v\xE4lja en",value:selectedFruit,onChange:setSelectedFruit,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Lime",children:"Lime"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"\xC4pple",children:"\xC4pple"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Banan",children:"Banan"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Kiwi",children:"Kiwi"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"Apelsin",children:"Apelsin"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("pre",{style:{marginTop:'1rem'},children:["Vald frukt: ",selectedFruit]})]});};var SectionedExample=function SectionedExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)(ComboBox_ComboBox,{label:"V\xE4lj din favoritfrukt eller gr\xF6nsak",description:"Du kan bara v\xE4lja en",items:[{name:'Grönsaker',children:[{name:'Morot',id:2},{name:'Broccoli',id:3},{name:'Spenat',id:4},{name:'Potatis',id:5},{name:'Tomat',id:6}]},{name:'Frukter',children:[{name:'Äpple',id:11},{name:'Banan',id:12},{name:'Kiwi',id:13},{name:'Fläder',id:14},{name:'Nektarin',id:15}]}],children:function children(section){return/*#__PURE__*/(0,jsx_runtime.jsxs)(ListBoxSection/* ListBoxSection */.r,{id:section.name,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxHeader/* ListBoxHeader */.P,{children:section.name}),/*#__PURE__*/(0,jsx_runtime.jsx)(CollectionBuilder/* Collection */.pM,{items:section.children,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:item.id,children:item.name});}})]});}});};var AsyncExample=function AsyncExample(){var list=(0,useAsyncList/* useAsyncList */.w)({load:function load(_ref){return (0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(){var signal,cursor,filterText,res,_yield$res$json,results,next;return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.n){case 0:signal=_ref.signal,cursor=_ref.cursor,filterText=_ref.filterText;if(cursor){cursor=cursor.replace(/^http:\/\//i,'https://');}_context.n=1;return fetch(cursor||"https://swapi.py4e.com/api/people/?search="+filterText,{signal:signal});case 1:res=_context.v;_context.n=2;return res.json();case 2:_yield$res$json=_context.v;results=_yield$res$json.results;next=_yield$res$json.next;return _context.a(2,{items:results,cursor:next});}},_callee);}))();}});return/*#__PURE__*/(0,jsx_runtime.jsxs)(ComboBox_ComboBox,{label:"Star Wars Character Lookup",placeholder:"V\xE4lj eller s\xF6k karakt\xE4r",description:"Anropar ett externt API",inputValue:list.filterText,onInputChange:list.setFilterText,allowsEmptyCollection:true,listBoxProps:{renderEmptyState:function renderEmptyState(){return list.isLoading?null:/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxEmptyState,{children:"Inga tr\xE4ffar"});}},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(CollectionBuilder/* Collection */.pM,{items:list.items,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:item.name,children:item.name});}}),list.isLoading&&/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxLoadMoreItem,{isLoading:list.isLoading})]});};
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: "En ComboBox är en sökbar version av Select. Combobox är lämplig att använda när listan med möjliga val är lång eftersom det ger användaren möjlighet att söka efter ett specifikt värde."
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { ComboBox, ListBoxItem } from '@midas-ds/components'\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      children: ["Använd ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: "onChange"
      }), " för att styra det valda värdet i ComboBox."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      children: ["För närvarande stödjer inte vår ComboBox flerval. Använd ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/dev/react-select",
        children: "Midas CSS för react-select"
      }), " för detta."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "sektioner",
      children: "Sektioner"
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { ListBoxHeader, ListBoxItem, ListBoxSection } from '@midas-ds/components'\nimport { Collection } from 'react-aria-components'\n\nconst options = [\n  {\n    name: 'Grönsaker',\n    children: [\n      { name: 'Morot', id: 2 },\n      { name: 'Broccoli', id: 3 },\n      { name: 'Spenat', id: 4 },\n      { name: 'Potatis', id: 5 },\n      { name: 'Tomat', id: 6 },\n    ],\n  },\n  {\n    name: 'Frukter',\n    children: [\n      { name: 'Äpple', id: 11 },\n      { name: 'Banan', id: 12 },\n      { name: 'Kiwi', id: 13 },\n      { name: 'Fläder', id: 14 },\n      { name: 'Nektarin', id: 15 },\n    ],\n  },\n]\n\nreturn (\n  <ComboBox\n    label='Välj din favoritfrukt eller grönsak'\n    description='Du kan bara välja en'\n    items={options}\n  >\n    {section => (\n      <ListBoxSection id={section.name}>\n        <ListBoxHeader>{section.name}</ListBoxHeader>\n        <Collection items={section.children}>\n          {item => {\n            return <ListBoxItem id={item.id}>{item.name}</ListBoxItem>\n          }}\n        </Collection>\n      </ListBoxSection>\n    )}\n  </ComboBox>\n)\n"
      })
    }), "\n", (0,jsx_runtime.jsx)("div", {
      className: "card",
