...
const $f1ab8c75478c6f73$export$3351871ee4b288b8 = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_4__).forwardRef(({ children: children, ...props }, ref)=>{
    ...
    context.ref = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .useObjectRef */ .U)(ref || (prevContext === null || prevContext === void 0 ? void 0 : prevContext.ref));
    (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .useSyncRef */ .w)(prevContext, context.ref);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ $e0b6e0b68ec7f50f$export$872b660ac5a1ff98)
/* harmony export */ });
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99672);
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24836);
...
function $e0b6e0b68ec7f50f$export$872b660ac5a1ff98(props) {
    ...
    let stateRef = (0, react__WEBPACK_IMPORTED_MODULE_3__.useRef)({
        isPointerDown: false,
        ignoreEmulatedMouseEvents: false
    });
    let onPointerDown = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .useEffectEvent */ .J)((e)=>{
        if (onInteractOutside && $e0b6e0b68ec7f50f$var$isValidEvent(e, ref)) {
            if (onInteractOutsideStart) onInteractOutsideStart(e);
            stateRef.current.isPointerDown = true;
        }
    });
    let triggerInteractOutside = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .useEffectEvent */ .J)((e)=>{
...
function $e0b6e0b68ec7f50f$var$isValidEvent(event, ref) {
    ...
    let target = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .getEventTarget */ .wt)(event);
    if (target) {
        // if the event target is no longer in the document, ignore
        const ownerDocument = target.ownerDocument;
        if (!ownerDocument || !(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .nodeContains */ .sD)(ownerDocument.documentElement, target)) return false;
...
/* harmony import */ var _react_aria_focus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(85652);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(96540);
...
/* harmony export */ });
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(37193);
...
/* harmony import */ var _react_stately_flags__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93399);
...
function $5e3802645cc19319$export$1c3ebcada18427bf(targets, options) {
    let windowObj = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerWindow */ .mD)(targets === null || targets === void 0 ? void 0 : targets[0]);
    ...
    if ((0, _react_stately_flags__WEBPACK_IMPORTED_MODULE_3__/* .shadowDOM */ .Nf)()) // find all shadow roots that are ancestors of the targets
    ...
    let walk = (root)=>{
        ...
        let acceptNode = (node)=>{
            ...
            for (let target of visibleNodes){
                if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .nodeContains */ .sD)(node, target)) return NodeFilter.FILTER_SKIP;
            }
            return NodeFilter.FILTER_ACCEPT;
        };
        let walker = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .createShadowTreeWalker */ .H)((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(root), root, NodeFilter.SHOW_ELEMENT, {
    ...
    let observer = new MutationObserver((changes)=>{
        for (let change of changes){
            ...
            if (change.target.isConnected && ![
                ...visibleNodes,
                ...hiddenNodes
            ].some((node)=>(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .nodeContains */ .sD)(node, change.target))) for (let node of change.addedNodes){
                if ((node instanceof HTMLElement || node instanceof SVGElement) && (node.dataset.liveAnnouncer === 'true' || node.dataset.reactAriaTopLayer === 'true')) visibleNodes.add(node);
                else if (node instanceof Element) walk(node);
            }
            if ((0, _react_stately_flags__WEBPACK_IMPORTED_MODULE_3__/* .shadowDOM */ .Nf)()) {
    ...
    if ((0, _react_stately_flags__WEBPACK_IMPORTED_MODULE_3__/* .shadowDOM */ .Nf)()) for (let shadowRoot of shadowRootsToWatch){
    ...
    return ()=>{
        observer.disconnect();
        if ((0, _react_stately_flags__WEBPACK_IMPORTED_MODULE_3__/* .shadowDOM */ .Nf)()) for (let shadowObserver of shadowObservers)shadowObserver.disconnect();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   e: () => (/* binding */ $a11501f3d1d39e6c$export$ea8f71083e90600f)
/* harmony export */ });
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99672);
/* harmony import */ var _react_aria_focus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85652);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(96540);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(59461);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(75723);
...
function $a11501f3d1d39e6c$export$ea8f71083e90600f(props, ref) {
    ...
    let lastVisibleOverlay = (0, react__WEBPACK_IMPORTED_MODULE_2__.useRef)(undefined);
    ...
    let onInteractOutsideStart = (e)=>{
        ...
        if (!shouldCloseOnInteractOutside || shouldCloseOnInteractOutside((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .getEventTarget */ .wt)(e))) {
    ...
    let { focusWithinProps: focusWithinProps } = (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_3__/* .useFocusWithin */ .R)({
        ...
        onBlurWithin: (e)=>{
            ...
            if (!e.relatedTarget || (0, _react_aria_focus__WEBPACK_IMPORTED_MODULE_1__/* .isElementInChildOfActiveScope */ .Pu)(e.relatedTarget)) return;
    ...
    let onPointerDownUnderlay = (e)=>{
        ...
        if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .getEventTarget */ .wt)(e) === e.currentTarget) e.preventDefault();
    };
    return {
        overlayProps: {
            onKeyDown: onKeyDown,
...
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(47912);
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(69202);
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3704);
...
function $49c51c25361d4cd2$export$ee0f7cc6afcd1c18(options = {}) {
    ...
    (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .useLayoutEffect */ .N)(()=>{
        ...
        if ($49c51c25361d4cd2$var$preventScrollCount === 1) {
            if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__/* .isIOS */ .un)()) $49c51c25361d4cd2$var$restore = $49c51c25361d4cd2$var$preventScrollMobileSafari();
...
function $49c51c25361d4cd2$var$preventScrollMobileSafari() {
    ...
    let onTouchStart = (e)=>{
        ...
        let target = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getEventTarget */ .wt)(e);
        scrollable = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__/* .isScrollable */ .o)(target) ? target : (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .getScrollParent */ .m)(target, true);
...
@layer {
  * {
    ...
    let onBlur = (e)=>{
        ...
        if (relatedTarget && (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__/* .willOpenKeyboard */ .o)(relatedTarget)) {
            // Focus without scrolling the whole page, and then scroll into view manually.
            relatedTarget.focus({
                preventScroll: true
            });
            $49c51c25361d4cd2$var$scrollIntoViewWhenReady(relatedTarget, (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__/* .willOpenKeyboard */ .o)(target));
    ...
    HTMLElement.prototype.focus = function(opts) {
        ...
        let activeElement = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)();
        let wasKeyboardVisible = activeElement != null && (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__/* .willOpenKeyboard */ .o)(activeElement);
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        if (!ref.current || !(0, DOMFunctions/* nodeContains */.sD)(ref.current, (0, DOMFunctions/* getEventTarget */.wt)(e))) return;
...
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3704);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(35044);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(60155);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4175);
/* harmony import */ var _react_aria_focus__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(55799);
...
function $880e95eb8b93ba9a$export$ecf600387e221c37(options) {
    ...
    let router = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__/* .useRouter */ .rd)();
    ...
    let onSelect = (e)=>{
        if (e.pointerType === 'keyboard' && (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_0__/* .isNonContiguousSelectionModifier */ .N9)(e)) manager.toggleSelection(key);
            ...
            else if (manager.selectionBehavior === 'toggle' || e && ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__/* .isCtrlKeyPressed */ .B)(e) || e.pointerType === 'touch' || e.pointerType === 'virtual')) // if touch or virtual (VO) then we just want to toggle, otherwise it's impossible to multi select because they don't have modifier keys
    ...
    (0, react__WEBPACK_IMPORTED_MODULE_11__.useEffect)(()=>{
        ...
        if (isFocused && manager.isFocused) {
            if (!shouldUseVirtualFocus) {
                if (focus) focus();
                else if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .getActiveElement */ .bq)() !== ref.current && ref.current) (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_9__/* .focusSafely */ .l)(ref.current);
            } else (0, _react_aria_focus__WEBPACK_IMPORTED_MODULE_10__/* .moveVirtualFocus */ .vX)(ref.current);
        }
    // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [
        ref,
    ...
    if (!shouldUseVirtualFocus && !isDisabled) itemProps = {
        ...
        onFocus (e) {
            if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .getEventTarget */ .wt)(e) === ref.current) manager.setFocusedKey(key);
        }
    };
    ...
    let modality = (0, react__WEBPACK_IMPORTED_MODULE_11__.useRef)(null);
    let longPressEnabled = hasAction && allowsSelection;
    let longPressEnabledOnPressStart = (0, react__WEBPACK_IMPORTED_MODULE_11__.useRef)(false);
    let hadPrimaryActionOnPressStart = (0, react__WEBPACK_IMPORTED_MODULE_11__.useRef)(false);
    ...
    if (shouldUseVirtualFocus) itemPressProps = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__/* .mergeProps */ .v)(itemPressProps, {
        onPressStart (e) {
            if (e.pointerType !== 'touch') {
                manager.setFocused(true);
                manager.setFocusedKey(key);
    ...
    let { pressProps: pressProps, isPressed: isPressed } = (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_7__/* .usePress */ .d)(itemPressProps);
    ...
    let { longPressProps: longPressProps } = (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_8__/* .useLongPress */ .H)({
    ...
    let onClick = linkBehavior !== 'none' && manager.isLink(key) ? (e)=>{
        if (!(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__/* .openLink */ .Fe).isOpening) e.preventDefault();
    } : undefined;
    return {
        itemProps: (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__/* .mergeProps */ .v)(itemProps, allowsSelection || hasPrimaryAction || shouldUseVirtualFocus && !isDisabled ? pressProps : {}, longPressEnabled ? longPressProps : {}, {
...
function $fb3050f43d946246$export$e32c88dfddc6e1d8(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        if (!character || e.ctrlKey || e.metaKey || !(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .nodeContains */ .sD)(e.currentTarget, (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .getEventTarget */ .wt)(e)) || state.search.length === 0 && character === ' ') return;
...
function $2f04cbc44ee30ce0$export$53a0910f038337bd(scrollView, element, opts = {}) {
    ...
    if (viewStyle.direction === 'rtl' && !(0, platform/* isIOS */.un)()) scrollPortLeft += scrollBarWidth;
...
/* unused harmony import specifier */ var $18I52$createBranchComponent;
/* unused harmony import specifier */ var $18I52$useContext;
...
function $7135fc7d473fd974$var$useCollectionRender(collection, parent, renderDropIndicator) {
    return (0, _react_aria_collections__WEBPACK_IMPORTED_MODULE_0__/* .useCachedChildren */ .p)({
        ...
        children (node) {
            ...
            if (node.type === 'content') return /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_1__).createElement((0, react__WEBPACK_IMPORTED_MODULE_1__).Fragment, null);
...
/* unused harmony import specifier */ var $64fa3d84918910a7$export$29f1550f4b0d4415;
/* unused harmony import specifier */ var $64fa3d84918910a7$export$df3a06d6289f983e;
/* unused harmony import specifier */ var $3zqIJ$forwardRef;
/* unused harmony import specifier */ var $3zqIJ$react;
...
const $63df2425e2108aa8$export$16e4d70cc375e707 = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $3zqIJ$forwardRef)(function Keyboard(props, ref) {
    ...
    return /*#__PURE__*/ (0, $3zqIJ$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).kbd, {
        dir: "ltr",
        ...props,
        ref: ref
    });
        ...
        onKeyDown: (e)=>{
            ...
            switch(e.key){
                ...
                case 'Enter':
                    ...
                    if ((0, DOMFunctions/* getEventTarget */.wt)(e).tagName !== 'A') (0, DOMFunctions/* getEventTarget */.wt)(e).click();
                    // click above sets modality to "virtual", need to set interaction modality back to 'keyboard' so focusSafely calls properly move focus
                    // to the newly opened submenu's first item.
                    (0, useFocusVisible/* setInteractionModality */.Cl)('keyboard');
                    break;
...
/* unused harmony import specifier */ var $64fa3d84918910a7$export$2881499e37b75b9a;
/* unused harmony import specifier */ var $7135fc7d473fd974$export$4feb769f8ddf26c5;
/* unused harmony import specifier */ var $de32f1b87079253c$export$d2f961adcb0afbe;
/* unused harmony import specifier */ var $07b14b47974efb58$export$9b9a0cd73afb7ca4;
/* unused harmony import specifier */ var $kM2ZM$useSubmenuTrigger;
/* unused harmony import specifier */ var $kM2ZM$createBranchComponent;
/* unused harmony import specifier */ var $kM2ZM$SectionNode;
/* unused harmony import specifier */ var $kM2ZM$useSubmenuTriggerState;
/* unused harmony import specifier */ var $kM2ZM$useObjectRef;
/* unused harmony import specifier */ var $kM2ZM$useContext;
/* unused harmony import specifier */ var $kM2ZM$useRef;
/* unused harmony import specifier */ var $kM2ZM$react;
...
function $3674c52c6b3c5bce$var$MenuSectionInner(props, ref, section, className = 'react-aria-MenuSection') {
    ...
    let closeOnSelect = (_useSlottedContext = (0, utils/* useSlottedContext */.CC)($3674c52c6b3c5bce$var$MenuItemContext)) === null || _useSlottedContext === void 0 ? void 0 : _useSlottedContext.shouldCloseOnSelect;
    let DOMProps = (0, filterDOMProps/* filterDOMProps */.$)(props, {
        global: true
    });
    delete DOMProps.id;
...
// EXTERNAL MODULE: ./node_modules/@react-aria/overlays/dist/useOverlay.mjs
var useOverlay = __webpack_require__(22548);
...
function $07b14b47974efb58$var$PopoverInner({ state: state, isExiting: isExiting, UNSTABLE_portalContainer: UNSTABLE_portalContainer, clearContexts: clearContexts, ...props }) {
    ...
    (0, react.useEffect)(()=>{
        if (isDialog && (props.trigger !== 'SubmenuTrigger' || (0, useFocusVisible/* getInteractionModality */.ME)() !== 'pointer') && ref.current && !(0, DOMFunctions/* isFocusWithin */.ae)(ref.current)) (0, focusSafely/* focusSafely */.l)(ref.current);
    }, [
        isDialog,
        ref,
        props.trigger
...
/* unused harmony import specifier */ var $64fa3d84918910a7$export$29f1550f4b0d4415;
/* unused harmony import specifier */ var $64fa3d84918910a7$export$df3a06d6289f983e;
/* unused harmony import specifier */ var $i9JCE$useSeparator;
/* unused harmony import specifier */ var $i9JCE$createLeafComponent;
/* unused harmony import specifier */ var $i9JCE$mergeProps;
/* unused harmony import specifier */ var $i9JCE$filterDOMProps;
/* unused harmony import specifier */ var $i9JCE$react;
