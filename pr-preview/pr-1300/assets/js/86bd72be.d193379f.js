...
const site_docs_dev_tanstack_table_mdx_86b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tanstack-table","title":"Tanstack Table","description":"Implementation av Tanstack Table","source":"@site/docs/dev/tanstack-table.mdx","sourceDirName":"dev","slug":"/dev/tanstack-table","permalink":"/pr-preview/pr-1300/dev/tanstack-table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tanstack Table","description":"Implementation av Tanstack Table"},"sidebar":"sideBar","previous":{"title":"Tailwind CSS","permalink":"/pr-preview/pr-1300/dev/tailwind"}}');
...
var SelectAll=function SelectAll(){var state=react.useContext(Select/* SelectStateContext */.nT);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var handleChange=function handleChange(){state==null||state.setValue(state!=null&&state.selectionManager.isSelectAll?null:Array.from(state.collection.getKeys()));state==null||state.commitValidation();};return/*#__PURE__*/(0,jsx_runtime.jsx)(Checkbox/* Checkbox */.S,{className:Select_module.selectAll,isIndeterminate:!(state!=null&&state.selectionManager.isSelectAll)&&!(state!=null&&state.selectionManager.isEmpty),isSelected:state==null?void 0:state.selectionManager.isSelectAll,onChange:handleChange,children:strings.format('selectAll')});};
...
var brandPrimary="light-dark(#b90835, #b90835)";// Migrationsverekts primära röda färg
