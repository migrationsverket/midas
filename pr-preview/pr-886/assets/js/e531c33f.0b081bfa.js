...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "Men, i de fall där informationen i kontrollen är relevant men användaren inte ska kunna interagera med kontrollen använder vi read-only. I detta läge har kontrollen ett annorlunda utseende för att indikera att den inte går att interagera med."
