...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "Typexemplet på när det är lämpligt att använda read-only är när en användare har begränsad behörighet. Den kan inte ändra vissa fält men behöver kunna se informationen i fälten. Vi bör alltid komplettera med information till användaren om varför vissa fält är read-only."
