...
(0,react.useEffect)(function(){if(selectionMode==='single'&&listState.selectedKeys.size){validationState.resetValidation();validationState.commitValidation();}},[listState.selectedKeys.size,selectionMode,validationState]);return Object.assign({},listState,triggerState,{close:function close(){triggerState.close();// Reset validation for multi selects when the list closes.
validationState.resetValidation();validationState.commitValidation();},open:function open(){// Don't open if the collection is empty.
