...
const site_docs_components_flex_mdx_6dc_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/flex","title":"Flex","description":"Grid baserat på tekniken display flex i css","source":"@site/docs/components/flex.mdx","sourceDirName":"components","slug":"/components/flex","permalink":"/pr-preview/pr-145/components/flex","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"grid","permalink":"/pr-preview/pr-145/tags/grid"}],"version":"current","frontMatter":{"title":"Flex","tags":["grid"],"description":"Grid baserat på tekniken display flex i css"},"sidebar":"sideBar","previous":{"title":"FileUpload","permalink":"/pr-preview/pr-145/components/fileupload"},"next":{"title":"Grid","permalink":"/pr-preview/pr-145/components/grid"}}');
