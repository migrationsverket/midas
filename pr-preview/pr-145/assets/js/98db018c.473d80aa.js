...
const site_docs_components_spinner_mdx_98d_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/spinner","title":"Spinner","description":"Upplys användaren om att systemet/tjänsten laddar","source":"@site/docs/components/spinner.mdx","sourceDirName":"components","slug":"/components/spinner","permalink":"/pr-preview/pr-145/components/spinner","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Spinner","tags":[],"description":"Upplys användaren om att systemet/tjänsten laddar"},"sidebar":"sideBar","previous":{"title":"Select","permalink":"/pr-preview/pr-145/components/select"},"next":{"title":"Table","permalink":"/pr-preview/pr-145/components/table"}}');
