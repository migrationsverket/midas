...
const site_docs_components_multi_select_mdx_725_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/multi-select","title":"MultiSelect","description":"<ComponentHeader","source":"@site/docs/components/multi-select.mdx","sourceDirName":"components","slug":"/components/multi-select","permalink":"/pr-preview/pr-147/components/multi-select","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"form","permalink":"/pr-preview/pr-147/tags/form"}],"version":"current","frontMatter":{"title":"MultiSelect","tags":["form"]},"sidebar":"sideBar","previous":{"title":"Modal","permalink":"/pr-preview/pr-147/components/modal"},"next":{"title":"Radio","permalink":"/pr-preview/pr-147/components/radio"}}');
