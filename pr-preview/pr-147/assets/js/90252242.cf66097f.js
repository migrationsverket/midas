...
const site_docs_components_modal_mdx_902_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/modal","title":"Modal","description":"Modal som lägger sig över allt annat innehåll.","source":"@site/docs/components/modal.mdx","sourceDirName":"components","slug":"/components/modal","permalink":"/pr-preview/pr-147/components/modal","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Modal","tags":[],"description":"Modal som lägger sig över allt annat innehåll."},"sidebar":"sideBar","previous":{"title":"Logo","permalink":"/pr-preview/pr-147/components/logo"},"next":{"title":"MultiSelect","permalink":"/pr-preview/pr-147/components/multi-select"}}');
