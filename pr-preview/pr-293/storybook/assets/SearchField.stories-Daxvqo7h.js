import{S as w}from"./SearchField-DqXTz8Vt.js";import{f as c,u as e,e as t}from"./index-DtSMq7G1.js";import"./jsx-runtime-DtgEGaVE.js";import"./index-BbAIUH2N.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./TextField.module-DBomeRQe.js";import"./clsx-B-dksMZM.js";import"./useControlledState-DGyHFLi9.js";import"./useFocusable-kTDKG0-I.js";import"./useLocalizedStringFormatter-DFEaIMYS.js";import"./context-_OjZNubd.js";import"./useTextField-Ca09ynha.js";import"./useFormValidation-DR3ZhvQ-.js";import"./useField-BCfbuq15.js";import"./useLabels-CfvNSRSq.js";import"./createLucideIcon-8wDOqnHv.js";import"./Button-BgnELAWU.js";import"./Button-Cm6N-U3G.js";import"./Hidden-BtGjzlYc.js";import"./index-cpIEhwLo.js";import"./x-Cu6J0Y2u.js";const z={component:w,title:"Components/SearchField",tags:["autodocs"],parameters:{layout:"centered"},args:{buttonText:"Sök"}},s={args:{placeholder:"Sök efter en person",onChange:c(),onSubmit:c()},play:async({canvas:a,step:n,args:{onChange:r,onSubmit:o,buttonText:k}})=>{await n("it should be possible to submit a search string using only the keyboard",async()=>{await e.tab(),await e.keyboard("hello"),await e.keyboard("[Enter]"),t(r).toHaveBeenCalledWith("hello"),t(o).toHaveBeenCalledWith("hello")}),await n("it should be possible to submit a search string using the mouse",async()=>{await e.tab(),await e.keyboard("hello"),await e.click(a.getByText(k)),t(r).toHaveBeenCalledWith("hello"),t(o).toHaveBeenCalledWith("hello")})}},i={args:{placeholder:'Sök efter "secret"',validate:a=>a==="secret"?"Sök inte efter hemligheter":!0,onChange:c(),onSubmit:c()},play:async({canvas:a,step:n,args:{onChange:r,onSubmit:o}})=>{await n("it should give a validation error if the user entered an unpermitted text",async()=>{await e.tab(),await e.keyboard("secret"),await e.tab(),await e.keyboard("[Enter]"),t(r).toHaveBeenCalledWith("secret"),t(o).not.toHaveBeenCalled(),t(a.getByText("Sök inte efter hemligheter")).toBeInTheDocument()})}},l={args:{placeholder:"Sök efter dokument",isInvalid:!0,errorMessage:"Något gick fel, var god försök igen"},play:async({canvas:a,step:n,args:{placeholder:r,errorMessage:o}})=>{await n("it should be invalid and show the custom message",async()=>{t(a.getByLabelText(r)).toBeInvalid(),t(a.getByText(o)).toBeInTheDocument()})}};var d,p,h;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(h=(p=s.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var m,u,g;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(v=l.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};const A=["Primary","CustomValidation","Invalid"];export{i as CustomValidation,l as Invalid,s as Primary,A as __namedExportsOrder,z as default};
