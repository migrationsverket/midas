...
const site_docs_design_patterns_tables_mdx_93c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/tables","title":"Tabeller","description":"Filtrering","source":"@site/docs/design-patterns/tables.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/tables","permalink":"/pr-preview/pr-953/design-patterns/tables","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function InlineFilter() {
  const lightSrc = (0,useBaseUrl/* default */.Ay)('/img/inline-filter.svg');
  const darkSrc = (0,useBaseUrl/* default */.Ay)('/img/inline-filter.svg');
...
function InlineFilterAccordion() {
  const lightSrc = (0,useBaseUrl/* default */.Ay)('/img/inline-filter-accordion.svg');
  const darkSrc = (0,useBaseUrl/* default */.Ay)('/img/inline-filter-accordion.svg');
  return (0,jsx_runtime.jsx)(ThemedImage/* default */.A, {
    alt: "Inline filter",
    sources: {
      light: lightSrc,
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["I detta mönster öppnas filtervalen i en popover via en knapp eller en ikon. Det ger en fokuserad tabellvy när filtrering inte är användarens primära handling. Inne i popovern läggs filtren i ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/accordion",
        children: "Accordion"
