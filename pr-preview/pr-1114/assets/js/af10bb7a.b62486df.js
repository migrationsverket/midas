...
const site_docs_components_select_mdx_af1_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/select","title":"Select","description":"Välj ett alternativ från en lista","source":"@site/docs/components/select.mdx","sourceDirName":"components","slug":"/components/select","permalink":"/pr-preview/pr-1114/components/select","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_custom_props":{"groups":["Formulär"]},"title":"Select","description":"Välj ett alternativ från en lista"},"sidebar":"sideBar","previous":{"title":"SearchField","permalink":"/pr-preview/pr-1114/components/search-field"},"next":{"title":"Skeleton","permalink":"/pr-preview/pr-1114/components/skeleton"}}');
...
const frontMatter = {
	...
	title: 'Select',
	description: 'Välj ett alternativ från en lista'
};
