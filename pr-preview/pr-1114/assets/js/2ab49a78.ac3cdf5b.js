...
const site_docs_components_calendar_mdx_2ab_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/calendar","title":"Calendar","description":"Använd en kalender när användaren ska välja ett datum eller visualisera ett datum valt på annat sätt.","source":"@site/docs/components/calendar.mdx","sourceDirName":"components","slug":"/components/calendar","permalink":"/pr-preview/pr-1114/components/calendar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_custom_props":{"groups":["Formulär"]},"title":"Calendar","description":"Använd en kalender när användaren ska välja ett datum eller visualisera ett datum valt på annat sätt."},"sidebar":"sideBar","previous":{"title":"Button","permalink":"/pr-preview/pr-1114/components/button"},"next":{"title":"Card","permalink":"/pr-preview/pr-1114/components/card"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
