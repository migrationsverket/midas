...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      }), ", DropZone och ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      className: "card",
      children: (0,jsx_runtime.jsx)(FileUploadExamples/* FileListExample */.f, {})
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "med-drag--drop",
    ...
    }), "\n", (0,jsx_runtime.jsx)(FileUploadExamples/* DropZoneExample */.q, {})]
  });
}
...
var FileListExample=function FileListExample(){var _React$useState=react.useState([]),files=_React$useState[0],setFiles=_React$useState[1];var handleSelect=function handleSelect(e){var selected=e?Array.from(e):[];setFiles(function(prev){var existingNames=new Set(prev.map(function(f){return f.name;}));return[].concat(prev,selected.filter(function(f){return!existingNames.has(f.name);}));});};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',width:'100%'},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:"Ladda upp en bild p\xE5 din favoritfrukt"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:"Du kan v\xE4lja flera om du har m\xE5nga favoritfrukter"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FileTrigger,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"secondary",icon:arrow_up_from_line/* default */.A,children:"V\xE4lj fil(er)"})}),files.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)(FileList/* FileList */.$,{children:files.map(function(file){return/*#__PURE__*/(0,jsx_runtime.jsx)(FileListItem/* FileListItem */.I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]})]});};var DropZoneExample=function DropZoneExample(){var _React$useState2=react.useState([]),files=_React$useState2[0],setFiles=_React$useState2[1];var setUniqueFiles=function setUniqueFiles(newFiles){setFiles(function(oldFiles){var existingNames=new Set(oldFiles.map(function(f){return f.name;}));return[].concat(oldFiles,newFiles.filter(function(f){return!existingNames.has(f.name);}));});};var handleDrop=/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(e){var fileItems,droppedFiles;return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.n){case 0:fileItems=e.items.filter(function(item){return item.kind==='file';});_context.n=1;return Promise.all(fileItems.map(function(item){return item.getFile();}));case 1:droppedFiles=_context.v;setUniqueFiles(droppedFiles);case 2:return _context.a(2);}},_callee);}));return function handleDrop(_x){return _ref.apply(this,arguments);};}();var handleSelect=function handleSelect(e){var selectedFiles=e?Array.from(e):[];setUniqueFiles(selectedFiles);};var handleDelete=function handleDelete(name){setFiles(function(prev){return prev.filter(function(f){return f.name!==name;});});};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',width:'100%'},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:"Ladda upp en bild p\xE5 din favoritfrukt"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:"Du kan v\xE4lja flera om du har m\xE5nga favoritfrukter"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(DropZone,{onDrop:handleDrop,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{alignItems:'center',display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"label",children:"V\xE4lj filer eller dra och sl\xE4pp filer h\xE4r"}),/*#__PURE__*/(0,jsx_runtime.jsx)(FileTrigger,{allowsMultiple:true,onSelect:handleSelect,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* Button */.$,{variant:"secondary",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(arrow_up_from_line/* default */.A,{size:20})," V\xE4lj fil(er)"]})})]})}),files.length>0&&/*#__PURE__*/(0,jsx_runtime.jsx)(FileList/* FileList */.$,{children:files.map(function(file){return/*#__PURE__*/(0,jsx_runtime.jsx)(FileListItem/* FileListItem */.I,{fileName:file.name,fileSize:(file.size/1024).toFixed(1)+" KB",onDelete:function onDelete(){return handleDelete(file.name);}},file.name);})})]})]});};
