"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[2722],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_file_upload_dropzone_mdx_d69_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-file-upload-dropzone-mdx-d69.json
const site_docs_components_file_upload_dropzone_mdx_d69_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/file-upload/dropzone","title":"DropZone","description":"Ett generellt mål för drag & drop — inte begränsat till filuppladdning.","source":"@site/docs/components/file-upload/dropzone.mdx","sourceDirName":"components/file-upload","slug":"/components/file-upload/dropzone","permalink":"/pr-preview/pr-1380/components/file-upload/dropzone","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"DropZone","description":"Ett generellt mål för drag & drop — inte begränsat till filuppladdning."},"sidebar":"sideBar","previous":{"title":"Filuppladdning","permalink":"/pr-preview/pr-1380/components/file-upload/file-uploading"},"next":{"title":"FileList","permalink":"/pr-preview/pr-1380/components/file-upload/file-list"}}');
...
;// ./apps/docs/docs/components/file-upload/dropzone.mdx
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["En yta som ett eller flera objekt kan dras och släppas på. Används för ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/file-upload/file-uploading/#med-drag--drop",
