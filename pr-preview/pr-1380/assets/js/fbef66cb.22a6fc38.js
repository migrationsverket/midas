...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_file_upload_file_list_mdx_fbe_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-file-upload-file-list-mdx-fbe.json
const site_docs_components_file_upload_file_list_mdx_fbe_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/file-upload/file-list","title":"FileList","description":"Lista uppladdade filer","source":"@site/docs/components/file-upload/file-list.mdx","sourceDirName":"components/file-upload","slug":"/components/file-upload/file-list","permalink":"/pr-preview/pr-1380/components/file-upload/file-list","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"FileList","description":"Lista uppladdade filer"},"sidebar":"sideBar","previous":{"title":"Filuppladdning","permalink":"/pr-preview/pr-1380/components/file-upload/file-uploading"},"next":{"title":"FileTrigger","permalink":"/pr-preview/pr-1380/components/file-upload/file-trigger"}}');
...
;// ./apps/docs/docs/components/file-upload/file-list.mdx
