"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[5757],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_file_upload_file_trigger_mdx_8e9_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-file-upload-file-trigger-mdx-8e9.json
const site_docs_components_file_upload_file_trigger_mdx_8e9_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/file-upload/file-trigger","title":"FileTrigger","description":"Åtkomst till filsystemet","source":"@site/docs/components/file-upload/file-trigger.mdx","sourceDirName":"components/file-upload","slug":"/components/file-upload/file-trigger","permalink":"/pr-preview/pr-1380/components/file-upload/file-trigger","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"FileTrigger","description":"Åtkomst till filsystemet"},"sidebar":"sideBar","previous":{"title":"FileList","permalink":"/pr-preview/pr-1380/components/file-upload/file-list"},"next":{"title":"Grid","permalink":"/pr-preview/pr-1380/components/grid"}}');
...
// EXTERNAL MODULE: ./apps/docs/src/components/examples/file-upload/FileUploadExamples.tsx + 2 modules
var FileUploadExamples = __webpack_require__(99656);
// EXTERNAL MODULE: ./apps/docs/src/components/PropsTable.tsx + 2 modules
var PropsTable = __webpack_require__(68713);
;// ./apps/docs/docs/components/file-upload/file-trigger.mdx
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  q: () => (/* binding */ DropZoneExample),
  f: () => (/* binding */ FileListExample)
});
