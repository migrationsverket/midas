...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_basics_index_mdx_d56_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-basics-index-mdx-d56.json
const site_docs_basics_index_mdx_d56_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/index","title":"Grunderna","description":"","source":"@site/docs/basics/index.mdx","sourceDirName":"basics","slug":"/basics/","permalink":"/pr-preview/pr-148/basics/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Grunderna"},"sidebar":"sideBar","previous":{"title":"För utvecklare","permalink":"/pr-preview/pr-148/get-started/develop/"},"next":{"title":"Design-DNA","permalink":"/pr-preview/pr-148/basics/design-dna"}}');
...
;// ./apps/docs/docs/basics/index.mdx
