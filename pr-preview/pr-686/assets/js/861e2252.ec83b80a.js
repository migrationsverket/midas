...
const site_docs_dev_dark_mode_mdx_861_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/dark-mode","title":"Mörkt läge","description":"Hantera mörkt i designsystemet","source":"@site/docs/dev/dark-mode.mdx","sourceDirName":"dev","slug":"/dev/dark-mode","permalink":"/pr-preview/pr-686/dev/dark-mode","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Mörkt läge","description":"Hantera mörkt i designsystemet","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
var _React$useState=react.useState(defaultValue),colorScheme=_React$useState[0],setColorScheme=_React$useState[1];react.useEffect(function(){var targetElement=document.querySelector(selector);if(targetElement){targetElement.style.setProperty('color-scheme',Array.from(colorScheme).join(' '));}else{console.warn("No element found for selector: \""+selector+"\"");}},[colorScheme,selector]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButtonGroup,{selectionMode:"single",selectedKeys:colorScheme,onSelectionChange:setColorScheme,disallowEmptySelection:true,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton,{id:"light dark",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(laptop/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:"Systeminst\xE4llning"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton,{id:"light",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Sun,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:"Ljust l\xE4ge"})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton,{id:"dark",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Moon,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:"M\xF6rkt l\xE4ge"})]})]});};
