...
const site_docs_dev_forms_mdx_ac3_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/forms","title":"Formulär","description":"Utvecklarinstruktioner för formulär","source":"@site/docs/dev/forms.mdx","sourceDirName":"dev","slug":"/dev/forms","permalink":"/pr-preview/pr-1316/dev/forms","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Formulär","description":"Utvecklarinstruktioner för formulär"},"sidebar":"sideBar","previous":{"title":"Mörkt läge","permalink":"/pr-preview/pr-1316/dev/dark-mode"},"next":{"title":"Lokalisering","permalink":"/pr-preview/pr-1316/dev/localization"}}');
