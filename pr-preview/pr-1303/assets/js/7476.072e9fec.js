"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[7476],{
...
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/gridlist/useGridList.mjs
var useGridList = __webpack_require__(34997);
...
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/gridlist/useGridListItem.mjs
var useGridListItem = __webpack_require__(53384);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   I: () => (/* binding */ $34d813d3524a584a$export$664f9155035607eb)
/* harmony export */ });
/* harmony import */ var _utils_filterDOMProps_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(46683);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98271);
/* harmony import */ var _utils_mergeProps_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(47425);
/* harmony import */ var _grid_useGridSelectionAnnouncement_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(53140);
/* harmony import */ var _focus_useHasTabbableChild_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16466);
/* harmony import */ var _grid_useHighlightSelectionDescription_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(62755);
/* harmony import */ var _utils_useId_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(19633);
/* harmony import */ var _selection_useSelectableList_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(70353);
...
function $34d813d3524a584a$export$664f9155035607eb(props, state, ref) {
    ...
    let { listProps: listProps } = (0, _selection_useSelectableList_mjs__WEBPACK_IMPORTED_MODULE_7__/* .useSelectableList */ .y)({
    ...
    let id = (0, _utils_useId_mjs__WEBPACK_IMPORTED_MODULE_6__/* .useId */ .Bi)(props.id);
    (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__/* .listMap */ .nV).set(state, {
        id: id,
        onAction: onAction,
        linkBehavior: linkBehavior,
    ...
    let descriptionProps = (0, _grid_useHighlightSelectionDescription_mjs__WEBPACK_IMPORTED_MODULE_5__/* .useHighlightSelectionDescription */ .m)({
        selectionManager: state.selectionManager,
        hasItemActions: !!onAction
    });
    let hasTabbableChild = (0, _focus_useHasTabbableChild_mjs__WEBPACK_IMPORTED_MODULE_4__/* .useHasTabbableChild */ .$)(ref, {
        isDisabled: state.collection.size !== 0
    });
    let domProps = (0, _utils_filterDOMProps_mjs__WEBPACK_IMPORTED_MODULE_0__/* .filterDOMProps */ .$)(props, {
        labelable: true
    });
    let gridProps = (0, _utils_mergeProps_mjs__WEBPACK_IMPORTED_MODULE_2__/* .mergeProps */ .v)(domProps, {
        role: 'grid',
        id: id,
    ...
    (0, _grid_useGridSelectionAnnouncement_mjs__WEBPACK_IMPORTED_MODULE_3__/* .useGridSelectionAnnouncement */ .H)({}, state);
    return {
        gridProps: gridProps
    };
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   n: () => (/* binding */ $be7bed9611dd7497$export$9610e69494fadfd2)
/* harmony export */ });
...
/* harmony import */ var _focus_FocusScope_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46686);
/* harmony import */ var _utils_domHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1612);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(98271);
/* harmony import */ var _utils_getScrollParent_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(99597);
/* harmony import */ var _interactions_useFocusVisible_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(35692);
/* harmony import */ var _utils_mergeProps_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(47425);
/* harmony import */ var _utils_scrollIntoView_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(58796);
/* harmony import */ var _selection_useSelectableItem_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(1904);
/* harmony import */ var _i18n_I18nProvider_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(78352);
/* harmony import */ var _utils_useId_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(19633);
/* harmony import */ var _utils_openLink_mjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(46271);
...
function $be7bed9611dd7497$export$9610e69494fadfd2(props, state, ref) {
    ...
    let { direction: direction } = (0, _i18n_I18nProvider_mjs__WEBPACK_IMPORTED_MODULE_11__/* .useLocale */ .Y)();
    let { onAction: onAction, linkBehavior: linkBehavior, keyboardNavigationBehavior: keyboardNavigationBehavior, shouldSelectOnPressUp: shouldSelectOnPressUp } = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .listMap */ .nV).get(state);
    let descriptionId = (0, _utils_useId_mjs__WEBPACK_IMPORTED_MODULE_12__/* .useSlotId */ .X1)();
    // We need to track the key of the item at the time it was last focused so that we force
    // focus to go to the item when the DOM node is reused for a different item in a virtualizer.
    let keyWhenFocused = (0, react__WEBPACK_IMPORTED_MODULE_14__.useRef)(null);
    let focus = ()=>{
        if (ref.current === null) return;
        if (focusMode === 'child') {
            // If focus is already on a focusable child within the row, early return so we don't shift focus
            if ((0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .isFocusWithin */ .ae)(ref.current) && ref.current !== (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getActiveElement */ .bq)((0, _utils_domHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getOwnerDocument */ .TW)(ref.current))) return;
            let treeWalker = (0, _focus_FocusScope_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getFocusableTreeWalker */ .N$)(ref.current, {
                tabbable: true
            });
            let focusable = treeWalker.firstChild();
            if (focusable) {
                (0, _interactions_focusSafely_mjs__WEBPACK_IMPORTED_MODULE_1__/* .focusSafely */ .l)(focusable);
                (0, _utils_scrollIntoView_mjs__WEBPACK_IMPORTED_MODULE_9__/* .scrollIntoViewport */ .o)(focusable, {
                    containingElement: (0, _utils_getScrollParent_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getScrollParent */ .m)(focusable)
                });
                return;
            }
        }
        ...
        if (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !(0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .isFocusWithin */ .ae)(ref.current)) (0, _interactions_focusSafely_mjs__WEBPACK_IMPORTED_MODULE_1__/* .focusSafely */ .l)(ref.current);
    };
    ...
    let { itemProps: itemProps, ...itemStates } = (0, _selection_useSelectableItem_mjs__WEBPACK_IMPORTED_MODULE_10__/* .useSelectableItem */ .p)({
        selectionManager: state.selectionManager,
        key: node.key,
        ref: ref,
        isVirtualized: isVirtualized,
        shouldSelectOnPressUp: props.shouldSelectOnPressUp || shouldSelectOnPressUp,
        onAction: onAction || node.props?.onAction ? (0, _utils_chain_mjs__WEBPACK_IMPORTED_MODULE_0__/* .chain */ .c)(node.props?.onAction, onAction ? ()=>onAction(node.key) : undefined) : undefined,
        focus: focus,
        linkBehavior: linkBehavior
    });
    let onKeyDownCapture = (e)=>{
        let activeElement = (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getActiveElement */ .bq)((0, _utils_domHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getOwnerDocument */ .TW)(ref.current));
        if (!(0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .nodeContains */ .sD)(e.currentTarget, (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEventTarget */ .wt)(e)) || !ref.current || !activeElement) return;
        let walker = (0, _focus_FocusScope_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getFocusableTreeWalker */ .N$)(ref.current);
        ...
        switch(e.key){
            case 'ArrowLeft':
                if (keyboardNavigationBehavior === 'arrow') {
                    ...
                    if (focusable) {
                        ...
                        (0, _interactions_focusSafely_mjs__WEBPACK_IMPORTED_MODULE_1__/* .focusSafely */ .l)(focusable);
                        (0, _utils_scrollIntoView_mjs__WEBPACK_IMPORTED_MODULE_9__/* .scrollIntoViewport */ .o)(focusable, {
                            containingElement: (0, _utils_getScrollParent_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getScrollParent */ .m)(ref.current)
                        });
                    } else {
                        ...
                        e.stopPropagation();
                        if (direction === 'rtl') {
                            (0, _interactions_focusSafely_mjs__WEBPACK_IMPORTED_MODULE_1__/* .focusSafely */ .l)(ref.current);
                            (0, _utils_scrollIntoView_mjs__WEBPACK_IMPORTED_MODULE_9__/* .scrollIntoViewport */ .o)(ref.current, {
                                containingElement: (0, _utils_getScrollParent_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getScrollParent */ .m)(ref.current)
                            });
                        } else {
                            ...
                            if (lastElement) {
                                (0, _interactions_focusSafely_mjs__WEBPACK_IMPORTED_MODULE_1__/* .focusSafely */ .l)(lastElement);
                                (0, _utils_scrollIntoView_mjs__WEBPACK_IMPORTED_MODULE_9__/* .scrollIntoViewport */ .o)(lastElement, {
                                    containingElement: (0, _utils_getScrollParent_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getScrollParent */ .m)(ref.current)
                                });
                            }
                        }
            ...
            case 'ArrowDown':
                ...
                if (!e.altKey && (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .nodeContains */ .sD)(ref.current, (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEventTarget */ .wt)(e))) {
                    e.stopPropagation();
                    e.preventDefault();
    ...
    let onFocus = (e)=>{
        ...
        if ((0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEventTarget */ .wt)(e) !== ref.current) {
            ...
            if (!(0, _interactions_useFocusVisible_mjs__WEBPACK_IMPORTED_MODULE_7__/* .isFocusVisible */ .pP)()) state.selectionManager.setFocusedKey(node.key);
            return;
        }
        ...
        if (focusMode === 'child' && e.relatedTarget && (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .nodeContains */ .sD)(ref.current, e.relatedTarget)) return;
        // If the cell itself is focused, wait a frame so that focus finishes propagating
        // up to the tree, and move focus to a focusable child if possible.
        requestAnimationFrame(()=>{
            if (focusMode === 'child' && (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getActiveElement */ .bq)((0, _utils_domHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getOwnerDocument */ .TW)(ref.current)) === ref.current) focus();
        });
    };
    let onKeyDown = (e)=>{
        let activeElement = (0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getActiveElement */ .bq)((0, _utils_domHelpers_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getOwnerDocument */ .TW)(ref.current));
        ...
        if (keyboardNavigationBehavior === 'tab') {
            ...
            if ((0, _utils_shadowdom_DOMFunctions_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getEventTarget */ .wt)(e) !== ref.current && e.key !== 'Tab') {
                e.stopPropagation();
                return;
            }
            if ($be7bed9611dd7497$var$handleTreeExpansionKeys(e, state, node, hasChildRows, direction, activeElement, ref.current, allowsArrowNavigation)) return;
    ...
    let syntheticLinkProps = (0, _utils_openLink_mjs__WEBPACK_IMPORTED_MODULE_13__/* .useSyntheticLinkProps */ .HI)(node.props);
    ...
    // }
    // oxlint-disable-next-line react/react-compiler
    let rowProps = (0, _utils_mergeProps_mjs__WEBPACK_IMPORTED_MODULE_8__/* .mergeProps */ .v)(itemProps, linkProps, {
        role: 'row',
        ...
        'aria-labelledby': descriptionId && (node['aria-label'] || node.textValue) ? `${(0, _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getRowId */ .uk)(state, node.key)} ${descriptionId}` : undefined,
        id: (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getRowId */ .uk)(state, node.key)
    });
    ...
    return {
        rowProps: {
            ...(0, _utils_mergeProps_mjs__WEBPACK_IMPORTED_MODULE_8__/* .mergeProps */ .v)(rowProps, treeGridRowProps)
        },
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   nV: () => (/* binding */ $c1c90317e8bffe4d$export$5b9bb410392e3991),
/* harmony export */   uk: () => (/* binding */ $c1c90317e8bffe4d$export$f45c25170b9a99c2)
/* harmony export */ });
