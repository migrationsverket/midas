...
'use client';var TextField_excluded=["className","form","list","ref","type"];var TextField=function TextField(_ref){var className=_ref.className,form=_ref.form,list=_ref.list,ref=_ref.ref,type=_ref.type,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,TextField_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(TextFieldBase/* TextFieldBase */.J,Object.assign({},rest,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Input,{className:(0,clsx/* default */.A)(className),form:form,list:list,ref:ref,type:type,skipContext:true})}));};
