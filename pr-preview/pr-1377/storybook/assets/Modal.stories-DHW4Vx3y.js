...
}`,...I.parameters?.docs?.source},description:{story:"Sticky footer via the `footer` prop — stays pinned to the bottom of the\nmodal while the body scrolls underneath it.",...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
