...
const site_docs_components_modal_mdx_902_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/modal","title":"Modal","description":"Modal som lägger sig över allt annat innehåll.","source":"@site/docs/components/modal.mdx","sourceDirName":"components","slug":"/components/modal","permalink":"/pr-preview/pr-1377/components/modal","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Modal","description":"Modal som lägger sig över allt annat innehåll."},"sidebar":"sideBar","previous":{"title":"Menu","permalink":"/pr-preview/pr-1377/components/menu"},"next":{"title":"Pagination","permalink":"/pr-preview/pr-1377/components/pagination"}}');
...
/* harmony default export */ const Modal_module = ({"modal":"modal_PJ14","dialog":"dialog_FDAr","modalHeader":"modalHeader_xDfh","modalTitle":"modalTitle_dMcA","modalBody":"modalBody_J9X6","modalFooter":"modalFooter_Ilx7"});
...
var _excluded=["children","title","hideCloseButton","footer"];var Modal_Modal=/*#__PURE__*/(0,react.forwardRef)(function(_ref,ref){var children=_ref.children,title=_ref.title,_ref$hideCloseButton=_ref.hideCloseButton,hideCloseButton=_ref$hideCloseButton===void 0?false:_ref$hideCloseButton,footer=_ref.footer,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return/*#__PURE__*/(0,jsx_runtime.jsx)(ModalOverlay/* ModalOverlay */.m,Object.assign({},rest,{children:(0,utils/* composeRenderProps */.HW)(children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsx)(Modal/* Modal */.aF,{className:Modal_module.modal,ref:ref,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Dialog/* Dialog */.lG,{className:Modal_module.dialog,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Modal_module.modalHeader,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Modal_module.modalTitle,children:title&&/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* Heading */.D,{level:3,elementType:"h2",slot:"title",children:title})}),!hideCloseButton&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{slot:"close",variant:"tertiary",icon:x/* default */.A,iconPlacement:"right",children:strings.format('close')})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Modal_module.modalBody,tabIndex:-1,children:children}),footer&&/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Modal_module.modalFooter,children:footer})]})});})}));});Modal_Modal.displayName='Modal';
