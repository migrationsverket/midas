...
const site_docs_basics_icons_mdx_79d_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/icons","title":"Ikoner","description":"Ikoner används som ett komplement till text för att underlätta för användaren. Midas använder Lucide Icons som ikonbibliotek. Vi använder ikonerna direkt från Lucide, utan några modifieringar.","source":"@site/docs/basics/icons.mdx","sourceDirName":"basics","slug":"/basics/icons","permalink":"/pr-preview/pr-1319/basics/icons","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"id":"icons","title":"Ikoner","sidebar_position":3},"sidebar":"sideBar","previous":{"title":"Färger","permalink":"/pr-preview/pr-1319/basics/tokens"},"next":{"title":"Språk","permalink":"/pr-preview/pr-1319/basics/language"}}');
