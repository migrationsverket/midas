...
const site_docs_components_tooltip_mdx_1e8_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/tooltip","title":"Tooltip","description":"Tooltip kan användas för att förklara en knapp eller annan interaktion när det inte går att få plats med informationen i knappen.","source":"@site/docs/components/tooltip.mdx","sourceDirName":"components","slug":"/components/tooltip","permalink":"/pr-preview/pr-1113/components/tooltip","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tooltip","description":"Tooltip kan användas för att förklara en knapp eller annan interaktion när det inte går att få plats med informationen i knappen."},"sidebar":"sideBar","previous":{"title":"Toast","permalink":"/pr-preview/pr-1113/components/toast"},"next":{"title":"Knappar och länkar","permalink":"/pr-preview/pr-1113/design-patterns/buttons-and-links"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
