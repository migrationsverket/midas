...
const site_docs_basics_language_mdx_558_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/language","title":"Språk","description":"När vi skriver texter för Migrationsverkets digitala kanaler och tjänster utgår vi från Myndigheternas skrivregler, som är Språkrådets vägledning för alla som skriver inom offentlig verksamhet.","source":"@site/docs/basics/language.mdx","sourceDirName":"basics","slug":"/basics/language","permalink":"/pr-preview/pr-646/basics/language","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"language","title":"Språk","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
