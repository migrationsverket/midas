...
var TextField = __webpack_require__(58081);
...
// EXTERNAL MODULE: ./packages/components/src/textfield/intl/translations.json
var translations = __webpack_require__(66248);
;// ./packages/components/src/textfield/SuccessMessage.tsx
var SuccessMessage=function SuccessMessage(_ref){var children=_ref.children;var fieldErrorContext=react.useContext(dist_FieldError/* FieldErrorContext */.C);var stringFormatter=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations);if(fieldErrorContext!=null&&fieldErrorContext.isInvalid){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,utils_clsx/* default */.A)(TextField_module/* default */.A.successMessage),slot:"errorMessage",children:children||stringFormatter.format('validationSuccessful')});};
;// ./packages/components/src/textfield/TextFieldBase.tsx
var TextFieldBase=/*#__PURE__*/react.forwardRef(function(props,ref){var _clsx;;var _useContextProps=(0,utils/* useContextProps */.JT)(props,ref,TextField/* TextFieldContext */.H);props=_useContextProps[0];var _props=props,label=_props.label,description=_props.description,errorMessage=_props.errorMessage,showCounter=_props.showCounter,_props$errorPosition=_props.errorPosition,errorPosition=_props$errorPosition===void 0?'top':_props$errorPosition,_props$size=_props.size,size=_props$size===void 0?'large':_props$size,popover=_props.popover,children=_props.children,isValid=_props.isValid,validationMessage=_props.validationMessage;return/*#__PURE__*/(0,jsx_runtime.jsxs)(TextField/* TextField */.A,Object.assign({},props,{className:(0,clsx/* clsx */.$)(TextField_module/* default */.A.textField,(_clsx={},_clsx[TextField_module/* default */.A.medium]=size==='medium',_clsx)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(LabelWrapper/* LabelWrapper */.cR,{popover:popover,children:label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:label})}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:description}),showCounter&&/*#__PURE__*/(0,jsx_runtime.jsx)(CharacterCounter,{isLonely:!description}),errorPosition==='top'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),isValid&&/*#__PURE__*/(0,jsx_runtime.jsx)(SuccessMessage,{children:validationMessage})]}),children,errorPosition==='bottom'&&/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",className:TextField_module/* default */.A.bottomError,children:errorMessage}),isValid&&/*#__PURE__*/(0,jsx_runtime.jsx)(SuccessMessage,{children:validationMessage})]})]}));});
...
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
// EXTERNAL MODULE: ./packages/components/src/textfield/TextFieldBase.tsx + 3 modules
var TextFieldBase = __webpack_require__(54284);
// EXTERNAL MODULE: ./node_modules/react-aria-components/dist/Input.mjs
var Input = __webpack_require__(79950);
// EXTERNAL MODULE: ./packages/components/src/utils/clsx.ts
var clsx = __webpack_require__(1160);
...
module.exports = /*#__PURE__*/JSON.parse('{"en":{"hide":"Hide","show":"Show","validationSuccessful":"Validation successful!"},"sv":{"hide":"Dölj","show":"Visa","validationSuccessful":"Validering lyckades!"}}');
...
/* harmony export */ });
// extracted by mini-css-extract-plugin
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"textField":"textField_IarX","bottomError":"bottomError_XU77","textArea":"textArea_M6yF","wrap":"wrap_ljmz","medium":"medium_jalb","input":"input_g6A6","passwordText":"passwordText_gBIs","passwordButton":"passwordButton_kacG","successMessage":"successMessage_YY5m"});
