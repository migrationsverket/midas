...
// EXTERNAL MODULE: ./packages/components/src/utils/intl/useLocalizedStringFormatter.ts
var useLocalizedStringFormatter = __webpack_require__(88413);
;// ./packages/components/src/validation-text/intl/translations.json
...
;// ./packages/components/src/validation-text/ValidationText.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const ValidationText_module = ({"validationText":"validationText_uZmm","error":"error_cPVE","success":"success_eAAN"});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/validation-text/Message.tsx
var Message=function Message(_ref){var children=_ref.children,className=_ref.className;return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(ValidationText_module.validationText,className),slot:"errorMessage",children:children});};
;// ./packages/components/src/validation-text/ValidationText.tsx
var _excluded=["className","isInvalid","message","validationSuccessful"];var ValidationText=function ValidationText(_ref){var className=_ref.className,isInvalid=_ref.isInvalid,message=_ref.message,validationSuccessful=_ref.validationSuccessful,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var context=react.useContext(FieldError/* FieldErrorContext */.C);var stringFormatter=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);if(!context&&isInvalid&&message&&typeof rest.children!=='function'){return/*#__PURE__*/(0,jsx_runtime.jsx)(Message,{className:(0,clsx/* default */.A)(ValidationText_module.error,className),children:message});}if(!(context!=null&&context.isInvalid)){return validationSuccessful?/*#__PURE__*/(0,jsx_runtime.jsx)(Message,{className:(0,clsx/* default */.A)(ValidationText_module.success,className),children:message||stringFormatter.format('validationSuccessful')}):null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,Object.assign({},rest,{className:(0,clsx/* default */.A)(ValidationText_module.validationText,ValidationText_module.error,className)}));};
...
// EXTERNAL MODULE: ./packages/components/src/text/Text.tsx + 1 modules
var Text = __webpack_require__(19615);
// EXTERNAL MODULE: ./packages/components/src/validation-text/ValidationText.tsx + 3 modules
var ValidationText = __webpack_require__(22515);
// EXTERNAL MODULE: ./node_modules/react-aria-components/dist/Input.mjs
var Input = __webpack_require__(79950);
...
var TextFieldBase=/*#__PURE__*/react.forwardRef(function(props,ref){var _clsx;;var _useContextProps=(0,utils/* useContextProps */.JT)(props,ref,TextField/* TextFieldContext */.H);props=_useContextProps[0];var _props=props,label=_props.label,description=_props.description,errorMessage=_props.errorMessage,showCounter=_props.showCounter,_props$errorPosition=_props.errorPosition,errorPosition=_props$errorPosition===void 0?'top':_props$errorPosition,_props$size=_props.size,size=_props$size===void 0?'large':_props$size,popover=_props.popover,children=_props.children,validationSuccessful=_props.validationSuccessful;return/*#__PURE__*/(0,jsx_runtime.jsxs)(TextField/* TextField */.A,Object.assign({},props,{className:(0,clsx/* clsx */.$)(TextField_module/* default */.A.textField,(_clsx={},_clsx[TextField_module/* default */.A.medium]=size==='medium',_clsx)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(LabelWrapper/* LabelWrapper */.cR,{popover:popover,children:label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{children:label})}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:description}),showCounter&&/*#__PURE__*/(0,jsx_runtime.jsx)(CharacterCounter,{isLonely:!description}),errorPosition==='top'&&/*#__PURE__*/(0,jsx_runtime.jsx)(ValidationText/* ValidationText */.t,{validationSuccessful:validationSuccessful,"data-testid":"validationText",children:errorMessage}),children,errorPosition==='bottom'&&/*#__PURE__*/(0,jsx_runtime.jsx)(ValidationText/* ValidationText */.t,{validationSuccessful:validationSuccessful,"data-testid":"validationText",className:TextField_module/* default */.A.bottomError,children:errorMessage})]}));});
...
const site_docs_dev_localization_mdx_e78_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/localization","title":"Lokalisering","description":"React Aria har en rad inbyggda funktioner som underlättar skapandet av tillgängliga","source":"@site/docs/dev/localization.mdx","sourceDirName":"dev","slug":"/dev/localization","permalink":"/pr-preview/pr-862/dev/localization","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Lokalisering","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
