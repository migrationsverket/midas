...
const site_docs_get_started_contribute_tests_mdx_85e_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"get-started/contribute/tests","title":"Tester","description":"Automatiska tester i Midas utgörs främst av komponenttester. Komponenttester testar interaktionen av renderade komponenter i en riktig eller emulerad webbläsare.","source":"@site/docs/get-started/contribute/tests.mdx","sourceDirName":"get-started/contribute","slug":"/get-started/contribute/tests","permalink":"/pr-preview/pr-969/get-started/contribute/tests","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"sidebar_label":"Tester","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
const toc = [{
  ...
  "value": "Lokala snapshottester",
  "id": "lokala-snapshottester",
  "level": 3
}];
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["Midas använder ", (0,jsx_runtime.jsx)(_components.a, {
        ...
        children: "Storybooks portable stories"
      ...
      children: ["Tester som använder Storybooks portable stories kan köras via terminalen med hjälp av ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://storybook.js.org/docs/writing-tests/integrations/vitest-addon",
        children: "Storybook Vitest addon"
      ...
      }), " bör den användas som en sista utväg."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "tillgänglighetstester",
      children: "Tillgänglighetstester"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      ...
      id: "lokala-snapshottester",
      children: "Lokala snapshottester"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Vi använder ", (0,jsx_runtime.jsx)(_components.a, {
        href: "https://github.com/repobuddy/visual-testing",
        children: "Storybook Vitest visual testing addon"
      }), " för lokala snapshottester.\nPluginet utgår från Storybook stories och tar bilder i ljust-, mörkt- och högkontrast-läge."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Kör snapshottester lokalt med"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-bash",
        children: "nx snapshot storybook\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Om du har lagt till en komponent, kör gärna snapshottester för samtliga lägen för att generera underlag för framtida jämförelser."
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-bash",
        children: "nx run storybook:snapshot && nx run storybook:snapshot:dark && nx run storybook:snapshot:forced-colors\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Om du har justerat en komponent och dina snapshottester förväntas faila behöver du uppdatera underlaget.\nEnklast är att radera allt underlag och sedan köra alla tester:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-bash",
        children: "rm -rf /path/to/midas/apps/storybook/__vis__ && nx run storybook:snapshot && nx run storybook:snapshot:dark && nx run storybook:snapshot:forced-colors\n"
      })
    })]
  });
}
