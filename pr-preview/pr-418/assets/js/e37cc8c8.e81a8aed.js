...
const site_docs_basics_tokens_mdx_e37_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/tokens","title":"Färger och tokens","description":"Här kan du läsa om hur vi använder färger i Midas och hur de är tokeniserade. Tokens är en del av vår design och används för att skapa enhetlighet i våra produkter. Vi har definierat ett antal paletter som används i designsystemets komponenter.","source":"@site/docs/basics/tokens.mdx","sourceDirName":"basics","slug":"/basics/tokens","permalink":"/pr-preview/pr-418/basics/tokens","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"tokens","title":"Färger och tokens","sidebar_label":"Färger","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "Här kan du läsa om hur vi använder färger i Midas och hur de är tokeniserade. Tokens är en del av vår design och används för att skapa enhetlighet i våra produkter. Vi har definierat ett antal paletter som används i designsystemets komponenter."
    }), "\n", (0,jsx_runtime.jsx)("div", {
      style: {
        display: 'flex',
        flexFlow: 'row wrap',
      ...
      children: "Referenstokens är direkt kopplade till färgvärden och används för att bygga upp våra paletter. Varje palett har 20 steg, från 10 (ljusast) ill 200 (mörkast). Referenstokens används endast som byggstenar och ska inte användas direkt i koden."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "semantiska-tokens",
      children: "Semantiska tokens"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Semantiska tokens är kopplade till referenstokens. De är döpta för att beskriva vart de bör användas.\nanvänds för att sätta en färg på element i både ljust och mörk läge. Nedan ser vi ett enkelt exempel med bakgrund och text med ett token men olika färger i ljust respektive mörkt läge."
