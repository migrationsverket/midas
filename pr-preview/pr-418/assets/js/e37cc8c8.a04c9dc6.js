...
const site_docs_basics_tokens_mdx_e37_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/tokens","title":"Färger och tokens","description":"Här kan du läsa om hur vi använder färger i Midas. Vi använder i huvudsak en gråskala och en blå skala som grund för våra gränssnitt. Gråskalan används främst för bakgrunder, ramar och typografi, medan den blå skalan fungerar som vår primära accentfärg för interaktiva element. Genom att bygga upp interfacet med dessa två paletter skapar vi ett tydligt, tillgängligt och konsekvent uttryck i hela designsystemet.","source":"@site/docs/basics/tokens.mdx","sourceDirName":"basics","slug":"/basics/tokens","permalink":"/pr-preview/pr-418/basics/tokens","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"tokens","title":"Färger och tokens","sidebar_label":"Färger","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "Det finns två lager: layer01 och layer02. Dessa lager används för att skapa djup och hierarki i designen. De används också för att separera olika delar av gränssnittet."
    }), "\n", (0,jsx_runtime.jsxs)(Flex/* Flex */.s, {
      fluid: true,
      className: "docs-card",
      children: [(0,jsx_runtime.jsx)(FlexItem/* FlexItem */.Z, {
