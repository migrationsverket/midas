...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "Lager används för att separera olika delar av gränssnittet. Våra färglägen har olika lagerstrutur: I ljust läge är varannat lager vitt och varannat grått och i mörkt läge är varje lager en ljusare grå än det föregående."
    }), "\n", (0,jsx_runtime.jsxs)(Flex/* Flex */.s, {
      fluid: true,
      className: "docs-card",
      children: [(0,jsx_runtime.jsx)(FlexItem/* FlexItem */.Z, {
