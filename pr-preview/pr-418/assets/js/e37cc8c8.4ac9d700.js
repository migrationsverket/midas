...
const site_docs_basics_tokens_mdx_e37_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/tokens","title":"Färger och tokens","description":"Här kan du läsa om hur vi använder färger i Midas och hur de är tokeniserade. Tokens är en del av vår design och används för att skapa enhetlighet och konsekvens i våra produkter. Vi har definierat ett antal färger, typsnitt och storlekar som används genom hela vår plattform.","source":"@site/docs/basics/tokens.mdx","sourceDirName":"basics","slug":"/basics/tokens","permalink":"/pr-preview/pr-418/basics/tokens","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"tokens","title":"Färger och tokens","sidebar_label":"Färger","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      children: "Här kan du läsa om hur vi använder färger i Midas och hur de är tokeniserade. Tokens är en del av vår design och används för att skapa enhetlighet och konsekvens i våra produkter. Vi har definierat ett antal färger, typsnitt och storlekar som används genom hela vår plattform."
    }), "\n", (0,jsx_runtime.jsx)("div", {
      style: {
        display: 'flex',
        flexFlow: 'row wrap',
      ...
      children: Object.entries(tokens.baseColors).filter(([key]) => key.startsWith('gray') || key.startsWith('blue') || key.startsWith('signal')).map(([key, value]) => (0,jsx_runtime.jsx)("div", {
        style: {
      ...
      children: "Färger är uppdelade i två grupper: referens och semantiska färger. Referensfärger är de grundläggande enskilda färgvärdena som används för att bygga upp vår palett."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Semantiska färger används för att sätta en färg på element i både ljust och mörk läge. De är döpta för att beskriva vart de bör användas. Nedan ser vi ett enkelt exempel med bakgrund och text med ett token men olika färger i ljust respektive mörkt läge."
      ...
      children: [(0,jsx_runtime.jsx)(Token, {
        ...
        token: "iconInverse",
        desc: "Inverterad ikonfärg. Ljus ikon i ljust läge och mörk ikon i mörkt läge. För färgade plattor har vi iconOnColor"
      }), (0,jsx_runtime.jsx)(Token, {
        token: "iconOnColor",
