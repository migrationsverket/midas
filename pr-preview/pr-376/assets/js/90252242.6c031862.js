...
if(selectionMode==='single'){triggerState.close();}}}));var validationState=(0,useFormValidationState/* useFormValidationState */.KZ)(Object.assign({},props,{validationBehavior:'native',value:selectionMode==='single'?(_multiSelectListState=multiSelectListState.selectedKeys.values().next().value)==null?void 0:_multiSelectListState.toString():singleSelectListState.selectedKey}));// Reset validation for single selects when the selected key changes.
(0,react.useEffect)(function(){if(selectionMode==='single'&&singleSelectListState.selectedKey){validationState.resetValidation();validationState.commitValidation();}},[selectionMode,singleSelectListState.selectedKey,validationState]);return Object.assign({},Object.assign({},multiSelectListState,singleSelectListState,{selectionManager:selectionMode==='multiple'?multiSelectListState.selectionManager:singleSelectListState.selectionManager}),triggerState,{close:function close(){triggerState.close();if(multiSelectListState.selectedKeys.size){validationState.resetValidation();validationState.commitValidation();}},open:function open(){// Don't open if the collection is empty.
if(multiSelectListState.collection.size!==0){triggerState.open();}},toggle:function toggle(focusStrategy){if(multiSelectListState.collection.size!==0){triggerState.toggle(focusStrategy);}},isFocused:isFocused,setFocused:setFocused},validationState);}
// EXTERNAL MODULE: ./node_modules/lucide-react/dist/esm/icons/x.js
var x = __webpack_require__(48697);
...
if(state.collection.size<=300){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",Object.assign({},containerProps,{"data-testid":"hidden-select-container",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("label",{children:[label,/*#__PURE__*/(0,jsx_runtime.jsxs)("select",Object.assign({},selectProps,{ref:selectRef,multiple:state.selectionMode==='multiple',children:[/*#__PURE__*/(0,jsx_runtime.jsx)("option",{}),[].concat(state.collection.getKeys()).map(function(key){var item=state.collection.getItem(key);if(item&&item.type==='item'){return/*#__PURE__*/(0,jsx_runtime.jsx)("option",{value:item.key,children:item.textValue},item.key);}return null;})]}))]})}));}else if(name){var _state$selectedKeys$v,_state$selectedKeys$v2,_Array$from$map;return/*#__PURE__*/(0,jsx_runtime.jsx)("input",{type:"hidden",autoComplete:selectProps.autoComplete,name:name,disabled:isDisabled,value:state.selectionMode==='single'?(_state$selectedKeys$v=(_state$selectedKeys$v2=state.selectedKeys.values().next().value)==null?void 0:_state$selectedKeys$v2.toString())!=null?_state$selectedKeys$v:'':(_Array$from$map=Array.from(state.selectedKeys).map(function(key){return key.toString();}))!=null?_Array$from$map:''});}return null;}
