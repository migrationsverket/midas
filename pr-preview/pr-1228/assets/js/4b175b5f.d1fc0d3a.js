...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Skeleton_module = ({"skeleton":"skeleton_r1UF","circle":"circle_V2WO","wave":"wave_h9Fk","onLayer01":"onLayer01_cFCw","form":"form_BsfF","formLabel":"formLabel_UDUU","formDescription":"formDescription_exJe","formInput":"formInput_vJyM","medium":"medium_FZ9R"});
// EXTERNAL MODULE: ./packages/components/src/utils/clsx.ts
var clsx = __webpack_require__(1160);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/skeleton/Skeleton.tsx
var _excluded=["variant","width","height","size","isAnimated","className","style","isOnLayer01"];var Skeleton=function Skeleton(_ref){var _ref$variant=_ref.variant,variant=_ref$variant===void 0?'rectangle':_ref$variant,width=_ref.width,height=_ref.height,_ref$size=_ref.size,size=_ref$size===void 0?'large':_ref$size,_ref$isAnimated=_ref.isAnimated,isAnimated=_ref$isAnimated===void 0?true:_ref$isAnimated,className=_ref.className,style=_ref.style,isOnLayer01=_ref.isOnLayer01,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);if(variant==='circle'&&height!==undefined){console.warn('Height is not allowed when using circle, control size with width');}if(variant==='form'){return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",Object.assign({className:(0,clsx/* default */.A)(Skeleton_module.form,Skeleton_module[size],isOnLayer01&&Skeleton_module.onLayer01,className),style:Object.assign({width:width},style)},rest,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module.formLabel,isAnimated&&Skeleton_module.wave,isOnLayer01&&Skeleton_module.onLayer01)}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module.formDescription,isAnimated&&Skeleton_module.wave,isOnLayer01&&Skeleton_module.onLayer01)}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module.formInput,isAnimated&&Skeleton_module.wave,isOnLayer01&&Skeleton_module.onLayer01)})]}));}return/*#__PURE__*/(0,jsx_runtime.jsx)("div",Object.assign({className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module[variant],isAnimated&&Skeleton_module.wave,isOnLayer01&&Skeleton_module.onLayer01,className),style:Object.assign({width:width,height:height},style)},rest));};
...
const site_docs_design_patterns_page_loading_mdx_4b1_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/page-loading","title":"Laddningsindikatorer","description":"Laddningsindikatorer är visuella platshållare för komponenter eller information som visas medan de laddar. Detta mönster beskriver hur och när vi använder olika laddningsindikatorer.","source":"@site/docs/design-patterns/page-loading.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/page-loading","permalink":"/pr-preview/pr-1228/design-patterns/page-loading","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{},"sidebar":"sideBar","previous":{"title":"Formulär","permalink":"/pr-preview/pr-1228/design-patterns/forms"},"next":{"title":"Read-only","permalink":"/pr-preview/pr-1228/design-patterns/read-only"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
var ButtonLoadingExample=function ButtonLoadingExample(){var _useState=(0,react.useState)(false),isPending=_useState[0],setPending=_useState[1];function handlePress(){return _handlePress.apply(this,arguments);}function _handlePress(){_handlePress=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee(){return (0,regenerator/* default */.A)().w(function(_context){while(1)switch(_context.n){case 0:setPending(true);// Simulate a slow API call
_context.n=1;return new Promise(function(resolve){return setTimeout(resolve,2000);});case 1:setPending(false);// Show success toast
Toast/* toastQueue */.ni.add({message:'Formuläret skickades!',type:'success'},{timeout:5000});case 2:return _context.a(2);}},_callee);}));return _handlePress.apply(this,arguments);}return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Toast/* GlobalToastRegion */.r$,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange ditt namn",description:"B\xE5de f\xF6r och efternamn"})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:{xs:12,sm:12,md:2,lg:2},children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{isPending:isPending,onPress:handlePress,children:isPending?'Skickar...':'Skicka'})})]})});};var InlineSpinnerExample=function InlineSpinnerExample(){var _useState2=(0,react.useState)(false),isChecking=_useState2[0],setIsChecking=_useState2[1];function handleBlur(){return _handleBlur.apply(this,arguments);}function _handleBlur(){_handleBlur=(0,asyncToGenerator/* default */.A)(/*#__PURE__*/(0,regenerator/* default */.A)().m(function _callee2(){return (0,regenerator/* default */.A)().w(function(_context2){while(1)switch(_context2.n){case 0:setIsChecking(true);// Simulate an async database check
_context2.n=1;return new Promise(function(resolve){return setTimeout(resolve,2500);});case 1:setIsChecking(false);case 2:return _context2.a(2);}},_callee2);}));return _handleBlur.apply(this,arguments);}return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Grid/* Grid */.x,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:12,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"field-and-spinner",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Ange ditt kortnummer",description:"Ditt kortnummer kontrolleras mot databasen. Det kan ta en liten stund",onBlur:handleBlur}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"spinner-box",children:isChecking&&/*#__PURE__*/(0,jsx_runtime.jsx)(Spinner/* Spinner */.y,{small:true})})]})}),/*#__PURE__*/(0,jsx_runtime.jsx)(GridItem/* GridItem */.E,{size:"auto",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{isDisabled:isChecking,children:isChecking?'Skicka':'Skicka'})})]})});};var SkeletonExample=function SkeletonExample(){var _useState3=(0,react.useState)(true),isLoading=_useState3[0],setIsLoading=_useState3[1];(0,react.useEffect)(function(){// Simulate data fetch delay
...
const toc = [{
  ...
  "value": "Spinner bredvid ett fält",
  "id": "spinner-bredvid-ett-fält",
  "level": 2
}];
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: (0,jsx_runtime.jsx)(_components.p, {
        children: "Använd laddningsindikatorer för operationer som förväntas ta mer än en sekund, för att udvika ett flimrande gränssnitt"
      })
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: "Vi använder inte Skeleton om vi inte vet hur innehållet ska se ut när det laddat klart. Då använder vi helskärmsspinner."
      }), "\n"]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Visa ", (0,jsx_runtime.jsx)(_components.a, {
          ...
          children: "Spinner"
        }), " centrerat på skärmen och tona ner bakgrunden."]
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Vi använder inte helskärmsspinner om vi vet hur gränssnittet kommer att se ut när det laddat klart. Då använder vi Skeleton."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Använd inte helskärmsspinner om endast en del av sidan laddas. Använd Spinner eller Skeleton på komponenten/delen istället"
      }), "\n"]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Använd prop ", (0,jsx_runtime.jsx)(_components.code, {
          ...
          children: "Button"
        }), ". Du kan ", (0,jsx_runtime.jsx)(_components.a, {
          href: "https://react-spectrum.adobe.com/react-aria/Button.html#pending",
          children: "läsa mer om det och se ett exempel hos React Aria"
        })]
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Ändra texten i knappen till presensformen av verbet (skicka -> skickar) under tiden som det laddar"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Meddela användaren när systemet laddat klart, tex med en toast"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(ButtonLoadingExample, {}), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "spinner-bredvid-ett-fält",
      children: "Spinner bredvid ett fält"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Används när det är ett fält som laddar, tex vid kontroll mot databas direkt när användaren lämnar fältet. Optimalt ska detta inte ta så lång tid att användaren behöver vänta, men i de fall där anropen tar lång tid kan en spinner läggas bredvid fältet som laddar. I nedan exempel syns en spinner så fort du lämnar fältet."
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["Visa en ", (0,jsx_runtime.jsx)(_components.code, {
          children: "small"
        ...
        children: "Använd inte spinner bredvid fält när kontrollen/valideringen sker vid submit. Då använder vi helskärmsspinner."
      }), "\n"]
