...
'use client';var Sidebar_excluded=["children","className","title"];var Sidebar=function Sidebar(_ref){var _clsx,_clsx2,_clsx3,_clsx4;var children=_ref.children,className=_ref.className,title=_ref.title,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Sidebar_excluded);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var isMobileDevice=(0,useIsMobileDevice/* useIsMobileDevice */.o)();var _useControlledState=(0,useControlledState/* useControlledState */.P)(props.isCollapsed,props.defaultCollapsed||false,props.onCollapseChange),isCollapsed=_useControlledState[0],setIsCollapsed=_useControlledState[1];var _React$useState=react.useState(false),isTransitioning=_React$useState[0],setIsTransitioning=_React$useState[1];var handlePress=function handlePress(){setIsTransitioning(true);setIsCollapsed(function(previouslyCollapsed){return!previouslyCollapsed;});};var handleTransitionEnd=function handleTransitionEnd(e){if(e.propertyName==='width'&&e.target===e.currentTarget){setIsTransitioning(false);}};return isMobileDevice?null:/*#__PURE__*/(0,jsx_runtime.jsx)(SidebarContext/* SidebarContext */.I.Provider,{value:{isCollapsed:isCollapsed},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelBody,Object.assign({className:(0,clsx/* default */.A)(className,Sidebar_module.sidebar,(_clsx={},_clsx[Sidebar_module.collapsed]=isCollapsed,_clsx)),"data-transitioning":isTransitioning||undefined,onTransitionEnd:handleTransitionEnd},$65484d02dcb7eb3e$export$457c3d6518dd4c6f(props,{propNames:new Set(['style'])}),{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelHeader,{className:(0,clsx/* default */.A)(Sidebar_module.sidebarHeader,(_clsx2={},_clsx2[Sidebar_module.collapsed]=isCollapsed,_clsx2)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(PanelTitle,{className:(0,clsx/* default */.A)(Sidebar_module.sidebarTitle,(_clsx3={},_clsx3[Sidebar_module.collapsed]=isCollapsed,_clsx3)),title:title}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":isCollapsed?strings.format('expandSidebar'):strings.format('collapseSidebar'),onPress:handlePress,variant:"icon",size:"medium",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(Sidebar_module.collapseButton,(_clsx4={},_clsx4[Sidebar_module.collapsed]=isCollapsed,_clsx4)),children:/*#__PURE__*/(0,jsx_runtime.jsx)(panel_left_close/* default */.A,{size:20})})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(PanelContent,{className:Sidebar_module.sidebarContent,children:children})]}))});};
