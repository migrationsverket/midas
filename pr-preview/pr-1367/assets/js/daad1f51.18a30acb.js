...
const site_docs_design_patterns_page_layout_only_header_mdx_daa_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/page-layout/header","title":"Applikationer utan huvudmeny","description":"Detta mönster är till för applikationer som inte behöver en meny för att navigera mellan flera delar. Headern kan innehålla globala handlingar, till exempel notifieringar, profil och inställningar.","source":"@site/docs/design-patterns/page-layout/only-header.mdx","sourceDirName":"design-patterns/page-layout","slug":"/design-patterns/page-layout/header","permalink":"/pr-preview/pr-1367/design-patterns/page-layout/header","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"id":"header","title":"Applikationer utan huvudmeny","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Tooltip","permalink":"/pr-preview/pr-1367/components/tooltip"},"next":{"title":"Applikationer med sidomeny","permalink":"/pr-preview/pr-1367/design-patterns/page-layout/header-sidebar-panel"}}');
