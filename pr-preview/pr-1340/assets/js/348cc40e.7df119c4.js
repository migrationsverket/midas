...
const site_docs_components_layout_mdx_348_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout","title":"Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud.","source":"@site/docs/components/layout.mdx","sourceDirName":"components","slug":"/components/layout","permalink":"/pr-preview/pr-1340/components/layout","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Layout","description":"En skalkomponent för att få en simpel sidomeny och sidhuvud."},"sidebar":"sideBar","previous":{"title":"InfoBanner","permalink":"/pr-preview/pr-1340/components/info-banner"},"next":{"title":"LinkButton","permalink":"/pr-preview/pr-1340/components/link-button"}}');
