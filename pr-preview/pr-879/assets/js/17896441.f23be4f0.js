...
// UNUSED EXPORTS: SelectContainer
...
// EXTERNAL MODULE: ./packages/components/src/label/LabelWrapper.tsx + 3 modules
var LabelWrapper = __webpack_require__(73202);
// EXTERNAL MODULE: ./node_modules/@react-stately/select/dist/useSelectState.mjs
var useSelectState = __webpack_require__(45999);
// EXTERNAL MODULE: ./node_modules/@react-aria/select/dist/useSelect.mjs
var useSelect = __webpack_require__(55437);
// EXTERNAL MODULE: ./node_modules/@react-aria/select/dist/HiddenSelect.mjs
var HiddenSelect = __webpack_require__(55996);
;// ./packages/components/src/select/Select.tsx
var Select_excluded=["isClearable","popover","selectRef"],_excluded2=["options"];var SelectComponent=function SelectComponent(_ref){var _state$value;var _ref$isClearable=_ref.isClearable,isClearable=_ref$isClearable===void 0?true:_ref$isClearable,popover=_ref.popover,selectRef=_ref.selectRef,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Select_excluded);var props=Object.assign({errorPosition:'top',isClearable:isClearable,size:'large',popover:popover,selectRef:selectRef},rest);var triggerRef=(0,useObjectRef/* useObjectRef */.U)(selectRef);var state=(0,useSelectState/* useSelectState */.n)(props);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var _useSelect=(0,useSelect/* useSelect */.W)(props,state,triggerRef),labelProps=_useSelect.labelProps,triggerProps=_useSelect.triggerProps,valueProps=_useSelect.valueProps,menuProps=_useSelect.menuProps,hiddenSelectProps=_useSelect.hiddenSelectProps;var _useObserveElement=(0,useObserveElement/* default */.A)(triggerRef.current,{includePadding:true}),triggerWidth=_useObserveElement.width;var handleSelectAll=function handleSelectAll(){if(state.selectionManager.isSelectAll){return state.selectionManager.clearSelection();}return state.setValue(Array.from(state.collection.getKeys()));};return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(Select_module.wrapper,props.className),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HiddenSelect/* HiddenSelect */.H,Object.assign({},hiddenSelectProps,{label:props.label+"-hidden"})),/*#__PURE__*/(0,jsx_runtime.jsx)(LabelWrapper/* LabelWrapper */.cR,{popover:popover,children:props.label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,Object.assign({},labelProps,{"data-disabled":props.isDisabled||undefined,children:props.label}))}),props.description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:props.description}),props.errorPosition==='top'&&/*#__PURE__*/(0,jsx_runtime.jsx)(SelectFieldError,Object.assign({},props,{state:state})),/*#__PURE__*/(0,jsx_runtime.jsx)(SelectTrigger,Object.assign({},props,triggerProps,{value:triggerProps.value,isInvalid:state.displayValidation.isInvalid,triggerRef:triggerRef,state:state,children:props.selectionMode==='multiple'&&typeof state.value!=='number'&&state!=null&&(_state$value=state.value)!=null&&_state$value.length?/*#__PURE__*/(0,jsx_runtime.jsx)("span",Object.assign({},valueProps,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(MultiSelectValueTag,Object.assign({},props,{state:state,parentWidth:triggerWidth,onClear:function onClear(){return state.selectionManager.clearSelection();},triggerRef:triggerRef}))})):null})),props.errorPosition==='bottom'&&/*#__PURE__*/(0,jsx_runtime.jsx)(SelectFieldError,Object.assign({},props,{state:state})),/*#__PURE__*/(0,jsx_runtime.jsxs)(ListBoxPopover/* ListBoxPopover */.f,{isOpen:state.isOpen,onOpenChange:function onOpenChange(isOpen){if(!isOpen){state.close();}},triggerRef:triggerRef,style:{width:triggerWidth},children:[props.isSelectableAll&&/*#__PURE__*/(0,jsx_runtime.jsx)(Checkbox/* Checkbox */.S,{isSelected:state.selectionManager.isSelectAll,isIndeterminate:!state.selectionManager.isSelectAll&&!state.selectionManager.isEmpty,className:Select_module.selectAll,onChange:handleSelectAll,children:strings.format('selectAll')}),/*#__PURE__*/(0,jsx_runtime.jsx)(SelectListBox,Object.assign({},menuProps,{disallowEmptySelection:!props.isClearable,state:state}))]}),props.showTags&&!!state.selectedItems&&/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* TagGroup */.C,{"aria-label":strings.format('selectedItems'),selectionBehavior:"toggle",onRemove:function onRemove(keys){state.selectionManager.toggleSelection(Array.from(keys)[0]);},className:Select_module.tagGroup,children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagList */.LY,{items:state.selectedItems,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{textValue:item.textValue,id:item.key,dismissable:true,isDisabled:props.isDisabled,children:item.textValue},item.key);}})})]});};var SelectContainer=function SelectContainer(_ref2,ref){var options=_ref2.options,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref2,_excluded2);return/*#__PURE__*/(0,jsx_runtime.jsx)(SelectComponent,Object.assign({},props,{items:options,selectRef:ref,children:function children(section){return section.children?/*#__PURE__*/(0,jsx_runtime.jsx)(Section/* Section */.w,{items:section.children,title:section.name,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Item/* Item */.q,{textValue:item.textValue,children:item.name});}},section.name):/*#__PURE__*/(0,jsx_runtime.jsx)(Item/* Item */.q,{textValue:section.textValue,children:section.name});}}));};var Select=/*#__PURE__*/react.forwardRef(SelectContainer);
...
var Select = __webpack_require__(43268);
