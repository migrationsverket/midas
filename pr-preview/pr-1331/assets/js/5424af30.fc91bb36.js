...
const site_docs_dev_layout_components_sidebar_mdx_542_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/sidebar","title":"Sidebar","description":"Kollapsbar sidomeny för desktop.","source":"@site/docs/dev/layout/components/sidebar.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/sidebar","permalink":"/pr-preview/pr-1331/dev/layout/components/sidebar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Sidebar","description":"Kollapsbar sidomeny för desktop."},"sidebar":"sideBar","previous":{"title":"Panel","permalink":"/pr-preview/pr-1331/dev/layout/components/panel"},"next":{"title":"Routing på klientnivå","permalink":"/pr-preview/pr-1331/dev/client-side-routing"}}');
...
// EXTERNAL MODULE: ./packages/layout/src/sidebar/Sidebar.tsx + 10 modules
var Sidebar = __webpack_require__(60199);
...
;// ./packages/layout/src/navigation/navigation-header/NavigationHeader.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const NavigationHeader_module = ({"navigationHeader":"navigationHeader_WNLU","collapsed":"collapsed_atsJ"});
;// ./packages/layout/src/navigation/navigation-header/NavigationHeader.tsx
'use client';var _excluded=["className"];var NavigationHeader=function NavigationHeader(_ref){var _clsx;var className=_ref.className,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var sidebarContext=(0,react.useContext)(SidebarContext/* SidebarContext */.I);return/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,Object.assign({className:(0,utils_clsx/* clsx */.$)(className,NavigationHeader_module.navigationHeader,(_clsx={},_clsx[NavigationHeader_module.collapsed]=sidebarContext==null?void 0:sidebarContext.isCollapsed,_clsx))},rest));};
...
;// ./packages/layout/src/navigation/navigation-section/NavigationSection.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const NavigationSection_module = ({"navigationSection":"navigationSection_za3L","collapsed":"collapsed_QzgT"});
;// ./packages/layout/src/navigation/navigation-section/NavigationSection.tsx
'use client';var NavigationSection_excluded=["className","title"];var NavigationSection=function NavigationSection(_ref){var _clsx;var className=_ref.className,title=_ref.title,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,NavigationSection_excluded);var sidebarContext=(0,react.useContext)(SidebarContext/* SidebarContext */.I);return/*#__PURE__*/(0,jsx_runtime.jsxs)(NavigationItem/* NavigationItem */.s,{children:[title&&/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationHeader,{children:title}),/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:(0,clsx/* default */.A)(className,NavigationSection_module.navigationSection,(_clsx={},_clsx[NavigationSection_module.collapsed]=sidebarContext==null?void 0:sidebarContext.isCollapsed,_clsx)),children:/*#__PURE__*/(0,jsx_runtime.jsx)(CollectionBuilder/* Collection */.pM,Object.assign({},rest))})]});};
...
;// ./apps/docs/src/components/examples/layout/SidebarExamples.tsx
var BasicExample=function BasicExample(){return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{width:240},children:/*#__PURE__*/(0,jsx_runtime.jsx)(Sidebar/* Sidebar */.B,{title:"Navigation",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Navigation/* Navigation */.V,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(NavigationSection,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationItem/* NavigationItem */.s,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationLink/* NavigationLink */.T,{href:"#",icon:/*#__PURE__*/(0,jsx_runtime.jsx)(house/* default */.A,{}),children:"Hem"})}),/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationItem/* NavigationItem */.s,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationLink/* NavigationLink */.T,{href:"#",icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings/* default */.A,{}),children:"Inst\xE4llningar"})})]})})})})});};
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Sidopanel som används som huvudnavigation i våra desktopapplikationer. Själva navigationen styrs av ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/dev/layout/components/navigation",
        children: "navigationskomponenterna"
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: "import { Sidebar, Navigation, NavigationItem, NavigationLink, NavigationSection } from '@midas-ds/layout'\nimport { House, Settings } from 'lucide-react'\n\nexport default function App() {\n  const pathname = usePathname() // or equivalent for your router\n\n  return (\n    <Sidebar title='Navigation'>\n      <Navigation>\n        <NavigationSection>\n          <NavigationItem>\n            <NavigationLink\n              href='/'\n              icon={<House />}\n              isActive={pathname === '/'}\n            >\n              Hem\n            </NavigationLink>\n          </NavigationItem>\n          <NavigationItem>\n            <NavigationLink\n              href='/installningar'\n              icon={<Settings />}\n              isActive={pathname === '/installningar'}\n            >\n              Inställningar\n            </NavigationLink>\n          </NavigationItem>\n        </NavigationSection>\n      </Navigation>\n    </Sidebar>\n  )\n}\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(BasicExample, {}), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "titel",
      children: "Titel"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Sidomenyn renderas som ett ", (0,jsx_runtime.jsx)(_components.code, {
        children: "<aside>"
      }), "-landmärke. ", (0,jsx_runtime.jsx)(_components.code, {
        children: "title"
      }), " används som landmärkets tillgängliga namn och ska därför vara ett namn som beskriver menyns syfte, inte applikationens namn. Oftast är \"Navigation\" ett bra alternativ."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "ihopfällt-läge",
      children: "Ihopfällt läge"
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      type: "note",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["När Sidebar är ihopfälld visas etiketten i ", (0,jsx_runtime.jsx)(_components.code, {
          children: "NavigationLink"
        }), " som en tooltip vid hover. Därför är det viktigt att varje länk har en ", (0,jsx_runtime.jsx)(_components.code, {
          children: "children"
        }), "-prop (etikett) eftersom det är nödvändigt för tillgänglighet."]
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Sidebar kan fällas ihop till enbart ikoner för att användaren ska kunna se mer av huvudinnehållet. Det kan styras antingen okontrollerat (internt tillstånd) eller kontrollerat av föräldrakomponenten."
      ...
      children: [(0,jsx_runtime.jsx)(_components.thead, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            ...
            }), " Namn på sidomenyn, används som tillgängligt landmärkesnamn."]
          })]
      ...
      children: [(0,jsx_runtime.jsx)(_components.thead, {
        ...
        children: [(0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            ...
            children: "Synlig rubrik för sektionen"
          })]
        }), (0,jsx_runtime.jsxs)(_components.tr, {
          children: [(0,jsx_runtime.jsx)(_components.td, {
            children: (0,jsx_runtime.jsx)(_components.code, {
...
'use client';var Sidebar_excluded=["children","className","title"];// @types/react's CSSProperties intentionally has no index signature for
...
var Sidebar=function Sidebar(_ref){var _clsx,_clsx2,_clsx3,_clsx4;var children=_ref.children,className=_ref.className,title=_ref.title,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,Sidebar_excluded);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var isMobileDevice=(0,useIsMobileDevice/* useIsMobileDevice */.o)();var _useControlledState=(0,useControlledState/* useControlledState */.P)(props.isCollapsed,props.defaultCollapsed||false,props.onCollapseChange),isCollapsed=_useControlledState[0],setIsCollapsed=_useControlledState[1];var _React$useState=react.useState(false),isTransitioning=_React$useState[0],setIsTransitioning=_React$useState[1];var handlePress=function handlePress(){setIsTransitioning(true);setIsCollapsed(function(previouslyCollapsed){return!previouslyCollapsed;});};var handleTransitionEnd=function handleTransitionEnd(e){if(e.propertyName==='width'&&e.target===e.currentTarget){setIsTransitioning(false);}};return isMobileDevice?null:/*#__PURE__*/(0,jsx_runtime.jsx)(SidebarContext/* SidebarContext */.I.Provider,{value:{isCollapsed:isCollapsed},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelBody,Object.assign({className:(0,clsx/* default */.A)(className,Sidebar_module.sidebar,(_clsx={},_clsx[Sidebar_module.collapsed]=isCollapsed,_clsx)),"data-transitioning":isTransitioning||undefined,onTransitionEnd:handleTransitionEnd},(0,filterDOMProps/* filterDOMProps */.$)(props,{propNames:new Set(['style'])}),{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelHeader,{className:(0,clsx/* default */.A)(Sidebar_module.sidebarHeader,(_clsx2={},_clsx2[Sidebar_module.collapsed]=isCollapsed,_clsx2)),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(PanelTitle,{className:(0,clsx/* default */.A)(Sidebar_module.sidebarTitle,(_clsx3={},_clsx3[Sidebar_module.collapsed]=isCollapsed,_clsx3)),title:title}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":isCollapsed?strings.format('expandSidebar'):strings.format('collapseSidebar'),onPress:handlePress,variant:"icon",size:"medium",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:(0,clsx/* default */.A)(Sidebar_module.collapseButton,(_clsx4={},_clsx4[Sidebar_module.collapsed]=isCollapsed,_clsx4)),children:/*#__PURE__*/(0,jsx_runtime.jsx)(panel_left_close/* default */.A,{size:20})})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(PanelContent,{className:Sidebar_module.sidebarContent,children:children})]}))});};
