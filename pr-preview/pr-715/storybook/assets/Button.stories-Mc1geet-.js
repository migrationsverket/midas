import{j as O}from"./jsx-runtime-BYYWji4R.js";import{B as q}from"./Button-CH0o21To.js";import{u as n,e as r}from"./index-Q7OVwvWC.js";import{s as A}from"./modes-BX-MOWoB.js";import{P as G}from"./plus-ujXGwDQp.js";import{X as J}from"./x-Dz2R9y6b.js";import"./index-ClcD9ViR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Button.module-DbxVSEkM.js";import"./Button-HNQZo37q.js";import"./utils-RHx87K0F.js";import"./SSRProvider-BhYbDCf7.js";import"./clsx-B-dksMZM.js";import"./Hidden-BC9qER92.js";import"./useFocusRing-Fkrzm1DF.js";import"./_class_private_field_init-BOtJyCjG.js";import"./index-DQEgcCId.js";import"./useLabels-FEgier_d.js";import"./context-zNjZoWML.js";import"./useButton-BLF2LAsl.js";import"./createLucideIcon-uZw3gxGR.js";const ga={component:q,title:"Components/Button",tags:["autodocs"],args:{variant:"primary",size:"large",children:"Button"},argTypes:{size:{control:{type:"radio"},options:["large","medium"]},children:{type:"string"},isDisabled:{options:[!0,!1],control:{type:"radio"}}},parameters:{chromatic:{modes:A}},play:async({canvas:e,step:a,args:{size:s}})=>{await a("it should have focus when clicked",async()=>{const t=e.getByRole("button");await n.click(t),await r(t).toBeEnabled(),t.focus(),await n.keyboard("{Enter}"),await r(t).toHaveFocus()}),await a("it should change size according to size prop",async()=>{await r(e.getByRole("button")).toHaveStyle({height:s==="large"?"47.6px":"39.6px"})})}},o={args:{children:"Button",className:"test-class"}},i={args:{variant:"secondary"}},c={args:{children:"Lägg till",variant:"tertiary",icon:G}},l={args:{variant:"primary",isDisabled:!0,children:"Lägg till"},play:async({canvas:e})=>{const a=e.getByRole("button");await n.click(a),await r(a).toBeDisabled()}},d={args:{variant:"secondary",isDisabled:!0},play:async({canvas:e})=>{const a=e.getByRole("button");await n.click(a),await r(a).toBeDisabled()}},p={args:{children:"Button",fullwidth:!0}},u={args:{variant:"tertiary",size:"small",children:"Small Tertiary"},argTypes:{variant:{options:["tertiary"],control:{type:"radio"}},size:{options:["small","medium","large"]}},play:async({canvas:e,step:a,args:{size:s}})=>{await a("it should have focus when clicked",async()=>{const t=e.getByRole("button");await n.click(t),await r(t).toBeEnabled(),t.focus(),await n.keyboard("{Enter}"),await r(t).toHaveFocus()}),await a("it should change size according to size prop",async()=>{const t=s==="large"?"47.6px":s==="small"?"21.6px":s==="medium"?"39.6px":void 0;await r(e.getByRole("button")).toHaveStyle({height:t})})}},m={args:{children:O.jsx(J,{size:20,"aria-hidden":!0}),variant:"icon","aria-label":"Stäng"}},g={args:{children:"Button",variant:"danger"}};var y,h,b;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    children: 'Button',
    className: 'test-class'
  }
}`,...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var v,w,B;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    variant: 'secondary'
  }
