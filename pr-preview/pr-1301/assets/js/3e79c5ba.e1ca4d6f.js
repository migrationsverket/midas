...
/* harmony default export */ const MobileMenu_module = ({"overlay":"overlay_Zzls","drawer-blur":"drawer-blur_g02Y","drawer":"drawer_H_wn","drawer-slide":"drawer-slide_Mtkt","dialog":"dialog_KEPB","header":"header__BSE"});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/layout/src/header/mobile-menu/MobileMenu.tsx
'use client';var _excluded=["children","className","defaultOpen","isOpen","onOpenChange","title"];var MobileMenu=function MobileMenu(_ref){var children=_ref.children,className=_ref.className,defaultOpen=_ref.defaultOpen,isOpen=_ref.isOpen,onOpenChange=_ref.onOpenChange,title=_ref.title,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var isMobile=(0,useIsMobileDevice/* useIsMobileDevice */.o)();var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return isMobile?/*#__PURE__*/(0,jsx_runtime.jsx)(MobileMenuContext/* MobileMenuContext */.x.Provider,{value:{},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Dialog/* DialogTrigger */.zM,{isOpen:isOpen,onOpenChange:onOpenChange,defaultOpen:defaultOpen,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":strings.format('openMenu'),icon:menu/* default */.A,variant:"icon"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ModalOverlay/* ModalOverlay */.m,Object.assign({className:(0,clsx/* clsx */.$)(className,MobileMenu_module.overlay),isDismissable:true},rest,{children:(0,utils/* composeRenderProps */.HW)(children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsx)(Modal/* Modal */.aF,{className:MobileMenu_module.drawer,children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Dialog/* Dialog */.lG,{className:MobileMenu_module.dialog,children:[title&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{className:MobileMenu_module.header,children:title}),children]})});})}))]})}):null;};
...
function HeaderMobileExample(){return/*#__PURE__*/(0,jsx_runtime.jsxs)(Layout/* Layout */.P,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Header/* Header */.Y,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(MobileMenu,{title:"Mitt system",children:/*#__PURE__*/(0,jsx_runtime.jsx)(Navigation/* Navigation */.V,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationItem/* NavigationItem */.s,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavigationLink/* NavigationLink */.T,{href:"#",icon:/*#__PURE__*/(0,jsx_runtime.jsx)(house/* default */.A,{}),isActive:true,children:"Hem"})})})}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderLogo/* HeaderLogo */.b,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderTitle/* HeaderTitle */.g,{children:"Mitt system"}),/*#__PURE__*/(0,jsx_runtime.jsxs)(HeaderActions/* HeaderActions */.l,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(bell/* default */.A,{size:20}),children:"Notiser"}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(user/* default */.A,{size:20}),children:"Min profil"}),/*#__PURE__*/(0,jsx_runtime.jsx)(HeaderAction/* HeaderAction */.u,{icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings/* default */.A,{size:20}),children:"Inst\xE4llningar"})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(LayoutContent/* LayoutContent */.A,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Main/* Main */.g,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{height:'100%',border:'dashed 2px var(--midas-border-color-subtle)',borderRadius:4,display:'flex',alignItems:'center',justifyContent:'center',color:'var(--midas-text-subtle)'},children:"App-inneh\xE5ll"})})})]});}
