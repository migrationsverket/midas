...
const site_docs_dev_layout_components_header_mdx_019_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/header","title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","source":"@site/docs/dev/layout/components/header.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/header","permalink":"/pr-preview/pr-1301/dev/layout/components/header","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny."},"sidebar":"sideBar","previous":{"title":"Migrationsguide","permalink":"/pr-preview/pr-1301/dev/layout/migration"},"next":{"title":"Layout, LayoutContent & Main","permalink":"/pr-preview/pr-1301/dev/layout/components/layout"}}');
...
var BasicHeaderExample=function BasicHeaderExample(){var url=(0,useBaseUrl/* default */.Ay)('/layout-examples/header');return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)("iframe",{title:"Header example",style:{width:'100%',height:200,border:'none'},src:url})});};var MobileHeaderExample=function MobileHeaderExample(){var url=(0,useBaseUrl/* default */.Ay)('/layout-examples/header-mobile');return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)("iframe",{title:"Header with mobile menu example",style:{width:'100%',height:350,border:'none'},src:url})});};var OverflowHeaderExample=function OverflowHeaderExample(){var url=(0,useBaseUrl/* default */.Ay)('/layout-examples/header-overflow');return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)("iframe",{title:"Header overflow menu example",style:{width:'100%',height:200,border:'none'},src:url})});};
