import{j as r}from"./jsx-runtime-DtgEGaVE.js";import{$ as le,a as de}from"./TextField-Ah33ZlDz.js";import{s as ue}from"./TextField.module-ewMUXt43.js";import{r as ce}from"./index-BbAIUH2N.js";import{c as V}from"./clsx-B-dksMZM.js";import{I as pe}from"./TextField-CAOpM9vW.js";import{e as l,u as n}from"./index-DtSMq7G1.js";import"./useFocusRing-CzvYi63w.js";import"./Form-CtPEz-EL.js";import"./Text-Bs3wmQ_r.js";import"./useFormValidation-COh_aIUh.js";import"./Input-6VVu8_gT.js";import"./Hidden-Cwv2mliU.js";import"./index-cpIEhwLo.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Label-D5LZnuba.js";import"./useTextField-B88Z0jeU.js";import"./useControlledState-DGyHFLi9.js";import"./useField-CeWVpZ88.js";import"./useLabels-C6xreehw.js";import"./useFocusable-BFetNXOg.js";import"./Button-CJeWw1a0.js";import"./Button-DWcm3eun.js";import"./LiveAnnouncer-DFDjXwI8.js";const me='"../theme/tokens.css"',he="undefined",fe="undefined",ge="undefined",ye="undefined",be="undefined",ve="undefined",we="undefined",xe="undefined",Ee="undefined",Te="undefined",Se="undefined",Ve="undefined",qe="undefined",Me="_textArea_r27ql_4",Ie="_count_r27ql_45",He="_countExceeded_r27ql_53",d={tokens:me,display:he,signalRed10:fe,smBreakpoint:ge,gray10:ye,gray20:be,gray50:ve,black:we,signalRed100:xe,blue100:Ee,mediumWeight:Te,regularWeight:Se,inputText:Ve,focus:qe,textArea:Me,count:Ie,countExceeded:He},u=({label:e,description:a,rows:t,maxLength:s,minLength:c,errorMessage:ee,showCounter:te,validate:T,className:ae,...w})=>{const[x,ne]=ce.useState(w.defaultValue??w.value??""),S=i=>{const E=i.target.value;ne(E)},re=()=>s?r.jsxs("span",{className:V(d.count,x.length>s&&d.countExceeded),children:[x.length," / ",s]}):te?r.jsx("span",{className:d.count,children:x.length}):null,se=i=>{const E=s&&i.length>s?`Du har angett ${i.length-s} tecken för mycket. Fältet är begränsat till ${s} tecken.`:null,oe=c&&i.length<c?`Du har angett ${Math.abs(i.length-c)} tecken för lite. Fältet kräver åtminstone ${c} tecken.`:null,ie=T?T(i):null;return E||oe||ie||!0};return r.jsx(le,{className:V(ue.inputField,ae),validate:se,...w,children:r.jsxs(pe,{label:e,description:a,errorMessage:ee,children:[r.jsx(re,{}),r.jsx(de,{className:d.textArea,rows:t,onFocus:S,onChange:S})]})})};try{u.displayName="TextArea",u.__docgenInfo={description:"",displayName:"TextArea",props:{label:{defaultValue:null,description:"Specify label displayed above the TextArea",name:"label",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"Specify description displayed below the label",name:"description",required:!1,type:{name:"string"}},rows:{defaultValue:null,description:"Set number of rows for the TextArea",name:"rows",required:!1,type:{name:"number"}},minLength:{defaultValue:null,description:"Set minimum number of characters that are allowed before the TextArea is put in an invalid state",name:"minLength",required:!1,type:{name:"number"}},showCounter:{defaultValue:{value:"false"},description:"Whether to show the character counter or not",name:"showCounter",required:!1,type:{name:"boolean"}},errorMessage:{defaultValue:null,description:"",name:"errorMessage",required:!1,type:{name:"string | ((validation: ValidationResult) => string)"}},isInvalid:{defaultValue:null,description:"Whether the value is invalid.",name:"isInvalid",required:!1,type:{name:"boolean"}},isDisabled:{defaultValue:null,description:"Whether the input is disabled.",name:"isDisabled",required:!1,type:{name:"boolean"}},autoFocus:{defaultValue:null,description:"Whether the element should receive focus on render.",name:"autoFocus",required:!1,type:{name:"boolean"}},onFocus:{defaultValue:null,description:"Handler that is called when the element receives focus.",name:"onFocus",required:!1,type:{name:"(e: FocusEvent<HTMLInputElement, Element>) => void"}},onBlur:{defaultValue:null,description:"Handler that is called when the element loses focus.",name:"onBlur",required:!1,type:{name:"(e: FocusEvent<HTMLInputElement, Element>) => void"}},onFocusChange:{defaultValue:null,description:"Handler that is called when the element's focus status changes.",name:"onFocusChange",required:!1,type:{name:"(isFocused: boolean) => void"}},onKeyDown:{defaultValue:null,description:"Handler that is called when a key is pressed.",name:"onKeyDown",required:!1,type:{name:"(e: KeyboardEvent) => void"}},onKeyUp:{defaultValue:null,description:"Handler that is called when a key is released.",name:"onKeyUp",required:!1,type:{name:"(e: KeyboardEvent) => void"}},"aria-haspopup":{defaultValue:null,description:"Indicates the availability and type of interactive popup element, such as menu or dialog, that can be triggered by an element.",name:"aria-haspopup",required:!1,type:{name:'boolean | "true" | "false" | "menu" | "listbox" | "tree" | "grid" | "dialog"'}},"aria-controls":{defaultValue:null,description:"Identifies the element (or elements) whose contents or presence are controlled by the current element.",name:"aria-controls",required:!1,type:{name:"string"}},type:{defaultValue:null,description:"The type of input to render. See [MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#htmlattrdeftype).",name:"type",required:!1,type:{name:'"search" | (string & {}) | "text" | "tel" | "url" | "email" | "password"'}},excludeFromTabOrder:{defaultValue:null,description:`Whether to exclude the element from the sequential tab order. If true,
...
}`,...(Y=(X=v.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};const tt=["Primary","NotValid","Required","CustomValidation","MaxLength","MinLength","ShowCounter","ShowCounterWithDefaultValue","Disabled"];export{h as CustomValidation,v as Disabled,f as MaxLength,g as MinLength,p as NotValid,o as Primary,m as Required,y as ShowCounter,b as ShowCounterWithDefaultValue,tt as __namedExportsOrder,et as default};
