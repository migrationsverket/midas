 ...
 * */
export declare const LinkButton: <C extends React.ElementType = typeof AriaLink>({ children, variant, fullwidth, icon: IconComponent, iconPlacement, className, as, ...rest }: LinkButtonProps<C>) => import("react/jsx-runtime").JSX.Element;
