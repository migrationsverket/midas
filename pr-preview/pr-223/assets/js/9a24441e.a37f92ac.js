...
const site_docs_design_patterns_personnummer_mdx_9a2_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/personnummer","title":"Personnummer","description":"Vi följer Skatteverkets regler gällande hur ett personnummer är formaterat. Personnummer består av födelsetid (ÅÅMMDD) och födelsenummer (NNNN) separerat med bindestreck - eller med plus + för personer som är äldre än hundra år. Ett personnummer skrivs alltså på formen ÅÅMMDD-NNNN och det är så vi anger det i hjälptexter m.m.","source":"@site/docs/design-patterns/personnummer.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/personnummer","permalink":"/pr-preview/pr-223/design-patterns/personnummer","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
