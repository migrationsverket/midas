...
const site_docs_components_breadcrumbs_mdx_aca_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/breadcrumbs","title":"Breadcrumbs","description":"Brödsmulor används för att visa användaren vart hen är i ett djupt navigationsträd.","source":"@site/docs/components/breadcrumbs.mdx","sourceDirName":"components","slug":"/components/breadcrumbs","permalink":"/pr-preview/pr-152/components/breadcrumbs","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"menu","permalink":"/pr-preview/pr-152/tags/menu"}],"version":"current","frontMatter":{"title":"Breadcrumbs","tags":["menu"],"description":"Brödsmulor används för att visa användaren vart hen är i ett djupt navigationsträd."},"sidebar":"sideBar","previous":{"title":"Accordion","permalink":"/pr-preview/pr-152/components/accordion"},"next":{"title":"Button","permalink":"/pr-preview/pr-152/components/button"}}');
