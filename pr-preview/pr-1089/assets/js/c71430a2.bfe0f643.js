...
'use client';var _excluded=["title","href","icon","active","hasBadge","onClick"];var SidebarLink=function SidebarLink(_ref){var title=_ref.title,href=_ref.href,IconComponent=_ref.icon,active=_ref.active,hasBadge=_ref.hasBadge,onClick=_ref.onClick,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var _useLayoutContext=useLayoutContext(),isCollapsed=_useLayoutContext.isCollapsed,setIsOpened=_useLayoutContext.setIsOpened,clientSideHref=_useLayoutContext.clientSideHref;var hrefWithBasePath=clientSideHref?clientSideHref(href):href;var _useState=(0,react.useState)(false),isActive=_useState[0],setIsActive=_useState[1];(0,react.useEffect)(function(){if(typeof window!=='undefined'){var isMatch=window.location.pathname===hrefWithBasePath||window.location.pathname.startsWith(hrefWithBasePath+'/');// eslint-disable-next-line
setIsActive(active!=null?active:isMatch);}},[active,hrefWithBasePath]);var onLinkClicked=function onLinkClicked(){setIsOpened==null||setIsOpened(false);if(onClick){onClick({title:title,href:hrefWithBasePath});}};if(isCollapsed)return/*#__PURE__*/(0,jsx_runtime.jsxs)(Tooltip/* TooltipTrigger */.k,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,Object.assign({href:href,"aria-label":title,className:(0,clsx/* default */.A)(Layout_module.listLink,Layout_module.listLinkCollapsed,isActive&&Layout_module.active),onPress:onLinkClicked},rest,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(BadgeContainer/* BadgeContainer */.d,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconComponent,{size:20,"aria-label":title}),hasBadge&&/*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* Badge */.E,{})]})})),/*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip/* Tooltip */.m,{placement:"right",children:title})]});return/*#__PURE__*/(0,jsx_runtime.jsxs)(Link/* Link */.N,Object.assign({href:href,"aria-label":title,className:(0,clsx/* default */.A)(Layout_module.listLink,isActive&&Layout_module.active),onPress:onLinkClicked},rest,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(BadgeContainer/* BadgeContainer */.d,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconComponent,{size:20}),hasBadge&&/*#__PURE__*/(0,jsx_runtime.jsx)(Badge/* Badge */.E,{})]}),title]}));};
