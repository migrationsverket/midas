...
function _createMdxContent(props) {
  ...
  >
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Placera de viktigast orden först i länken. Det gör det enklare att hitta länken när användaren skannar av en sidan och förstå vad länken innebär."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Var tydlig med var länken leder. Var beskrivande i vart den leder eller vad som händer när användaren klickar på den."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Var specifik och tydlig med länkens syfte. Användaren ska förstå vad länken innebär även utan kontext (utan att behöva läsa all annan text). Skriv inte \"Klicka här\" eller \"Läs mer\" eftersom det inte hjälper användaren att särskilja länkar eller förstå dess syfte."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Länkarna ska gå att särskilja. Använd samma text om länken leder till samma sida. En unik länk för varje unik destination."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Skriv ut formatet om länken leder till ett dokument, till exempel pdf eller doc Exempel: Verksamhetsplan 2025 (pdf)"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Placera eventuell beskrivning av länken innan själva länken och i direkt anslutning till länken, i samma mening, stycke, listobjekt eller tabellcell som är nära förknippad med länken."
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "val-av-komponent",
