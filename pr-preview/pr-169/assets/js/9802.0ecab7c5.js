"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9802],{
...
/* harmony export */ });
/* harmony import */ var _chunk_U6O4IJP6_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86825);
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(isBarPlot, "isBarPlot");
function isBandAxisData(data) {
  return data.type === "band";
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(isBandAxisData, "isBandAxisData");
function isLinearAxisData(data) {
  return data.type === "linear";
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(isLinearAxisData, "isLinearAxisData");
...
var TextDimensionCalculatorWithFont = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "TextDimensionCalculatorWithFont");
  }
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_U6O4IJP6_mjs__WEBPACK_IMPORTED_MODULE_0__/* .computeDimensionOfText */ .W6)(elem, 1, t);
...
var BaseAxis = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "BaseAxis");
  }
  setRange(range) {
    this.range = range;
...
var BandAxis = class extends BaseAxis {
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "BandAxis");
  }
  ...
  recalculateScale() {
    ...
    _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.trace("BandAxis axis final categories, range: ", this.categories, this.getRange());
  }
  getTickValues() {
...
var LinearAxis = class extends BaseAxis {
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "LinearAxis");
  }
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getAxis, "getAxis");
...
var ChartTitle = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "ChartTitle");
  }
  setBoundingBoxXY(point) {
    this.boundingRect.x = point.x;
    this.boundingRect.y = point.y;
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartTitleComponent, "getChartTitleComponent");
...
var LinePlot = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "LinePlot");
  }
  getDrawableElement() {
...
var BarPlot = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "BarPlot");
  }
  getDrawableElement() {
...
var BasePlot = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "BasePlot");
  }
  setAxes(xAxis, yAxis) {
    this.xAxis = xAxis;
    this.yAxis = yAxis;
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getPlotComponent, "getPlotComponent");
...
var Orchestrator = class {
  ...
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "Orchestrator");
  }
...
var XYChartBuilder = class {
  static {
    (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(this, "XYChartBuilder");
  }
...
function getChartDefaultThemeConfig() {
  const defaultThemeVariables = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getThemeVariables */ .P$)();
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_MCANT3UC_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)(
    _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.xyChart,
    config.xyChart
  );
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartDefaultConfig, "getChartDefaultConfig");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartDefaultData, "getChartDefaultData");
function textSanitizer(text) {
  const config = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(text.trim(), config);
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(textSanitizer, "textSanitizer");
function setTmpSVGG(SVGG) {
  tmpSVGGroup = SVGG;
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setTmpSVGG, "setTmpSVGG");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setOrientation, "setOrientation");
function setXAxisTitle(title) {
  xyChartData.xAxis.title = textSanitizer(title.text);
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setXAxisTitle, "setXAxisTitle");
function setXAxisRangeData(min, max) {
  xyChartData.xAxis = { type: "linear", title: xyChartData.xAxis.title, min, max };
  hasSetXAxis = true;
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setXAxisRangeData, "setXAxisRangeData");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setXAxisBand, "setXAxisBand");
function setYAxisTitle(title) {
  xyChartData.yAxis.title = textSanitizer(title.text);
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setYAxisTitle, "setYAxisTitle");
function setYAxisRangeData(min, max) {
  xyChartData.yAxis = { type: "linear", title: xyChartData.yAxis.title, min, max };
  hasSetYAxis = true;
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setYAxisRangeData, "setYAxisRangeData");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setYAxisRangeFromPlotData, "setYAxisRangeFromPlotData");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(transformDataWithoutCategory, "transformDataWithoutCategory");
function getPlotColorFromPalette(plotIndex2) {
  return plotColorPalette[plotIndex2 === 0 ? 0 : plotIndex2 % plotColorPalette.length];
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getPlotColorFromPalette, "getPlotColorFromPalette");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setLineData, "setLineData");
...
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(setBarData, "setBarData");
function getDrawableElem() {
  if (xyChartData.plots.length === 0) {
    throw Error("No Plot to render, please provide a plot with some data");
  }
  xyChartData.title = (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab)();
  return XYChartBuilder.build(xyChartConfig, xyChartData, xyChartThemeConfig, tmpSVGGroup);
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getDrawableElem, "getDrawableElem");
function getChartThemeConfig() {
  return xyChartThemeConfig;
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartThemeConfig, "getChartThemeConfig");
function getChartConfig() {
  return xyChartConfig;
}
(0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getChartConfig, "getChartConfig");
...
var draw = /* @__PURE__ */ (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  const db = diagObj.db;
  ...
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getDominantBaseLine, "getDominantBaseLine");
  function getTextAnchor(verticalPos) {
    return verticalPos === "left" ? "start" : verticalPos === "right" ? "end" : "middle";
  }
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getTextAnchor, "getTextAnchor");
  function getTextTransformation(data) {
    return `translate(${data.x}, ${data.y}) rotate(${data.rotation || 0})`;
  }
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getTextTransformation, "getTextTransformation");
  _chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug("Rendering xychart chart\n" + txt);
  ...
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, chartConfig.height, chartConfig.width, true);
  ...
  (0,_chunk_P27NXTFD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(getGroup, "getGroup");
