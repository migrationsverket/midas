...
var sizeIcon="1rem";// Standardstorlek för ikoner. 1rem / 16px.
var sizeIconSm="1.25rem";// Liten ikonstorlek. 1.25rem / 20px.
...
var transitionDurationSlow="500ms";// Långsam övergång. 500ms. Används för större layoutförändringar som sidopaneler och expanderbara sektioner.
...
var tag_group_TagGroup = __webpack_require__(45361);
...
var SelectTags=function SelectTags(_ref){var showTags=_ref.showTags,isDisabled=_ref.isDisabled;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var state=(0,react.useContext)(Select/* SelectStateContext */.nT);var handleRemove=function handleRemove(keys){state==null||state.selectionManager.toggleSelection(Array.from(keys)[0]);};if(!(state!=null&&state.selectedItems.length)||!showTags){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(tag_group_TagGroup/* TagGroup */.C,{"aria-label":strings.format('selectedItems'),className:Select_module.tagGroup,onRemove:handleRemove,selectionBehavior:"toggle",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagList */.LY,{items:state.selectedItems,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{isDismissable:true,id:item.key,isDisabled:isDisabled,textValue:item.textValue,children:item.textValue},item.key);}})});};
// EXTERNAL MODULE: ./node_modules/clsx/dist/clsx.mjs
...
const site_docs_dev_tanstack_table_mdx_86b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tanstack-table","title":"Tanstack Table","description":"Implementation av Tanstack Table","source":"@site/docs/dev/tanstack-table.mdx","sourceDirName":"dev","slug":"/dev/tanstack-table","permalink":"/pr-preview/pr-1226/dev/tanstack-table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tanstack Table","description":"Implementation av Tanstack Table"},"sidebar":"sideBar","previous":{"title":"Tailwind CSS","permalink":"/pr-preview/pr-1226/dev/tailwind"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
var _excluded=["className","color","dismissable","isDismissable","type"];var Tag=function Tag(_ref){var _clsx;var className=_ref.className,color=_ref.color,_ref$dismissable=_ref.dismissable,dismissable=_ref$dismissable===void 0?false:_ref$dismissable,isDismissable=_ref.isDismissable,type=_ref.type,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var isTagDismissable=isDismissable||typeof isDismissable==='undefined'&&dismissable;return/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* Tag */.vw,Object.assign({className:(0,clsx/* default */.A)(Tag_module.tag,isTagDismissable&&Tag_module.dismissable,(_clsx={},_clsx[Tag_module.sky]=color?color==='sky':type==='info',_clsx[Tag_module.blue]=color==='blue',_clsx[Tag_module.mint]=color?color==='mint':type==='success',_clsx[Tag_module.green]=color==='green',_clsx[Tag_module.cream]=color?color==='cream':type==='important',_clsx[Tag_module.yellow]=color==='yellow',_clsx[Tag_module.teal]=color==='teal',_clsx[Tag_module.lagoon]=color==='lagoon',_clsx[Tag_module.lagoonblue]=color==='lagoonblue',_clsx[Tag_module.lavender]=color==='lavender',_clsx[Tag_module.purple]=color==='purple',_clsx[Tag_module.peach]=color==='peach',_clsx[Tag_module.orange]=color==='orange',_clsx[Tag_module.pippin]=color?color==='pippin':type==='warning',_clsx[Tag_module.red]=color==='red',_clsx),className)},props,{textValue:props.textValue||(typeof props.children==='string'?props.children:undefined),children:(0,utils/* composeRenderProps */.HW)(props.children,function(children){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Tag_module.tagText,children:children}),isTagDismissable&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",size:"medium",className:Tag_module.button,slot:"remove",children:/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20})})]});})}));};
