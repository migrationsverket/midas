...
var DynamicExample=function DynamicExample(){var items=[{id:'blue',name:'Blue'},{id:'green',name:'Green'},{id:'lagoonblue',name:'Lagoonblue'},{id:'orange',name:'Orange'},{id:'purple',name:'Purple'},{id:'red',name:'Red'},{id:'teal',name:'Teal'},{id:'yellow',name:'Yellow'}];return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"card",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagGroup/* TagGroup */.C,{"aria-label":"Taggar",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TagList/* TagList */.L,{items:items,children:function children(item){return/*#__PURE__*/(0,jsx_runtime.jsx)(Tag/* Tag */.v,{id:item.id,color:item.id,children:item.name});}})})});};
