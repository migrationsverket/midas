...
var tagBlueBackground="light-dark(#cde6f3, #101037)";// Tag bakgrund blå
var tagBlueBorderColor="#4a95df";// Tag kantlinje blå
var tagGreenBackground="light-dark(#d5f2d9, #07270b)";// Tag bakgrund grön
var tagGreenBorderColor="#75b47d";// Tag kantlinje grön
var tagLagoonblueBackground="light-dark(#d2daf9, #0a1332)";// Tag bakgrund lagunblå
var tagLagoonblueBorderColor="#7088e0";// Tag kantlinje lagunblå
var tagOrangeBackground="light-dark(#ffe6d9, #421d0a)";// Tag bakgrund orange
var tagOrangeBorderColor="#e87031";// Tag kantlinje orange
var tagPurpleBackground="light-dark(#f6d0f9, #391c3b)";// Tag bakgrund lila
var tagPurpleBorderColor="#b77dbc";// Tag kantlinje lila
var tagRedBackground="light-dark(#ffe0e0, #431919)";// Tag bakgrund röd
var tagRedBorderColor="#f17575";// Tag kantlinje röd
var tagTealBackground="light-dark(#cdf2f2, #0d2c2c)";// Tag bakgrund blågrön
var tagTealBorderColor="#43bcbc";// Tag kantlinje blågrön
var tagYellowBackground="light-dark(#fff5db, #2c2719)";// Tag bakgrund gul
var tagYellowBorderColor="#ecbe4a";// Tag kantlinje gul
