import{L as d}from"./LinkButton-wba1Uc16.js";import"./iframe-Cn95Trhs.js";import"./preload-helper-Ct5FWWRu.js";import"./arrow-right-DQbOfoUr.js";import"./utils-B_Rqc_aW.js";import"./clsx-B-dksMZM.js";import"./useFocusRing-_qs5_0yz.js";import"./index-BY3baLss.js";import"./index-BcP-6fTE.js";import"./createLucideIcon-BhsQ84wm.js";import"./clsx-Ciqy0D92.js";import"./square-arrow-out-up-right-BVPQY2qM.js";const{expect:p,userEvent:m}=__STORYBOOK_MODULE_TEST__,B={component:d,title:"Components/LinkButton",tags:["autodocs"],parameters:{layout:"centered"},argTypes:{children:{name:"label"},variant:{options:["primary","secondary","tertiary","danger"],control:{type:"radio"},defaultValue:"primary"},isDisabled:{options:[!0,!1],control:{type:"radio"}},iconPlacement:{options:["right","left"],control:{type:"radio"},defaultValue:"left"}},args:{size:"large"}},r={args:{children:"Till E-tjänst",href:"#","data-testid":"link-button",className:"test-class"}},a={args:{...r.args,variant:"secondary"}},e={args:{...r.args,variant:"tertiary"}},t={args:{...r.args,children:"Föregående",iconPlacement:"left"}},n={args:{...r.args,isDisabled:!0},play:async({canvas:c,step:l})=>{await l("It should have cursor not allowed when disabled",async()=>{const i=c.getByRole("link");await m.hover(i),await p(i).toHaveStyle({cursor:"not-allowed"})})}},s={args:{children:"Till E-tjänst","data-testid":"link-button",onPress:()=>alert("navigation fn")}},o={args:{"data-testid":"link-button",children:"Radera",variant:"danger"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
