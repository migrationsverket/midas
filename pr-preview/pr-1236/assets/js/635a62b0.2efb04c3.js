...
const site_docs_components_menu_mdx_635_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/menu","title":"Menu","description":"En meny kan användas för att samla ihop funktioner som sällan används eller som kompletterar nuvarande funktion.","source":"@site/docs/components/menu.mdx","sourceDirName":"components","slug":"/components/menu","permalink":"/pr-preview/pr-1236/components/menu","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Menu","description":"En meny kan användas för att samla ihop funktioner som sällan används eller som kompletterar nuvarande funktion."},"sidebar":"sideBar","previous":{"title":"Logo","permalink":"/pr-preview/pr-1236/components/logo"},"next":{"title":"Modal","permalink":"/pr-preview/pr-1236/components/modal"}}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
;// ./apps/docs/src/components/examples/menu/MenuExamples.tsx
var OnActionExample=function OnActionExample(){var _useState=(0,react.useState)([]),actions=_useState[0],setActions=_useState[1];return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',flexDirection:'column',alignItems:'flex-start',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Menu/* MenuTrigger */.cQ,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{"aria-label":"Menu",variant:"icon",children:/*#__PURE__*/(0,jsx_runtime.jsx)(menu/* default */.A,{size:20})}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuPopover/* MenuPopover */.b,{children:/*#__PURE__*/(0,jsx_runtime.jsxs)(menu_Menu/* Menu */.W,{onAction:function onAction(key){return setActions(function(prev){return[].concat(prev,[key]);});},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:"open",children:"Open"}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:"rename",children:"Rename..."}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:"duplicate",children:"Duplicate"}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:"share",children:"Share..."}),/*#__PURE__*/(0,jsx_runtime.jsx)(MenuItem/* MenuItem */.D,{id:"delete",children:"Delete..."})]})})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("strong",{children:"onAction"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("ul",{style:{margin:'0.25rem 0 0',paddingLeft:'1.25rem'},children:[actions.length===0&&/*#__PURE__*/(0,jsx_runtime.jsx)("li",{style:{color:'var(--midas-text-secondary)'},children:"\u2013"}),actions.map(function(action,i){return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{children:action},i);})]})]})]});};
