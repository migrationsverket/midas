...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ $2b4dce13dd5a17fa$export$842a2cf37af977e1)
/* harmony export */ });
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ou: () => (/* binding */ $11d87f3f76e88657$export$d9b67bc93c097491),
...
/* harmony export */   xe: () => (/* binding */ $11d87f3f76e88657$export$d33f79e3ffc3dc83),
/* harmony export */   yP: () => (/* binding */ $11d87f3f76e88657$export$b4a036af3fc0b032)
/* harmony export */ });
/* unused harmony exports getTimeZoneOffset, possibleAbsolutes, fromDate, fromDateToLocal, toDateFields, toTimeFields, toTimeZone */
/* harmony import */ var _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99451);
/* harmony import */ var _manipulation_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9078);
/* harmony import */ var _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(55845);
/* harmony import */ var _queries_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97819);
...
function $11d87f3f76e88657$export$bd4fb2bc8bb06fb(date) {
    date = $11d87f3f76e88657$export$b4a036af3fc0b032(date, new (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__/* .GregorianCalendar */ .FG)());
    let year = (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getExtendedYear */ .LA)(date.era, date.year);
...
function $11d87f3f76e88657$export$59c99f3515d3493f(ms, timeZone) {
    ...
    if (ms > 0 && timeZone === (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getLocalTimeZone */ .Xj)() && !(0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isLocalTimeZoneOverridden */ .rS)()) return new Date(ms).getTimezoneOffset() * -60000;
...
function $11d87f3f76e88657$export$5107c82f94518f5c(date, timeZone, disambiguation = 'compatible') {
    ...
    // Skip this fast path if the local timezone was explicitly overridden via setLocalTimeZone,
    // since native Date always uses the browser's timezone, not the overridden one.
    if (timeZone === (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getLocalTimeZone */ .Xj)() && disambiguation === 'compatible' && !(0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isLocalTimeZoneOverridden */ .rS)()) {
        dateTime = $11d87f3f76e88657$export$b4a036af3fc0b032(dateTime, new (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__/* .GregorianCalendar */ .FG)());
        // Don't use Date constructor here because two-digit years are interpreted in the 20th century.
        let date = new Date();
        let year = (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getExtendedYear */ .LA)(dateTime.era, dateTime.year);
...
function $11d87f3f76e88657$export$1b96692a1ba042ac(ms, timeZone) {
    ...
    return new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .ZonedDateTime */ .Ip)(year < 1 ? 'BC' : 'AD', year < 1 ? -year + 1 : year, month, day, timeZone, offset, hour, minute, second, millisecond);
}
...
function $11d87f3f76e88657$export$93522d1a439f3617(dateTime) {
    return new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CalendarDate */ .ng)(dateTime.calendar, dateTime.era, dateTime.year, dateTime.month, dateTime.day);
}
...
function $11d87f3f76e88657$export$b21e0b124e224484(date, time) {
    ...
    return new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CalendarDateTime */ ._l)(date.calendar, date.era, date.year, date.month, date.day, hour, minute, second, millisecond);
}
function $11d87f3f76e88657$export$d33f79e3ffc3dc83(dateTime) {
    return new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .Time */ .gX)(dateTime.hour, dateTime.minute, dateTime.second, dateTime.millisecond);
}
function $11d87f3f76e88657$export$b4a036af3fc0b032(date, calendar) {
    if ((0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isEqualCalendar */ .Jg)(date.calendar, calendar)) return date;
    ...
    (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_1__/* .constrain */ .AU)(copy);
    return copy;
}
function $11d87f3f76e88657$export$84c95a83c799e074(date, timeZone, disambiguation) {
    if (date instanceof (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .ZonedDateTime */ .Ip)) {
...
function $11d87f3f76e88657$export$d9b67bc93c097491(date) {
    return $11d87f3f76e88657$export$538b00033cc11c75(date, (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getLocalTimeZone */ .Xj)());
}
...
/* harmony export */ });
/* harmony import */ var _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99451);
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(31384);
...
class $3b62074eb05584b2$export$80ee6245ec4f29ec {
    fromJulianDay(jd) {
        ...
        let dqc = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__/* .mod */ .z)(depoch, 146097);
        let cent = Math.floor(dqc / 36524);
        let dcent = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__/* .mod */ .z)(dqc, 36524);
        let quad = Math.floor(dcent / 1461);
        let dquad = (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_1__/* .mod */ .z)(dcent, 1461);
        ...
        return new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CalendarDate */ .ng)(era, year, month, day);
    }
    toJulianDay(date) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $T: () => (/* binding */ $fae977aafc393c5c$export$60dfd74aa96791bd),
/* harmony export */   DP: () => (/* binding */ $fae977aafc393c5c$export$588937bcd60ade55),
/* harmony export */   _U: () => (/* binding */ $fae977aafc393c5c$export$6b862160d295c8e),
/* harmony export */   e6: () => (/* binding */ $fae977aafc393c5c$export$bf79f1ebf4b18792),
/* harmony export */   ot: () => (/* binding */ $fae977aafc393c5c$export$f59dee82248f5ad4),
/* harmony export */   qk: () => (/* binding */ $fae977aafc393c5c$export$4223de14708adc63)
/* harmony export */ });
/* unused harmony exports parseTime, parseZonedDateTime, parseAbsolute, parseAbsoluteToLocal, parseDuration */
/* harmony import */ var _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99451);
/* harmony import */ var _conversion_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(40277);
/* harmony import */ var _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(55845);
...
function $fae977aafc393c5c$export$6b862160d295c8e(value) {
    ...
    let date = new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CalendarDate */ .ng)($fae977aafc393c5c$var$parseNumber(m[1], 0, 9999), $fae977aafc393c5c$var$parseNumber(m[2], 1, 12), 1);
...
function $fae977aafc393c5c$export$588937bcd60ade55(value) {
    ...
    let date = new (0, _CalendarDate_mjs__WEBPACK_IMPORTED_MODULE_0__/* .CalendarDateTime */ ._l)(era, year < 1 ? -year + 1 : year, $fae977aafc393c5c$var$parseNumber(m[2], 1, 12), 1, m[4] ? $fae977aafc393c5c$var$parseNumber(m[4], 0, 23) : 0, m[5] ? $fae977aafc393c5c$var$parseNumber(m[5], 0, 59) : 0, m[6] ? $fae977aafc393c5c$var$parseNumber(m[6], 0, 59) : 0, m[7] ? $fae977aafc393c5c$var$parseNumber(m[7], 0, Infinity) * 1000 : 0);
...
function $fae977aafc393c5c$export$60dfd74aa96791bd(date) {
    let gregorianDate = (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_1__/* .toCalendar */ .yP)(date, new (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_2__/* .GregorianCalendar */ .FG)());
    let year;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Jg: () => (/* binding */ $14e0f24ef4ac5c92$export$dbc69fd56b53d5e),
  NV: () => (/* binding */ $14e0f24ef4ac5c92$export$91b62ebf2ba703ee),
  rS: () => (/* binding */ $14e0f24ef4ac5c92$export$6ab69b273755230b),
...
// UNUSED EXPORTS: endOfYear, getHoursInDay, getMinimumDayInMonth, getMinimumMonthInYear, isEqualMonth, isEqualYear, isSameYear, isWeekday, isWeekend, resetLocalTimeZone, setLocalTimeZone
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Ip: () => (/* binding */ $35ea8db9cb2ccb90$export$d3b7288e7994edea),
/* harmony export */   _l: () => (/* binding */ $35ea8db9cb2ccb90$export$ca871e8dbb80966f),
/* harmony export */   gX: () => (/* binding */ $35ea8db9cb2ccb90$export$680ea196effce5f),
/* harmony export */   ng: () => (/* binding */ $35ea8db9cb2ccb90$export$99faa760c7908e4f)
/* harmony export */ });
/* harmony import */ var _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9078);
/* harmony import */ var _queries_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(97819);
/* harmony import */ var _string_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(77282);
/* harmony import */ var _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55845);
/* harmony import */ var _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(40277);
/* harmony import */ var _swc_helpers_class_private_field_init__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(20051);
...
function $35ea8db9cb2ccb90$var$shiftArgs(args) {
    let calendar = typeof args[0] === 'object' ? args.shift() : new (0, _GregorianCalendar_mjs__WEBPACK_IMPORTED_MODULE_3__/* .GregorianCalendar */ .FG)();
    let era;
...
class $35ea8db9cb2ccb90$export$99faa760c7908e4f {
    ...
    /** Returns a new `CalendarDate` with the given duration added to it. */ add(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .add */ .WQ)(this, duration);
    }
    /** Returns a new `CalendarDate` with the given duration subtracted from it. */ subtract(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .subtract */ .Re)(this, duration);
    }
    /** Returns a new `CalendarDate` with the given fields set to the provided values. Other fields will be constrained accordingly. */ set(fields) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .set */ .hZ)(this, fields);
    }
    /**
   * Returns a new `CalendarDate` with the given field adjusted by a specified amount.
   * When the resulting value reaches the limits of the field, it wraps around.
   */ cycle(field, amount, options) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .cycleDate */ .xy)(this, field, amount, options);
    }
    /** Converts the date to a native JavaScript Date object, with the time set to midnight in the given time zone. */ toDate(timeZone) {
        return (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__/* .toDate */ .ay)(this, timeZone);
    }
    /** Converts the date to an ISO 8601 formatted string. */ toString() {
        return (0, _string_mjs__WEBPACK_IMPORTED_MODULE_2__/* .dateToString */ .$T)(this);
    }
    /** Compares this date with another. A negative result indicates that this date is before the given one, and a positive date indicates that it is after. */ compare(b) {
        return (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compareDate */ .SE)(this, b);
    }
    constructor(...args){
        ...
        this.month = month;
        this.day = day;
        (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .constrain */ .AU)(this);
    }
}
var // This prevents TypeScript from allowing other types with the same fields to match.
// @ts-ignore
...
class $35ea8db9cb2ccb90$export$680ea196effce5f {
    ...
    /** Returns a new `Time` with the given duration added to it. */ add(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .addTime */ .tY)(this, duration);
    }
    /** Returns a new `Time` with the given duration subtracted from it. */ subtract(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .subtractTime */ .YP)(this, duration);
    }
    /** Returns a new `Time` with the given fields set to the provided values. Other fields will be constrained accordingly. */ set(fields) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setTime */ .ib)(this, fields);
    }
    /**
   * Returns a new `Time` with the given field adjusted by a specified amount.
   * When the resulting value reaches the limits of the field, it wraps around.
   */ cycle(field, amount, options) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .cycleTime */ .gt)(this, field, amount, options);
    }
    /** Converts the time to an ISO 8601 formatted string. */ toString() {
        return (0, _string_mjs__WEBPACK_IMPORTED_MODULE_2__/* .timeToString */ .ot)(this);
    }
    /** Compares this time with another. A negative result indicates that this time is before the given one, and a positive time indicates that it is after. */ compare(b) {
        return (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compareTime */ .Nu)(this, b);
    }
    constructor(hour = 0, minute = 0, second = 0, millisecond = 0){
        ...
        (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .constrainTime */ .Rb)(this);
    }
}
var // This prevents TypeScript from allowing other types with the same fields to match.
// @ts-ignore
...
class $35ea8db9cb2ccb90$export$ca871e8dbb80966f {
    ...
    /** Returns a new `CalendarDateTime` with the given fields set to the provided values. Other fields will be constrained accordingly. */ set(fields) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .set */ .hZ)((0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setTime */ .ib)(this, fields), fields);
    }
    /**
   ...
   */ cycle(field, amount, options) {
    ...
    /** Converts the date to a native JavaScript Date object in the given time zone. */ toDate(timeZone, disambiguation) {
        return (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__/* .toDate */ .ay)(this, timeZone, disambiguation);
    }
    /** Converts the date to an ISO 8601 formatted string. */ toString() {
        return (0, _string_mjs__WEBPACK_IMPORTED_MODULE_2__/* .dateTimeToString */ .qk)(this);
    }
    /** Compares this date with another. A negative result indicates that this date is before the given one, and a positive date indicates that it is after. */ compare(b) {
        let res = (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compareDate */ .SE)(this, b);
        if (res === 0) return (0, _queries_mjs__WEBPACK_IMPORTED_MODULE_1__/* .compareTime */ .Nu)(this, (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__/* .toCalendarDateTime */ .tR)(b));
        return res;
    }
    constructor(...args){
...
class $35ea8db9cb2ccb90$export$d3b7288e7994edea {
    ...
    /** Returns a new `ZonedDateTime` with the given duration added to it. */ add(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .addZoned */ .E0)(this, duration);
    }
    /** Returns a new `ZonedDateTime` with the given duration subtracted from it. */ subtract(duration) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .subtractZoned */ .d_)(this, duration);
    }
    /** Returns a new `ZonedDateTime` with the given fields set to the provided values. Other fields will be constrained accordingly. */ set(fields, disambiguation) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .setZoned */ .D8)(this, fields, disambiguation);
    }
    /**
   * Returns a new `ZonedDateTime` with the given field adjusted by a specified amount.
   * When the resulting value reaches the limits of the field, it wraps around.
   */ cycle(field, amount, options) {
        return (0, _manipulation_mjs__WEBPACK_IMPORTED_MODULE_0__/* .cycleZoned */ .XH)(this, field, amount, options);
    }
    /** Converts the date to a native JavaScript Date object. */ toDate() {
        return (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__/* .zonedToDate */ .cd)(this);
    }
    /** Converts the date to an ISO 8601 formatted string, including the UTC offset and time zone identifier. */ toString() {
        return (0, _string_mjs__WEBPACK_IMPORTED_MODULE_2__/* .zonedDateTimeToString */ .e6)(this);
    }
    ...
    /** Compares this date with another. A negative result indicates that this date is before the given one, and a positive date indicates that it is after. */ compare(b) {
        ...
        return this.toDate().getTime() - (0, _conversion_mjs__WEBPACK_IMPORTED_MODULE_4__/* .toZoned */ .uB)(b, this.timeZone).toDate().getTime();
    }
    constructor(...args){
