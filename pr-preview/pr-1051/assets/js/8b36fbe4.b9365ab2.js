...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["En sökning sker som sagt innan det finns någon data att ta ställning till. Användaren vet inte vilka värden som finns och sökningen är därför oftast mer fri. Standardfallet vid sökning är ett ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/search-field",
        children: "Sökfält"
      }), " där användaren skriver in en sökterm, tex Dossnummer. I vissa fall behövs en mer avancerad sökning med flera alternativ och då använder vi samma designmönster som för filtrering, se nedan."]
