 ...
 */const X=[["path",{d:"M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z",key:"1rqfz7"}],["path",{d:"M14 2v4a2 2 0 0 0 2 2h4",key:"tnqrlb"}]],ee=Y("file",X),{expect:K,userEvent:y}=__STORYBOOK_MODULE_TEST__,f=["Ett","Två","Tre","Fyra"],Le={component:l,subcomponents:{AccordionItem:i},title:"Components/Accordion",tags:["autodocs"],args:{}},a={args:{className:"test",children:f.map(e=>n.jsxs(i,{id:e,title:"En öppningsbar panel "+e.toLocaleLowerCase(),children:["Innehåll i öppningsbar panel ",e,". Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore nesciunt at aliquam! Blanditiis quasi consequuntur doloremque harum commodi odit velit pariatur voluptate aliquid, inventore praesentium tempore dignissimos officia sint libero!"]},e))},play:async({canvasElement:e,step:t})=>{await t("It should preserve its classNames when being passed new ones",async()=>{const r=e.querySelector("div");await K(r).toHaveClass(v.root,"test")})}},o={args:{...a.args,isContained:!0}},s={tags:["!snapshot"],parameters:{chromatic:{disableSnapshot:!0}},args:{...a.args,allowsMultipleExpanded:!0}},u={args:{...a.args,defaultExpandedKeys:["Två"]}},d={args:{...o.args,children:f.map((e,t)=>n.jsxs(i,{id:e,title:n.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"1rem"},children:[n.jsx(ee,{}),n.jsxs("b",{children:["En öppningsbar panel ' + ",e.toLocaleLowerCase()]}),n.jsxs("p",{style:{margin:0},children:["2025-03-0",t]})]}),children:["Innehåll i öppningsbarpanel ",e," Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus perspiciatis officia, voluptate ratione quam nemo quod aut maiores animi nostrum, in labore adipisci ullam suscipit esse vel odit tenetur dicta. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit dolorem tempora laboriosam asperiores eum dignissimos accusantium voluptate eligendi beatae vel quis rerum error dolore cum incidunt pariatur accusamus, illum consequuntur?"]},e))}},c={args:{},tags:["!dev","!autodocs","!snapshot"],parameters:{chromatic:{disableSnapshot:!0}},render:()=>n.jsxs(l,{children:[n.jsxs(i,{title:"AccordionItem with dynamic content",children:["Knowledge is knowing a tomato is a fruit; wisdom is not putting it in a fruit salad.",n.jsx(ne,{})]}),n.jsx(i,{title:"Another AccordionItem",children:"More text about another subject..."})]}),play:async({canvas:e})=>{await y.click(e.getByRole("button",{name:"AccordionItem with dynamic content"})),await y.click(e.getByTestId("btn-0")),await K(e.getByTestId("hidden-content")).toBeVisible()}},m={tags:["!dev","!autodocs","!snapshot"],parameters:{chromatic:{disableSnapshot:!0}},render:()=>n.jsx(l,{children:n.jsx(i,{title:"Test",children:n.jsx(Z,{isDisabled:!0,children:"Test"})})})},ne=()=>{const[e,t]=G.useState(!1);return n.jsxs("div",{children:[n.jsx("button",{onClick:()=>t(r=>!r),"data-testid":"btn-0",children:e?"hide":"show"}),e?n.jsx("div",{style:{background:"black",color:"white",height:"auto",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem"},"data-testid":"hidden-content",children:"Pineapples were once so rare and expensive in Europe that people used them as a status symbol—even renting them for parties to show off wealth, without ever eating them!"}):null]})},p={args:{variant:"contained",children:f.map((e,t)=>n.jsxs(i,{id:e,title:"En öppningsbar panel "+e.toLocaleLowerCase(),type:t===2?"success":t===3?"warning":void 0,children:["Innehåll i öppningsbar panel ",e," Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus perspiciatis officia, voluptate ratione quam nemo quod aut maiores animi nostrum, in labore adipisci ullam suscipit esse vel odit tenetur dicta. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Impedit dolorem tempora laboriosam asperiores eum dignissimos accusantium voluptate eligendi beatae vel quis rerum error dolore cum incidunt pariatur accusamus, illum consequuntur?"]},e))}};var h,T,M;a.parameters={...a.parameters,docs:{...(h=a.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(M=(T=a.parameters)==null?void 0:T.docs)==null?void 0:M.source}}};var H,g,C;o.parameters={...o.parameters,docs:{...(H=o.parameters)==null?void 0:H.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    isContained: true
  }
}`,...(C=(g=o.parameters)==null?void 0:g.docs)==null?void 0:C.source}}};var q,D,L;s.parameters={...s.parameters,docs:{...(q=s.parameters)==null?void 0:q.docs,source:{originalSource:`{
  tags: ['!snapshot'],
  parameters: {
    chromatic: {
...
}`,...(L=(D=s.parameters)==null?void 0:D.docs)==null?void 0:L.source}}};var b,V,x;u.parameters={...u.parameters,docs:{...(b=u.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    ...Default.args,
    defaultExpandedKeys: ['Två']
  }
}`,...(x=(V=u.parameters)==null?void 0:V.docs)==null?void 0:x.source}}};var A,P,w;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    ...Contained.args,
...
}`,...(w=(P=d.parameters)==null?void 0:P.docs)==null?void 0:w.source}}};var I,S,k;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {},
...
}`,...(k=(S=c.parameters)==null?void 0:S.docs)==null?void 0:k.source}}};var _,j,O;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  tags: ['!dev', '!autodocs', '!snapshot'],
  parameters: {
    chromatic: {
      disableSnapshot: true
  ...
  //   )
  // },
}`,...(O=(j=m.parameters)==null?void 0:j.docs)==null?void 0:O.source}}};var B,R,N;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    variant: 'contained',
...
}`,...(N=(R=p.parameters)==null?void 0:R.docs)==null?void 0:N.source}}};const be=["Default","Contained","AllowsMultipleExpanded","DefaultExpandedKeys","CustomTriggerElements","DynamicContent","DS1060","AccordionHasBackground"];export{p as AccordionHasBackground,s as AllowsMultipleExpanded,o as Contained,d as CustomTriggerElements,m as DS1060,a as Default,u as DefaultExpandedKeys,c as DynamicContent,be as __namedExportsOrder,Le as default};
