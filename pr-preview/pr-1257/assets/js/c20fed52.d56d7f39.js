...
const toc = [{
  ...
  "value": "Översikter och dashboards",
  "id": "översikter-och-dashboards",
  "level": 4
}, {
  "value": "Varianter",
  "id": "varianter",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: "Komponent som samlar logiskt relaterad information om ett ämne i en visuellt distinkt enhet."
      ...
      children: "För att kortet ska vara lätt att läsa och tolka bör det ha en tydlig informationshierarki. Rubriken, med eventuell underrubrik, ska ge kortet en tydlig identifikation. Genom att komponera våra kort med rubrik överst följt av innehåll och sist handlingar skapar vi ett kort där informationshierarkin, den visuella ordningen och fokusordningen följer varandra. Det innebär att upplevelsen av korten kommer vara liknande oavsett användning av hjälpmedel eller sätt att interagera med korten."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "användningsområden",
      children: "Användningsområden"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Kort passar särskilt bra i två situationer:"
      ...
      children: ["Om du visar en samling objekt av samma typ med återkommande innehållsdelar bör du i första hand överväga en lista, särskilt om det är viktigt att användaren ska kunna jämföra objekten. Är objekten mer heterogena eller innehåller bilder, kan kort vara ett lämpligt val.\nI sådana fall bör du använda en ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/grid",
        children: "grid-layout"
      }), " som gör det enkelt att skanna samlingen. Det underlättas av att korten placeras i raka kolumner och rader. En utmaning med grid-layouter är varierad höjd på korten. Är variationen liten kan du fylla ut med whitespace så att korten får samma höjd och innehållet linjerar. Är variationen stor kan det behövas en maxhöjd i kombination med trunkering."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "översikter-och-dashboards",
      children: "Översikter och dashboards"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["I en översikt eller en dashboard kan kort användas för att dela upp och presentera olika datamängder i separata, lättöverskådliga enheter. Varje kort representerar ett avgränsat informationsområde, vilket gör det enkelt för användaren att snabbt få en överblick och identifiera det som är relevant.\nKort i dashboards behöver inte ha samma storlek. Anpassa storleken efter innehållet, ett nyckeltal kan rymmas i ett litet kort medan ett diagram eller en tabell kan kräva mer utrymme. Använd ett ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/grid",
      ...
      children: ["Om kortet rymmer många handlingar kan vi placera sekundära handlingar i en meny. För att skapa en meny i ett kort används ", (0,jsx_runtime.jsx)(_components.a, {
