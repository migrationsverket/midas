"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9299],{
...
var DEFAULT_PACKET_CONFIG = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.packet;
var PacketDB = class {
  constructor() {
    this.packet = [];
    this.setAccTitle = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccTitle */ .SV;
    this.getAccTitle = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccTitle */ .iN;
    this.setDiagramTitle = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setDiagramTitle */ .ke;
    this.getDiagramTitle = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab;
    this.getAccDescription = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getAccDescription */ .m7;
    this.setAccDescription = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setAccDescription */ .EI;
  }
  static {
  ...
  getConfig() {
    const config = (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)({
      ...
      ...(0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().packet
    });
    if (config.showBits) {
      config.paddingY += 10;
    }
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((_text, id, _version, diagram2) => {
  ...
  (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config.useMaxWidth);
...
var styles = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(({ packet } = {}) => {
  const options = (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(defaultPacketStyleOptions, packet);
  return `
	.packetByte {
