...
const site_docs_basics_language_mdx_558_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"basics/language","title":"Språk","description":"När vi skriver texter för Migrationsverkets digitala kanaler och tjänster utgår vi från Myndigheternas skrivregler, som är Språkrådets vägledning för alla som skriver inom offentlig verksamhet.","source":"@site/docs/basics/language.mdx","sourceDirName":"basics","slug":"/basics/language","permalink":"/pr-preview/pr-534/basics/language","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"language","title":"Språk","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "I språklagen står det att myndigheter, kommuner, regioner och annan offentlig verksamhet ska använda klarspråk. Att Migrationsverket använder klarspråk är viktigt av både rättssäkerhets- och demokratiskäl. Alla i samhället ska kunna förstå information från myndigheter, oavsett om det handlar om beslut i ärenden om uppehållstillstånd eller information om hur man deklarerar."
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), ". Texten ska utgå från läsarens behov och situation. Det ska framgå tydligt vad läsaren behöver veta och göra. Texten ska svara på läsarens frågor och förklara nästa steg."]
      }), "\n"]
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), " Inled med den viktigaste informationen. Sammanfatta budskapet."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), " Skriv kortfattat. Undvik information och detaljer som inte behövs. Använd tydliga rubriker och underrubriker. Om texten är lång, låt varje stycke bestå av endast ett ämne. Använd gärna punktlistor, faktarutor och diagram för att framhäva information."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)("div", {
      className: "card-guidelines",
      children: [(0,jsx_runtime.jsx)(InfoBanner/* InfoBanner */.z, {
 ...
 Du ska skicka med kopior av de sidor i ditt pass som visar: 
  ...
  På kopiorna måste även siffror och tecken längst upp och längst ned på passidorna synas tydligt.
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        }), " Texten ska ha ett direkt tilltal, \"du\" om den vänder sig till en person eller \"ni\" om det är flera. Benämn avsändaren som \"vi\", när det är tydligt vilka vi är. Texten ska ha en vänlig ton."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsxs)("div", {
      className: "card-guidelines",
      children: [(0,jsx_runtime.jsx)(InfoBanner/* InfoBanner */.z, {
