import{j as a}from"./jsx-runtime-DtgEGaVE.js";import{R as b,a as t,s as q}from"./Radio-wWVGoSTT.js";import{e as g,u as r}from"./index-DtSMq7G1.js";import"./index-BbAIUH2N.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Group-DITek4ZD.js";import"./utils-Dv9Ux5aE.js";import"./clsx-B-dksMZM.js";import"./useFocusRing-CPQALXIu.js";import"./Form-BMyPeP3B.js";import"./Text-D0cNLqf0.js";import"./filterDOMProps-BSfnXAP7.js";import"./useFormValidation-BrFQy5aA.js";import"./Label-Cr3pFc-x.js";import"./Hidden-lswqw32w.js";import"./useControlledState-DGyHFLi9.js";import"./FocusScope-C0EWTSbR.js";import"./useField-BWvtu4tG.js";import"./useLabel-BAqrTMfP.js";import"./context-oTIQb5ND.js";import"./usePress-B1qsLRUy.js";import"./_class_private_field_init-BOtJyCjG.js";import"./index-cpIEhwLo.js";import"./useFocusable-b_0ijIRa.js";import"./VisuallyHidden-DiGk2ECL.js";import"./Label-BdAnV8MH.js";import"./Text-DJ2zVqb4.js";import"./FieldError-BI5lou7e.js";const be={title:"Components/Radio",component:b,tags:["autodocs"],args:{label:"Välj frukt",description:"Valfri beskrivning",errorMessage:"Du måste välja en frukt?",errorPosition:"top"},argTypes:{children:{table:{disable:!0}},label:{type:"string",control:{type:"text"}},isDisabled:{type:"boolean",options:[!1,!0],control:{type:"radio"}},isInvalid:{type:"boolean",options:[!1,!0],control:{type:"radio"}}}},z=["Äpple","Banan","Kiwi","Apelsin"],i=z.map(e=>a.jsx(t,{value:e,id:e.toLowerCase(),children:e},e)),H=[a.jsx(t,{value:"banan",children:"Banan"},"radio-banan"),a.jsx(t,{value:"apelsin",isDisabled:!0,children:"Apelsin"},"radio-apelsin"),a.jsx(t,{value:"kiwi",children:"Kiwi"},"radio-kiwi")],n={args:{label:"Frukt",description:"Välj en frukt",children:i,className:"test-class"},play:async({canvas:e,step:s,args:o})=>{await s("it should preserve its classNames when being passed new ones",async()=>{const O=e.getByLabelText(o.label);g(O).toHaveClass(q.radioGroup,o.className)})}},l={args:{children:i,isDisabled:!0}},d={args:{children:H}},p={args:{children:i,isInvalid:!0,errorMessage:"Det här stämmer inte!"}},c={tags:["!dev"],args:{label:"Frukt",description:"Välj en frukt",children:i,isRequired:!0},render:e=>a.jsxs("form",{children:[a.jsx(b,{...e}),a.jsx("button",{type:"submit",children:"Submit"})]}),play:async({canvas:e,step:s,args:o})=>{await s("should show a validation error message if the user submitted without selecting anything",async()=>{await r.tab(),await r.tab(),await r.keyboard("[Enter]"),g(e.getByRole("radiogroup")).toBeInvalid(),g(e.getByText(o.errorMessage)).toBeInTheDocument()})}},m={tags:["!dev"],args:{label:"Frukt",description:"Välj en frukt",children:i,errorMessage:void 0,validate:e=>e!=null&&e.includes("Äpple")?"Inga äpplen är tillåtna":!0},render:e=>a.jsxs("form",{children:[a.jsx(b,{...e}),a.jsx("button",{type:"submit",children:"Submit"})]}),play:async({canvas:e,step:s})=>{await s("it should show the custom error message if the constraints was not satisfied",async()=>{await r.tab(),await r.keyboard("[Enter]"),await r.tab(),await r.keyboard("[Enter]"),g(e.getByText("Inga äpplen är tillåtna")).toBeInTheDocument()})}},u={args:{...n.args,children:a.jsxs(a.Fragment,{children:[a.jsx(t,{value:"apple",children:"Äpple"},"radio-apple"),a.jsx(t,{value:"banan",children:"Banan"},"radio-banan")]}),orientation:"horizontal"}};var h,y,v;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    label: 'Frukt',
