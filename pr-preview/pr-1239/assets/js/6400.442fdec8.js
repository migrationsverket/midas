"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[6400],{
...
function $ab90dcbc1b5466d0$export$c7e10bfc0c59f67c(props, state, ref) {
    ...
    let focus = ()=>{
        if (ref.current) {
            ...
            if (focusMode === 'child') {
                ...
                if ((0, DOMFunctions/* isFocusWithin */.ae)(ref.current) && ref.current !== (0, DOMFunctions/* getActiveElement */.bq)()) return;
    ...
    let onFocus = (e)=>{
        ...
        requestAnimationFrame(()=>{
            if (focusMode === 'child' && (0, DOMFunctions/* getActiveElement */.bq)() === ref.current) focus();
        });
    };
...
const $1910c06f0ca9905e$export$7063e69b8a954175 = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $dbSRa$forwardRef)(function ResizableTableContainer(props, ref) {
    ...
    return /*#__PURE__*/ (0, $dbSRa$react).createElement((0, $64fa3d84918910a7$export$df3a06d6289f983e).div, {
        render: props.render,
...
let $1910c06f0ca9905e$var$TableElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableElementType(props, ref) {
...
function $1910c06f0ca9905e$var$TableInner({ props: props, forwardedRef: ref, selectionState: selectionState, collection: collection }) {
    ...
    }, /*#__PURE__*/ (0, react).createElement((0, FocusScope/* FocusScope */.n1), null, /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableElementType, {
...
let $1910c06f0ca9905e$var$THeadElementType = /*#__PURE__*/ (0, react.forwardRef)(function THeadElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $1910c06f0ca9905e$export$f850895b287ef28e = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)($1910c06f0ca9905e$var$TableHeaderNode, (props, ref)=>{
    ...
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$THeadElementType, {
...
let $1910c06f0ca9905e$var$TableHeaderRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableHeaderRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
...
function $1910c06f0ca9905e$var$TableHeaderRow({ item: item }) {
    ...
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableHeaderRowElementType, {
        ...rowProps,
        ref: ref
...
let $1910c06f0ca9905e$var$ColumnElementType = /*#__PURE__*/ (0, react.forwardRef)(function ColumnElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $1910c06f0ca9905e$export$816b5d811295e6bc = /*#__PURE__*/ (0, CollectionBuilder/* createLeafComponent */.KU)($1910c06f0ca9905e$var$TableColumnNode, (props, forwardedRef, column)=>{
    ...
    let state = (0, react.useContext)($1910c06f0ca9905e$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    let { columnHeaderProps: columnHeaderProps, isPressed: isPressed } = (0, $f329116d8ad0aba0$export$9514819a8c81e960)({
        node: column,
        isVirtualized: isVirtualized
    }, state, ref);
...
{}
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$ColumnElementType, {
...
let $1910c06f0ca9905e$var$TableBodyElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableBodyElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $1910c06f0ca9905e$export$76ccd210b9029917 = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)($1910c06f0ca9905e$var$TableBodyNode, (props, ref)=>{
    ...
    if (isEmpty && props.renderEmptyState && state) {
        ...
        emptyState = /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
            role: "row",
            ...rowProps,
            style: style
        }, /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableCellElementType, {
            role: "rowheader",
            ...rowHeaderProps,
            style: style
    ...
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableBodyElementType, {
...
let $1910c06f0ca9905e$var$TableRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
{}
    ...
    return /*#__PURE__*/ (0, react).createElement((0, react).Fragment, null, dropIndicator && !dropIndicator.isHidden && /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        role: "row",
        style: {
            height: 0
        }
    ...
    }))), /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
...
let $1910c06f0ca9905e$var$TableCellElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableCellElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $1910c06f0ca9905e$export$f6f0c3fe4ec306ea = /*#__PURE__*/ (0, CollectionBuilder/* createLeafComponent */.KU)($1910c06f0ca9905e$var$TableCellNode, (props, forwardedRef, cell)=>{
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableCellElementType, {
...
let $1910c06f0ca9905e$var$TableDropIndicatorRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableDropIndicatorRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
let $1910c06f0ca9905e$var$TableDropIndicatorTDElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableDropIndicatorTDElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
function $1910c06f0ca9905e$var$TableDropIndicator(props, ref) {
    ...
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableDropIndicatorRowElementType, {
    ...
    }, /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableDropIndicatorTDElementType, {
        role: "gridcell",
        colSpan: state.collection.columnCount,
        style: {
            padding: 0
...
function $1910c06f0ca9905e$var$RootDropIndicator() {
    ...
    return /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        role: "row",
...
const $1910c06f0ca9905e$export$8f5bea0338ed243c = (0, CollectionBuilder/* createLeafComponent */.KU)((0, BaseCollection/* LoaderNode */.OJ), function TableLoadingIndicator(props, ref, item) {
    ...
    return /*#__PURE__*/ (0, react).createElement((0, react).Fragment, null, /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        style: {
            height: 0
        },
    ...
    }))), isLoading && renderProps.children && /*#__PURE__*/ (0, react).createElement($1910c06f0ca9905e$var$TableRowElementType, {
        ...(0, mergeProps/* mergeProps */.v)((0, filterDOMProps/* filterDOMProps */.$)(props, {
            global: true
        }), rowProps),
        ...renderProps,
