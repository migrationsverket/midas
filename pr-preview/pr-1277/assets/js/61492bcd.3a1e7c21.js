...
const site_docs_dev_layout_overview_mdx_614_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/overview","title":"Översikt","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","source":"@site/docs/dev/layout/overview.mdx","sourceDirName":"dev/layout","slug":"/dev/layout/overview","permalink":"/pr-preview/pr-1277/dev/layout/overview","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Översikt","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Validering i formulär","permalink":"/pr-preview/pr-1277/design-patterns/validation"},"next":{"title":"Migrationsguide","permalink":"/pr-preview/pr-1277/dev/layout/migration"}}');
