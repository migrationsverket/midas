...
'use client';var FileListItem=function FileListItem(_ref){var _id=_ref.id,fileName=_ref.fileName,fileSize=_ref.fileSize,onDelete=_ref.onDelete,className=_ref.className;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{className:(0,clsx/* default */.A)(FileList_module/* default */.A.fileListItem,className),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:FileList_module/* default */.A.fileInfo,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileName,children:fileName}),fileSize&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module/* default */.A.fileSize,children:fileSize})]}),onDelete&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",onPress:onDelete,"aria-label":strings.format('removeFile')+" "+fileName,className:FileList_module/* default */.A.deleteButton,children:/*#__PURE__*/(0,jsx_runtime.jsx)(trash_2/* default */.A,{size:20,"aria-hidden":true})})]});};
