...
;// ./packages/components/src/file-list/FileList.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const FileList_module = ({"fileList":"fileList_v7Yz","fileListItem":"fileListItem_rpF7","fileInfo":"fileInfo_mtqe","fileName":"fileName_qyUR","fileSize":"fileSize_ds3p","deleteButton":"deleteButton_ulZ8"});
;// ./packages/components/src/file-list/FileList.tsx
'use client';var _excluded=["className","children"];var FileList=function FileList(_ref){var className=_ref.className,children=_ref.children,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)("ul",Object.assign({},props,{className:(0,clsx/* default */.A)(FileList_module.fileList,className),children:children}));};
...
'use client';var FileListItem=function FileListItem(_ref){var id=_ref.id,fileName=_ref.fileName,fileSize=_ref.fileSize,onDelete=_ref.onDelete,className=_ref.className;var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{id:id,className:(0,clsx/* default */.A)(FileList_module.fileListItem,className),children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:FileList_module.fileInfo,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module.fileName,children:fileName}),fileSize&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:FileList_module.fileSize,children:fileSize})]}),onDelete&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",onPress:onDelete,"aria-label":strings.format('removeFile')+" "+fileName,className:FileList_module.deleteButton,children:/*#__PURE__*/(0,jsx_runtime.jsx)(trash_2/* default */.A,{size:20,"aria-hidden":true})})]});};
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      className: "card",
      children: (0,jsx_runtime.jsx)(FileList, {
        "aria-label": "Uppladdade filer",
        children: (0,jsx_runtime.jsx)(FileListItem, {
          id: "1",
          fileName: "CV_Anna_Svensson.pdf",
          fileSize: "1.2 MB",
          onDelete: () => {}
      ...
      className: "card",
      children: (0,jsx_runtime.jsxs)(FileList, {
        "aria-label": "Bifogade filer",
        children: [(0,jsx_runtime.jsx)(FileListItem, {
          id: "1",
          fileName: "Beslut.pdf",
          fileSize: "512 KB"
        }), (0,jsx_runtime.jsx)(FileListItem, {
          id: "2",
