...
const site_docs_design_patterns_page_layout_header_navbar_panel_mdx_294_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/page-layout/header-navbar-panel","title":"Mobilorienterade applikationer","description":"Detta mönster är till för applikationer som främst används på mobila enheter och där ska upplevas som native-appar. Det använder Navbar för navigering på små skärmar och Sidebar för navigering på större skärmar. Navbar har endast plats för ett begränsat antal navigeringsalternativ och är därför inte en generell ersättare för MobileMenu på små skärmar.","source":"@site/docs/design-patterns/page-layout/header-navbar-panel.mdx","sourceDirName":"design-patterns/page-layout","slug":"/design-patterns/page-layout/header-navbar-panel","permalink":"/pr-preview/pr-1369/design-patterns/page-layout/header-navbar-panel","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"id":"header-navbar-panel","title":"Mobilorienterade applikationer","sidebar_position":3},"sidebar":"sideBar","previous":{"title":"Applikationer med sidomeny","permalink":"/pr-preview/pr-1369/design-patterns/page-layout/header-sidebar-panel"},"next":{"title":"Handlingar","permalink":"/pr-preview/pr-1369/design-patterns/actions"}}');
