import{S as x}from"./SearchField-D3e_OgBm.js";import{f as d,u as e,e as t}from"./index-DtSMq7G1.js";import"./jsx-runtime-DtgEGaVE.js";import"./index-BbAIUH2N.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./TextField.module-BiYOq6rA.js";import"./clsx-B-dksMZM.js";import"./useControlledState-DGyHFLi9.js";import"./utils-B5vVULSi.js";import"./useLocalizedStringFormatter-BsPioxkm.js";import"./context-B5OQOlVG.js";import"./useTextField-JsK-ISgg.js";import"./useFocusRing-HUlwicEq.js";import"./filterDOMProps-BSfnXAP7.js";import"./useFormValidation-C6V_c74n.js";import"./useField-BiUYFPQe.js";import"./useLabel-XbSNQJBa.js";import"./useFocusable-BvehpvqX.js";import"./focusSafely-BIGdxh6G.js";import"./createLucideIcon-8wDOqnHv.js";import"./Button-CnrB9SBi.js";import"./Button-BpxGj6Q-.js";import"./ProgressBar-C-2ZZqws.js";import"./Label-DK2CQORK.js";import"./Hidden-lswqw32w.js";import"./NumberFormatter-DT0cDaax.js";import"./LiveAnnouncer-DFDjXwI8.js";import"./usePress-CCvsZXnc.js";import"./index-cpIEhwLo.js";import"./x-Cu6J0Y2u.js";const te={component:x,title:"Components/SearchField",tags:["autodocs"],parameters:{layout:"centered"},args:{buttonText:"Sök"}},s={args:{placeholder:"Sök efter en person",onChange:d(),onSubmit:d()},play:async({canvas:a,step:r,args:{onChange:n,onSubmit:o,buttonText:B}})=>{await r("it should be possible to submit a search string using only the keyboard",async()=>{await e.tab(),await e.keyboard("hello"),await e.keyboard("[Enter]"),t(n).toHaveBeenCalledWith("hello"),t(o).toHaveBeenCalledWith("hello")}),await r("it should be possible to submit a search string using the mouse",async()=>{await e.tab(),await e.keyboard("hello"),await e.click(a.getByText(B)),t(n).toHaveBeenCalledWith("hello"),t(o).toHaveBeenCalledWith("hello")})}},i={args:{placeholder:'Sök efter "secret"',validate:a=>a==="secret"?"Sök inte efter hemligheter":!0,onChange:d(),onSubmit:d()},play:async({canvas:a,step:r,args:{onChange:n,onSubmit:o}})=>{await r("it should give a validation error if the user entered an unpermitted text",async()=>{await e.tab(),await e.keyboard("secret"),await e.tab(),await e.keyboard("[Enter]"),t(n).toHaveBeenCalledWith("secret"),t(o).not.toHaveBeenCalled(),t(a.getByText("Sök inte efter hemligheter")).toBeInTheDocument()})}},l={args:{placeholder:"Sök efter dokument",isInvalid:!0,errorMessage:"Något gick fel, var god försök igen"},play:async({canvas:a,step:r,args:{placeholder:n,errorMessage:o}})=>{await r("it should be invalid and show the custom message",async()=>{t(a.getByLabelText(n)).toBeInvalid(),t(a.getByText(o)).toBeInTheDocument()})}},c={args:{placeholder:"Sök efter dokument",isDisabled:!0}};var p,m,u;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
...
}`,...(f=(S=c.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};const ae=["Primary","CustomValidation","Invalid","Disabled"];export{i as CustomValidation,c as Disabled,l as Invalid,s as Primary,ae as __namedExportsOrder,te as default};
