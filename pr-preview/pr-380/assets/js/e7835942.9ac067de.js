 ...
 */function useLocalizedStringFormatter(strings// packageName?: string,
){var _useLocale=(0,context/* useLocale */.Y)(),locale=_useLocale.locale;// let dictionary = useLocalizedStringDictionary(strings, packageName);
return (0,react.useMemo)(function(){var dictionary=new dist_LocalizedStringDictionary/* LocalizedStringDictionary */.B(strings,'sv-SV');return new LocalizedStringFormatter/* LocalizedStringFormatter */.J(locale,dictionary);},[locale,strings]);}
