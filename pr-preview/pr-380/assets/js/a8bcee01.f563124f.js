...
const site_docs_design_patterns_forms_mdx_a8b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/forms","title":"Formulär","description":"Obligatorisk vs valfri","source":"@site/docs/design-patterns/forms.mdx","sourceDirName":"design-patterns","slug":"/design-patterns/forms","permalink":"/pr-preview/pr-380/design-patterns/forms","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const CharacterCounter_module = ({"tokens":"\"../theme/tokens.css\"","--font-family":"\"Inter\", sans-serif","--line-height-02":"1.125rem","--size-02":"0.875rem","--text-invalid":"light-dark(#e62323, #e62323)","--text-primary":"light-dark(#171717, #f2f2f2)","count":"count_vtbh","countExceeded":"countExceeded_tImT"});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/character-counter/CharacterCounter.tsx
var CharacterCounter=/*#__PURE__*/react.forwardRef(function(props,ref){var _value$toString;;var _useContextProps=(0,utils/* useContextProps */.JT)(props,ref,Input/* InputContext */.E);props=_useContextProps[0];ref=_useContextProps[1];var _props=props,maxLength=_props.maxLength,value=_props.value;var stringValue=(_value$toString=value==null?void 0:value.toString())!=null?_value$toString:'';if(maxLength!==undefined){return/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:(0,clsx/* default */.A)(CharacterCounter_module.count,stringValue.length>maxLength&&CharacterCounter_module.countExceeded),children:[stringValue.length," / ",maxLength]});}return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:CharacterCounter_module.count,children:stringValue.length});});
;// ./packages/components/src/textfield/TextFieldBase.tsx
var TextFieldBase=/*#__PURE__*/react.forwardRef(function(props,ref){var _ref,_props$defaultValue;;var _useContextProps=(0,utils/* useContextProps */.JT)(props,ref,TextField/* TextFieldContext */.H);props=_useContextProps[0];ref=_useContextProps[1];var _props=props,label=_props.label,description=_props.description,errorMessage=_props.errorMessage,showCounter=_props.showCounter;var _React$useState=react.useState((_ref=(_props$defaultValue=props.defaultValue)!=null?_props$defaultValue:props.value)!=null?_ref:''),value=_React$useState[0],setValue=_React$useState[1];var handleChange=function handleChange(value){setValue(value);};var handleFocus=function handleFocus(event){setValue(event.target.value);};return/*#__PURE__*/(0,jsx_runtime.jsxs)(TextField/* TextField */.A,Object.assign({},props,{className:(0,clsx/* default */.A)(TextField_module/* default */.A.textField,props.className),onChange:handleChange,onFocus:handleFocus,value:value,children:[label&&/*#__PURE__*/(0,jsx_runtime.jsx)(Label/* Label */.J,{variant:"label-02",children:label}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)(Text/* Text */.E,{slot:"description",children:description}),showCounter&&/*#__PURE__*/(0,jsx_runtime.jsx)(CharacterCounter,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(FieldError/* FieldError */.b,{"data-testid":"fieldError",children:errorMessage}),props.children]}));});
