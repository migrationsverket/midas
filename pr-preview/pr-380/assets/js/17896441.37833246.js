...
/* harmony import */ var _textfield__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(49154);
...
'use client';var _excluded=["showCounter"];var TextArea_TextArea=/*#__PURE__*/react.forwardRef(function(_ref,ref){var _ref2,_props$defaultValue$t,_props$defaultValue,_props$value;var showCounter=_ref.showCounter,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);;var _useContextProps=(0,utils/* useContextProps */.JT)(props,ref,TextArea/* TextAreaContext */.k);props=_useContextProps[0];ref=_useContextProps[1];var _React$useState=react.useState((_ref2=(_props$defaultValue$t=(_props$defaultValue=props.defaultValue)==null?void 0:_props$defaultValue.toString())!=null?_props$defaultValue$t:(_props$value=props.value)==null?void 0:_props$value.toString())!=null?_ref2:''),value=_React$useState[0],setValue=_React$useState[1];var handleFocus=function handleFocus(event){setValue(event.target.value);props.onFocus&&props.onFocus(event);};var handleChange=function handleChange(event){setValue(event.target.value);props.onChange&&props.onChange(event);};// TODO: What do we do with the counter?
var Count=function Count(){if(props.maxLength!==undefined){return/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:(0,clsx/* default */.A)(TextArea_module.count,value.length>props.maxLength&&TextArea_module.countExceeded),children:[value.length," / ",props.maxLength]});}if(showCounter){return/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:TextArea_module.count,children:value.length});}return null;};return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Count,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(TextArea/* TextArea */.f,Object.assign({},props,{value:value,ref:ref,className:(0,clsx/* default */.A)(TextArea_module.textArea,props.className),onFocus:handleFocus,onChange:handleChange}))]});});
