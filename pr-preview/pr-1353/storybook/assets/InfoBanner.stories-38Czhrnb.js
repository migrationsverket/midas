import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{t as r,z as i}from"./iframe-BW2g9V1x.js";import{n as a,t as o}from"./clsx-tGqRxOdu.js";import{t as s}from"./Button-r33rTZ8A.js";import{n as c,t as l}from"./lucide-react-Czq9it2u.js";import{r as u,t as d}from"./intl-n751mdD2.js";import{t as f}from"./button-ClBpeXvo.js";import{n as p,t as m}from"./FeedbackStatusIcon-CxkQwAMw.js";import{t as h}from"./import-DCTf59n0.js";var g,_,v,y,b,x,S,C,w,T,E,D=e((()=>{g=`_infoBanner_7d8d1_1`,_=`_success_7d8d1_11`,v=`_info_7d8d1_1`,y=`_important_7d8d1_21`,b=`_warning_7d8d1_26`,x=`_content_7d8d1_40`,S=`_heading_7d8d1_46`,C=`_text_7d8d1_51`,w=`_icon_7d8d1_66`,T=`_dismissable_7d8d1_75`,E={infoBanner:g,success:_,info:v,important:y,warning:b,content:x,heading:S,text:C,icon:w,dismissable:T}})),O,k,A,j=e((()=>{O={close:`Close`},k={close:`Stäng`},A={en:O,sv:k}})),M,N,P=e((()=>{n(),l(),D(),a(),f(),d(),j(),p(),h(),M=r(),N=({title:e,message:t,type:n,children:r,isDismissable:a=!1,defaultOpen:l=!0,isOpen:d,onOpenChange:f,...p})=>{let[h,g]=i(d,l,f),_=u(A),v=()=>{g(!1)};return h?(0,M.jsxs)(`aside`,{...p,className:o(E.infoBanner,E[n],p.className),children:[(0,M.jsx)(m,{"aria-hidden":!0,className:E.icon,status:n}),(0,M.jsxs)(`div`,{className:E.content,children:[e&&(0,M.jsx)(`strong`,{className:E.heading,children:e}),(0,M.jsxs)(`div`,{className:E.text,children:[t,r]})]}),a&&(0,M.jsx)(`div`,{className:E.dismissable,children:(0,M.jsx)(s,{variant:`icon`,"aria-label":_.format(`close`),onPress:v,children:(0,M.jsx)(c,{size:20})})})]}):null},N.__docgenInfo={description:`Displays a static message as an inline banner`,methods:[],displayName:`InfoBanner`,props:{type:{required:!0,tsType:{name:`union`,raw:`'success' | 'info' | 'important' | 'warning'`,elements:[{name:`literal`,value:`'success'`},{name:`literal`,value:`'info'`},{name:`literal`,value:`'important'`},{name:`literal`,value:`'warning'`}]},description:`Determines the visual style and semantic meaning of the InfoBanner (e.g., success, info, warning, important).`},title:{required:!1,tsType:{name:`string`},description:`The title of the banner.`},message:{required:!1,tsType:{name:`union`,raw:`string | React.ReactNode`,elements:[{name:`string`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:`The message to be displayed in the banner. Can be a string or a React node.`},children:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:`Additional elements to be displayed inside the banner.`},isDismissable:{required:!1,tsType:{name:`boolean`},description:`If true, a dismiss button will be displayed in the top right corner.`,defaultValue:{value:`false`,computed:!1}},defaultOpen:{required:!1,tsType:{name:`boolean`},description:`The initial visibility of the banner when it is uncontrolled.`,defaultValue:{value:`true`,computed:!1}},isOpen:{required:!1,tsType:{name:`boolean`},description:`Controls the visibility of the banner when it is controlled.`},onOpenChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`(isOpen: boolean) => void`,signature:{arguments:[{type:{name:`boolean`},name:`isOpen`}],return:{name:`void`}}},description:`Callback fired when the visibility of the banner changes.`}}}})),F,I,L,R,z,B,V,H,U,W;e((()=>{F=t(n(),1),P(),f(),I=r(),L={component:N,title:`Components/InfoBanner`,tags:[`autodocs`]},R={args:{title:`Thank you!`,message:`You are now done sharing all passports - alternatively you have 
