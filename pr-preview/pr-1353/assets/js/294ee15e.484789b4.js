...
const site_docs_design_patterns_page_layout_header_navbar_panel_mdx_294_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"design-patterns/page-layout/header-navbar-panel","title":"Mobilorienterade applikationer","description":"Detta mönster är till för applikationer som främst används på mobila enheter och där ska upplevas som native-appar. Det använder Navbar för navigering på små skärmar och Sidebar för navigering på större skärmar. Navbar har endast plats för ett begränsat antal navigeringsalternativ och är därför inte en generell ersättare för MobileMenu på små skärmar.","source":"@site/docs/design-patterns/page-layout/header-navbar-panel.mdx","sourceDirName":"design-patterns/page-layout","slug":"/design-patterns/page-layout/header-navbar-panel","permalink":"/pr-preview/pr-1353/design-patterns/page-layout/header-navbar-panel","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":3,"frontMatter":{"id":"header-navbar-panel","title":"Mobilorienterade applikationer","sidebar_position":3},"sidebar":"sideBar","previous":{"title":"Applikationer med sidomeny","permalink":"/pr-preview/pr-1353/design-patterns/page-layout/header-sidebar-panel"},"next":{"title":"Handlingar","permalink":"/pr-preview/pr-1353/design-patterns/actions"}}');
...
const contentTitle = 'Mobilorienterade applikationer';
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      children: (0,jsx_runtime.jsx)(_components.h1, {
        id: "mobilorienterade-applikationer",
        children: "Mobilorienterade applikationer"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Detta mönster är till för applikationer som främst används på mobila enheter och där ska upplevas som native-appar. Det använder ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/layout/navbar",
        children: "Navbar"
      }), " för navigering på små skärmar och ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/layout/sidebar",
        children: "Sidebar"
      }), " för navigering på större skärmar. Navbar har endast plats för ett begränsat antal navigeringsalternativ och är därför inte en generell ersättare för ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/layout/header/#mobilemenu",
        children: "MobileMenu"
      }), " på små skärmar."]
    }), "\n", (0,jsx_runtime.jsx)(PageLayoutExamples/* MobileAppSidebarNavbarExample */.qh, {}), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "navigation",
      children: "Navigation"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "För att stödja navigation för alla fönster- och skärmstorlekar måste både Navbar och Sidebar inkluderas i trädet. Sidebar och Navbar visas respektive döljs automatiskt vid brytpunkten 640px. För att undvika kodduplicering rekommenderas att lägga navigationsinnehållet i en delad komponent och använda den till Navbar och Sidebar."
...
// EXTERNAL MODULE: ./packages/layout/src/layout/LayoutBreakpointContext.tsx
var LayoutBreakpointContext = __webpack_require__(46199);
...
'use client';var HeaderLogo=function HeaderLogo(_ref){var primary=_ref.primary;var hasBreakpointOverride=(0,react.useContext)(LayoutBreakpointContext/* LayoutBreakpointContext */.x)!==undefined;var isMobileDevice=(0,useIsMobileDevice/* useIsMobileDevice */.o)();// Only set when a consumer overrides the default breakpoint (see
// LayoutBreakpointContext) — the built-in @media rules already handle the
// default 640px split with no JS needed.
var breakpointMode=hasBreakpointOverride?isMobileDevice?'mobile':'desktop':undefined;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Logo/* Logo */.g,{size:"x-small",primary:primary,padding:false,className:HeaderLogo_module.mobile,"data-breakpoint-mode":breakpointMode}),/*#__PURE__*/(0,jsx_runtime.jsx)(Logo/* Logo */.g,{size:"small",primary:primary,padding:false,className:HeaderLogo_module.desktop,"data-breakpoint-mode":breakpointMode})]});};
...
var _excluded=["children","className","breakpoint"];var Layout=function Layout(_ref){var children=_ref.children,className=_ref.className,breakpoint=_ref.breakpoint,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",Object.assign({className:(0,clsx/* default */.A)(className,Layout_module.layout)},rest,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SkipToContent,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(LayoutBreakpointContext/* LayoutBreakpointProvider */.Z,{breakpoint:breakpoint,children:children})]}));};
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ LayoutBreakpointProvider),
/* harmony export */   x: () => (/* binding */ LayoutBreakpointContext)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
 ...
 * value.
 */var LayoutBreakpointContext=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)(undefined);/**
 ...
 */var LayoutBreakpointProvider=function LayoutBreakpointProvider(_ref){var breakpoint=_ref.breakpoint,children=_ref.children;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(LayoutBreakpointContext.Provider,{value:breakpoint,children:children});};
...
'use client';var _excluded=["className","children"];var Navbar=function Navbar(_ref){var className=_ref.className,children=_ref.children,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var hasBreakpointOverride=(0,react.useContext)(LayoutBreakpointContext/* LayoutBreakpointContext */.x)!==undefined;var isMobileDevice=(0,useIsMobileDevice/* useIsMobileDevice */.o)();return/*#__PURE__*/(0,jsx_runtime.jsx)("footer",Object.assign({className:(0,clsx/* default */.A)(className,Navbar_module.navbar)// Only set when a consumer overrides the default breakpoint (see
// LayoutBreakpointContext) — the built-in @media rule already handles
// the default 640px split with no JS needed.
,"data-breakpoint-mode":hasBreakpointOverride?isMobileDevice?'mobile':'desktop':undefined},rest,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(NavbarContext/* NavbarContext */.q.Provider,{value:{},children:children})}));};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _react_spectrum_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13486);
/* harmony import */ var _midas_ds_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17366);
/* harmony import */ var _layout_LayoutBreakpointContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46199);
'use client';function useIsMobileDevice(){var breakpointOverride=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_layout_LayoutBreakpointContext__WEBPACK_IMPORTED_MODULE_3__/* .LayoutBreakpointContext */ .x);var breakpoint=breakpointOverride!==undefined?breakpointOverride+"px":_midas_ds_theme__WEBPACK_IMPORTED_MODULE_2__/* .variables.windowSizesLayoutSplit */ .E.hiM;return (0,_react_spectrum_utils__WEBPACK_IMPORTED_MODULE_1__/* .useMediaQuery */ .U)("(max-width: "+breakpoint+")");}
