...
const site_docs_components_toast_mdx_a2c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/toast","title":"Toast","description":"Toasts visar korta, tillfälliga meddelanden om åtgärder, fel eller andra händelser i en applikation.","source":"@site/docs/components/toast.mdx","sourceDirName":"components","slug":"/components/toast","permalink":"/pr-preview/pr-1353/components/toast","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Toast","description":"Toasts visar korta, tillfälliga meddelanden om åtgärder, fel eller andra händelser i en applikation."},"sidebar":"sideBar","previous":{"title":"TimeField","permalink":"/pr-preview/pr-1353/components/timefield"},"next":{"title":"Tooltip","permalink":"/pr-preview/pr-1353/components/tooltip"}}');
...
;// ./apps/docs/src/components/examples/toast/ToastExamples.tsx
var DynamicToastExample=function DynamicToastExample(){var _React$useState=react.useState('success'),type=_React$useState[0],setType=_React$useState[1];var _React$useState2=react.useState('Allt funkar som det ska!'),message=_React$useState2[0],setMessage=_React$useState2[1];var _React$useState3=react.useState('5000'),timeout=_React$useState3[0],setTimeout=_React$useState3[1];var hasTimeout=timeout!=='none';var addArgs=hasTimeout?"{ type: '"+type+"', message: '"+message+"' },\n    { timeout: "+timeout+" }":"{ type: '"+type+"', message: '"+message+"' }";var code="import { GlobalToastRegion, toastQueue, Button } from '@midas-ds/components'\n\n<GlobalToastRegion />\n\n<Button\n  onPress={() =>\n    toastQueue.add(\n    "+addArgs+"\n  )}\n>\n  Visa toast\n</Button>";return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Toast/* GlobalToastRegion */.r$,{}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"card",style:{display:'flex',flexDirection:'column',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{style:{display:'flex',gap:'1rem'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{flex:1},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Select/* Select */.l,{label:"Typ",value:type,onChange:function onChange(key){return setType(key);},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"success",children:"Success"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"info",children:"Info"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"important",children:"Important"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"warning",children:"Warning"})]})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{flex:1},children:/*#__PURE__*/(0,jsx_runtime.jsxs)(Select/* Select */.l,{label:"Timeout (ms)",value:timeout,onChange:function onChange(key){return setTimeout(key);},children:[/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"none",children:"Ingen"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"5000",children:"5000"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"7000",children:"7000"}),/*#__PURE__*/(0,jsx_runtime.jsx)(ListBoxItem/* ListBoxItem */.n,{id:"10000",children:"10000"})]})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(TextField/* TextField */.A,{label:"Meddelande",value:message,onChange:setMessage}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{onPress:function onPress(){return Toast/* toastQueue */.ni.add({type:type,message:message},hasTimeout?{timeout:Number(timeout)}:{});},children:"Visa toast"})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlock/* default */.A,{language:"tsx",children:code})]});};
...
const toc = [{
  ...
  "value": "Programmatisk stängning",
  "id": "programmatisk-stängning",
  "level": 2
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: "Komponent för att visa ett kort, tillfälligt meddelande om åtgärder, fel eller andra händelser i en applikation."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Toast har fyra varianter: ", (0,jsx_runtime.jsx)(_components.code, {
        children: "success"
    ...
    }), "\n", (0,jsx_runtime.jsx)(DynamicToastExample, {}), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "implementationer",
      ...
      children: "Om det triggas flera toasts sätts de i en kö för att visas i turordning. Maximala antalet som visas samtidigt är 5."
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "programmatisk-stängning",
      children: "Programmatisk stängning"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.code, {
        children: ".add()"
      }), " returnerar en nyckel som kan användas för att stänga en toast programmatiskt med ", (0,jsx_runtime.jsx)(_components.code, {
        children: ".close()"
      }), ". Callbacken ", (0,jsx_runtime.jsx)(_components.code, {
        children: "onClose"
      }), " kan användas för att reagera när en toast stängs, oavsett om det sker manuellt eller via timeout."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "const key = toastQueue.add(\n  { type: 'info', message: 'Bearbetar...' }\n)\n\n// Stäng toasten programmatiskt\ntoastQueue.close(key)\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "toastQueue.add(\n  { type: 'success', message: 'Filen sparades' },\n  {\n    timeout: 5000,\n    onClose: () => console.log('Toasten stängdes'),\n  }\n)\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "tillgänglighet",
      children: "Tillgänglighet"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Toast-regionen renderas som ett landmärke (", (0,jsx_runtime.jsx)(_components.code, {
        children: "role=\"region\""
      }), ") som kan nås med tangentbordet via ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "F6"
      }), " (framåt) och ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "Shift+F6"
      }), " (bakåt). Det gör att användare med hjälpmedel snabbt kan navigera till aktiva toasts utan att behöva tabba genom hela sidan."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "När toast-regionen får fokus pausas alla nedräkningstimer automatiskt, så att användaren hinner läsa innehållet. Timern återupptas när fokus lämnar regionen."
    }), "\n", (0,jsx_runtime.jsx)(_components.admonition, {
      title: "Automatisk stängning",
      type: "info",
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["Använd automatisk stängning med ", (0,jsx_runtime.jsx)(_components.code, {
          children: "timeout"
        }), " enbart för icke-kritiska meddelanden. Vissa användare kan behöva extra tid att läsa innehållet, och användare med skärmförstoring kan missa toasts helt. Timeout ska vara minst 5000 ms."]
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "api",
      children: "API"
...
var useToastRegion = __webpack_require__(73713);
...
var useToastState = __webpack_require__(91573);
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Toast_module = ({"toastRegion":"toastRegion_KbVp","toast":"toast_gxso","success":"success_KyPa","info":"info_RCx7","important":"important_YYqr","warning":"warning_Rmak","icon":"icon_ZuqY","toastContent":"toastContent_LoSC","toastMessage":"toastMessage_HVa6","viewTransition":"viewTransition_CwQS","slideInTop":"slideInTop_NcfI","slideInEnd":"slideInEnd_Alfu","slideOutTop":"slideOutTop_Hd_W","slideOutEnd":"slideOutEnd_O0VY"});
// EXTERNAL MODULE: ./node_modules/lucide-react/dist/esm/icons/x.js
var x = __webpack_require__(48697);
// EXTERNAL MODULE: ./packages/components/src/utils/clsx.ts
var clsx = __webpack_require__(1160);
...
/* unused harmony import specifier */ var Toast_useToastState;
...
var windowSizesLayoutSplit="640px";// Brytpunkt för layout-komponenters mobil/skrivbords-växling (Sidebar, Navbar, HeaderLogo). 640px. Eget värde, inte på den generella skärmstorleksskalan.
