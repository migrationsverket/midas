...
const site_docs_components_layout_header_mdx_0fd_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/header","title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","source":"@site/docs/components/layout/header.mdx","sourceDirName":"components/layout","slug":"/components/layout/header","permalink":"/pr-preview/pr-1353/components/layout/header","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":1,"frontMatter":{"title":"Header","description":"Sidhuvud med stöd för logotyp, systemnamn, åtgärdsknappar och mobilmeny.","sidebar_position":1},"sidebar":"sideBar","previous":{"title":"Kom igång","permalink":"/pr-preview/pr-1353/components/layout/get-started"},"next":{"title":"Navbar","permalink":"/pr-preview/pr-1353/components/layout/navbar"}}');
 ...
 * `windowSizesLayoutSplit` token from `@midas-ds/theme` (640px), resolved at
 * build time via CSS `@custom-media` with no extra runtime cost. Setting an
 * override switches the affected components to a JS-driven visibility check
 * instead, since a CSS media condition can never reference a runtime value.
