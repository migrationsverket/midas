 ...
 */var Link=function Link(props){var brokenLinks=(0,useBrokenLinks/* default */.A)();// Only check internal links
if(!props.href.includes('//')){brokenLinks.collectLink(props.href);}return/*#__PURE__*/(0,jsx_runtime.jsx)(link_Link/* Link */.N,Object.assign({},props));};
