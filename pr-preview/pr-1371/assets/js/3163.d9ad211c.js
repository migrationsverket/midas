"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[3163],{
...
const ArrowDown = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("arrow-down", __iconNode);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ ArrowUpDown)
/* harmony export */ });
/* unused harmony export __iconNode */
/* harmony import */ var _createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59582);
/**
...
const ArrowUpDown = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("arrow-up-down", __iconNode);
...
const GripVertical = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("grip-vertical", __iconNode);
...
__webpack_require__.d(__webpack_exports__, {
  fh: () => (/* binding */ $76d00c5a4edb230a$export$f6f0c3fe4ec306ea),
  VP: () => (/* binding */ $76d00c5a4edb230a$export$816b5d811295e6bc),
  fI: () => (/* binding */ $76d00c5a4edb230a$export$b59bdbef9ce70de2),
  XI: () => (/* binding */ $76d00c5a4edb230a$export$54ec01a60f47d33d),
  BF: () => (/* binding */ $76d00c5a4edb230a$export$76ccd210b9029917),
  A0: () => (/* binding */ $76d00c5a4edb230a$export$f850895b287ef28e),
  mz: () => (/* binding */ $76d00c5a4edb230a$export$fddc468cd8cb4db9)
});

// UNUSED EXPORTS: ColumnResizer, ResizableTableContainer, RowFocusContext, TableColumnResizeStateContext, TableContext, TableFooter, TableLoadMoreItem, TableStateContext
...
;// ./node_modules/react-aria-components/dist/private/TreeDropTargetDelegate.mjs
...
;// ./node_modules/react-stately/dist/private/grid/GridCollection.mjs
/*
...
;// ./node_modules/react-stately/dist/private/table/TableCollection.mjs
...
class $3b14a8cc70843920$export$596e1b2e2cf93690 extends (0, $22f4441660dfbf05$export$de3fdf6493c353d) {
    ...
    *[Symbol.iterator]() {
    ...
    getFirstKey() {
        return (0, getChildNodes/* getFirstItem */.ue)(this.body.childNodes)?.key ?? null;
    }
    getLastKey() {
        return (0, getChildNodes/* getLastItem */.W)(this.body.childNodes)?.key ?? null;
    }
    getItem(key) {
...
;// ./node_modules/react-stately/dist/private/grid/useGridState.mjs
    ...
    selectionState.setFocusedKey = (key, child)=>{
        ...
        if (focusMode === 'cell' && key != null) {
            ...
            if (item?.type === 'item') {
                ...
                if (child === 'last') key = (0, getChildNodes/* getLastItem */.W)(children)?.key ?? null;
                else key = (0, getChildNodes/* getFirstItem */.ue)(children)?.key ?? null;
            }
        }
...
;// ./node_modules/react-stately/dist/private/table/useTableState.mjs
...
function $178a7f94e1b4b497$export$907bcc6c48325fd6(props) {
    ...
    let collection = (0, useCollection/* useCollection */.G)(props, (0, react.useCallback)((nodes)=>new (0, $3b14a8cc70843920$export$596e1b2e2cf93690)(nodes, null, context), [
        context
    ]), context);
    ...
    let [expandedKeys, setExpandedKeys] = (0, useControlledState/* useControlledState */.P)(props.expandedKeys ? new Set(props.expandedKeys) : undefined, props.defaultExpandedKeys ? new Set(props.defaultExpandedKeys) : new Set(), props.onExpandedChange);
    return {
        collection: collection,
        disabledKeys: disabledKeys,
        selectionManager: selectionManager,
...
function $178a7f94e1b4b497$export$31447e17397b15c2(state, filterFn) {
    let collection = (0, react.useMemo)(()=>filterFn ? state.collection.filter(filterFn) : state.collection, [
        state.collection,
        filterFn
    ]);
...
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/selection/DOMLayoutDelegate.mjs
var DOMLayoutDelegate = __webpack_require__(75823);
;// ./node_modules/react-aria/dist/private/grid/GridKeyboardDelegate.mjs
...
class $c7bb87e55e1ab755$export$de9feff04fda126e {
    constructor(options){
        ...
        this.layoutDelegate = options.layoutDelegate || (options.layout ? new $c7bb87e55e1ab755$var$DeprecatedLayoutDelegate(options.layout) : new (0, DOMLayoutDelegate/* DOMLayoutDelegate */.K)(options.ref));
    ...
    getKeyForItemInRowByIndex(key, index = 0) {
        ...
        if (!item) return null;
        let i = 0;
        for (let child of (0, getChildNodes/* getChildNodes */.iQ)(item, this.collection)){
    ...
    getKeyRightOf(key) {
        ...
        if (this.isRow(item)) {
            ...
            return (this.direction === 'rtl' ? (0, getChildNodes/* getLastItem */.W)(children)?.key : (0, getChildNodes/* getFirstItem */.ue)(children)?.key) ?? null;
        }
        ...
        if (this.isCell(item) && item.parentKey != null) {
            ...
            let next = (this.direction === 'rtl' ? (0, getChildNodes/* getNthItem */.cj)(children, item.index - 1) : (0, getChildNodes/* getNthItem */.cj)(children, item.index + 1)) ?? null;
    ...
    getKeyLeftOf(key) {
        ...
        if (this.isRow(item)) {
            let children = (0, getChildNodes/* getChildNodes */.iQ)(item, this.collection);
            return (this.direction === 'rtl' ? (0, getChildNodes/* getFirstItem */.ue)(children)?.key : (0, getChildNodes/* getLastItem */.W)(children)?.key) ?? null;
        }
        ...
        if (this.isCell(item) && item.parentKey != null) {
            ...
            if (!parent) return null;
            let children = (0, getChildNodes/* getChildNodes */.iQ)(parent, this.collection);
            let prev = (this.direction === 'rtl' ? (0, getChildNodes/* getNthItem */.cj)(children, item.index + 1) : (0, getChildNodes/* getNthItem */.cj)(children, item.index - 1)) ?? null;
    ...
    getFirstKey(fromKey, global) {
        ...
        if (key != null) {
            ...
            if (this.isCell(item) && !global && item.parentKey != null) {
                let parent = this.collection.getItem(item.parentKey);
                if (!parent) return null;
                return (0, getChildNodes/* getFirstItem */.ue)((0, getChildNodes/* getChildNodes */.iQ)(parent, this.collection))?.key ?? null;
            }
        }
        // Find the first row
        ...
        if (key != null && (item && this.isCell(item) && global || this.focusMode === 'cell')) {
            let item = this.collection.getItem(key);
            if (!item) return null;
            key = (0, getChildNodes/* getFirstItem */.ue)((0, getChildNodes/* getChildNodes */.iQ)(item, this.collection))?.key ?? null;
        }
    ...
    getLastKey(fromKey, global) {
        ...
        if (key != null) {
            ...
            if (this.isCell(item) && !global && item.parentKey != null) {
                ...
                if (!parent) return null;
                let children = (0, getChildNodes/* getChildNodes */.iQ)(parent, this.collection);
                return (0, getChildNodes/* getLastItem */.W)(children)?.key ?? null;
            }
        }
        // Find the last row
        ...
        if (key != null && (item && this.isCell(item) && global || this.focusMode === 'cell')) {
            ...
            if (!item) return null;
            let children = (0, getChildNodes/* getChildNodes */.iQ)(item, this.collection);
            key = (0, getChildNodes/* getLastItem */.W)(children)?.key ?? null;
        }
        // Otherwise, focus the row itself.
        return key;
    }
        ...
        while(key != null){
            ...
            if (item.textValue) {
                ...
                if (this.collator.compare(substring, search) === 0) {
                    if (this.isRow(item) && this.focusMode === 'cell') return (0, getChildNodes/* getFirstItem */.ue)((0, getChildNodes/* getChildNodes */.iQ)(item, this.collection))?.key ?? null;
                    return item.key;
                }
            }
...
;// ./node_modules/react-aria/dist/private/grid/utils.mjs
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License. You may obtain a copy
 ...
 * OF ANY KIND, either express or implied. See the License for the specific language
 * governing permissions and limitations under the License.
 */ const $90a81c508a5c0de1$export$e6235c0d09b995d0 = new WeakMap();
...
;// ./node_modules/react-aria/dist/private/grid/useGrid.mjs
...
function $e9c0503d101e30f9$export$f6b86a04e5d66d90(props, state, ref) {
    ...
    let delegate = (0, react.useMemo)(()=>keyboardDelegate || new (0, $c7bb87e55e1ab755$export$de9feff04fda126e)({
    ...
    (0, useGridSelectionAnnouncement/* useGridSelectionAnnouncement */.H)({
...
;// ./node_modules/react-aria/dist/private/table/utils.mjs
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License. You may obtain a copy
...
;// ./node_modules/react-aria/dist/private/intl/table/ar-AE.mjs
var $a10cd6e667253061$exports = {};
$a10cd6e667253061$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/bg-BG.mjs
var $f833f49c391c486d$exports = {};
$f833f49c391c486d$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/cs-CZ.mjs
var $e1d51bb8289599c0$exports = {};
$e1d51bb8289599c0$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/da-DK.mjs
...
;// ./node_modules/react-aria/dist/private/intl/table/de-DE.mjs
var $c364d2816a375361$exports = {};
$c364d2816a375361$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/el-GR.mjs
var $0df507a20cd3de68$exports = {};
$0df507a20cd3de68$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/en-US.mjs
var $160d566c570091e8$exports = {};
$160d566c570091e8$exports = {
    "select": `Select`,
...
;// ./node_modules/react-aria/dist/private/intl/table/es-ES.mjs
var $d4414c84e6d49dbd$exports = {};
$d4414c84e6d49dbd$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/et-EE.mjs
var $ec636463074d0694$exports = {};
$ec636463074d0694$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/fi-FI.mjs
var $b9af5cacb30118d3$exports = {};
$b9af5cacb30118d3$exports = {
    "ascending": `nouseva`,
...
;// ./node_modules/react-aria/dist/private/intl/table/fr-FR.mjs
var $5d623a6b4bfba620$exports = {};
$5d623a6b4bfba620$exports = {
    "ascending": `croissant`,
...
;// ./node_modules/react-aria/dist/private/intl/table/he-IL.mjs
var $d3538834bc29f0e4$exports = {};
$d3538834bc29f0e4$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/hr-HR.mjs
var $ff234028e319d566$exports = {};
$ff234028e319d566$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/hu-HU.mjs
var $a460605373fc3c6e$exports = {};
$a460605373fc3c6e$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/it-IT.mjs
var $08adf0fa2daf2795$exports = {};
$08adf0fa2daf2795$exports = {
    "ascending": `crescente`,
...
;// ./node_modules/react-aria/dist/private/intl/table/ja-JP.mjs
var $f0df77706c7c9d19$exports = {};
$f0df77706c7c9d19$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/ko-KR.mjs
var $e5ac4371cd150188$exports = {};
$e5ac4371cd150188$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/lt-LT.mjs
var $f47edc2cbf755d2f$exports = {};
$f47edc2cbf755d2f$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/lv-LV.mjs
var $be90ff34dfb20f33$exports = {};
$be90ff34dfb20f33$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/nb-NO.mjs
var $41302606c501089a$exports = {};
$41302606c501089a$exports = {
    "ascending": `stigende`,
...
;// ./node_modules/react-aria/dist/private/intl/table/nl-NL.mjs
var $3a8ceb4ed1945141$exports = {};
$3a8ceb4ed1945141$exports = {
    "ascending": `oplopend`,
...
;// ./node_modules/react-aria/dist/private/intl/table/pl-PL.mjs
var $ea686931ac732950$exports = {};
$ea686931ac732950$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/pt-BR.mjs
var $0427088f367c2e58$exports = {};
$0427088f367c2e58$exports = {
    "ascending": `crescente`,
...
;// ./node_modules/react-aria/dist/private/intl/table/pt-PT.mjs
var $3cc20af1f1f186ed$exports = {};
$3cc20af1f1f186ed$exports = {
    "ascending": `ascendente`,
...
;// ./node_modules/react-aria/dist/private/intl/table/ro-RO.mjs
var $e965f1ac9c7323c6$exports = {};
$e965f1ac9c7323c6$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/ru-RU.mjs
var $9ff37df8122f4c31$exports = {};
$9ff37df8122f4c31$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/sk-SK.mjs
var $e19dad5c3f0832dd$exports = {};
$e19dad5c3f0832dd$exports = {
    "ascending": `vzostupne`,
...
;// ./node_modules/react-aria/dist/private/intl/table/sl-SI.mjs
var $a034c26f08723019$exports = {};
$a034c26f08723019$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/sr-SP.mjs
var $0656e59894541e33$exports = {};
$0656e59894541e33$exports = {
    "ascending": `rastu\u{107}i`,
...
;// ./node_modules/react-aria/dist/private/intl/table/sv-SE.mjs
var $d28c154af217b83d$exports = {};
$d28c154af217b83d$exports = {
    "ascending": `stigande`,
...
;// ./node_modules/react-aria/dist/private/intl/table/tr-TR.mjs
var $7ffc8c16cb887a33$exports = {};
$7ffc8c16cb887a33$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/uk-UA.mjs
var $408719d7344ddfb6$exports = {};
$408719d7344ddfb6$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/zh-CN.mjs
var $8138b1e3892af333$exports = {};
$8138b1e3892af333$exports = {
...
;// ./node_modules/react-aria/dist/private/intl/table/zh-TW.mjs
var $819032430b9f61a9$exports = {};
$819032430b9f61a9$exports = {
...
;// ./node_modules/react-aria/dist/private/table/intlStrings.mjs
...
$b0fbbc5fdcc6603a$exports = {
    "ar-AE": $a10cd6e667253061$exports,
    "bg-BG": $f833f49c391c486d$exports,
    "cs-CZ": $e1d51bb8289599c0$exports,
    "da-DK": $4969ddadcdabd0a2$exports,
    "de-DE": $c364d2816a375361$exports,
    "el-GR": $0df507a20cd3de68$exports,
    "en-US": $160d566c570091e8$exports,
    "es-ES": $d4414c84e6d49dbd$exports,
    "et-EE": $ec636463074d0694$exports,
    "fi-FI": $b9af5cacb30118d3$exports,
    "fr-FR": $5d623a6b4bfba620$exports,
    "he-IL": $d3538834bc29f0e4$exports,
    "hr-HR": $ff234028e319d566$exports,
    "hu-HU": $a460605373fc3c6e$exports,
    "it-IT": $08adf0fa2daf2795$exports,
    "ja-JP": $f0df77706c7c9d19$exports,
    "ko-KR": $e5ac4371cd150188$exports,
    "lt-LT": $f47edc2cbf755d2f$exports,
    "lv-LV": $be90ff34dfb20f33$exports,
    "nb-NO": $41302606c501089a$exports,
    "nl-NL": $3a8ceb4ed1945141$exports,
    "pl-PL": $ea686931ac732950$exports,
    "pt-BR": $0427088f367c2e58$exports,
    "pt-PT": $3cc20af1f1f186ed$exports,
    "ro-RO": $e965f1ac9c7323c6$exports,
    "ru-RU": $9ff37df8122f4c31$exports,
    "sk-SK": $e19dad5c3f0832dd$exports,
    "sl-SI": $a034c26f08723019$exports,
    "sr-SP": $0656e59894541e33$exports,
    "sv-SE": $d28c154af217b83d$exports,
    "tr-TR": $7ffc8c16cb887a33$exports,
    "uk-UA": $408719d7344ddfb6$exports,
    "zh-CN": $8138b1e3892af333$exports,
    "zh-TW": $819032430b9f61a9$exports
};
...
;// ./node_modules/react-aria/dist/private/table/TableKeyboardDelegate.mjs
...
class $0048eb146240e3fa$export$da43f8f5cb04028d extends (0, $c7bb87e55e1ab755$export$de9feff04fda126e) {
    isCell(node) {
...
;// ./node_modules/react-aria/dist/private/table/useTable.mjs
...
function $fb95af427cd4e876$export$25bceaac3c7e4dc7(props, state, ref) {
    ...
    let { direction: direction } = (0, I18nProvider/* useLocale */.Y)();
    let disabledBehavior = state.selectionManager.disabledBehavior;
    let delegate = (0, react.useMemo)(()=>keyboardDelegate || new (0, $0048eb146240e3fa$export$da43f8f5cb04028d)({
            collection: state.collection,
            disabledKeys: state.disabledKeys,
            disabledBehavior: disabledBehavior,
            ref: ref,
    ...
    let stringFormatter = (0, useLocalizedStringFormatter/* useLocalizedStringFormatter */.o)((0, ($parcel$interopDefault($b0fbbc5fdcc6603a$exports))), '@react-aria/table');
    ...
    (0, useUpdateEffect/* useUpdateEffect */.w)(()=>{
        if (sortDescription) (0, LiveAnnouncer/* announce */.iP)(sortDescription, 'assertive', 500);
    }, [
        sortDescription
    ]);
    return {
...
;// ./node_modules/react-aria/dist/private/grid/useGridRowGroup.mjs
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License. You may obtain a copy
 ...
 * OF ANY KIND, either express or implied. See the License for the specific language
 * governing permissions and limitations under the License.
 */ function $9364b4956b51a42c$export$d3037f5d3f3e51bf() {
    return {
        rowGroupProps: {
            role: 'rowgroup'
        }
...
;// ./node_modules/react-aria/dist/private/table/useTableRowGroup.mjs
 ...
 * governing permissions and limitations under the License.
 */ 
function $a88c5fd7483f9127$export$6fb1613bd7b28198() {
    return (0, $9364b4956b51a42c$export$d3037f5d3f3e51bf)();
}



//# sourceMappingURL=useTableRowGroup.mjs.map

;// ./node_modules/react-aria/dist/private/table/useTableHeaderRow.mjs
/*
 * Copyright 2020 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License. You may obtain a copy
 ...
 * OF ANY KIND, either express or implied. See the License for the specific language
 * governing permissions and limitations under the License.
 */ function $b79421b14039b021$export$1b95a7d2d517b841(props, state, // eslint-disable-next-line @typescript-eslint/no-unused-vars
ref) {
...
// EXTERNAL MODULE: ./node_modules/react-aria/dist/private/grid/intlStrings.mjs + 34 modules
var intlStrings = __webpack_require__(94165);
;// ./node_modules/react-aria/dist/private/grid/useGridSelectionCheckbox.mjs
...
function $575d7acf5e0b35f6$export$70e2eed1a92976ad(props, state) {
    ...
    const stringFormatter = (0, useLocalizedStringFormatter/* useLocalizedStringFormatter */.o)((0, (useGridSelectionCheckbox_$parcel$interopDefault(intlStrings/* default */.A))), '@react-aria/grid');
    return {
        checkboxProps: {
            id: checkboxId,
...
;// ./node_modules/react-aria/dist/private/table/useTableSelectionCheckbox.mjs
...
function $9f1626ae989538fb$export$1003db6a7e384b99(state) {
    ...
    const stringFormatter = (0, useLocalizedStringFormatter/* useLocalizedStringFormatter */.o)((0, (useTableSelectionCheckbox_$parcel$interopDefault($b0fbbc5fdcc6603a$exports))), '@react-aria/table');
    return {
        checkboxProps: {
...
;// ./node_modules/react-aria/dist/private/grid/useGridCell.mjs
...
function $a4d729ad50b8576a$export$c7e10bfc0c59f67c(props, state, ref) {
    let { node: node, isVirtualized: isVirtualized, focusMode: focusModeProp, allowsArrowNavigation: allowsArrowNavigation, shouldSelectOnPressUp: shouldSelectOnPressUp, onAction: onAction } = props;
    let { direction: direction } = (0, I18nProvider/* useLocale */.Y)();
    let { keyboardDelegate: keyboardDelegate, actions: { onCellAction: onCellAction }, keyboardNavigationBehavior: keyboardNavigationBehavior } = (0, $90a81c508a5c0de1$export$e6235c0d09b995d0).get(state);
    ...
    let onKeyDownCapture = (e)=>{
        ...
        if (!(0, DOMFunctions/* nodeContains */.sD)(e.currentTarget, (0, DOMFunctions/* getEventTarget */.wt)(e)) || state.isKeyboardNavigationDisabled || !ref.current || !activeElement) return;
...
;// ./node_modules/react-aria/dist/private/table/useTableColumnHeader.mjs
...
function $7354db473d14c864$export$9514819a8c81e960(props, state, ref) {
    ...
    let { focusableProps: focusableProps } = (0, useFocusable/* useFocusable */.Wc)({}, ref);
    ...
    let stringFormatter = (0, useLocalizedStringFormatter/* useLocalizedStringFormatter */.o)((0, (useTableColumnHeader_$parcel$interopDefault($b0fbbc5fdcc6603a$exports))), '@react-aria/table');
    let sortDescription;
    if (allowsSorting) {
    ...
    return {
        columnHeaderProps: {
            ...(0, mergeProps/* mergeProps */.v)(focusableProps, gridCellProps, pressProps, descriptionProps, // If the table is empty, make all column headers untabbable
            shouldDisableFocus ? {
                tabIndex: -1
            } : null),
            role: 'columnheader',
...
;// ./node_modules/react-aria/dist/private/grid/useGridRow.mjs
...
function $6b16276e8bbdaf8e$export$96357d5a73f686fa(props, state, ref) {
    ...
    let { itemProps: itemProps, ...states } = (0, useSelectableItem/* useSelectableItem */.p)({
        ...
        onAction: onRowAction || node?.props?.onAction ? (0, chain/* chain */.c)(node?.props?.onAction, onRowAction) : undefined,
        isDisabled: state.collection.size === 0
    });
...
;// ./node_modules/react-aria/dist/private/table/useTableRow.mjs
...
function useTableRow_$parcel$interopDefault(a) {
  return a && a.__esModule ? a.default : a;
}
/*
 * Copyright 2020 Adobe. All rights reserved.
...
function $d5954d038bf91c37$export$7f2f6ae19e707aa5(props, state, ref) {
    ...
    let stringFormatter = (0, useLocalizedStringFormatter/* useLocalizedStringFormatter */.o)((0, (useTableRow_$parcel$interopDefault($b0fbbc5fdcc6603a$exports))), '@react-aria/table');
...
;// ./node_modules/react-aria/dist/private/table/useTableCell.mjs
...
;// ./node_modules/react-aria-components/dist/private/Table.mjs
...
/* unused harmony import specifier */ var $f9554a667e4f0374$export$d188a835a7bc5783;
/* unused harmony import specifier */ var $f9554a667e4f0374$export$971707d8a129a1f7;
/* unused harmony import specifier */ var $8WNJc$intlStringsmjs;
/* unused harmony import specifier */ var $8WNJc$createBranchComponent;
/* unused harmony import specifier */ var $8WNJc$filterDOMProps;
/* unused harmony import specifier */ var $8WNJc$isScrollable;
/* unused harmony import specifier */ var $8WNJc$mergeProps;
/* unused harmony import specifier */ var $8WNJc$forwardRef;
/* unused harmony import specifier */ var $8WNJc$useRef;
/* unused harmony import specifier */ var $8WNJc$useState;
/* unused harmony import specifier */ var $8WNJc$useMemo;
/* unused harmony import specifier */ var $8WNJc$react;
/* unused harmony import specifier */ var $8WNJc$useContext;
/* unused harmony import specifier */ var $8WNJc$useEffect;
/* unused harmony import specifier */ var $8WNJc$reactdom;
/* unused harmony import specifier */ var $8WNJc$useTableColumnResizeState;
/* unused harmony import specifier */ var $8WNJc$useFocusRing;
/* unused harmony import specifier */ var $8WNJc$useHover;
/* unused harmony import specifier */ var $8WNJc$useLayoutEffect;
/* unused harmony import specifier */ var $8WNJc$useLocale;
/* unused harmony import specifier */ var $8WNJc$useLocalizedStringFormatter;
/* unused harmony import specifier */ var $8WNJc$useObjectRef;
/* unused harmony import specifier */ var $8WNJc$useResizeObserver;
/* unused harmony import specifier */ var $8WNJc$useTableColumnResize;
/* unused harmony import specifier */ var $8WNJc$useTableRowGroup;
...
class $76d00c5a4edb230a$var$TableCollection extends (0, BaseCollection/* BaseCollection */.Wk) {
    ...
    updateColumns(isSSR) {
        ...
        this.headerRows = (0, $3b14a8cc70843920$export$7c127db850d4e81e)(columnKeyMap, this.columns);
...
const $76d00c5a4edb230a$var$ResizableTableContainerContext = /*#__PURE__*/ (0, react.createContext)(null);
const $76d00c5a4edb230a$export$7063e69b8a954175 = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $8WNJc$forwardRef)(function ResizableTableContainer(props, ref) {
...
const $76d00c5a4edb230a$export$93e4b0b2cc49b648 = /*#__PURE__*/ (0, react.createContext)(null);
const $76d00c5a4edb230a$export$38de1cb0526c21fb = /*#__PURE__*/ (0, react.createContext)(null);
const $76d00c5a4edb230a$export$a2680a798823803c = /*#__PURE__*/ (0, react.createContext)(null);
const $76d00c5a4edb230a$export$54ec01a60f47d33d = /*#__PURE__*/ (0, react.forwardRef)(function Table(props, ref) {
    // oxlint-disable-next-line react/react-compiler
    [props, ref] = (0, utils/* useContextProps */.JT)(props, ref, $76d00c5a4edb230a$export$93e4b0b2cc49b648);
    ...
    let content = /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableOptionsContext.Provider, {
        value: ctx
    ...
    }, (collection)=>/*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableInner, {
            props: props,
            forwardedRef: ref,
...
let $76d00c5a4edb230a$var$TableElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).table, {
        ...props,
        ref: ref
    });
});
...
function $76d00c5a4edb230a$var$TableInner({ props: props, forwardedRef: ref, selectionState: selectionState, collection: collection }) {
    ...
    let tableContainerContext = (0, react.useContext)($76d00c5a4edb230a$var$ResizableTableContainerContext);
    ref = (0, useObjectRef/* useObjectRef */.U)((0, react.useMemo)(()=>(0, mergeRefs/* mergeRefs */.P)(ref, tableContainerContext?.tableRef), [
        ref,
        tableContainerContext?.tableRef
    ]));
    let [expandedKeys, setExpandedKeys] = (0, useControlledState/* useControlledState */.P)(props.expandedKeys ? new Set(props.expandedKeys) : undefined, props.defaultExpandedKeys ? new Set(props.defaultExpandedKeys) : new Set(), props.onExpandedChange);
    // oxlint-disable-next-line react/react-compiler
    collection = (0, react.useMemo)(()=>collection.withExpandedKeys(expandedKeys), [
        collection,
        expandedKeys
    ]);
    ...
    // oxlint-disable-next-line react/react-compiler
    let filteredState = (0, $178a7f94e1b4b497$export$31447e17397b15c2)(tableState, filter);
    ...
    let { gridProps: gridProps } = (0, $fb95af427cd4e876$export$25bceaac3c7e4dc7)({
        ...DOMCollectionProps,
        layoutDelegate: layoutDelegate,
        isVirtualized: isVirtualized
    }, filteredState, ref);
    ...
    let { direction: direction } = (0, I18nProvider/* useLocale */.Y)();
    let [treeDropTargetDelegate] = (0, react.useState)(()=>new (0, $808d92ba0ee34db1$export$82c13862611c034e)());
    ...
    }, /*#__PURE__*/ (0, react).createElement((0, FocusScope/* FocusScope */.n1), null, /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableElementType, {
        ...(0, mergeProps/* mergeProps */.v)(DOMProps, renderProps, gridProps, focusProps, droppableCollection?.collectionProps),
        style: style,
        ref: ref,
...
const $76d00c5a4edb230a$var$TableOptionsContext = /*#__PURE__*/ (0, react.createContext)(null);
function $76d00c5a4edb230a$export$fddc468cd8cb4db9() {
    return (0, react.useContext)($76d00c5a4edb230a$var$TableOptionsContext);
}
class $76d00c5a4edb230a$var$TableHeaderNode extends (0, BaseCollection/* CollectionNode */.Pt) {
    static{
        this.type = 'tableheader';
    }
}
let $76d00c5a4edb230a$var$THeadElementType = /*#__PURE__*/ (0, react.forwardRef)(function THeadElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $76d00c5a4edb230a$export$f850895b287ef28e = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)($76d00c5a4edb230a$var$TableHeaderNode, (props, ref)=>{
    let collection = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb).collection;
    let headerRows = (0, useCachedChildren/* useCachedChildren */.p)({
        items: collection.headerRows,
        children: (0, react.useCallback)((item)=>{
            switch(item.type){
                case 'headerrow':
                    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableHeaderRow, {
                        item: item
                    });
                default:
    ...
    let { rowGroupProps: rowGroupProps } = (0, $a88c5fd7483f9127$export$6fb1613bd7b28198)();
    ...
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$THeadElementType, {
...
let $76d00c5a4edb230a$var$TableHeaderRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableHeaderRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement("div", {
        ...props,
        ref: ref
    });
...
function $76d00c5a4edb230a$var$TableHeaderRow({ item: item }) {
    ...
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    ...
    let { rowProps: rowProps } = (0, $b79421b14039b021$export$1b95a7d2d517b841)({
        node: item,
        isVirtualized: isVirtualized
    }, state, ref);
    let { checkboxProps: checkboxProps } = (0, $9f1626ae989538fb$export$1003db6a7e384b99)(state);
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableHeaderRowElementType, {
        ...rowProps,
        ref: ref
    }, /*#__PURE__*/ (0, react).createElement((0, utils/* Provider */.Kq), {
        values: [
            [
                (0, Checkbox/* CheckboxContext */.BP),
                {
                    slots: {
            ...
            [
                (0, Checkbox/* CheckboxFieldContext */.t7),
                {
                    slots: {
                        selection: checkboxProps
                    }
...
class $76d00c5a4edb230a$var$TableColumnNode extends (0, BaseCollection/* CollectionNode */.Pt) {
    static{
        this.type = 'column';
    }
}
let $76d00c5a4edb230a$var$ColumnElementType = /*#__PURE__*/ (0, react.forwardRef)(function ColumnElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $76d00c5a4edb230a$export$816b5d811295e6bc = /*#__PURE__*/ (0, CollectionBuilder/* createLeafComponent */.KU)($76d00c5a4edb230a$var$TableColumnNode, (props, forwardedRef, column)=>{
    let ref = (0, useObjectRef/* useObjectRef */.U)(forwardedRef);
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    let { columnHeaderProps: columnHeaderProps, isPressed: isPressed } = (0, $7354db473d14c864$export$9514819a8c81e960)({
        node: column,
        isVirtualized: isVirtualized,
    ...
    let layoutState = (0, react.useContext)($76d00c5a4edb230a$export$a2680a798823803c);
...
{}
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$ColumnElementType, {
        ...(0, mergeProps/* mergeProps */.v)(DOMProps, columnHeaderProps, focusProps, hoverProps),
        ...renderProps,
        style: style,
        ref: ref,
        "data-hovered": isHovered || undefined,
...
const $76d00c5a4edb230a$var$ColumnResizerContext = /*#__PURE__*/ (0, react.createContext)(null);
const $76d00c5a4edb230a$export$ee689e97a7664bfd = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $8WNJc$forwardRef)(function ColumnResizer(props, ref) {
    ...
    let stringFormatter = (0, $8WNJc$useLocalizedStringFormatter)((0, (Table_$parcel$interopDefault($8WNJc$intlStringsmjs))), 'react-aria-components');
...
class $76d00c5a4edb230a$var$TableBodyNode extends (0, BaseCollection/* FilterableNode */.ru) {
    static{
        this.type = 'tablebody';
    }
}
let $76d00c5a4edb230a$var$TableBodyElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableBodyElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
const $76d00c5a4edb230a$export$76ccd210b9029917 = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)($76d00c5a4edb230a$var$TableBodyNode, (props, ref, node)=>{
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    ...
    if (isEmpty && props.renderEmptyState && state) {
        ...
        emptyState = /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
            role: "row",
            ...rowProps,
            style: style
        }, /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableCellElementType, {
            role: "rowheader",
            ...rowHeaderProps,
            style: style
    ...
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableBodyElementType, {
        ...(0, mergeProps/* mergeProps */.v)(DOMProps, renderProps, rowGroupProps),
        ref: ref,
        "data-empty": isEmpty || undefined
    }, isDroppable && /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$RootDropIndicator, null), /*#__PURE__*/ (0, react).createElement(CollectionBranch, {
        collection: collection,
        parent: node,
        renderDropIndicator: (0, DragAndDrop/* useRenderDropIndicator */.oC)(dragAndDropHooks, dropState)
    }), emptyState);
});
class $76d00c5a4edb230a$var$TableFooterNode extends (0, BaseCollection/* FilterableNode */.ru) {
    static{
        this.type = 'tablefooter';
    }
}
let $76d00c5a4edb230a$var$TableFooterElementType = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $8WNJc$forwardRef)(function TableFooterElementType(props, ref) {
...
const $76d00c5a4edb230a$export$1f116082bba1f9a8 = /*#__PURE__*/ (/* unused pure expression or super */ null && ((0, $8WNJc$createBranchComponent)($76d00c5a4edb230a$var$TableFooterNode, (props, ref, node)=>{
...
const $76d00c5a4edb230a$export$1a75e308b53225a6 = /*#__PURE__*/ (0, react.createContext)({
    isFocusVisibleWithinRow: false
});
class $76d00c5a4edb230a$var$TableRowNode extends (0, BaseCollection/* CollectionNode */.Pt) {
    static{
        this.type = 'item';
    }
...
let $76d00c5a4edb230a$var$TableRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).tr, {
        ...props,
        ref: ref
    });
});
const $76d00c5a4edb230a$export$b59bdbef9ce70de2 = /*#__PURE__*/ (0, CollectionBuilder/* createBranchComponent */.yq)($76d00c5a4edb230a$var$TableRowNode, (props, forwardedRef, item)=>{
    let ref = (0, useObjectRef/* useObjectRef */.U)(forwardedRef);
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    ...
    let { rowProps: rowProps, expandButtonProps: expandButtonProps, ...states } = (0, $d5954d038bf91c37$export$7f2f6ae19e707aa5)({
        node: item,
    ...
    let { checkboxProps: checkboxProps } = (0, $9f1626ae989538fb$export$16ea7f650bd7c1bb)({
        key: item.key
    }, state);
    ...
    (0, react.useEffect)(()=>{
        if (dragState && !dragButtonRef.current && "production" !== 'production') // removed by dead control flow
{}
    ...
    return /*#__PURE__*/ (0, react).createElement((0, react).Fragment, null, dropIndicator && !dropIndicator.isHidden && /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
        role: "row",
        style: {
            height: 0
        }
    ...
    }))), /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
        ...(0, mergeProps/* mergeProps */.v)(DOMProps, renderProps, rowProps, focusProps, hoverProps, draggableItem?.dragProps, focusWithinProps),
        ref: ref,
...
class $76d00c5a4edb230a$var$TableCellNode extends (0, BaseCollection/* CollectionNode */.Pt) {
    static{
        this.type = 'cell';
    }
}
let $76d00c5a4edb230a$var$TableCellElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableCellElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
    });
    return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).td, {
        ...props,
        ref: ref
    });
});
const $76d00c5a4edb230a$export$f6f0c3fe4ec306ea = /*#__PURE__*/ (0, CollectionBuilder/* createLeafComponent */.KU)($76d00c5a4edb230a$var$TableCellNode, (props, forwardedRef, cell)=>{
    let ref = (0, useObjectRef/* useObjectRef */.U)(forwardedRef);
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    let { dragState: dragState } = (0, react.useContext)((0, DragAndDrop/* DragAndDropContext */.Ux));
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    cell.column = state.collection.columns[cell.index];
    let { gridCellProps: gridCellProps, isPressed: isPressed } = (0, $059e6e023d86289a$export$49571c903d73624c)({
        node: cell,
        shouldSelectOnPressUp: !!dragState,
        isVirtualized: isVirtualized,
        focusMode: props.focusMode,
    ...
    let { isFocused: isFocused, isFocusVisible: isFocusVisible, focusProps: focusProps } = (0, useFocusRing/* useFocusRing */.o)();
    let { hoverProps: hoverProps, isHovered: isHovered } = (0, useHover/* useHover */.M)({});
    let { isFocusVisibleWithinRow: isFocusVisibleWithinRow } = (0, react.useContext)($76d00c5a4edb230a$export$1a75e308b53225a6);
    ...
    delete DOMProps.id;
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableCellElementType, {
        ...(0, mergeProps/* mergeProps */.v)(DOMProps, renderProps, gridCellProps, focusProps, hoverProps),
        ref: ref,
        "data-focused": isFocused || undefined,
        "data-focus-visible": isFocusVisible || undefined,
...
function $76d00c5a4edb230a$var$TableDropIndicatorWrapper(props, ref) {
    ...
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableDropIndicatorForwardRef, {
        ...props,
...
let $76d00c5a4edb230a$var$TableDropIndicatorRowElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableDropIndicatorRowElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
let $76d00c5a4edb230a$var$TableDropIndicatorTDElementType = /*#__PURE__*/ (0, react.forwardRef)(function TableDropIndicatorTDElementType(props, ref) {
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    if (isVirtualized) return /*#__PURE__*/ (0, react).createElement((0, utils/* dom */.tT).div, {
        ...props,
        ref: ref
...
function $76d00c5a4edb230a$var$TableDropIndicator(props, ref) {
    ...
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableDropIndicatorRowElementType, {
        ...
        "aria-level": level
    }, /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableDropIndicatorTDElementType, {
        role: "gridcell",
        colSpan: state.collection.columnCount,
        style: {
            padding: 0
...
const $76d00c5a4edb230a$var$TableDropIndicatorForwardRef = /*#__PURE__*/ (0, react.forwardRef)($76d00c5a4edb230a$var$TableDropIndicator);
function $76d00c5a4edb230a$var$RootDropIndicator() {
    ...
    return /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
        role: "row",
...
const $76d00c5a4edb230a$export$8f5bea0338ed243c = (0, CollectionBuilder/* createLeafComponent */.KU)((0, BaseCollection/* LoaderNode */.OJ), function TableLoadingIndicator(props, ref, item) {
    let state = (0, react.useContext)($76d00c5a4edb230a$export$38de1cb0526c21fb);
    let { isVirtualized: isVirtualized } = (0, react.useContext)((0, Collection/* CollectionRendererContext */.zL));
    ...
    return /*#__PURE__*/ (0, react).createElement((0, react).Fragment, null, /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
        style: {
            height: 0
        },
    ...
    }))), isLoading && renderProps.children && /*#__PURE__*/ (0, react).createElement($76d00c5a4edb230a$var$TableRowElementType, {
        ...(0, mergeProps/* mergeProps */.v)((0, filterDOMProps/* filterDOMProps */.$)(props, {
            global: true
        }), rowProps),
        ...renderProps,
