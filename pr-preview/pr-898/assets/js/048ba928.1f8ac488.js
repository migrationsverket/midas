...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.h2, {
      ...
      }), " innehåller komponenter och mönster som vi använder för att designa våra produkter och tjänster. Komponenterna i vårt UI-kit är en spegling av hur komponenterna ser ut i komponentbiblioteket. Vi använder så ofta som möjligt samma namn på variant properties i Figma som namnen på props i komponenterna."]
