...
// NAMESPACE OBJECT: ./packages/components/src/index.ts
...
__webpack_require__.d(mvdsExports_namespaceObject, {
  ...
  Flex: () => (src_namespaceObject.Flex),
  FlexItem: () => (src_namespaceObject.FlexItem),
  Grid: () => (Grid/* Grid */.x),
...
var _excluded=["title","message","type","children","isDismissable"];/**
