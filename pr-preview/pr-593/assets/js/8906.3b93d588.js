"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[8906],{
...
class $a86207c5d7f7e1fb$var$LandmarkManager {
   ...
   */ getLandmarkByRole(role) {
    ...
    addLandmark(newLandmark) {
        ...
        if (this.landmarks.filter((landmark)=>landmark.role === 'main').length > 1 && "production" !== 'production') {}
   ...
   */ checkLabels(role) {
        ...
        if (landmarksWithRole.size > 1) {
            ...
            if (duplicatesWithoutLabel.length > 0 && "production" !== 'production') {}
            else if (false) {}
        }
    }
    /**
