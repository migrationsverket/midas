...
function IconCopy({name}) {
  const handleCopy = () => {
    navigator.clipboard.writeText(name);
    Toast/* toastQueue */.ni.add({
      type: "success",
  ...
  return (0,jsx_runtime.jsxs)(Tooltip/* TooltipTrigger */.k, {
    children: [(0,jsx_runtime.jsx)(useFocusable/* Focusable */.zo, {
      ...
      children: "Klicka för att kopiera"
    })]
  });
}
const toc = [{
