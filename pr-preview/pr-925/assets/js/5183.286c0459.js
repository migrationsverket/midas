"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[5183],{
...
function withFloating(Component) {
    function WithFloating(props) {
        ...
        var floatingProps = floating_ui_react_useFloating(_assign({ open: !hidePopper, whileElementsMounted: floating_ui_dom/* autoUpdate */.ll, placement: props.popperPlacement, middleware: __spreadArray([
                flip({ padding: 15 }),
