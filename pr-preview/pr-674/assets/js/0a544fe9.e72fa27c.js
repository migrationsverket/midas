...
'use client';var _excluded=["tabs","label","children","className","isDissmissable"];var Tabs=function Tabs(_ref){var tabs=_ref.tabs,label=_ref.label,children=_ref.children,className=_ref.className,isDissmissable=_ref.isDissmissable,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);var _useObserveElement=(0,useObserveElement/* default */.A)(typeof document==='undefined'?null:document.body,{includePadding:true}),bodyWidth=_useObserveElement.width;var orientation=bodyWidth>=tokens.windowSizes.md?'horizontal':'vertical';var childrenArray=react.Children.toArray(children);var _useState=(0,react.useState)(tabs),localTabs=_useState[0],setLocalTabs=_useState[1];var _useState2=(0,react.useState)(childrenArray),localChildren=_useState2[0],setLocalChildren=_useState2[1];(0,react.useEffect)(function(){setLocalTabs(tabs);setLocalChildren(childrenArray);},[tabs,children,childrenArray]);if(localChildren.length!==localTabs.length){console.error("The number of children must match the number of tabs. Children: "+localChildren.length+" Tabs: "+localTabs.length);return null;}var handleCloseTab=function handleCloseTab(tabToRemove){if(localTabs.length<=1)return;var index=localTabs.indexOf(tabToRemove);if(index===-1)return;var newTabs=[].concat(localTabs);newTabs.splice(index,1);var newChildren=[].concat(localChildren);newChildren.splice(index,1);setLocalTabs(newTabs);setLocalChildren(newChildren);};var tabContentMap=localChildren.reduce(function(acc,child,index){if(/*#__PURE__*/react.isValidElement(child)){var title=localTabs[index];if(title){acc[title]=/*#__PURE__*/react.cloneElement(child,{id:title});}}return acc;},{});return/*#__PURE__*/(0,jsx_runtime.jsxs)(dist_Tabs/* Tabs */.tU,Object.assign({orientation:orientation,className:(0,clsx/* default */.A)(Tabs_module.container,className)},rest,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Tabs/* TabList */.wb,{"aria-label":label,className:Tabs_module.list,children:localTabs.map(function(tab){return/*#__PURE__*/(0,jsx_runtime.jsxs)(dist_Tabs/* Tab */.oz,{id:tab,className:(0,clsx/* default */.A)(Tabs_module.listItem,isDissmissable&&Tabs_module.isDissmissableTab,localTabs.length===1&&Tabs_module.lastTab),children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{children:tab}),isDissmissable&&localTabs.length>1&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{className:Tabs_module.btn,variant:"icon",icon:x/* default */.A,size:"medium",iconPlacement:"right",onPress:function onPress(){return handleCloseTab(tab);}})]},tab);})}),localTabs.map(function(tab){return/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Tabs/* TabPanel */.Kp,{id:tab,className:Tabs_module.panel,children:tabContentMap[tab]},tab);})]}));};
