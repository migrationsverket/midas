"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9760],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_components_layout_index_mdx_a16_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./apps/docs/.docusaurus/docusaurus-plugin-content-docs/default/site-docs-components-layout-index-mdx-a16.json
const site_docs_components_layout_index_mdx_a16_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/layout/index","title":"Layout","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter.","source":"@site/docs/components/layout/index.mdx","sourceDirName":"components/layout","slug":"/components/layout/","permalink":"/pr-preview/pr-1339/components/layout/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Layout","description":"Modulärt layoutpaket för att sätta ihop sidstruktur med komponenter."},"sidebar":"sideBar","previous":{"title":"InfoBanner","permalink":"/pr-preview/pr-1339/components/info-banner"},"next":{"title":"Header","permalink":"/pr-preview/pr-1339/components/layout/header"}}');
...
;// ./apps/docs/docs/components/layout/index.mdx
