import{j as s}from"./jsx-runtime-CfatFE5O.js";import{$ as v,a as F,I as B,b as L}from"./TextField-CdDi8fW9.js";import{R as O}from"./index-ClcD9ViR.js";import{c as q}from"./clsx-B-dksMZM.js";import"./Form-Bnef0d36.js";import"./useFocusable-CUvAewCR.js";import"./index-ZuzByk-F.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./Text-CUSXFwf2.js";import"./useControlledState-DFHhQ_7Z.js";import"./Hidden-CB9z-rbJ.js";import"./Button-CSKZEJUE.js";import"./ButtonGroup-Duds0FV0.js";const z='"../../../theme/src/lib/tokens.css"',G='"Inter", sans-serif',H="#ffdfdf",J="(max-width: 767px)",K="#f2f2f2",Q="#e6e6e6",U="#bfbfbf",X="#000000",Y="#e62323",Z="#2e7ca5",ee="500",re="400",se="#1f1f1f",te="0 0 0 2px #ffffff, 0 0 0 4px #000000",ae="_textArea_9dtf9_4",oe="_count_9dtf9_40",ne="_countExceeded_9dtf9_48",a={tokens:z,display:G,signalRed10:H,smBreakpoint:J,gray10:K,gray20:Q,gray50:U,black:X,signalRed100:Y,blue100:Z,mediumWeight:ee,regularWeight:re,inputText:se,focus:te,textArea:ae,count:oe,countExceeded:ne},ce=({label:w,description:A,rows:D,maxCharacters:r,errorMessage:I,showCounter:N,validate:p,...P})=>{const[d,T]=O.useState(""),u=t=>{const l=t.target.value;T(l)},V=()=>r?s.jsxs("span",{className:q(a.count,d.length>r&&a.countExceeded),children:[d.length," / ",r]}):N?s.jsx("span",{className:a.count,children:d.length}):null,W=t=>{const l=r&&t.length>r?`${t.length-r} tecken för mycket`:null,M=p?p(t):null;return l||M||!0};return s.jsx(v,{className:F.inputField,validate:W,...P,children:s.jsxs(B,{label:w,description:A,errorMessage:I,children:[s.jsx(V,{}),s.jsx(L,{className:a.textArea,rows:D,onFocus:u,onChange:u})]})})},_e={component:ce,title:"Components/TextArea",tags:["autodocs"],argTypes:{label:{type:"string",description:"Etikett"},description:{type:"string"}}},e={args:{label:"Label",description:"Description"}},o={args:{...e.args,isInvalid:!0,errorMessage:"Error"}},n={args:{...e.args,maxCharacters:50}},c={args:{...e.args,showCounter:!0}},i={args:{...e.args,isDisabled:!0}};var m,g,f;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    label: 'Label',
