"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9717],{
...
var chunk_55IACEB6 = __webpack_require__(89625);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-QN33PNHL.mjs
var chunk_QN33PNHL = __webpack_require__(21152);
...
var MindmapDB = class {
  ...
  addNode(level, id, descr, type) {
    ...
    const conf = (0,chunk_ABZYJK2D/* getConfig2 */.D7)();
    let padding = conf.mindmap?.padding ?? chunk_ABZYJK2D/* defaultConfig_default */.UI.mindmap.padding;
    switch (type) {
    ...
    const node = {
      id: this.count++,
      nodeId: (0,chunk_ABZYJK2D/* sanitizeText */.jZ)(id, conf),
      level,
      descr: (0,chunk_ABZYJK2D/* sanitizeText */.jZ)(descr, conf),
      type,
      children: [],
      width: conf.mindmap?.maxNodeWidth ?? chunk_ABZYJK2D/* defaultConfig_default */.UI.mindmap.maxNodeWidth,
      padding,
      isRoot
    };
  ...
  decorateNode(decoration) {
    ...
    const config = (0,chunk_ABZYJK2D/* getConfig2 */.D7)();
    const node = this.nodes[this.nodes.length - 1];
    if (decoration.icon) {
      node.icon = (0,chunk_ABZYJK2D/* sanitizeText */.jZ)(decoration.icon, config);
    }
    if (decoration.class) {
      node.class = (0,chunk_ABZYJK2D/* sanitizeText */.jZ)(decoration.class, config);
    }
  }
  type2Str(type) {
    switch (type) {
  ...
  getData() {
    ...
    const config = (0,chunk_ABZYJK2D/* getConfig2 */.D7)();
    const userDefinedConfig = (0,chunk_ABZYJK2D/* getUserDefinedConfig */.TM)();
...
var draw = /* @__PURE__ */ (0,chunk_AGHRB4JF/* __name */.K2)(async (text, id, _version, diagObj) => {
  ...
  data4Layout.layoutAlgorithm = (0,chunk_N4CR4FBY/* getRegisteredLayoutAlgorithm */.q7)(data4Layout.config.layout, {
  ...
  await (0,chunk_N4CR4FBY/* render */.XX)(data4Layout, svg);
  (0,chunk_QN33PNHL/* setupViewPortForSVG */.P)(
    svg,
    data4Layout.config.mindmap?.padding ?? chunk_ABZYJK2D/* defaultConfig_default */.UI.mindmap.padding,
    "mindmapDiagram",
    data4Layout.config.mindmap?.useMaxWidth ?? chunk_ABZYJK2D/* defaultConfig_default */.UI.mindmap.useMaxWidth
  );
}, "draw");
