"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[3061],{
...
function $4e8b0456ef72939f$export$9610e69494fadfd2(props, state, ref) {
    ...
    let focus = ()=>{
        ...
        if (ref.current !== null && (keyWhenFocused.current != null && node.key !== keyWhenFocused.current || !((_ref_current = ref.current) === null || _ref_current === void 0 ? void 0 : _ref_current.contains(document.activeElement)))) (0, _react_aria_focus__WEBPACK_IMPORTED_MODULE_4__/* .focusSafely */ .l)(ref.current);
    };
    ...
    if (node != null && 'expandedKeys' in state) {
        ...
        if (node.level > 0 && (node === null || node === void 0 ? void 0 : node.parentKey) != null) {
            ...
            if (parent) {
                ...
                setSize = (0, _react_stately_collections__WEBPACK_IMPORTED_MODULE_5__/* .getLastItem */ .W)(siblings).index + 1;
            }
