"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[8578],{
...
/* harmony import */ var _react_aria_focus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(58374);
...
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44178);
...
function $880e95eb8b93ba9a$export$ecf600387e221c37(options) {
    ...
    let onSelect = (e)=>{
        if (e.pointerType === 'keyboard' && (0, _utils_mjs__WEBPACK_IMPORTED_MODULE_3__/* .isNonContiguousSelectionModifier */ .N)(e)) manager.toggleSelection(key);
        else {
    ...
    (0, react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{
        ...
        if (isFocused && manager.isFocused) {
            if (!shouldUseVirtualFocus) {
                if (focus) focus();
                else if (document.activeElement !== ref.current && ref.current) (0, _react_aria_focus__WEBPACK_IMPORTED_MODULE_5__/* .focusSafely */ .l)(ref.current);
            } else {
                var _ref_current;
                let updateActiveDescendant = new CustomEvent((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_6__/* .UPDATE_ACTIVEDESCENDANT */ .yI), {
                    cancelable: true,
                    bubbles: true
                });
    ...
    return {
        itemProps: (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_9__/* .mergeProps */ .v)(itemProps, allowsSelection || hasPrimaryAction ? pressProps : {}, longPressEnabled ? longPressProps : {}, {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CC: () => (/* binding */ $5671b20cf9b562b2$export$831c820ad60f9d12),
/* harmony export */   m9: () => (/* binding */ $5671b20cf9b562b2$export$447a38995de2c711),
/* harmony export */   yI: () => (/* binding */ $5671b20cf9b562b2$export$9db568f6321ad9dc)
/* harmony export */ });
/*
 * Copyright 2024 Adobe. All rights reserved.
 * This file is licensed to you under the Apache License, Version 2.0 (the "License");
...
// EXTERNAL MODULE: ./node_modules/@react-aria/utils/dist/constants.mjs
var constants = __webpack_require__(44178);
...
function $ae20dd8cbca75726$export$d6daf82dcd84e87c(options) {
    ...
    let onKeyDown = (e)=>{
        ...
        const navigateToKey = (key, childFocus)=>{
            if (key != null) {
                if (manager.isLink(key) && linkBehavior === 'selection' && selectOnFocus && !(0, utils/* isNonContiguousSelectionModifier */.N)(e)) {
                ...
                else if (selectOnFocus && !(0, utils/* isNonContiguousSelectionModifier */.N)(e)) manager.replaceSelection(key);
            }
        };
        switch(e.key){
            case 'ArrowDown':
    ...
    let onFocus = (e)=>{
        ...
        if (manager.focusedKey != null && scrollRef.current) {
            ...
            if (element) {
                ...
                if (!element.contains(document.activeElement)) (0, focusWithoutScrolling/* focusWithoutScrolling */.e)(element);
    ...
    // TODO: fix type later
    (0, useEvent/* useEvent */._)(ref, (0, constants/* FOCUS_EVENT */.CC), !shouldUseVirtualFocus ? undefined : (e)=>{
        let { detail: detail } = e;
        e.stopPropagation();
        manager.setFocused(true);
    ...
    let updateActiveDescendant = (0, useEffectEvent/* useEffectEvent */.J)(()=>{
        ...
        if (keyToFocus == null) {
            var _ref_current;
            (_ref_current = ref.current) === null || _ref_current === void 0 ? void 0 : _ref_current.dispatchEvent(new CustomEvent((0, constants/* UPDATE_ACTIVEDESCENDANT */.yI), {
                cancelable: true,
                bubbles: true
            }));
    ...
    (0, useEvent/* useEvent */._)(ref, (0, constants/* CLEAR_FOCUS_EVENT */.m9), !shouldUseVirtualFocus ? undefined : (e)=>{
        e.stopPropagation();
