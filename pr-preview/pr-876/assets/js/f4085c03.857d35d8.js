...
var info_banner_InfoBanner = __webpack_require__(59560);
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Försök så långt det går att beskriva vad användaren ska göra för att det ska bli rätt. Undvik att skriva generiska felmeddelanden som ”fel format”."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
      ...
      children: ["I tjänster som primärt är formulär som användaren ska fylla i, t.ex. e-ansökningar, använder vi förutom felmeddelande på varje kontroll även en Felmeddelandelista ovanför formuläret. Felmeddelandelistan är inte någon egen komponent utan består av en ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/info-banner",
        children: "Infobanner"
      }), " med ankarlänkar till de komponenter som behöver rättas till."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Det viktiga är att ", (0,jsx_runtime.jsx)(_components.code, {
        children: "href"
      }), " i listan matchar ", (0,jsx_runtime.jsx)(_components.code, {
        children: "id"
      }), " på det fält det länkar till — det är så ankarlänken fungerar och hjälpmedel kan navigera direkt till fältet."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "const [errors, setErrors] = useState({ name: false, email: false })\n\n{/* href måste matcha id på respektive fält */}\n{(errors.name || errors.email) && (\n  <InfoBanner type='warning' title='Justera dessa fält'>\n    <ul>\n      {errors.name && <li><Link href='#name'>Du måste ange ett namn</Link></li>}\n      {errors.email && <li><Link href='#email'>Du måste ange en e-postadress</Link></li>}\n    </ul>\n  </InfoBanner>\n)}\n<TextField id='name' label='Namn' isInvalid={errors.name} ... />\n<TextField id='email' label='E-postadress' isInvalid={errors.email} ... />\n"
      })
