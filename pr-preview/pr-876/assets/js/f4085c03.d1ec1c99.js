...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "För att undvika att användaren blir störd av för mycket felmeddelanden krävs en balans mellan att ge snabb återkoppling och att låta användaren jobba ostört."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "fält-som-är-obligatoriska-men-inte-kan-valideras-mot-format",
      children: "Fält som är obligatoriska men inte kan valideras mot format"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Fält som är obligatoriska, men saknar bestämt format eller regel, valideras efter att användaren försökt skicka in formuläret. I exemplet nedan blir det validerinsfel om fältet lämnas tomt."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      ...
      children: "Fält som har ett bestämt format eller regel valideras när användaren lämnat fältet. Eftersom det går att avgöra direkt om värdet är ogiltigt kan snabb återkoppling ges, vilket sparar tid för\nanvändaren och förhindrar fel längre fram. När användaren har rättat felet och lämnat fältet, återgår fältet till ursprungsläget och något felmeddelande visas inte längre."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Exempel: mejladress, telefonnummer, organisationsnummer/personnummer och postnummer"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        ...
        children: "Använd en positiv och inte en dömande ton. Undvik att skylla på eller antyda att användaren har gjort fel. Undvik ord som ogiltigt, otillåtet eller felaktigt."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
      ...
      children: ["I tjänster som primärt består av formulär som användaren ska fylla i, t.ex. e-ansökningar, ska det utöver felmeddelande på varje kontroll även visas en Felmeddelandelista ovanför formuläret. Syftet är att ge användaren en överblick över felen och vad som måste göras för att korrigera dem. Felmeddelandelistan är inte någon egen komponent utan består av en ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: (0,jsx_runtime.jsxs)(_components.p, {
        children: ["Val av metod för att hålla koll på vilka fält som är ogiltiga beror på vilket formulärbibliotek som används. Med t.ex. ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: "I exemplet ovan är båda fälten obligatoriska, men valideras först när användaren försöker skicka in formuläret. När det finns valideringsfel visas Felmeddelandelistan."
    })]
  });
}
