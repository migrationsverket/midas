...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "För att undvika att användaren blir överväldigad av felmeddelanden krävs att vi har en balans mellan att ge snabb återkoppling och låta användaren jobba ostört. Vissa fält ska ge omedelbar feedback när användaren lämnar dem, medan andra bara ska valideras vid efter att formuläret skickats."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "fält-som-är-obligatoriska-men-inte-kan-valideras-mot-format",
      children: "Fält som är obligatoriska men inte kan valideras mot format"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Fält som användaren måste fylla i men inte har ett bestämt format eller regel valideras efter att användaren försökt skicka in formuläret."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Exempel: Namn, fritextfält"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Motivering: Det finns inget \"fel\" förrän fältet är tomt vid inskick. Att validera dessa fält när användaren lämnar dem här riskerar att ge onödig stress och distraktion."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "fält-med-validerbart-format-eller-regel",
      children: "Fält med validerbart format eller regel"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Fält där vi har ett bestämt format eller regel valideras när användaren lämnat fältet. När användaren har rättat felet så återgår fältet till ursprungsläget och har inte längre något felmeddelande."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Exempel: e-postadress, telefonnummer, organisationsnummer/personnummer och postnummer"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Motivering: Eftersom vi direkt kan avgöra om värdet är ogiltigt kan vi snabbt ge feedback, vilket sparar tid för användaren och förhindrar fel längre fram."
    }), "\n", (0,jsx_runtime.jsx)("div", {
      className: "card",
      children: (0,jsx_runtime.jsx)(TextField/* TextField */.A, {
        type: "email",
      ...
      children: ["Fält som kontrolleras mot databas eller extern källa valideras efter användaren lämnat fältet. ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/pr-876/design-patterns/page-loading",
      ...
      children: ["I externa tjänster, tex e-ansökningar, som primärt är formulär som användaren ska fylla i, använder vi ", (0,jsx_runtime.jsx)(_components.code, {
        children: "Felmeddelandelista"
      }), " för att visa felen som kvarstår efter att formuläret skickats in. Felmeddelandelistan är inte någon egen komponent utan består av en ", (0,jsx_runtime.jsx)(_components.a, {
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Visa Felmeddelandelistan ovanför formuläret"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Länkarnas text ska vara felmeddelandet från komponeterna med valideringsfel."
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "riktlinjer-för-felmeddelandet",
