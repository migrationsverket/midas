...
const toc = [{
  ...
  "value": "Validering efter att användaren skickat in formuläret",
  "id": "validering-efter-att-användaren-skickat-in-formuläret",
  "level": 3
}, {
  "value": "Validering när användaren lämnar fältet",
  "id": "validering-när-användaren-lämnar-fältet",
  "level": 3
}, {
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      id: "validering-efter-att-användaren-skickat-in-formuläret",
      children: "Validering efter att användaren skickat in formuläret"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Fält som är obligatoriska men inte kan valideras mot ett specifikt format, tex obligatoriska fritextfält, valideras efter att användaren skickat in formuläret."
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "validering-när-användaren-lämnar-fältet",
      children: "Validering när användaren lämnar fältet"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
