...
const site_docs_dev_layout_components_header_mdx_019_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/header","title":"Header","description":"Sidhuvud med stöd för logotyp, åtgärdsknappar och mobilmeny.","source":"@site/docs/dev/layout/components/header.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/header","permalink":"/pr-preview/pr-1221/dev/layout/components/header","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Header","description":"Sidhuvud med stöd för logotyp, åtgärdsknappar och mobilmeny."},"sidebar":"sideBar","previous":{"title":"Migrationsguide","permalink":"/pr-preview/pr-1221/dev/layout/migration"},"next":{"title":"Layout, LayoutContent & Main","permalink":"/pr-preview/pr-1221/dev/layout/components/layout"}}');
