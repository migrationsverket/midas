...
/* unused harmony import specifier */ var brush_dispatch;
/* unused harmony import specifier */ var dragDisable;
/* unused harmony import specifier */ var dragEnable;
/* unused harmony import specifier */ var brush_interpolate;
/* unused harmony import specifier */ var pointer;
/* unused harmony import specifier */ var brush_select;
/* unused harmony import specifier */ var brush_interrupt;
/* unused harmony import specifier */ var brush_constant;
/* unused harmony import specifier */ var BrushEvent;
/* unused harmony import specifier */ var noevent;
/* unused harmony import specifier */ var nopropagation;
...
function brush_brush(dim) {
  var extent = defaultExtent,
      ...
      keys = true,
      listeners = brush_dispatch("start", "brush", "end"),
      handleSize = 6,
      touchending;
      ...
      group
          ...
          .tween("brush", function() {
            var that = this,
                ...
                i = brush_interpolate(selection0, selection1);
  ...
  Emitter.prototype = {
    ...
    emit: function(type, event, mode) {
      var d = brush_select(this.that).datum();
      listeners.call(
        type,
        this.that,
        new BrushEvent(type, {
  ...
  function started(event) {
    ...
    if (event.touches) {
      ...
      var view = brush_select(event.view)
  ...
  brush.extent = function(_) {
    return arguments.length ? (extent = typeof _ === "function" ? _ : brush_constant(number2(_)), brush) : extent;
  };

  brush.filter = function(_) {
    return arguments.length ? (filter = typeof _ === "function" ? _ : brush_constant(!!_), brush) : filter;
  };

  brush.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : brush_constant(!!_), brush) : touchable;
  };
...
/* unused harmony import specifier */ var zoom_dispatch;
/* unused harmony import specifier */ var zoom_dragDisable;
/* unused harmony import specifier */ var zoom_dragEnable;
/* unused harmony import specifier */ var interpolateZoom;
/* unused harmony import specifier */ var zoom_pointer;
/* unused harmony import specifier */ var zoom_select;
/* unused harmony import specifier */ var zoom_interrupt;
/* unused harmony import specifier */ var zoom_constant;
/* unused harmony import specifier */ var ZoomEvent;
/* unused harmony import specifier */ var zoom_identity;
/* unused harmony import specifier */ var zoom_Transform;
/* unused harmony import specifier */ var zoom_noevent;
/* unused harmony import specifier */ var zoom_nopropagation;
...
function defaultTransform() {
  return this.__zoom || zoom_identity;
}
...
/* harmony default export */ function zoom() {
  var filter = zoom_defaultFilter,
      ...
      listeners = zoom_dispatch("start", "zoom", "end"),
      touchstarting,
      touchfirst,
      touchending,
      touchDelay = 500,
  ...
  zoom.translateTo = function(selection, x, y, p, event) {
    zoom.transform(selection, function() {
      var e = extent.apply(this, arguments),
          t = this.__zoom,
          p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p;
      return constrain(zoom_identity.translate(p0[0], p0[1]).scale(t.k).translate(
        typeof x === "function" ? -x.apply(this, arguments) : -x,
        typeof y === "function" ? -y.apply(this, arguments) : -y
      ), e, translateExtent);
    }, p, event);
  ...
  function scale(transform, k) {
    ...
    return k === transform.k ? transform : new zoom_Transform(k, transform.x, transform.y);
  }

  function translate(transform, p0, p1) {
    var x = p0[0] - p1[0] * transform.k, y = p0[1] - p1[1] * transform.k;
    return x === transform.x && y === transform.y ? transform : new zoom_Transform(transform.k, x, y);
  }
    ...
    transition
        ...
        .tween("zoom", function() {
          ...
          return function(t) {
            ...
            else { var l = i(t), k = w / l[2]; t = new zoom_Transform(k, p[0] - l[0] * k, p[1] - l[1] * k); }
            g.zoom(null, t);
          };
        });
  }
  ...
  Gesture.prototype = {
    ...
    emit: function(type) {
      var d = zoom_select(this.that).datum();
      listeners.call(
        type,
        this.that,
        new ZoomEvent(type, {
  ...
  function mousedowned(event, ...args) {
    ...
    var currentTarget = event.currentTarget,
        ...
        v = zoom_select(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true),
        p = zoom_pointer(event, currentTarget),
        x0 = event.clientX,
        y0 = event.clientY;

    zoom_dragDisable(event.view);
    zoom_nopropagation(event);
    ...
    function mousemoved(event) {
      ...
      g.event(event)
       .zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = zoom_pointer(event, currentTarget), g.mouse[1]), g.extent, translateExtent));
    }

    function mouseupped(event) {
      v.on("mousemove.zoom mouseup.zoom", null);
      zoom_dragEnable(event.view, g.moved);
      zoom_noevent(event);
      g.event(event).end();
    }
  }
  ...
  function dblclicked(event, ...args) {
    if (!filter.apply(this, arguments)) return;
    var t0 = this.__zoom,
        p0 = zoom_pointer(event.changedTouches ? event.changedTouches[0] : event, this),
        p1 = t0.invert(p0),
        k1 = t0.k * (event.shiftKey ? 0.5 : 2),
        t1 = constrain(translate(scale(t0, k1), p0, p1), extent.apply(this, args), translateExtent);

    zoom_noevent(event);
    if (duration > 0) zoom_select(this).transition().duration(duration).call(schedule, t1, p0, event);
    else zoom_select(this).call(zoom.transform, t1, p0, event);
  }
  ...
  function touchstarted(event, ...args) {
    ...
    zoom_nopropagation(event);
    for (i = 0; i < n; ++i) {
      t = touches[i], p = zoom_pointer(t, this);
  ...
  function touchended(event, ...args) {
    ...
    if (g.touch0) g.touch0[1] = this.__zoom.invert(g.touch0[0]);
      ...
      if (g.taps === 2) {
        t = zoom_pointer(t, this);
        if (Math.hypot(touchfirst[0] - t[0], touchfirst[1] - t[1]) < tapDistance) {
          var p = zoom_select(this).on("dblclick.zoom");
  ...
  zoom.wheelDelta = function(_) {
    return arguments.length ? (wheelDelta = typeof _ === "function" ? _ : zoom_constant(+_), zoom) : wheelDelta;
  };

  zoom.filter = function(_) {
    return arguments.length ? (filter = typeof _ === "function" ? _ : zoom_constant(!!_), zoom) : filter;
  };

  zoom.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : zoom_constant(!!_), zoom) : touchable;
  };

  zoom.extent = function(_) {
    return arguments.length ? (extent = typeof _ === "function" ? _ : zoom_constant([[+_[0][0], +_[0][1]], [+_[1][0], +_[1][1]]]), zoom) : extent;
  };
