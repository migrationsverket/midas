...
const site_docs_components_tooltip_mdx_1e8_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/tooltip","title":"Tooltip","description":"Tooltip kan användas för att förklara en knapp eller annan interaktion när det inte går att få plats med informationen i knappen.","source":"@site/docs/components/tooltip.mdx","sourceDirName":"components","slug":"/components/tooltip","permalink":"/pr-preview/pr-1285/components/tooltip","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tooltip","description":"Tooltip kan användas för att förklara en knapp eller annan interaktion när det inte går att få plats med informationen i knappen."},"sidebar":"sideBar","previous":{"title":"Toast","permalink":"/pr-preview/pr-1285/components/toast"},"next":{"title":"Handlingar","permalink":"/pr-preview/pr-1285/design-patterns/actions"}}');
...
const Save = (0,createLucideIcon/* default */.A)("save", __iconNode);
...
const toc = [{
  ...
  "value": "Använd Tooltip för:",
  "id": "använd-tooltip-för",
  "level": 3
}, {
  "value": "Använd inte Tooltip för:",
  "id": "använd-inte-tooltip-för",
  "level": 3
}, {
  "value": "Riktlinjer",
  "id": "riktlinjer",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: "Komponent som användas för att visa kort, temporär och icke-essentiell information när användaren hovrar över eller fokuserar på ett element."
      ...
      children: ["Typiska användningsområden för Tooltip är för att förklara ikoner, för att visa kortkommandon eller för att beskriva en term. Tooltips ska inte användas för att visa information som användaren behöver för att kunna använda en komponent eller slutföra en uppgift. Om det finns mer information att visa än vad som ryms i en Tooltip, om det behövs interaktiva element eller om informationen är viktig för användaren används ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/components/popover",
        children: "Popover"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "använd-tooltip-för",
      children: "Använd Tooltip för:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Kort, stödjande information som är extra och inte nödvändig för att förstå eller slutföra en uppgift."
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "använd-inte-tooltip-för",
      children: "Använd inte Tooltip för:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Viktig information, felmeddelanden eller instruktioner som användaren måste se för att kunna fortsätta."
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "riktlinjer",
      children: "Riktlinjer"
      ...
      children: ["\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Håll texten kort och konkret"
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Se till att tooltipen beskriver samma sak som triggern visar."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Lägg inte längre text i en Tooltip än vad som är lätt att läsa på en gång."
      }), "\n", (0,jsx_runtime.jsx)(_components.li, {
        children: "Använd inte Tooltip som enda sätt att göra en funktion synlig eller förståelig"
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "implementation",
