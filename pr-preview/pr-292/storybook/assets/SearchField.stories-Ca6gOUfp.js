  ...
  render: function SimpleSearchComponent() {
    ...
    return <div style={{
      ...
      margin: '0 auto'
        ...
        <SearchField placeholder='Sök efter en frukt...' buttonText='Sök' onChange={value => setSearchTerm(value)} style={{
        width: '100%'
      }} />
