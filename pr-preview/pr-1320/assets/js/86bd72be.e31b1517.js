...
const site_docs_dev_tanstack_table_mdx_86b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tanstack-table","title":"Tanstack Table","description":"Implementation av Tanstack Table","source":"@site/docs/dev/tanstack-table.mdx","sourceDirName":"dev","slug":"/dev/tanstack-table","permalink":"/pr-preview/pr-1320/dev/tanstack-table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tanstack Table","description":"Implementation av Tanstack Table"},"sidebar":"sideBar","previous":{"title":"Tailwind CSS","permalink":"/pr-preview/pr-1320/dev/tailwind"}}');
...
var field02Base="light-dark(#fff, #383838)";// Sekundärfärg för fält, som ligger på layer01
...
var iconTertiary="light-dark(#143c50, #f2f2f2)";// Tertiär ikonfärg, används för ikoner i tertiary-knappar och länkikoner
