...
const site_docs_dev_layout_components_navbar_mdx_d09_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/navbar","title":"Navbar","description":"Navigationsbar längst ned på sidan för mobila enheter.","source":"@site/docs/dev/layout/components/navbar.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/navbar","permalink":"/pr-preview/pr-1310/dev/layout/components/navbar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Navbar","description":"Navigationsbar längst ned på sidan för mobila enheter."},"sidebar":"sideBar","previous":{"title":"Layout, LayoutContent & Main","permalink":"/pr-preview/pr-1310/dev/layout/components/layout"},"next":{"title":"Navigation","permalink":"/pr-preview/pr-1310/dev/layout/components/navigation"}}');
