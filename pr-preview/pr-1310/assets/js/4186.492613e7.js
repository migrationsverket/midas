"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[4186],{

/***/ 85652
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C7: () => (/* binding */ $9bf71ea28793e738$export$c5251b9e124bf29),
/* harmony export */   H8: () => (/* binding */ $9bf71ea28793e738$export$10c5169755ce7bd7),
/* harmony export */   N$: () => (/* binding */ $9bf71ea28793e738$export$2d6ec8fc375ceafa),
/* harmony export */   Pu: () => (/* binding */ $9bf71ea28793e738$export$1258395f99bf9cbf),
/* harmony export */   n1: () => (/* binding */ $9bf71ea28793e738$export$20e40289641fbbb6)
/* harmony export */ });
...
/* harmony import */ var _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72912);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(95562);
/* harmony import */ var _react_aria_interactions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4175);
...
const $9bf71ea28793e738$var$FocusContext = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_8__).createContext(null);
...
function $9bf71ea28793e738$export$20e40289641fbbb6(props) {
    ...
    let { parentNode: parentNode } = (0, react__WEBPACK_IMPORTED_MODULE_8__.useContext)($9bf71ea28793e738$var$FocusContext) || {};
    // Create a tree node here so we can add children to it even before it is added to the tree.
    let node = (0, react__WEBPACK_IMPORTED_MODULE_8__.useMemo)(()=>new $9bf71ea28793e738$var$TreeNode({
            scopeRef: scopeRef
        }), [
        scopeRef
    ]);
    ...
    (0, react__WEBPACK_IMPORTED_MODULE_8__.useEffect)(()=>{
        const activeElement = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(scopeRef.current ? scopeRef.current[0] : undefined));
        let scope = null;
    ...
    let focusManager = (0, react__WEBPACK_IMPORTED_MODULE_8__.useMemo)(()=>$9bf71ea28793e738$var$createFocusManagerForScope(scopeRef), []);
    ...
    return /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_8__).createElement($9bf71ea28793e738$var$FocusContext.Provider, {
        value: value
...
function $9bf71ea28793e738$export$10c5169755ce7bd7() {
    var _useContext;
    return (_useContext = (0, react__WEBPACK_IMPORTED_MODULE_8__.useContext)($9bf71ea28793e738$var$FocusContext)) === null || _useContext === void 0 ? void 0 : _useContext.focusManager;
}
function $9bf71ea28793e738$var$createFocusManagerForScope(scopeRef) {
    return {
        focusNext (opts = {}) {
            ...
            var _scope_;
            let node = from || (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)((_scope_ = scope[0]) !== null && _scope_ !== void 0 ? _scope_ : undefined));
...
function $9bf71ea28793e738$var$getRadiosInGroup(element) {
    ...
    return Array.from((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(element).querySelectorAll(`input[type="radio"][name="${CSS.escape(element.name)}"]`)).filter((radio)=>!radio.form);
    ...
    let ownerWindow = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerWindow */ .mD)(element);
...
function $9bf71ea28793e738$var$useFocusContainment(scopeRef, contain) {
    ...
    (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .useLayoutEffect */ .N)(()=>{
        ...
        const ownerDocument = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(scope ? scope[0] : undefined);
        // Handle the Tab key to contain focus within the scope
        let onKeyDown = (e)=>{
            if (e.key !== 'Tab' || e.altKey || e.ctrlKey || e.metaKey || !$9bf71ea28793e738$var$shouldContainFocus(scopeRef) || e.isComposing) return;
            let focusedElement = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)(ownerDocument);
            let scope = scopeRef.current;
        ...
        let onFocus = (e)=>{
            ...
            if ((!$9bf71ea28793e738$var$activeScope || $9bf71ea28793e738$var$isAncestorScope($9bf71ea28793e738$var$activeScope, scopeRef)) && $9bf71ea28793e738$var$isElementInScope((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getEventTarget */ .wt)(e), scopeRef.current)) {
                $9bf71ea28793e738$var$activeScope = scopeRef;
                focusedNode.current = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getEventTarget */ .wt)(e);
            } else if ($9bf71ea28793e738$var$shouldContainFocus(scopeRef) && !$9bf71ea28793e738$var$isElementInChildScope((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getEventTarget */ .wt)(e), scopeRef)) {
                // If a focus event occurs outside the active scope (e.g. user tabs from browser location bar),
                // restore focus to the previously focused node or the first tabbable element in the active scope.
                if (focusedNode.current) focusedNode.current.focus();
                else if ($9bf71ea28793e738$var$activeScope && $9bf71ea28793e738$var$activeScope.current) $9bf71ea28793e738$var$focusFirstInScope($9bf71ea28793e738$var$activeScope.current);
            } else if ($9bf71ea28793e738$var$shouldContainFocus(scopeRef)) focusedNode.current = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getEventTarget */ .wt)(e);
        };
        let onBlur = (e)=>{
            ...
            raf.current = requestAnimationFrame(()=>{
                ...
                let modality = (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_6__/* .getInteractionModality */ .ME)();
                let shouldSkipFocusRestore = (modality === 'virtual' || modality === null) && (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__/* .isAndroid */ .m0)() && (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_4__/* .isChrome */ .H8)();
                // Use document.activeElement instead of e.relatedTarget so we can tell if user clicked into iframe
                let activeElement = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)(ownerDocument);
...
function $9bf71ea28793e738$var$isElementInScope(element, scope) {
    ...
    return scope.some((node)=>(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .nodeContains */ .sD)(node, element));
}
...
function $9bf71ea28793e738$var$focusElement(element, scroll = false) {
    if (element != null && !scroll) try {
        (0, _react_aria_interactions__WEBPACK_IMPORTED_MODULE_7__/* .focusSafely */ .l)(element);
    } catch  {
    // ignore
    }
...
function $9bf71ea28793e738$var$useAutoFocus(scopeRef, autoFocus) {
    ...
    (0, react__WEBPACK_IMPORTED_MODULE_8__.useEffect)(()=>{
        if (autoFocusRef.current) {
            $9bf71ea28793e738$var$activeScope = scopeRef;
            const ownerDocument = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(scopeRef.current ? scopeRef.current[0] : undefined);
            if (!$9bf71ea28793e738$var$isElementInScope((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)(ownerDocument), $9bf71ea28793e738$var$activeScope.current) && scopeRef.current) $9bf71ea28793e738$var$focusFirstInScope(scopeRef.current);
        }
...
function $9bf71ea28793e738$var$useRestoreFocus(scopeRef, restoreFocus, contain) {
    ...
    const nodeToRestoreRef = (0, react__WEBPACK_IMPORTED_MODULE_8__.useRef)(typeof document !== 'undefined' ? (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(scopeRef.current ? scopeRef.current[0] : undefined)) : null);
    ...
    (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_3__/* .useLayoutEffect */ .N)(()=>{
        ...
        let onFocus = ()=>{
            // If focusing an element in a child scope of the currently active scope, the child becomes active.
            // Moving out of the active scope to an ancestor is not allowed.
            if ((!$9bf71ea28793e738$var$activeScope || $9bf71ea28793e738$var$isAncestorScope($9bf71ea28793e738$var$activeScope, scopeRef)) && $9bf71ea28793e738$var$isElementInScope((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)(ownerDocument), scopeRef.current)) $9bf71ea28793e738$var$activeScope = scopeRef;
        };
        ownerDocument.addEventListener('focusin', onFocus, false);
        scope === null || scope === void 0 ? void 0 : scope.forEach((element)=>element.addEventListener('focusin', onFocus, false));
        return ()=>{
...
function $9bf71ea28793e738$export$2d6ec8fc375ceafa(root, opts, scope) {
    let filter = (opts === null || opts === void 0 ? void 0 : opts.tabbable) ? (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__/* .isTabbable */ .A) : (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_5__/* .isFocusable */ .t);
    // Ensure that root is an Element or fall back appropriately
    let rootElement = (root === null || root === void 0 ? void 0 : root.nodeType) === Node.ELEMENT_NODE ? root : null;
    // Determine the document to use
    let doc = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(rootElement);
    // Create a TreeWalker, ensuring the root is an Element or Document
    let walker = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .createShadowTreeWalker */ .H)(doc, root || doc, NodeFilter.SHOW_ELEMENT, {
        acceptNode (node) {
            // Skip nodes inside the starting node.
            if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .nodeContains */ .sD)(opts === null || opts === void 0 ? void 0 : opts.from, node)) return NodeFilter.FILTER_REJECT;
...
function $9bf71ea28793e738$export$c5251b9e124bf29(ref, defaultOptions = {}) {
    return {
        focusNext (opts = {}) {
            ...
            let node = from || (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .getActiveElement */ .bq)((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_2__/* .getOwnerDocument */ .TW)(root));
            let walker = $9bf71ea28793e738$export$2d6ec8fc375ceafa(root, {
                tabbable: tabbable,
                accept: accept
            });
            if ((0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_1__/* .nodeContains */ .sD)(root, node)) walker.currentNode = node;
            let nextNode = walker.nextNode();
            if (!nextNode && wrap) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   H: () => (/* binding */ $dfc540311bf7f109$export$4d0f8be8b12a7ef6)
/* harmony export */ });
...
function $dfc540311bf7f109$export$4d0f8be8b12a7ef6(doc, root, whatToShow, filter) {
    if ((0, _react_stately_flags__WEBPACK_IMPORTED_MODULE_1__/* .shadowDOM */ .Nf)()) return new $dfc540311bf7f109$export$63eb3ababa9c55c4(doc, root, whatToShow, filter);
