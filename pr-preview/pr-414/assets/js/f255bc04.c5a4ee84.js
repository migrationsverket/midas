...
const site_docs_components_progress_bar_mdx_f25_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/progress-bar","title":"ProgressBar","description":"Progress bar med fördefinerad stil, använder role=\\"progressbar\\" under huven","source":"@site/docs/components/progress-bar.mdx","sourceDirName":"components","slug":"/components/progress-bar","permalink":"/pr-preview/pr-414/components/progress-bar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"ProgressBar","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
/* harmony default export */ const ProgressBar_module = ({"tokens":"\"../theme/tokens.css\"","--layer-accent-01":"light-dark(#d9d9d9, #383838)","--signal-green-140":"#008d3c","progressBar":"progressBar_fYul","label":"label_qT2F","value":"value_KQQb","bar":"bar_WK5A","fill":"fill_xgsq","indeterminate":"indeterminate_xtlO"});
