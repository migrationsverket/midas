"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[491],{
...
var chunk_7BUUIJ7U = __webpack_require__(91865);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-UBXNYLIW.mjs
var chunk_UBXNYLIW = __webpack_require__(6129);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-WRU74C26.mjs + 1 modules
var chunk_WRU74C26 = __webpack_require__(47244);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-4I5QYGJK.mjs + 12 modules
var chunk_4I5QYGJK = __webpack_require__(14512);
...
var diagramId = "";
var sanitizeText2 = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)((txt) => chunk_I66GZJ75/* common_default */.Y2.sanitizeText(txt, (0,chunk_I66GZJ75/* getConfig2 */.D7)()), "sanitizeText");
...
var db = {
  getConfig: /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(() => (0,chunk_I66GZJ75/* getConfig */.zj)().block, "getConfig"),
  typeStr2Type,
  edgeTypeStr2Type,
  edgeStrToEdgeData,
...
function layout(db2) {
  ...
  const padding = (0,chunk_I66GZJ75/* getConfig2 */.D7)()?.block?.padding ?? 8;
...
var createLabel = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (element, _vertexText, style, isTitle = false, isNode = false) => {
  ...
  const config = (0,chunk_I66GZJ75/* getConfig2 */.D7)();
  const useHtmlLabels = (0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)(config);
  return await (0,chunk_WRU74C26/* createText */.G)(
    element,
    vertexText,
    {
      style,
...
var insertEdgeLabel = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (elem, edge) => {
  ...
  const labelElement = await (0,chunk_WRU74C26/* createText */.G)(
    elem,
    edge.label,
    {
...
function setTerminalWidth(fo, value) {
  if ((0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)((0,chunk_I66GZJ75/* getConfig2 */.D7)()) && fo) {
...
var positionEdgeLabel = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)((edge, paths) => {
  ...
  const siteConfig = (0,chunk_I66GZJ75/* getConfig2 */.D7)();
  const { subGraphTitleTotalMargin } = (0,chunk_UBXNYLIW/* getSubGraphTitleMargins */.O)(siteConfig);
  if (edge.label) {
    const el = edgeLabels[edge.id];
    let x = edge.x;
    let y = edge.y;
    if (path) {
      const pos = chunk_NSK5VX7P/* utils_default */._K.calcLabelPosition(path);
      chunk_X3CZISLH/* log */.R.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = chunk_NSK5VX7P/* utils_default */._K.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = chunk_NSK5VX7P/* utils_default */._K.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = chunk_NSK5VX7P/* utils_default */._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = chunk_NSK5VX7P/* utils_default */._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var insertEdge = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(function(elem, e, edge, clusterDb, diagramType, graph, id) {
  ...
  let url = "";
  if ((0,chunk_I66GZJ75/* getConfig2 */.D7)().flowchart.arrowMarkerAbsolute || (0,chunk_I66GZJ75/* getConfig2 */.D7)().state.arrowMarkerAbsolute) {
    url = (0,chunk_I66GZJ75/* getUrl */.ID)(true);
  }
...
var labelHelper = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (parent, node, _classes, isNode) => {
  const config = (0,chunk_I66GZJ75/* getConfig2 */.D7)();
  let classes2;
  const useHtmlLabels = node.useHtmlLabels || (0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)(config);
  if (!_classes) {
  ...
  if (node.labelType === "markdown") {
    text = (0,chunk_WRU74C26/* createText */.G)(
      label,
      (0,chunk_I66GZJ75/* sanitizeText */.jZ)((0,chunk_NSK5VX7P/* decodeEntities */.Sm)(labelText), config),
      {
        useHtmlLabels,
  ...
  if ((0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)(config)) {
    const div = text.children[0];
    const dv = (0,src/* select */.Ltv)(text);
    await (0,chunk_UBXNYLIW/* configureLabelImages */.X)(div, labelText);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
var note = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (parent, node) => {
  const useHtmlLabels = node.useHtmlLabels || (0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)((0,chunk_I66GZJ75/* getConfig2 */.D7)());
  if (!useHtmlLabels) {
...
var rectWithTitle = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (parent, node) => {
  ...
  if ((0,chunk_I66GZJ75/* getEffectiveHtmlLabels */.E)((0,chunk_I66GZJ75/* getConfig2 */.D7)())) {
    const div = text.children[0];
    const dv = (0,src/* select */.Ltv)(text);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
var insertNode = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async (elem, node, renderOptions) => {
  ...
  if (node.link) {
    let target;
    if ((0,chunk_I66GZJ75/* getConfig2 */.D7)().securityLevel === "sandbox") {
      target = "_top";
...
function getNodeFromBlock(block, db2, positioned = false) {
  ...
  const styles = (0,chunk_NSK5VX7P/* getStylesFromArray */.sM)(vertex?.styles ?? []);
  ...
  const node = {
    ...
    intersect: void 0,
    type: vertex.type,
    padding: padding ?? (0,chunk_I66GZJ75/* getConfig */.zj)()?.block?.padding ?? 0,
...
async function calculateBlockSize(elem, block, db2) {
  ...
  const config = (0,chunk_I66GZJ75/* getConfig */.zj)();
...
var draw = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)(async function(text, id, _version, diagObj) {
  const { securityLevel, block: conf } = (0,chunk_I66GZJ75/* getConfig */.zj)();
  ...
  if (bounds) {
    ...
    (0,chunk_I66GZJ75/* configureSvgSize */.a$)(svg, height, width, !!useMaxWidth);
