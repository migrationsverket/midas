...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(74848);
var _excluded=["className"];var Breadcrumb=function Breadcrumb(_ref){var className=_ref.className,rest=(0,_home_runner_work_midas_midas_node_modules_babel_runtime_helpers_esm_objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)(_ref,_excluded);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(react_aria_components__WEBPACK_IMPORTED_MODULE_1__/* .Breadcrumb */ .Qp,Object.assign({className:(0,_utils_clsx__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A)(className)},rest));};
...
var _excluded=["className"],_excluded2=["items"];/** @deprecated since v16.6.3 Use the compound `<Breadcrumbs>` + `<Breadcrumb>` API instead. */function isDeprecatedUsage(props){if(!('items'in props)||!Array.isArray(props.items))return false;if(props.children!=null&&typeof props.children==='function')return false;var first=props.items[0];return first!=null&&'href'in first&&'title'in first;}var Breadcrumbs=function Breadcrumbs(_ref){var className=_ref.className,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);if(isDeprecatedUsage(rest)){if(false)// removed by dead control flow
{}var items=rest.items,ariaProps=(0,objectWithoutPropertiesLoose/* default */.A)(rest,_excluded2);return/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Breadcrumbs/* Breadcrumbs */.BI,Object.assign({className:(0,clsx/* default */.A)(Breadcrumbs_module.container,className)},ariaProps,{children:items.map(function(_ref2,index){var title=_ref2.title,href=_ref2.href,isDisabled=_ref2.isDisabled;return/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Breadcrumbs/* Breadcrumb */.Qp,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,{href:href,isDisabled:isDisabled,children:title})},title.toLocaleLowerCase()+index);})}));}return/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Breadcrumbs/* Breadcrumbs */.BI,Object.assign({className:(0,clsx/* default */.A)(Breadcrumbs_module.container,className)},rest));};
