...
const site_docs_components_skeleton_mdx_25b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/skeleton","title":"Skeleton","description":"Laddningsindikator för komponenter","source":"@site/docs/components/skeleton.mdx","sourceDirName":"components","slug":"/components/skeleton","permalink":"/pr-preview/pr-537/components/skeleton","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Skeleton","description":"Laddningsindikator för komponenter","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
...
var Skeleton=function Skeleton(_ref){var _ref$variant=_ref.variant,variant=_ref$variant===void 0?'rectangle':_ref$variant,width=_ref.width,height=_ref.height,_ref$animation=_ref.animation,animation=_ref$animation===void 0?'wave':_ref$animation,isAnimated=_ref.isAnimated;if(variant==='circle'&&height!==undefined){console.warn('Height is not allowed when using circle, control size with width');}if(variant==='rectangular'){console.warn('Rectangular will be deprecated since v8.4.0 - Use Rectangle instead. This will be removed in future versions');}return/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Skeleton_module.skeleton,Skeleton_module[variant],(isAnimated!=null?isAnimated:animation==='wave')&&Skeleton_module.wave),style:{width:width,height:height}});};
