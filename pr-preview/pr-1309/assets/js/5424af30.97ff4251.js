...
const site_docs_dev_layout_components_sidebar_mdx_542_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/layout/components/sidebar","title":"Sidebar","description":"Kollapsbar sidomeny för desktop.","source":"@site/docs/dev/layout/components/sidebar.mdx","sourceDirName":"dev/layout/components","slug":"/dev/layout/components/sidebar","permalink":"/pr-preview/pr-1309/dev/layout/components/sidebar","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Sidebar","description":"Kollapsbar sidomeny för desktop."},"sidebar":"sideBar","previous":{"title":"Panel","permalink":"/pr-preview/pr-1309/dev/layout/components/panel"},"next":{"title":"Routing på klientnivå","permalink":"/pr-preview/pr-1309/dev/client-side-routing"}}');
