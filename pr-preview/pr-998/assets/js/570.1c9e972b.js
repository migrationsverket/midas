"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[570],{
...
const $fc0b13b484ac1194$export$e5c5a5f917a5871c = typeof document !== 'undefined' ? (0, react).useLayoutEffect : ()=>{};
...
function $ce3a951440fc273f$var$renderWrapper(parent, reusableView, renderDropIndicator) {
    ...
    if ((node === null || node === void 0 ? void 0 : node.type) === 'item' && renderDropIndicator && layout.getDropTargetLayoutInfo) rendered = /*#__PURE__*/ (0, react).createElement((0, react).Fragment, {
        key: reusableView.key
    }, $ce3a951440fc273f$var$renderDropIndicatorWrapper(parent, reusableView, {
        type: 'item',
        key: reusableView.content.key,
        dropPosition: 'before'
    }, renderDropIndicator), rendered, (0, Collection/* renderAfterDropIndicators */.Cv)(collection, node, (target)=>$ce3a951440fc273f$var$renderDropIndicatorWrapper(parent, reusableView, target, renderDropIndicator)));
    return rendered;
}
...
class $61ef60fc9b1041f4$export$cacbb3924155d68e extends (0, $c74cda7d31af1253$export$c84671f46d6a1ca) {
    ...
    getDropTargetLayoutInfo(target) {
        ...
        let rect;
        if (target.dropPosition === 'before') rect = new (0, Rect/* Rect */.r)(layoutInfo.rect.x, Math.max(0, layoutInfo.rect.y - this.dropIndicatorThickness / 2), layoutInfo.rect.width, this.dropIndicatorThickness);
            ...
            rect = new (0, Rect/* Rect */.r)(layoutInfo.rect.x, layoutInfo.rect.maxY - this.dropIndicatorThickness / 2, layoutInfo.rect.width, this.dropIndicatorThickness);
