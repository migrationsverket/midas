...
/* unused harmony import specifier */ var $7yuSY$react;
...
function $dd149f63282afbbf$export$18fc8428861184da(opts) {
    ...
    (0, react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        ...
        let onScroll = (e)=>{
            ...
            let target = (0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .getEventTarget */ .wt)(e);
            // window is not a Node and doesn't have contain, but window contains everything
            if (!triggerRef.current || target instanceof Node && !(0, _react_aria_utils__WEBPACK_IMPORTED_MODULE_0__/* .nodeContains */ .sD)(target, triggerRef.current)) return;
...
function $2a41e45df1593e64$export$d39e1813b3bdd0e1(props) {
    ...
    let updatePosition = (0, react.useCallback)(()=>{
        ...
        if (scrollRef.current && (0, DOMFunctions/* isFocusWithin */.ae)(scrollRef.current)) {
            ...
            let anchorRect = (_getActiveElement = (0, DOMFunctions/* getActiveElement */.bq)()) === null || _getActiveElement === void 0 ? void 0 : _getActiveElement.getBoundingClientRect();
