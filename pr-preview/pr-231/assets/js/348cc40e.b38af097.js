...
'use client';var Layout=function Layout(_ref){var items=_ref.items,title=_ref.title,user=_ref.user,app=_ref.app,children=_ref.children,headerChildren=_ref.headerChildren,clientSideRouter=_ref.clientSideRouter;var _React$useState=react.useState(false),isCollapsed=_React$useState[0],setIsCollapsed=_React$useState[1];var _React$useState2=react.useState(false),isOpened=_React$useState2[0],setIsOpened=_React$useState2[1];react.useEffect(function(){var handleEsc=function handleEsc(event){if(event.key==='Escape'){setIsOpened(false);}};window.addEventListener('keydown',handleEsc);return function(){window.removeEventListener('keydown',handleEsc);};},[]);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.baseLayout,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(SkipLink,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(Header,{title:title,headerChildren:headerChildren,user:user,app:app,isOpened:isOpened,setIsOpened:setIsOpened,setIsCollapsed:setIsCollapsed}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.mainContent,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Sidebar,{items:items,app:app,isOpened:isOpened,isCollapsed:isCollapsed,setIsCollapsed:setIsCollapsed,setIsOpened:setIsOpened,clientSideRouter:clientSideRouter}),/*#__PURE__*/(0,jsx_runtime.jsx)(FlexItem/* FlexItem */.Z,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("main",{className:Layout_module.main,children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Layout_module.app,children:children})})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Layout_module.backdrop,isOpened&&Layout_module.backdropOpened),onClick:function onClick(){return setIsOpened(false);},"aria-hidden":true})]})]});};
