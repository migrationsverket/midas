...
;// ./packages/components/src/theme/tokens.ts
...
var _excluded=["label","title","children"];function Dropdown(_ref){var label=_ref.label,title=_ref.title,children=_ref.children,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsxs)(dist_Menu/* MenuTrigger */.cQ,Object.assign({},props,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Button/* Button */.$,{"aria-label":label,variant:"icon",children:[title,/*#__PURE__*/(0,jsx_runtime.jsx)(EllipsisVertical,{size:20,"aria-hidden":true})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Popover/* Popover */.A,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Menu/* Menu */.W1,Object.assign({},props,{className:Dropdown_module.dropDownMenu,children:children}))})]}));}function DropdownItem(props){var textValue=props.textValue||(typeof props.children==='string'?props.children:undefined);return/*#__PURE__*/(0,jsx_runtime.jsx)(dist_Menu/* MenuItem */.Dr,Object.assign({},props,{textValue:textValue,className:function className(_ref2){var isFocused=_ref2.isFocused,isOpen=_ref2.isOpen;return Dropdown_module.dropdownMenu+" "+(isFocused?'focused':'')+" "+(isOpen?'open':'');},children:function children(_ref3){var hasSubmenu=_ref3.hasSubmenu;return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[props.children,hasSubmenu&&/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{className:"chevron",viewBox:"0 0 24 24",children:/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:"m9 18 6-6-6-6"})})]});}}));}
...
'use client';var Layout=function Layout(_ref){var items=_ref.items,title=_ref.title,user=_ref.user,app=_ref.app,children=_ref.children,headerChildren=_ref.headerChildren,clientSideRouter=_ref.clientSideRouter;var _React$useState=react.useState(false),isCollapsed=_React$useState[0],setIsCollapsed=_React$useState[1];var _React$useState2=react.useState(false),isOpened=_React$useState2[0],setIsOpened=_React$useState2[1];react.useEffect(function(){var handleEsc=function handleEsc(event){if(event.key==='Escape'){setIsOpened(false);}};window.addEventListener('keydown',handleEsc);return function(){window.removeEventListener('keydown',handleEsc);};},[]);return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.baseLayout,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Header,{title:title,headerChildren:headerChildren,user:user,app:app,isOpened:isOpened,setIsOpened:setIsOpened,setIsCollapsed:setIsCollapsed}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.mainContent,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Sidebar,{items:items,app:app,isOpened:isOpened,isCollapsed:isCollapsed,setIsCollapsed:setIsCollapsed,clientSideRouter:clientSideRouter}),/*#__PURE__*/(0,jsx_runtime.jsx)(FlexItem/* FlexItem */.Z,{children:/*#__PURE__*/(0,jsx_runtime.jsx)("main",{className:Layout_module.main,children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Layout_module.app,children:children})})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:(0,clsx/* default */.A)(Layout_module.backdrop,isOpened&&Layout_module.backdropOpened),onClick:function onClick(){return setIsOpened(false);},"aria-hidden":true})]})]});};var Sidebar=function Sidebar(_ref2){var items=_ref2.items,app=_ref2.app,isOpened=_ref2.isOpened,isCollapsed=_ref2.isCollapsed,setIsCollapsed=_ref2.setIsCollapsed,clientSideRouter=_ref2.clientSideRouter;var LinkTree=function LinkTree(_ref3){var group=_ref3.group;return/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:Layout_module.list,children:group.items.map(function(link,i){return/*#__PURE__*/(0,jsx_runtime.jsx)("li",{className:(0,clsx/* default */.A)(Layout_module.listItem,isCollapsed&&Layout_module.listItemCollapsed),children:/*#__PURE__*/(0,jsx_runtime.jsx)(SidebarLink,Object.assign({},link,{isCollapsed:isCollapsed}))},'link_'+i);})});};return/*#__PURE__*/(0,jsx_runtime.jsxs)("aside",{id:"midasMainMenu",className:(0,clsx/* default */.A)(Layout_module.sidebar,isCollapsed&&Layout_module.sidebarCollapsed,isOpened&&Layout_module.sidebarOpened),children:[/*#__PURE__*/(0,jsx_runtime.jsx)("nav",{className:Layout_module.sidebarNav,children:/*#__PURE__*/(0,jsx_runtime.jsx)("ul",{className:Layout_module.list,children:items.map(function(group,i){return/*#__PURE__*/(0,jsx_runtime.jsxs)("li",{children:[group.title&&!isCollapsed&&/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Layout_module.listGroupTitle,children:group.title}),clientSideRouter?/*#__PURE__*/(0,jsx_runtime.jsx)(openLink/* RouterProvider */.pg,{navigate:clientSideRouter,children:/*#__PURE__*/(0,jsx_runtime.jsx)(LinkTree,{group:group})}):/*#__PURE__*/(0,jsx_runtime.jsx)(LinkTree,{group:group})]},'list_'+i);})})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.sidebarFooter,children:[!isCollapsed&&/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Layout_module.appName,children:app.name}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"tertiary","aria-label":isCollapsed?'Maximera sidomenyn':'Minimera sidomenyn',onPress:function onPress(){return setIsCollapsed(!isCollapsed);},className:Layout_module.collapseButton,children:isCollapsed?/*#__PURE__*/(0,jsx_runtime.jsx)(PanelLeftOpen,{size:20}):/*#__PURE__*/(0,jsx_runtime.jsx)(PanelLeftClose,{size:20})})]})]});};var Header=function Header(_ref4){var title=_ref4.title,user=_ref4.user,app=_ref4.app,headerChildren=_ref4.headerChildren,isOpened=_ref4.isOpened,setIsOpened=_ref4.setIsOpened,setIsCollapsed=_ref4.setIsCollapsed;return/*#__PURE__*/(0,jsx_runtime.jsxs)("header",{className:Layout_module.header,style:{borderTop:"solid 4px "+(app.color?app.color:midasColors.logoPrimary)},children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:Layout_module.headerContent,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Logo/* Logo */.g,{padding:false,size:"small",className:Layout_module.logo}),isOpened!==undefined&&setIsCollapsed&&setIsOpened&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* Button */.$,{variant:"icon",className:Layout_module.toggleButton,"aria-label":isOpened?'Stäng meny':'Öppna meny',"aria-controls":"midasMainMenu",onPress:function onPress(){setIsCollapsed(false);setIsOpened(!isOpened);},children:isOpened?/*#__PURE__*/(0,jsx_runtime.jsx)(x/* default */.A,{size:20,"aria-hidden":true}):/*#__PURE__*/(0,jsx_runtime.jsx)(Menu,{size:20,"aria-hidden":true})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Layout_module.userName,children:user.name}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Layout_module.userTitle,children:user.title}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:Layout_module.title,children:title})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Layout_module.headerItems,children:headerChildren}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:Layout_module.headerMenu,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Dropdown,{label:"\xD6ppna meny",children:react.Children.map(headerChildren,function(child){return/*#__PURE__*/(0,jsx_runtime.jsx)(DropdownItem,{children:child});})})})]});};var SidebarLink=function SidebarLink(_ref5){var title=_ref5.title,href=_ref5.href,active=_ref5.active,IconComponent=_ref5.icon,isCollapsed=_ref5.isCollapsed;var _React$useState3=react.useState(false),showText=_React$useState3[0],setShowText=_React$useState3[1];react.useEffect(function(){var timeoutId;if(!isCollapsed){timeoutId=setTimeout(function(){setShowText(true);},100);}else{setShowText(false);}return function(){clearTimeout(timeoutId);};},[isCollapsed]);if(isCollapsed)return/*#__PURE__*/(0,jsx_runtime.jsxs)(Tooltip/* TooltipTrigger */.k,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* Link */.N,{href:href,"aria-label":title,className:(0,clsx/* default */.A)(Layout_module.listLink,Layout_module.listLinkCollapsed,active&&Layout_module.active),children:/*#__PURE__*/(0,jsx_runtime.jsx)(IconComponent,{size:20,"aria-label":title})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip/* Tooltip */.m,{placement:"right",children:title})]});return/*#__PURE__*/(0,jsx_runtime.jsxs)(Link/* Link */.N,{href:href,"aria-label":title,className:(0,clsx/* default */.A)(Layout_module.listLink,active&&Layout_module.active),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconComponent,{size:20}),showText&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:Layout_module.linkText,children:title})]});};
...
const AppExample = () => {
  return (0,jsx_runtime.jsx)("div", {
    style: {
      background: src.baseColors.white,
      display: 'flex',
      justifyContent: 'center',
      alignItems: 'center',
      height: '100vh',
      border: `dotted 2px ${src.baseColors.gray20}`
    },
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
        children: "import { Header, Sidebar } from '@midas-ds/components'\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "riktlinjer",
      children: "Riktlinjer"
...
var _excluded=["children","placement"],_excluded2=["children","delay"];function Tooltip_Tooltip(_ref){var children=_ref.children,placement=_ref.placement,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Tooltip/* Tooltip */.m_,Object.assign({className:Tooltip_module.tooltip,placement:placement},props,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(OverlayArrow/* OverlayArrow */.k,{className:Tooltip_module.arrow,children:/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{width:8,height:8,viewBox:"0 0 8 8",children:/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:"M0 0 L4 4 L8 0"})})}),children]}));}function TooltipTrigger(_ref2){var children=_ref2.children,_ref2$delay=_ref2.delay,delay=_ref2$delay===void 0?0:_ref2$delay,props=(0,objectWithoutPropertiesLoose/* default */.A)(_ref2,_excluded2);return/*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip/* TooltipTrigger */.k$,Object.assign({delay:delay},props,{children:children}));}
