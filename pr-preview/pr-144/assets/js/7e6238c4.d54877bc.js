...
const site_docs_components_radio_mdx_7e6_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/radio","title":"Radio","description":"Radio Button är en typ av inmatningsfält som används för att välja ett alternativ från en uppsättning alternativ","source":"@site/docs/components/radio.mdx","sourceDirName":"components","slug":"/components/radio","permalink":"/pr-preview/pr-144/components/radio","draft":false,"unlisted":false,"tags":[{"inline":true,"label":"form","permalink":"/pr-preview/pr-144/tags/form"}],"version":"current","frontMatter":{"title":"Radio","description":"Radio Button är en typ av inmatningsfält som används för att välja ett alternativ från en uppsättning alternativ","tags":["form"]},"sidebar":"sideBar","previous":{"title":"MultiSelect","permalink":"/pr-preview/pr-144/components/multi-select"},"next":{"title":"SearchField","permalink":"/pr-preview/pr-144/components/search-field"}}');
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Radioknappar är en typ av inmatningsfält som används för att välja ett (1) alternativ från en uppsättning av flera alternativ. Om det är fler alternativ än fem bör ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/pr-144/components/select",
        children: "Select"
      }), " användas istället."]
