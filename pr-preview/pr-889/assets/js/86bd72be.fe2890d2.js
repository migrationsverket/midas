...
const site_docs_dev_tanstack_table_mdx_86b_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"dev/tanstack-table","title":"Tanstack Table","description":"Implementation av Tanstack Table","source":"@site/docs/dev/tanstack-table.mdx","sourceDirName":"dev","slug":"/dev/tanstack-table","permalink":"/pr-preview/pr-889/dev/tanstack-table","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Tanstack Table","description":"Implementation av Tanstack Table","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
...
(0,index_es/* registerLocale */.E)('sv',sv.sv);(0,index_es/* setDefaultLocale */.YC)('sv');var DefaultReactDatepickerExample=function DefaultReactDatepickerExample(){var _useState=(0,react.useState)(null),selectedDate=_useState[0],setSelectedDate=_useState[1];return/*#__PURE__*/(0,jsx_runtime.jsx)(index_es/* default */.Ay,{showIcon:true,selected:selectedDate,onChange:function onChange(date){return setSelectedDate(date);},preventOpenOnFocus:true,toggleCalendarOnIconClick:true,icon:/*#__PURE__*/(0,jsx_runtime.jsx)(calendar_days/* default */.A,{height:20}),showPopperArrow:false,dateFormat:"dd-MM-yyyy",placeholderText:"Select a date"});};var MonthSelectExample=function MonthSelectExample(){var _useState2=(0,react.useState)(null),selectedDate=_useState2[0],setSelectedDate=_useState2[1];return/*#__PURE__*/(0,jsx_runtime.jsx)(index_es/* default */.Ay,{showPopperArrow:false,selected:selectedDate,showIcon:true,preventOpenOnFocus:true,toggleCalendarOnIconClick:true,icon:/*#__PURE__*/(0,jsx_runtime.jsx)(calendar_days/* default */.A,{height:20})/*renderMonthContent={renderMonthContent}*/,showMonthYearPicker:true,onChange:function onChange(date){return setSelectedDate(date);},dateFormat:"MM-yyyy",placeholderText:"Select a date"});};
