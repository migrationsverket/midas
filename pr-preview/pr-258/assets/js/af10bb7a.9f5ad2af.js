...
const site_docs_components_select_mdx_af1_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"components/select","title":"Select","description":"<ComponentHeader","source":"@site/docs/components/select.mdx","sourceDirName":"components","slug":"/components/select","permalink":"/pr-preview/pr-258/components/select","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Select","pagination_prev":null,"pagination_next":null},"sidebar":"sideBar"}');
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Om det är färre alternativ än fem bör ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/pr-preview/pr-258/components/radio",
        children: "Radio"
      }), " användas istället."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h2, {
      id: "api",
...
/** Added this for a better output, will see how this plays out */function useMultiSelectState(props){var _useState=(0,react.useState)(false),isFocused=_useState[0],setFocused=_useState[1];var triggerState=(0,useMenuTriggerState/* useMenuTriggerState */.I)(props);var listState=useMultiSelectListState(Object.assign({},props,{onSelectionChange:function onSelectionChange(keys){if(props.onSelectionChange!=null){if(keys==='all'){// This may change back to "all" once we will implement async loading of additional
// items and differentiation between "select all" vs. "select visible".
props.onSelectionChange(Array.from(listState.collection.getKeys()));}else{props.onSelectionChange(Array.from(keys));}}// Multi select stays open after item selection
if(props.selectionMode==='single'){triggerState.close();}}}));return Object.assign({},listState,triggerState,{close:function close(){triggerState.close();},open:function open(){// Don't open if the collection is empty.
