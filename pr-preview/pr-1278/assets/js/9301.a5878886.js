"use strict";
(self["webpackChunk_midas_ds_source"] = self["webpackChunk_midas_ds_source"] || []).push([[9301],{
...
var DEFAULT_PIE_CONFIG = _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.pie;
var DEFAULT_PIE_DB = {
...
var createPieArcs = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((sections2) => {
  ...
  const pie = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .pie */ .rLf)().value((d) => d.value).sort(null);
  return pie(pieData);
}, "createPieArcs");
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((text, id, _version, diagObj) => {
  ...
  const globalConfig = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig2 */ .D7)();
  const pieConfig = (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(db2.getConfig(), globalConfig.pie);
  const MARGIN = 40;
  ...
  let [outerStrokeWidth] = (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .parseFontSize */ .I5)(themeVariables.pieOuterStrokeWidth);
  outerStrokeWidth ??= 2;
  ...
  const color = (0,d3__WEBPACK_IMPORTED_MODULE_6__/* .scaleOrdinal */ .UMr)(myGeneratedColors).domain([
    ...sections2.keys()
  ]);
  ...
  (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, height, totalWidth, pieConfig.useMaxWidth);
}, "draw");
var renderer = { draw };
