...
/* unused harmony import specifier */ var HeaderExamples_useBaseUrl;
/* unused harmony import specifier */ var MoreHorizontal;
/* unused harmony import specifier */ var Bell;
/* unused harmony import specifier */ var Settings;
/* unused harmony import specifier */ var User;
/* unused harmony import specifier */ var useMediaQuery;
/* unused harmony import specifier */ var Menu;
/* unused harmony import specifier */ var MenuItem;
/* unused harmony import specifier */ var MenuPopover;
/* unused harmony import specifier */ var MenuTrigger;
/* unused harmony import specifier */ var HeaderLogo;
/* unused harmony import specifier */ var HeaderTitle;
/* unused harmony import specifier */ var HeaderActions;
/* unused harmony import specifier */ var HeaderAction;
/* unused harmony import specifier */ var Header;
/* unused harmony import specifier */ var _jsx;
/* unused harmony import specifier */ var _jsxs;
var collapsibleActions=[{id:'profile',label:'Min profil',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(user/* default */.A,{size:20})},{id:'settings',label:'Inställningar',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(settings/* default */.A,{size:20})},{id:'help',label:'Hjälp',icon:/*#__PURE__*/(0,jsx_runtime.jsx)(circle_question_mark/* default */.A,{size:20})}];var BasicHeaderExample=function BasicHeaderExample(){return/*#__PURE__*/_jsx("div",{className:"card",style:{overflow:'hidden',padding:0},children:/*#__PURE__*/_jsxs(Header,{children:[/*#__PURE__*/_jsx(HeaderLogo,{}),/*#__PURE__*/_jsx(HeaderTitle,{children:"Mitt system"}),/*#__PURE__*/_jsxs(HeaderActions,{children:[/*#__PURE__*/_jsx(HeaderAction,{icon:/*#__PURE__*/_jsx(Bell,{size:20}),children:"Notiser"}),/*#__PURE__*/_jsx(HeaderAction,{icon:/*#__PURE__*/_jsx(User,{size:20}),children:"Min profil"}),/*#__PURE__*/_jsx(HeaderAction,{icon:/*#__PURE__*/_jsx(Settings,{size:20}),children:"Inst\xE4llningar"})]})]})});};var OverflowHeaderExample=function OverflowHeaderExample(){var isNarrow=useMediaQuery('(max-width: 700px)');return/*#__PURE__*/_jsx("div",{className:"card",style:{overflow:'hidden',padding:0},children:/*#__PURE__*/_jsxs(Header,{children:[/*#__PURE__*/_jsx(HeaderLogo,{}),/*#__PURE__*/_jsx(HeaderTitle,{children:"Mitt system"}),/*#__PURE__*/_jsxs(HeaderActions,{children:[/*#__PURE__*/_jsx(HeaderAction,{icon:/*#__PURE__*/_jsx(Bell,{size:20}),children:"Notiser"}),isNarrow?/*#__PURE__*/_jsxs(MenuTrigger,{children:[/*#__PURE__*/_jsx(HeaderAction,{"aria-label":"Fler alternativ",icon:/*#__PURE__*/_jsx(MoreHorizontal,{size:20})}),/*#__PURE__*/_jsx(MenuPopover,{children:/*#__PURE__*/_jsx(Menu,{children:collapsibleActions.map(function(action){return/*#__PURE__*/_jsx(MenuItem,{id:action.id,children:action.label},action.id);})})})]}):collapsibleActions.map(function(action){return/*#__PURE__*/_jsx(HeaderAction,{icon:action.icon,children:action.label},action.id);})]})]})});};var MobileHeaderExample=function MobileHeaderExample(){var url=HeaderExamples_useBaseUrl('/layout-examples/header-mobile');return/*#__PURE__*/_jsx("div",{className:"card",style:{overflow:'hidden',padding:0,maxWidth:480},children:/*#__PURE__*/_jsx("iframe",{title:"Header with mobile menu example",style:{width:'100%',height:72,border:'none',display:'block'},src:url})});};
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      children: ["Sidhuvudet innehåller logotypen och plats för globala handlingar. Renderar ett semantiskt ", (0,jsx_runtime.jsx)(_components.code, {
        children: "<header>"
      ...
      }), ". Varje global handling (", (0,jsx_runtime.jsx)(_components.code, {
        children: "HeaderAction"
      }), ") ska ha en ikon och en beskrivande etikett."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      children: ["Navigering på små skärmar/webbläsarfönster görs via Header och komponenten ", (0,jsx_runtime.jsx)(_components.code, {
        children: "MobileMenu"
