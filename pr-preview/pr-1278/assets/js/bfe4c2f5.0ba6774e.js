...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(getComponentMetaData/* ComponentHeader */.B, {
      ...
      }), " låter användaren välja mellan ljust läge, mörkt läge eller att följa systemets inställning."]
      ...
      children: ["Som standard påverkas ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":root"
      }), ", men du kan rikta mot ett annat element med ", (0,jsx_runtime.jsx)(_components.code, {
        children: "selector"
      }), "-propen. Det är användbart om du bara vill byta färgschema för en avgränsad del av sidan."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      children: [(0,jsx_runtime.jsx)(_components.code, {
        ...
        children: "'light dark'"
      }), ", vilket innebär att systemets inställning används."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-tsx",
      ...
      }), " för att reagera på användarens val — till exempel för att spara det i ", (0,jsx_runtime.jsx)(_components.code, {
...
'use client';var ColorSchemeSwitch=function ColorSchemeSwitch(_ref){var _ref$selector=_ref.selector,selector=_ref$selector===void 0?':root':_ref$selector,_ref$defaultScheme=_ref.defaultScheme,defaultScheme=_ref$defaultScheme===void 0?'light dark':_ref$defaultScheme,scheme=_ref.scheme,onSchemeChange=_ref.onSchemeChange,defaultValue=_ref.defaultValue,className=_ref.className;var _React$useState=react.useState(defaultValue!=null?defaultValue:new Set([scheme!=null?scheme:defaultScheme])),colorScheme=_React$useState[0],setColorScheme=_React$useState[1];var resolvedKeys=scheme?new Set([scheme]):colorScheme;react.useEffect(function(){var targetElement=document.querySelector(selector);if(targetElement){var resolved=Array.from(resolvedKeys).join(' ');targetElement.style.removeProperty('color-scheme');if(resolved==='light dark'){delete targetElement.dataset.colorScheme;}else{targetElement.dataset.colorScheme=resolved;}}else{console.warn("No element found for selector: \""+selector+"\"");}},[resolvedKeys,selector]);var strings=(0,useLocalizedStringFormatter/* useLocalizedStringFormatter */.oe)(translations_namespaceObject);var handleSelectionChange=function handleSelectionChange(keys){var next=Array.from(keys)[0];setColorScheme(keys);onSchemeChange==null||onSchemeChange(next);};return/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButtonGroup/* ToggleButtonGroup */.W,{selectionMode:"single",selectedKeys:resolvedKeys,onSelectionChange:handleSelectionChange,disallowEmptySelection:true,className:className,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton/* ToggleButton */.f,{id:"light dark",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(laptop/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:strings.format('system')}),/*#__PURE__*/(0,jsx_runtime.jsx)(SelectionIndicator/* SelectionIndicator */.i,{className:ColorSchemeSwitch_module.selectionIndicator})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton/* ToggleButton */.f,{id:"light",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(sun/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:strings.format('lightMode')}),/*#__PURE__*/(0,jsx_runtime.jsx)(SelectionIndicator/* SelectionIndicator */.i,{className:ColorSchemeSwitch_module.selectionIndicator})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)(ToggleButton/* ToggleButton */.f,{id:"dark",className:ColorSchemeSwitch_module.button,children:[/*#__PURE__*/(0,jsx_runtime.jsx)(moon/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(VisuallyHidden/* VisuallyHidden */.s,{children:strings.format('darkMode')}),/*#__PURE__*/(0,jsx_runtime.jsx)(SelectionIndicator/* SelectionIndicator */.i,{className:ColorSchemeSwitch_module.selectionIndicator})]})]});};
