...
// UNUSED EXPORTS: CardActionArea, CardActions, CardContent, CardImage, CardTitle
...
/* harmony default export */ const Card_module = ({"tokens":"\"../theme/tokens.css\"","--font-family":"\"Inter\", sans-serif","--background-01":"light-dark(#ffffff, #171717)","--border-strong":"light-dark(#171717, #f2f2f2)","--layer-01":"light-dark(#f2f2f2, #262626)","--border-subtle":"light-dark(#bfbfbf, #383838)","--notification-background-success":"light-dark(#d5f2d9, light-dark(#f2f2f2, #262626))","--notification-border-success":"light-dark(#008d3c, #008d3c)","--button-background-icon-hover":"light-dark(rgba(0 0 0 / 10%), rgba(255 255 255 / 10%))","--button-background-icon-active":"light-dark(rgba(0 0 0 / 20%), rgba(255 255 255 / 20%))","--focus":"0 0 0 2px white, 0 0 0 4px black","card":"card_Ssoo","cardEditable":"cardEditable_Np2h","cardSuccess":"cardSuccess_DfEX","horizontal":"horizontal_p4Mn","cardContent":"cardContent_JE5V","cardTitle":"cardTitle_N9Au","cardActions":"cardActions_HxzH","cardActionArea":"cardActionArea_re2y","cardImage":"cardImage_BIZa"});
// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(96540);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./packages/components/src/card/Card.tsx
var _excluded=["horizontal","status","state","className","children"],_excluded2=(/* unused pure expression or super */ null && (["children","className"])),_excluded3=(/* unused pure expression or super */ null && (["as","className"]));var CardContext=/*#__PURE__*/react.createContext({horizontal:undefined,status:undefined,state:undefined});var Card=function Card(_ref){var horizontal=_ref.horizontal,status=_ref.status,state=_ref.state,className=_ref.className,children=_ref.children,rest=(0,objectWithoutPropertiesLoose/* default */.A)(_ref,_excluded);return/*#__PURE__*/(0,jsx_runtime.jsx)(CardContext.Provider,{value:{horizontal:horizontal,status:status,state:state},children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",Object.assign({},rest,{className:(0,dist_clsx/* default */.A)(Card_module.card,horizontal&&Card_module.horizontal,state==='edit'&&Card_module.cardEditable,status==='success'&&Card_module.cardSuccess,className),children:children}))});};var CardContent=function CardContent(_ref2){var children=_ref2.children;var _React$useContext=React.useContext(CardContext),horizontal=_React$useContext.horizontal;return/*#__PURE__*/_jsx("div",{className:clsx(styles.cardContent,horizontal&&styles.horizontal),children:children});};var CardTitle=function CardTitle(_ref3){var _ref3$elementType=_ref3.elementType,elementType=_ref3$elementType===void 0?'h2':_ref3$elementType,children=_ref3.children;var _React$useContext2=React.useContext(CardContext),horizontal=_React$useContext2.horizontal;return/*#__PURE__*/_jsx(Heading,{level:horizontal?5:2,elementType:elementType,isExpressive:horizontal,className:clsx(styles.cardTitle,horizontal&&styles.horizontal),children:children});};var CardActions=function CardActions(_ref4){var children=_ref4.children;return/*#__PURE__*/_jsx("div",{className:styles.cardActions,children:children});};var CardActionArea=function CardActionArea(_ref5){var children=_ref5.children,className=_ref5.className,rest=_objectWithoutPropertiesLoose(_ref5,_excluded2);return/*#__PURE__*/_jsx(Button,Object.assign({},rest,{className:clsx(styles.cardActionArea,className),children:children}));};var CardImage=function CardImage(_ref6){var _ref6$as=_ref6.as,ImageComponent=_ref6$as===void 0?'img':_ref6$as,className=_ref6.className,rest=_objectWithoutPropertiesLoose(_ref6,_excluded3);return/*#__PURE__*/_jsx(ImageComponent,Object.assign({className:clsx(styles.cardImage,className)},rest));};
